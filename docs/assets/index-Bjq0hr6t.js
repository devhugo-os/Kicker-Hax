 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ze(){return typeof navigator<"u"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function Cc(){return typeof window<"u"&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(Ze())}function Zy(){var n;const e=(n=sa())===null||n===void 0?void 0:n.forceEnvironment;if(e==="node")return!0;if(e==="browser")return!1;try{return Object.prototype.toString.call(global.process)==="[object process]"}catch{return!1}}function ev(){return typeof navigator<"u"&&navigator.userAgent==="Cloudflare-Workers"}function tv(){const n=typeof chrome=="object"?chrome.runtime:typeof browser=="object"?browser.runtime:void 0;return typeof n=="object"&&n.id!==void 0}function Pp(){return typeof navigator=="object"&&navigator.product==="ReactNative"}function nv(){const n=Ze();return n.indexOf("MSIE ")>=0||n.indexOf("Trident/")>=0}function sv(){return wp.NODE_ADMIN===!0}function iv(){return!Zy()&&!!navigator.userAgent&&navigator.userAgent.includes("Safari")&&!navigator.userAgent.includes("Chrome")}function rv(){try{return typeof indexedDB=="object"}catch{return!1}}function ov(){return new Promise((n,e)=>{try{let t=!0;const s="validate-browser-context-for-indexeddb-analytics-module",i=self.indexedDB.open(s);i.onsuccess=()=>{i.result.close(),t||self.indexedDB.deleteDatabase(s),n(!0)},i.onupgradeneeded=()=>{t=!1},i.onerror=()=>{var r;e(((r=i.error)===null||r===void 0?void 0:r.message)||"")}}catch(t){e(t)}})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var te;(function(n){n[n.DEBUG=0]="DEBUG",n[n.VERBOSE=1]="VERBOSE",n[n.INFO=2]="INFO",n[n.WARN=3]="WARN",n[n.ERROR=4]="ERROR",n[n.SILENT=5]="SILENT"})(te||(te={}));const wv={debug:te.DEBUG,verbose:te.VERBOSE,info:te.INFO,warn:te.WARN,error:te.ERROR,silent:te.SILENT},Tv=te.INFO,Iv={[te.DEBUG]:"log",[te.VERBOSE]:"log",[te.INFO]:"info",[te.WARN]:"warn",[te.ERROR]:"error"},Cv=(n,e,...t)=>{if(e<n.logLevel)return;const s=new Date().toISOString(),i=Iv[e];if(i)console[i](`[${s}]  ${n.name}:`,...t);else throw new Error(`Attempted to log a message with an invalid logType (value: ${e})`)};class oa{constructor(e){this.name=e,this._logLevel=Tv,this._logHandler=Cv,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in te))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel=typeof e=="string"?wv[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if(typeof e!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,te.DEBUG,...e),this._logHandler(this,te.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,te.VERBOSE,...e),this._logHandler(this,te.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,te.INFO,...e),this._logHandler(this,te.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,te.WARN,...e),this._logHandler(this,te.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,te.ERROR,...e),this._logHandler(this,te.ERROR,...e)}}const bv=(n,e)=>e.some(t=>n instanceof t);let cd,hd;function Sv(){return cd||(cd=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function Rv(){return hd||(hd=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const Dp=new WeakMap,Ll=new WeakMap,xp=new WeakMap,sl=new WeakMap,bc=new WeakMap;function Av(n){const e=new Promise((t,s)=>{const i=()=>{n.removeEventListener("success",r),n.removeEventListener("error",o)},r=()=>{t(In(n.result)),i()},o=()=>{s(n.error),i()};n.addEventListener("success",r),n.addEventListener("error",o)});return e.then(t=>{t instanceof IDBCursor&&Dp.set(t,n)}).catch(()=>{}),bc.set(e,n),e}function kv(n){if(Ll.has(n))return;const e=new Promise((t,s)=>{const i=()=>{n.removeEventListener("complete",r),n.removeEventListener("error",o),n.removeEventListener("abort",o)},r=()=>{t(),i()},o=()=>{s(n.error||new DOMException("AbortError","AbortError")),i()};n.addEventListener("complete",r),n.addEventListener("error",o),n.addEventListener("abort",o)});Ll.set(n,e)}let Ol={get(n,e,t){if(n instanceof IDBTransaction){if(e==="done")return Ll.get(n);if(e==="objectStoreNames")return n.objectStoreNames||xp.get(n);if(e==="store")return t.objectStoreNames[1]?void 0:t.objectStore(t.objectStoreNames[0])}return In(n[e])},set(n,e,t){return n[e]=t,!0},has(n,e){return n instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in n}};function Pv(n){Ol=n(Ol)}function Nv(n){return n===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(e,...t){const s=n.call(il(this),e,...t);return xp.set(s,e.sort?e.sort():[e]),In(s)}:Rv().includes(n)?function(...e){return n.apply(il(this),e),In(Dp.get(this))}:function(...e){return In(n.apply(il(this),e))}}function Dv(n){return typeof n=="function"?Nv(n):(n instanceof IDBTransaction&&kv(n),bv(n,Sv())?new Proxy(n,Ol):n)}function In(n){if(n instanceof IDBRequest)return Av(n);if(sl.has(n))return sl.get(n);const e=Dv(n);return e!==n&&(sl.set(n,e),bc.set(e,n)),e}const il=n=>bc.get(n);function xv(n,e,{blocked:t,upgrade:s,blocking:i,terminated:r}={}){const o=indexedDB.open(n,e),l=In(o);return s&&o.addEventListener("upgradeneeded",c=>{s(In(o.result),c.oldVersion,c.newVersion,In(o.transaction),c)}),t&&o.addEventListener("blocked",c=>t(c.oldVersion,c.newVersion,c)),l.then(c=>{r&&c.addEventListener("close",()=>r()),i&&c.addEventListener("versionchange",h=>i(h.oldVersion,h.newVersion,h))}).catch(()=>{}),l}const Lv=["get","getKey","getAll","getAllKeys","count"],Ov=["put","add","delete","clear"],rl=new Map;function ud(n,e){if(!(n instanceof IDBDatabase&&!(e in n)&&typeof e=="string"))return;if(rl.get(e))return rl.get(e);const t=e.replace(/FromIndex$/,""),s=e!==t,i=Ov.includes(t);if(!(t in(s?IDBIndex:IDBObjectStore).prototype)||!(i||Lv.includes(t)))return;const r=async function(o,...l){const c=this.transaction(o,i?"readwrite":"readonly");let h=c.store;return s&&(h=h.index(l.shift())),(await Promise.all([h[t](...l),i&&c.done]))[0]};return rl.set(e,r),r}Pv(n=>({...n,get:(e,t,s)=>ud(e,t)||n.get(e,t,s),has:(e,t)=>!!ud(e,t)||n.has(e,t)}));/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const as=hE;function Lp(n,e={}){let t=n;typeof e!="object"&&(e={name:e});const s=Object.assign({name:Vl,automaticDataCollectionEnabled:!1},e),i=s.name;if(typeof i!="string"||!i)throw Cn.create("bad-app-name",{appName:String(i)});if(t||(t=Rp()),!t)throw Cn.create("no-options");const r=bo.get(i);if(r){if(Co(t,r.options)&&Co(s,r.config))return r;throw Cn.create("duplicate-app",{appName:i})}const o=new Ev(i);for(const c of Fl.values())o.addComponent(c);const l=new pE(t,s,o);return bo.set(i,l),l}function Sc(n=Vl){const e=bo.get(n);if(!e&&n===Vl&&Rp())return Lp();if(!e)throw Cn.create("no-app",{appName:n});return e}function kt(n,e,t){var s;let i=(s=uE[n])!==null&&s!==void 0?s:n;t&&(i+=`-${t}`);const r=i.match(/\s|\//),o=e.match(/\s|\//);if(r||o){const l=[`Unable to register library "${i}" with version "${e}":`];r&&l.push(`library name "${i}" contains illegal characters (whitespace or "/")`),r&&o&&l.push("and"),o&&l.push(`version name "${e}" contains illegal characters (whitespace or "/")`),nn.warn(l.join(" "));return}Xn(new Pn(`${i}-version`,()=>({library:i,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */kt(CE,bE,"app");function Rc(n,e){var t={};for(var s in n)Object.prototype.hasOwnProperty.call(n,s)&&e.indexOf(s)<0&&(t[s]=n[s]);if(n!=null&&typeof Object.getOwnPropertySymbols=="function")for(var i=0,s=Object.getOwnPropertySymbols(n);i<s.length;i++)e.indexOf(s[i])<0&&Object.prototype.propertyIsEnumerable.call(n,s[i])&&(t[s[i]]=n[s[i]]);return t}function Vp(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const SE=Vp,Fp=new ur("auth","Firebase",Vp());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const So=new oa("@firebase/auth");function RE(n,...e){So.logLevel<=te.WARN&&So.warn(`Auth (${as}): ${n}`,...e)}function ro(n,...e){So.logLevel<=te.ERROR&&So.error(`Auth (${as}): ${n}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function xt(n,...e){throw kc(n,...e)}function bt(n,...e){return kc(n,...e)}function Ac(n,e,t){const s=Object.assign(Object.assign({},SE()),{[e]:t});return new ur("auth","Firebase",s).create(e,{appName:n.name})}function Qn(n){return Ac(n,"operation-not-supported-in-this-environment","Operations that alter the current user are not supported in conjunction with FirebaseServerApp")}function AE(n,e,t){const s=t;if(!(e instanceof s))throw s.name!==e.constructor.name&&xt(n,"argument-error"),Ac(n,"argument-error",`Type of ${e.constructor.name} does not match expected instance.Did you pass a reference from a different Auth SDK?`)}function kc(n,...e){if(typeof n!="string"){const t=e[0],s=[...e.slice(1)];return s[0]&&(s[0].appName=n.name),n._errorFactory.create(t,...s)}return Fp.create(n,...e)}function Q(n,e,...t){if(!n)throw kc(e,...t)}function Jt(n){const e="INTERNAL ASSERTION FAILED: "+n;throw ro(e),new Error(e)}function sn(n,e){n||Jt(e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xE=new dr(3e4,6e4);function Nc(n,e){return n.tenantId&&!e.tenantId?Object.assign(Object.assign({},e),{tenantId:n.tenantId}):e}async function Xs(n,e,t,s,i={}){return Up(n,i,async()=>{let r={},o={};s&&(e==="GET"?o=s:r={body:JSON.stringify(s)});const l=Js(Object.assign({key:n.config.apiKey},o)).slice(1),c=await n._getAdditionalHeaders();c["Content-Type"]="application/json",n.languageCode&&(c["X-Firebase-Locale"]=n.languageCode);const h=Object.assign({method:e,headers:c},r);return ev()||(h.referrerPolicy="no-referrer"),Bp.fetch()(qp(n,n.config.apiHost,t,l),h)})}async function Up(n,e,t){n._canInitEmulator=!1;const s=Object.assign(Object.assign({},DE),e);try{const i=new OE(n),r=await Promise.race([t(),i.promise]);i.clearNetworkTimeout();const o=await r.json();if("needConfirmation"in o)throw Qr(n,"account-exists-with-different-credential",o);if(r.ok&&!("errorMessage"in o))return o;{const l=r.ok?o.errorMessage:o.error.message,[c,h]=l.split(" : ");if(c==="FEDERATED_USER_ID_ALREADY_LINKED")throw Qr(n,"credential-already-in-use",o);if(c==="EMAIL_EXISTS")throw Qr(n,"email-already-in-use",o);if(c==="USER_DISABLED")throw Qr(n,"user-disabled",o);const d=s[c]||c.toLowerCase().replace(/[_\s]+/g,"-");if(h)throw Ac(n,d,h);xt(n,d)}}catch(i){if(i instanceof ln)throw i;xt(n,"network-request-failed",{message:String(i)})}}async function LE(n,e,t,s,i={}){const r=await Xs(n,e,t,s,i);return"mfaPendingCredential"in r&&xt(n,"multi-factor-auth-required",{_serverResponse:r}),r}function qp(n,e,t,s){const i=`${e}${t}?${s}`;return n.config.emulator?Pc(n.config,i):`${n.config.apiScheme}://${i}`}class OE{constructor(e){this.auth=e,this.timer=null,this.promise=new Promise((t,s)=>{this.timer=setTimeout(()=>s(bt(this.auth,"network-request-failed")),xE.get())})}clearNetworkTimeout(){clearTimeout(this.timer)}}function Qr(n,e,t){const s={appName:n.name};t.email&&(s.email=t.email),t.phoneNumber&&(s.phoneNumber=t.phoneNumber);const i=bt(n,e,s);return i.customData._tokenResponse=t,i}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ro(n){var e;const t=n.auth,s=await n.getIdToken(),i=await Yi(n,Wp(t,{idToken:s}));Q(i==null?void 0:i.users.length,t,"internal-error");const r=i.users[0];n._notifyReloadListener(r);const o=!((e=r.providerUserInfo)===null||e===void 0)&&e.length?$p(r.providerUserInfo):[],l=qE(n.providerData,o),c=n.isAnonymous,h=!(n.email&&r.passwordHash)&&!(l!=null&&l.length),d=c?h:!1,p={uid:r.localId,displayName:r.displayName||null,photoURL:r.photoUrl||null,email:r.email||null,emailVerified:r.emailVerified||!1,phoneNumber:r.phoneNumber||null,tenantId:r.tenantId||null,providerData:l,metadata:new Ul(r.createdAt,r.lastLoginAt),isAnonymous:d};Object.assign(n,p)}async function UE(n){const e=ge(n);await Ro(e),await e.auth._persistUserIfCurrent(e),e.auth._notifyListenersIfCurrent(e)}function qE(n,e){return[...n.filter(s=>!e.some(i=>i.providerId===s.providerId)),...e]}function $p(n){return n.map(e=>{var{providerId:t}=e,s=Rc(e,["providerId"]);return{providerId:t,uid:s.rawId||"",displayName:s.displayName||null,email:s.email||null,phoneNumber:s.phoneNumber||null,photoURL:s.photoUrl||null}})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ps{constructor(){this.refreshToken=null,this.accessToken=null,this.expirationTime=null}get isExpired(){return!this.expirationTime||Date.now()>this.expirationTime-3e4}updateFromServerResponse(e){Q(e.idToken,"internal-error"),Q(typeof e.idToken<"u","internal-error"),Q(typeof e.refreshToken<"u","internal-error");const t="expiresIn"in e&&typeof e.expiresIn<"u"?Number(e.expiresIn):yd(e.idToken);this.updateTokensAndExpiration(e.idToken,e.refreshToken,t)}updateFromIdToken(e){Q(e.length!==0,"internal-error");const t=yd(e);this.updateTokensAndExpiration(e,null,t)}async getToken(e,t=!1){return!t&&this.accessToken&&!this.isExpired?this.accessToken:(Q(this.refreshToken,e,"user-token-expired"),this.refreshToken?(await this.refresh(e,this.refreshToken),this.accessToken):null)}clearRefreshToken(){this.refreshToken=null}async refresh(e,t){const{accessToken:s,refreshToken:i,expiresIn:r}=await WE(e,t);this.updateTokensAndExpiration(s,i,Number(r))}updateTokensAndExpiration(e,t,s){this.refreshToken=t||null,this.accessToken=e||null,this.expirationTime=Date.now()+s*1e3}static fromJSON(e,t){const{refreshToken:s,accessToken:i,expirationTime:r}=t,o=new Ps;return s&&(Q(typeof s=="string","internal-error",{appName:e}),o.refreshToken=s),i&&(Q(typeof i=="string","internal-error",{appName:e}),o.accessToken=i),r&&(Q(typeof r=="number","internal-error",{appName:e}),o.expirationTime=r),o}toJSON(){return{refreshToken:this.refreshToken,accessToken:this.accessToken,expirationTime:this.expirationTime}}_assign(e){this.accessToken=e.accessToken,this.refreshToken=e.refreshToken,this.expirationTime=e.expirationTime}_clone(){return Object.assign(new Ps,this.toJSON())}_performRefresh(){return Jt("not implemented")}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function mn(n,e){Q(typeof n=="string"||typeof n>"u","internal-error",{appName:e})}class Xt{constructor(e){var{uid:t,auth:s,stsTokenManager:i}=e,r=Rc(e,["uid","auth","stsTokenManager"]);this.providerId="firebase",this.proactiveRefresh=new BE(this),this.reloadUserInfo=null,this.reloadListener=null,this.uid=t,this.auth=s,this.stsTokenManager=i,this.accessToken=i.accessToken,this.displayName=r.displayName||null,this.email=r.email||null,this.emailVerified=r.emailVerified||!1,this.phoneNumber=r.phoneNumber||null,this.photoURL=r.photoURL||null,this.isAnonymous=r.isAnonymous||!1,this.tenantId=r.tenantId||null,this.providerData=r.providerData?[...r.providerData]:[],this.metadata=new Ul(r.createdAt||void 0,r.lastLoginAt||void 0)}async getIdToken(e){const t=await Yi(this,this.stsTokenManager.getToken(this.auth,e));return Q(t,this.auth,"internal-error"),this.accessToken!==t&&(this.accessToken=t,await this.auth._persistUserIfCurrent(this),this.auth._notifyListenersIfCurrent(this)),t}getIdTokenResult(e){return VE(this,e)}reload(){return UE(this)}_assign(e){this!==e&&(Q(this.uid===e.uid,this.auth,"internal-error"),this.displayName=e.displayName,this.photoURL=e.photoURL,this.email=e.email,this.emailVerified=e.emailVerified,this.phoneNumber=e.phoneNumber,this.isAnonymous=e.isAnonymous,this.tenantId=e.tenantId,this.providerData=e.providerData.map(t=>Object.assign({},t)),this.metadata._copy(e.metadata),this.stsTokenManager._assign(e.stsTokenManager))}_clone(e){const t=new Xt(Object.assign(Object.assign({},this),{auth:e,stsTokenManager:this.stsTokenManager._clone()}));return t.metadata._copy(this.metadata),t}_onReload(e){Q(!this.reloadListener,this.auth,"internal-error"),this.reloadListener=e,this.reloadUserInfo&&(this._notifyReloadListener(this.reloadUserInfo),this.reloadUserInfo=null)}_notifyReloadListener(e){this.reloadListener?this.reloadListener(e):this.reloadUserInfo=e}_startProactiveRefresh(){this.proactiveRefresh._start()}_stopProactiveRefresh(){this.proactiveRefresh._stop()}async _updateTokensIfNecessary(e,t=!1){let s=!1;e.idToken&&e.idToken!==this.stsTokenManager.accessToken&&(this.stsTokenManager.updateFromServerResponse(e),s=!0),t&&await Ro(this),await this.auth._persistUserIfCurrent(this),s&&this.auth._notifyListenersIfCurrent(this)}async delete(){if(Yt(this.auth.app))return Promise.reject(Qn(this.auth));const e=await this.getIdToken();return await Yi(this,ME(this.auth,{idToken:e})),this.stsTokenManager.clearRefreshToken(),this.auth.signOut()}toJSON(){return Object.assign(Object.assign({uid:this.uid,email:this.email||void 0,emailVerified:this.emailVerified,displayName:this.displayName||void 0,isAnonymous:this.isAnonymous,photoURL:this.photoURL||void 0,phoneNumber:this.phoneNumber||void 0,tenantId:this.tenantId||void 0,providerData:this.providerData.map(e=>Object.assign({},e)),stsTokenManager:this.stsTokenManager.toJSON(),_redirectEventId:this._redirectEventId},this.metadata.toJSON()),{apiKey:this.auth.config.apiKey,appName:this.auth.name})}get refreshToken(){return this.stsTokenManager.refreshToken||""}static _fromJSON(e,t){var s,i,r,o,l,c,h,d;const p=(s=t.displayName)!==null&&s!==void 0?s:void 0,m=(i=t.email)!==null&&i!==void 0?i:void 0,E=(r=t.phoneNumber)!==null&&r!==void 0?r:void 0,C=(o=t.photoURL)!==null&&o!==void 0?o:void 0,R=(l=t.tenantId)!==null&&l!==void 0?l:void 0,k=(c=t._redirectEventId)!==null&&c!==void 0?c:void 0,V=(h=t.createdAt)!==null&&h!==void 0?h:void 0,U=(d=t.lastLoginAt)!==null&&d!==void 0?d:void 0,{uid:q,emailVerified:ee,isAnonymous:he,providerData:de,stsTokenManager:I}=t;Q(q&&I,e,"internal-error");const _=Ps.fromJSON(this.name,I);Q(typeof q=="string",e,"internal-error"),mn(p,e.name),mn(m,e.name),Q(typeof ee=="boolean",e,"internal-error"),Q(typeof he=="boolean",e,"internal-error"),mn(E,e.name),mn(C,e.name),mn(R,e.name),mn(k,e.name),mn(V,e.name),mn(U,e.name);const y=new Xt({uid:q,auth:e,email:m,emailVerified:ee,displayName:p,isAnonymous:he,photoURL:C,phoneNumber:E,tenantId:R,stsTokenManager:_,createdAt:V,lastLoginAt:U});return de&&Array.isArray(de)&&(y.providerData=de.map(w=>Object.assign({},w))),k&&(y._redirectEventId=k),y}static async _fromIdTokenResponse(e,t,s=!1){const i=new Ps;i.updateFromServerResponse(t);const r=new Xt({uid:t.localId,auth:e,stsTokenManager:i,isAnonymous:s});return await Ro(r),r}static async _fromGetAccountInfoResponse(e,t,s){const i=t.users[0];Q(i.localId!==void 0,"internal-error");const r=i.providerUserInfo!==void 0?$p(i.providerUserInfo):[],o=!(i.email&&i.passwordHash)&&!(r!=null&&r.length),l=new Ps;l.updateFromIdToken(s);const c=new Xt({uid:i.localId,auth:e,stsTokenManager:l,isAnonymous:o}),h={uid:i.localId,displayName:i.displayName||null,photoURL:i.photoUrl||null,email:i.email||null,emailVerified:i.emailVerified||!1,phoneNumber:i.phoneNumber||null,tenantId:i.tenantId||null,providerData:r,metadata:new Ul(i.createdAt,i.lastLoginAt),isAnonymous:!(i.email&&i.passwordHash)&&!(r!=null&&r.length)};return Object.assign(c,h),c}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function wd(n){const e=n.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(Kp(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(zp(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(Yp(e))return"Blackberry";if(Jp(e))return"Webos";if(Gp(e))return"Safari";if((e.includes("chrome/")||Hp(e))&&!e.includes("edge/"))return"Chrome";if(Qp(e))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,s=n.match(t);if((s==null?void 0:s.length)===2)return s[1]}return"Other"}function zp(n=Ze()){return/firefox\//i.test(n)}function Gp(n=Ze()){const e=n.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function Hp(n=Ze()){return/crios\//i.test(n)}function Kp(n=Ze()){return/iemobile/i.test(n)}function Qp(n=Ze()){return/android/i.test(n)}function Yp(n=Ze()){return/blackberry/i.test(n)}function Jp(n=Ze()){return/webos/i.test(n)}function xc(n=Ze()){return/iphone|ipad|ipod/i.test(n)||/macintosh/i.test(n)&&/mobile/i.test(n)}function jE(n=Ze()){var e;return xc(n)&&!!(!((e=window.navigator)===null||e===void 0)&&e.standalone)}function zE(){return nv()&&document.documentMode===10}function Xp(n=Ze()){return xc(n)||Qp(n)||Jp(n)||Yp(n)||/windows phone/i.test(n)||Kp(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Zp(n,e=[]){let t;switch(n){case"Browser":t=wd(Ze());break;case"Worker":t=`${wd(Ze())}-${n}`;break;default:t=n}const s=e.length?e.join(","):"FirebaseCore-web";return`${t}/JsCore/${as}/${s}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Lc={async loadJS(){throw new Error("Unable to load external scripts")},recaptchaV2Script:"",recaptchaEnterpriseScript:"",gapiScript:""};function JE(n){Lc=n}function XE(n){return Lc.loadJS(n)}function ZE(){return Lc.gapiScript}function ew(n){return`__${n}${Math.floor(Math.random()*1e6)}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function tw(n,e){const t=aa(n,"auth");if(t.isInitialized()){const i=t.getImmediate(),r=t.getOptions();if(Co(r,e??{}))return i;xt(i,"already-initialized")}return t.initialize({options:e})}function nw(n,e){const t=(e==null?void 0:e.persistence)||[],s=(Array.isArray(t)?t:[t]).map(Zt);e!=null&&e.errorMap&&n._updateErrorMap(e.errorMap),n._initializeWithPersistence(s,e==null?void 0:e.popupRedirectResolver)}function sw(n,e,t){const s=la(n);Q(s._canInitEmulator,s,"emulator-config-failed"),Q(/^https?:\/\//.test(e),s,"invalid-emulator-scheme");const i=!1,r=em(e),{host:o,port:l}=iw(e),c=l===null?"":`:${l}`;s.config.emulator={url:`${r}//${o}${c}/`},s.settings.appVerificationDisabledForTesting=!0,s.emulatorConfig=Object.freeze({host:o,port:l,protocol:r.replace(":",""),options:Object.freeze({disableWarnings:i})}),rw()}function em(n){const e=n.indexOf(":");return e<0?"":n.substr(0,e+1)}function iw(n){const e=em(n),t=/(\/\/)?([^?#/]+)/.exec(n.substr(e.length));if(!t)return{host:"",port:null};const s=t[2].split("@").pop()||"",i=/^(\[[^\]]+\])(:|$)/.exec(s);if(i){const r=i[1];return{host:r,port:Id(s.substr(r.length+1))}}else{const[r,o]=s.split(":");return{host:r,port:Id(o)}}}function Id(n){if(!n)return null;const e=Number(n);return isNaN(e)?null:e}function rw(){function n(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",n):n())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ds(n,e){return LE(n,"POST","/v1/accounts:signInWithIdp",Nc(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ow="http://localhost";class Zn extends tm{constructor(){super(...arguments),this.pendingToken=null}static _fromParams(e){const t=new Zn(e.providerId,e.signInMethod);return e.idToken||e.accessToken?(e.idToken&&(t.idToken=e.idToken),e.accessToken&&(t.accessToken=e.accessToken),e.nonce&&!e.pendingToken&&(t.nonce=e.nonce),e.pendingToken&&(t.pendingToken=e.pendingToken)):e.oauthToken&&e.oauthTokenSecret?(t.accessToken=e.oauthToken,t.secret=e.oauthTokenSecret):xt("argument-error"),t}toJSON(){return{idToken:this.idToken,accessToken:this.accessToken,secret:this.secret,nonce:this.nonce,pendingToken:this.pendingToken,providerId:this.providerId,signInMethod:this.signInMethod}}static fromJSON(e){const t=typeof e=="string"?JSON.parse(e):e,{providerId:s,signInMethod:i}=t,r=Rc(t,["providerId","signInMethod"]);if(!s||!i)return null;const o=new Zn(s,i);return o.idToken=r.idToken||void 0,o.accessToken=r.accessToken||void 0,o.secret=r.secret,o.nonce=r.nonce,o.pendingToken=r.pendingToken||null,o}_getIdTokenResponse(e){const t=this.buildRequest();return Ds(e,t)}_linkToIdToken(e,t){const s=this.buildRequest();return s.idToken=t,Ds(e,s)}_getReauthenticationResolver(e){const t=this.buildRequest();return t.autoCreate=!1,Ds(e,t)}buildRequest(){const e={requestUri:ow,returnSecureToken:!0};if(this.pendingToken)e.pendingToken=this.pendingToken;else{const t={};this.idToken&&(t.id_token=this.idToken),this.accessToken&&(t.access_token=this.accessToken),this.secret&&(t.oauth_token_secret=this.secret),t.providerId=this.providerId,this.nonce&&!this.pendingToken&&(t.nonce=this.nonce),e.postBody=Js(t)}return e}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function um(n,e){return e?Zt(e):(Q(n._popupRedirectResolver,n,"argument-error"),n._popupRedirectResolver)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class dm{constructor(e,t,s,i,r=!1){this.auth=e,this.resolver=s,this.user=i,this.bypassAuthState=r,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(t)?t:[t]}execute(){return new Promise(async(e,t)=>{this.pendingPromise={resolve:e,reject:t};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(s){this.reject(s)}})}async onAuthEvent(e){const{urlResponse:t,sessionId:s,postBody:i,tenantId:r,error:o,type:l}=e;if(o){this.reject(o);return}const c={auth:this.auth,requestUri:t,sessionId:s,tenantId:r||void 0,postBody:i||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(l)(c))}catch(h){this.reject(h)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return kw;case"linkViaPopup":case"linkViaRedirect":return Nw;case"reauthViaPopup":case"reauthViaRedirect":return Pw;default:xt(this.auth,"internal-error")}}resolve(e){sn(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){sn(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Dw=new dr(2e3,1e4);async function xw(n,e,t){if(Yt(n.app))return Promise.reject(bt(n,"operation-not-supported-in-this-environment"));const s=la(n);AE(n,e,Oc);const i=um(s,t);return new Gn(s,"signInViaPopup",e,i).executeNotNull()}class Gn extends dm{constructor(e,t,s,i,r){super(e,t,i,r),this.provider=s,this.authWindow=null,this.pollId=null,Gn.currentPopupAction&&Gn.currentPopupAction.cancel(),Gn.currentPopupAction=this}async executeNotNull(){const e=await this.execute();return Q(e,this.auth,"internal-error"),e}async onExecution(){sn(this.filter.length===1,"Popup operations only handle one event");const e=Mc();this.authWindow=await this.resolver._openPopup(this.auth,this.provider,this.filter[0],e),this.authWindow.associatedEvent=e,this.resolver._originValidation(this.auth).catch(t=>{this.reject(t)}),this.resolver._isIframeWebStorageSupported(this.auth,t=>{t||this.reject(bt(this.auth,"web-storage-unsupported"))}),this.pollUserCancellation()}get eventId(){var e;return((e=this.authWindow)===null||e===void 0?void 0:e.associatedEvent)||null}cancel(){this.reject(bt(this.auth,"cancelled-popup-request"))}cleanUp(){this.authWindow&&this.authWindow.close(),this.pollId&&window.clearTimeout(this.pollId),this.authWindow=null,this.pollId=null,Gn.currentPopupAction=null}pollUserCancellation(){const e=()=>{var t,s;if(!((s=(t=this.authWindow)===null||t===void 0?void 0:t.window)===null||s===void 0)&&s.closed){this.pollId=window.setTimeout(()=>{this.pollId=null,this.reject(bt(this.auth,"popup-closed-by-user"))},8e3);return}this.pollId=window.setTimeout(e,Dw.get())};e()}}Gn.currentPopupAction=null;/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Lw="pendingRedirect",ao=new Map;class Ow extends dm{constructor(e,t,s=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],t,void 0,s),this.eventId=null}async execute(){let e=ao.get(this.auth._key());if(!e){try{const s=await Mw(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(s)}catch(t){e=()=>Promise.reject(t)}ao.set(this.auth._key(),e)}return this.bypassAuthState||ao.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const t=await this.auth._redirectUserForId(e.eventId);if(t)return this.user=t,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function Mw(n,e){const t=Bw(e),s=Fw(n);if(!await s._isAvailable())return!1;const i=await s._get(t)==="true";return await s._remove(t),i}function Vw(n,e){ao.set(n._key(),e)}function Fw(n){return Zt(n._redirectPersistence)}function Bw(n){return oo(Lw,n.config.apiKey,n.name)}async function Uw(n,e,t=!1){if(Yt(n.app))return Promise.reject(Qn(n));const s=la(n),i=um(s,e),o=await new Ow(s,i,t).execute();return o&&!t&&(delete o.user._redirectEventId,await s._persistUserIfCurrent(o.user),await s._setRedirectUser(null,e)),o}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qw=new dr(3e4,6e4);function Ad(){const n=Pt().___jsl;if(n!=null&&n.H){for(const e of Object.keys(n.H))if(n.H[e].r=n.H[e].r||[],n.H[e].L=n.H[e].L||[],n.H[e].r=[...n.H[e].L],n.CP)for(let t=0;t<n.CP.length;t++)n.CP[t]=null}}function Yw(n){return new Promise((e,t)=>{var s,i,r;function o(){Ad(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{Ad(),t(bt(n,"network-request-failed"))},timeout:Qw.get()})}if(!((i=(s=Pt().gapi)===null||s===void 0?void 0:s.iframes)===null||i===void 0)&&i.Iframe)e(gapi.iframes.getContext());else if(!((r=Pt().gapi)===null||r===void 0)&&r.load)o();else{const l=ew("iframefcb");return Pt()[l]=()=>{gapi.load?o():t(bt(n,"network-request-failed"))},XE(`${ZE()}?onload=${l}`).catch(c=>t(c))}}).catch(e=>{throw lo=null,e})}let lo=null;function Jw(n){return lo=lo||Yw(n),lo}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xw=new dr(5e3,15e3),Zw="__/auth/iframe",eT="emulator/auth/iframe",tT={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},nT=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function sT(n){const e=n.config;Q(e.authDomain,n,"auth-domain-config-required");const t=e.emulator?Pc(e,eT):`https://${n.config.authDomain}/${Zw}`,s={apiKey:e.apiKey,appName:n.name,v:as},i=nT.get(n.config.apiHost);i&&(s.eid=i);const r=n._getFrameworks();return r.length&&(s.fw=r.join(",")),`${t}?${Js(s).slice(1)}`}async function iT(n){const e=await Jw(n),t=Pt().gapi;return Q(t,n,"internal-error"),e.open({where:document.body,url:sT(n),messageHandlersFilter:t.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:tT,dontclear:!0},s=>new Promise(async(i,r)=>{await s.restyle({setHideOnLeave:!1});const o=bt(n,"network-request-failed"),l=Pt().setTimeout(()=>{r(o)},Xw.get());function c(){Pt().clearTimeout(l),i(s)}s.ping(c).then(c,()=>{r(o)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const dT="__/auth/handler",fT="emulator/auth/handler",pT=encodeURIComponent("fac");async function Pd(n,e,t,s,i,r){Q(n.config.authDomain,n,"auth-domain-config-required"),Q(n.config.apiKey,n,"invalid-api-key");const o={apiKey:n.config.apiKey,appName:n.name,authType:t,redirectUrl:s,v:as,eventId:i};if(e instanceof Oc){e.setDefaultLanguage(n.languageCode),o.providerId=e.providerId||"",xl(e.getCustomParameters())||(o.customParameters=JSON.stringify(e.getCustomParameters()));for(const[d,p]of Object.entries({}))o[d]=p}if(e instanceof fr){const d=e.getScopes().filter(p=>p!=="");d.length>0&&(o.scopes=d.join(","))}n.tenantId&&(o.tid=n.tenantId);const l=o;for(const d of Object.keys(l))l[d]===void 0&&delete l[d];const c=await n._getAppCheckToken(),h=c?`#${pT}=${encodeURIComponent(c)}`:"";return`${mT(n)}?${Js(l).slice(1)}${h}`}function mT({config:n}){return n.emulator?Pc(n,fT):`https://${n.authDomain}/${dT}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ll="webStorageSupport";class gT{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=om,this._completeRedirectFn=Uw,this._overrideRedirectResult=Vw}async _openPopup(e,t,s,i){var r;sn((r=this.eventManagers[e._key()])===null||r===void 0?void 0:r.manager,"_initialize() not called before _openPopup()");const o=await Pd(e,t,s,Bl(),i);return hT(e,o,Mc())}async _openRedirect(e,t,s,i){await this._originValidation(e);const r=await Pd(e,t,s,Bl(),i);return vw(r),new Promise(()=>{})}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:i,promise:r}=this.eventManagers[t];return i?Promise.resolve(i):(sn(r,"If manager is not set, promise should be"),r)}const s=this.initAndGetManager(e);return this.eventManagers[t]={promise:s},s.catch(()=>{delete this.eventManagers[t]}),s}async initAndGetManager(e){const t=await iT(e),s=new Ww(e);return t.register("authEvent",i=>(Q(i==null?void 0:i.authEvent,e,"invalid-auth-event"),{status:s.onEvent(i.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:s},this.iframes[e._key()]=t,s}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send(ll,{type:ll},i=>{var r;const o=(r=i==null?void 0:i[0])===null||r===void 0?void 0:r[ll];o!==void 0&&t(!!o),xt(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=Hw(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return Xp()||Gp()||xc()}}const _T=gT;var Nd="@firebase/auth",Dd="1.7.9";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const wT=5*60,TT=Ap("authIdTokenMaxAge")||wT;let xd=null;const IT=n=>async e=>{const t=e&&await e.getIdTokenResult(),s=t&&(new Date().getTime()-Date.parse(t.issuedAtTime))/1e3;if(s&&s>TT)return;const i=t==null?void 0:t.token;xd!==i&&(xd=i,await fetch(n,{method:i?"POST":"DELETE",headers:i?{Authorization:`Bearer ${i}`}:{}}))};function CT(n=Sc()){const e=aa(n,"auth");if(e.isInitialized())return e.getImmediate();const t=tw(n,{popupRedirectResolver:_T,persistence:[Aw,gw,om]}),s=Ap("authTokenSyncURL");if(s&&typeof isSecureContext=="boolean"&&isSecureContext){const r=new URL(s,location.origin);if(location.origin===r.origin){const o=IT(r.toString());uw(t,o,()=>o(t.currentUser)),hw(t,l=>o(l))}}const i=bp("auth");return i&&sw(t,`http://${i}`),t}function bT(){var n,e;return(e=(n=document.getElementsByTagName("head"))===null||n===void 0?void 0:n[0])!==null&&e!==void 0?e:document}JE({loadJS(n){return new Promise((e,t)=>{const s=document.createElement("script");s.setAttribute("src",n),s.onload=e,s.onerror=i=>{const r=bt("internal-error");r.customData=i,t(r)},s.type="text/javascript",s.charset="UTF-8",bT().appendChild(s)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});ET("Browser");var Ld=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
...
*/var Yn,pm;(function(){var n;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(I,_){function y(){}y.prototype=_.prototype,I.D=_.prototype,I.prototype=new y,I.prototype.constructor=I,I.C=function(w,T,S){for(var v=Array(arguments.length-2),ze=2;ze<arguments.length;ze++)v[ze-2]=arguments[ze];return _.prototype[T].apply(w,v)}}function t(){this.blockSize=-1}function s(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}e(s,t),s.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function i(I,_,y){y||(y=0);var w=Array(16);if(typeof _=="string")for(var T=0;16>T;++T)w[T]=_.charCodeAt(y++)|_.charCodeAt(y++)<<8|_.charCodeAt(y++)<<16|_.charCodeAt(y++)<<24;else for(T=0;16>T;++T)w[T]=_[y++]|_[y++]<<8|_[y++]<<16|_[y++]<<24;_=I.g[0],y=I.g[1],T=I.g[2];var S=I.g[3],v=_+(S^y&(T^S))+w[0]+3614090360&4294967295;_=y+(v<<7&4294967295|v>>>25),v=S+(T^_&(y^T))+w[1]+3905402710&4294967295,S=_+(v<<12&4294967295|v>>>20),v=T+(y^S&(_^y))+w[2]+606105819&4294967295,T=S+(v<<17&4294967295|v>>>15),v=y+(_^T&(S^_))+w[3]+3250441966&4294967295,y=T+(v<<22&4294967295|v>>>10),v=_+(S^y&(T^S))+w[4]+4118548399&4294967295,_=y+(v<<7&4294967295|v>>>25),v=S+(T^_&(y^T))+w[5]+1200080426&4294967295,S=_+(v<<12&4294967295|v>>>20),v=T+(y^S&(_^y))+w[6]+2821735955&4294967295,T=S+(v<<17&4294967295|v>>>15),v=y+(_^T&(S^_))+w[7]+4249261313&4294967295,y=T+(v<<22&4294967295|v>>>10),v=_+(S^y&(T^S))+w[8]+1770035416&4294967295,_=y+(v<<7&4294967295|v>>>25),v=S+(T^_&(y^T))+w[9]+2336552879&4294967295,S=_+(v<<12&4294967295|v>>>20),v=T+(y^S&(_^y))+w[10]+4294925233&4294967295,T=S+(v<<17&4294967295|v>>>15),v=y+(_^T&(S^_))+w[11]+2304563134&4294967295,y=T+(v<<22&4294967295|v>>>10),v=_+(S^y&(T^S))+w[12]+1804603682&4294967295,_=y+(v<<7&4294967295|v>>>25),v=S+(T^_&(y^T))+w[13]+4254626195&4294967295,S=_+(v<<12&4294967295|v>>>20),v=T+(y^S&(_^y))+w[14]+2792965006&4294967295,T=S+(v<<17&4294967295|v>>>15),v=y+(_^T&(S^_))+w[15]+1236535329&4294967295,y=T+(v<<22&4294967295|v>>>10),v=_+(T^S&(y^T))+w[1]+4129170786&4294967295,_=y+(v<<5&4294967295|v>>>27),v=S+(y^T&(_^y))+w[6]+3225465664&4294967295,S=_+(v<<9&4294967295|v>>>23),v=T+(_^y&(S^_))+w[11]+643717713&4294967295,T=S+(v<<14&4294967295|v>>>18),v=y+(S^_&(T^S))+w[0]+3921069994&4294967295,y=T+(v<<20&4294967295|v>>>12),v=_+(T^S&(y^T))+w[5]+3593408605&4294967295,_=y+(v<<5&4294967295|v>>>27),v=S+(y^T&(_^y))+w[10]+38016083&4294967295,S=_+(v<<9&4294967295|v>>>23),v=T+(_^y&(S^_))+w[15]+3634488961&4294967295,T=S+(v<<14&4294967295|v>>>18),v=y+(S^_&(T^S))+w[4]+3889429448&4294967295,y=T+(v<<20&4294967295|v>>>12),v=_+(T^S&(y^T))+w[9]+568446438&4294967295,_=y+(v<<5&4294967295|v>>>27),v=S+(y^T&(_^y))+w[14]+3275163606&4294967295,S=_+(v<<9&4294967295|v>>>23),v=T+(_^y&(S^_))+w[3]+4107603335&4294967295,T=S+(v<<14&4294967295|v>>>18),v=y+(S^_&(T^S))+w[8]+1163531501&4294967295,y=T+(v<<20&4294967295|v>>>12),v=_+(T^S&(y^T))+w[13]+2850285829&4294967295,_=y+(v<<5&4294967295|v>>>27),v=S+(y^T&(_^y))+w[2]+4243563512&4294967295,S=_+(v<<9&4294967295|v>>>23),v=T+(_^y&(S^_))+w[7]+1735328473&4294967295,T=S+(v<<14&4294967295|v>>>18),v=y+(S^_&(T^S))+w[12]+2368359562&4294967295,y=T+(v<<20&4294967295|v>>>12),v=_+(y^T^S)+w[5]+4294588738&4294967295,_=y+(v<<4&4294967295|v>>>28),v=S+(_^y^T)+w[8]+2272392833&4294967295,S=_+(v<<11&4294967295|v>>>21),v=T+(S^_^y)+w[11]+1839030562&4294967295,T=S+(v<<16&4294967295|v>>>16),v=y+(T^S^_)+w[14]+4259657740&4294967295,y=T+(v<<23&4294967295|v>>>9),v=_+(y^T^S)+w[1]+2763975236&4294967295,_=y+(v<<4&4294967295|v>>>28),v=S+(_^y^T)+w[4]+1272893353&4294967295,S=_+(v<<11&4294967295|v>>>21),v=T+(S^_^y)+w[7]+4139469664&4294967295,T=S+(v<<16&4294967295|v>>>16),v=y+(T^S^_)+w[10]+3200236656&4294967295,y=T+(v<<23&4294967295|v>>>9),v=_+(y^T^S)+w[13]+681279174&4294967295,_=y+(v<<4&4294967295|v>>>28),v=S+(_^y^T)+w[0]+3936430074&4294967295,S=_+(v<<11&4294967295|v>>>21),v=T+(S^_^y)+w[3]+3572445317&4294967295,T=S+(v<<16&4294967295|v>>>16),v=y+(T^S^_)+w[6]+76029189&4294967295,y=T+(v<<23&4294967295|v>>>9),v=_+(y^T^S)+w[9]+3654602809&4294967295,_=y+(v<<4&4294967295|v>>>28),v=S+(_^y^T)+w[12]+3873151461&4294967295,S=_+(v<<11&4294967295|v>>>21),v=T+(S^_^y)+w[15]+530742520&4294967295,T=S+(v<<16&4294967295|v>>>16),v=y+(T^S^_)+w[2]+3299628645&4294967295,y=T+(v<<23&4294967295|v>>>9),v=_+(T^(y|~S))+w[0]+4096336452&4294967295,_=y+(v<<6&4294967295|v>>>26),v=S+(y^(_|~T))+w[7]+1126891415&4294967295,S=_+(v<<10&4294967295|v>>>22),v=T+(_^(S|~y))+w[14]+2878612391&4294967295,T=S+(v<<15&4294967295|v>>>17),v=y+(S^(T|~_))+w[5]+4237533241&4294967295,y=T+(v<<21&4294967295|v>>>11),v=_+(T^(y|~S))+w[12]+1700485571&4294967295,_=y+(v<<6&4294967295|v>>>26),v=S+(y^(_|~T))+w[3]+2399980690&4294967295,S=_+(v<<10&4294967295|v>>>22),v=T+(_^(S|~y))+w[10]+4293915773&4294967295,T=S+(v<<15&4294967295|v>>>17),v=y+(S^(T|~_))+w[1]+2240044497&4294967295,y=T+(v<<21&4294967295|v>>>11),v=_+(T^(y|~S))+w[8]+1873313359&4294967295,_=y+(v<<6&4294967295|v>>>26),v=S+(y^(_|~T))+w[15]+4264355552&4294967295,S=_+(v<<10&4294967295|v>>>22),v=T+(_^(S|~y))+w[6]+2734768916&4294967295,T=S+(v<<15&4294967295|v>>>17),v=y+(S^(T|~_))+w[13]+1309151649&4294967295,y=T+(v<<21&4294967295|v>>>11),v=_+(T^(y|~S))+w[4]+4149444226&4294967295,_=y+(v<<6&4294967295|v>>>26),v=S+(y^(_|~T))+w[11]+3174756917&4294967295,S=_+(v<<10&4294967295|v>>>22),v=T+(_^(S|~y))+w[2]+718787259&4294967295,T=S+(v<<15&4294967295|v>>>17),v=y+(S^(T|~_))+w[9]+3951481745&4294967295,I.g[0]=I.g[0]+_&4294967295,I.g[1]=I.g[1]+(T+(v<<21&4294967295|v>>>11))&4294967295,I.g[2]=I.g[2]+T&4294967295,I.g[3]=I.g[3]+S&4294967295}s.prototype.u=function(I,_){_===void 0&&(_=I.length);for(var y=_-this.blockSize,w=this.B,T=this.h,S=0;S<_;){if(T==0)for(;S<=y;)i(this,I,S),S+=this.blockSize;if(typeof I=="string"){for(;S<_;)if(w[T++]=I.charCodeAt(S++),T==this.blockSize){i(this,w),T=0;break}}else for(;S<_;)if(w[T++]=I[S++],T==this.blockSize){i(this,w),T=0;break}}this.h=T,this.o+=_},s.prototype.v=function(){var I=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);I[0]=128;for(var _=1;_<I.length-8;++_)I[_]=0;var y=8*this.o;for(_=I.length-8;_<I.length;++_)I[_]=y&255,y/=256;for(this.u(I),I=Array(16),_=y=0;4>_;++_)for(var w=0;32>w;w+=8)I[y++]=this.g[_]>>>w&255;return I};function r(I,_){var y=l;return Object.prototype.hasOwnProperty.call(y,I)?y[I]:y[I]=_(I)}function o(I,_){this.h=_;for(var y=[],w=!0,T=I.length-1;0<=T;T--){var S=I[T]|0;w&&S==_||(y[T]=S,w=!1)}this.g=y}var l={};function c(I){return-128<=I&&128>I?r(I,function(_){return new o([_|0],0>_?-1:0)}):new o([I|0],0>I?-1:0)}function h(I){if(isNaN(I)||!isFinite(I))return p;if(0>I)return k(h(-I));for(var _=[],y=1,w=0;I>=y;w++)_[w]=I/y|0,y*=4294967296;return new o(_,0)}function d(I,_){if(I.length==0)throw Error("number format error: empty string");if(_=_||10,2>_||36<_)throw Error("radix out of range: "+_);if(I.charAt(0)=="-")return k(d(I.substring(1),_));if(0<=I.indexOf("-"))throw Error('number format error: interior "-" character');for(var y=h(Math.pow(_,8)),w=p,T=0;T<I.length;T+=8){var S=Math.min(8,I.length-T),v=parseInt(I.substring(T,T+S),_);8>S?(S=h(Math.pow(_,S)),w=w.j(S).add(h(v))):(w=w.j(y),w=w.add(h(v)))}return w}var p=c(0),m=c(1),E=c(16777216);n=o.prototype,n.m=function(){if(R(this))return-k(this).m();for(var I=0,_=1,y=0;y<this.g.length;y++){var w=this.i(y);I+=(0<=w?w:4294967296+w)*_,_*=4294967296}return I},n.toString=function(I){if(I=I||10,2>I||36<I)throw Error("radix out of range: "+I);if(C(this))return"0";if(R(this))return"-"+k(this).toString(I);for(var _=h(Math.pow(I,6)),y=this,w="";;){var T=ee(y,_).g;y=V(y,T.j(_));var S=((0<y.g.length?y.g[0]:y.h)>>>0).toString(I);if(y=T,C(y))return S+w;for(;6>S.length;)S="0"+S;w=S+w}},n.i=function(I){return 0>I?0:I<this.g.length?this.g[I]:this.h};function C(I){if(I.h!=0)return!1;for(var _=0;_<I.g.length;_++)if(I.g[_]!=0)return!1;return!0}function R(I){return I.h==-1}n.l=function(I){return I=V(this,I),R(I)?-1:C(I)?0:1};function k(I){for(var _=I.g.length,y=[],w=0;w<_;w++)y[w]=~I.g[w];return new o(y,~I.h).add(m)}n.abs=function(){return R(this)?k(this):this},n.add=function(I){for(var _=Math.max(this.g.length,I.g.length),y=[],w=0,T=0;T<=_;T++){var S=w+(this.i(T)&65535)+(I.i(T)&65535),v=(S>>>16)+(this.i(T)>>>16)+(I.i(T)>>>16);w=v>>>16,S&=65535,v&=65535,y[T]=v<<16|S}return new o(y,y[y.length-1]&-2147483648?-1:0)};function V(I,_){return I.add(k(_))}n.j=function(I){if(C(this)||C(I))return p;if(R(this))return R(I)?k(this).j(k(I)):k(k(this).j(I));if(R(I))return k(this.j(k(I)));if(0>this.l(E)&&0>I.l(E))return h(this.m()*I.m());for(var _=this.g.length+I.g.length,y=[],w=0;w<2*_;w++)y[w]=0;for(w=0;w<this.g.length;w++)for(var T=0;T<I.g.length;T++){var S=this.i(w)>>>16,v=this.i(w)&65535,ze=I.i(T)>>>16,_t=I.i(T)&65535;y[2*w+2*T]+=v*_t,U(y,2*w+2*T),y[2*w+2*T+1]+=S*_t,U(y,2*w+2*T+1),y[2*w+2*T+1]+=v*ze,U(y,2*w+2*T+1),y[2*w+2*T+2]+=S*ze,U(y,2*w+2*T+2)}for(w=0;w<_;w++)y[w]=y[2*w+1]<<16|y[2*w];for(w=_;w<2*_;w++)y[w]=0;return new o(y,0)};function U(I,_){for(;(I[_]&65535)!=I[_];)I[_+1]+=I[_]>>>16,I[_]&=65535,_++}function q(I,_){this.g=I,this.h=_}function ee(I,_){if(C(_))throw Error("division by zero");if(C(I))return new q(p,p);if(R(I))return _=ee(k(I),_),new q(k(_.g),k(_.h));if(R(_))return _=ee(I,k(_)),new q(k(_.g),_.h);if(30<I.g.length){if(R(I)||R(_))throw Error("slowDivide_ only works with positive integers.");for(var y=m,w=_;0>=w.l(I);)y=he(y),w=he(w);var T=de(y,1),S=de(w,1);for(w=de(w,2),y=de(y,2);!C(w);){var v=S.add(w);0>=v.l(I)&&(T=T.add(y),S=v),w=de(w,1),y=de(y,1)}return _=V(I,T.j(_)),new q(T,_)}for(T=p;0<=I.l(_);){for(y=Math.max(1,Math.floor(I.m()/_.m())),w=Math.ceil(Math.log(y)/Math.LN2),w=48>=w?1:Math.pow(2,w-48),S=h(y),v=S.j(_);R(v)||0<v.l(I);)y-=w,S=h(y),v=S.j(_);C(S)&&(S=m),T=T.add(S),I=V(I,v)}return new q(T,I)}n.A=function(I){return ee(this,I).h},n.and=function(I){for(var _=Math.max(this.g.length,I.g.length),y=[],w=0;w<_;w++)y[w]=this.i(w)&I.i(w);return new o(y,this.h&I.h)},n.or=function(I){for(var _=Math.max(this.g.length,I.g.length),y=[],w=0;w<_;w++)y[w]=this.i(w)|I.i(w);return new o(y,this.h|I.h)},n.xor=function(I){for(var _=Math.max(this.g.length,I.g.length),y=[],w=0;w<_;w++)y[w]=this.i(w)^I.i(w);return new o(y,this.h^I.h)};function he(I){for(var _=I.g.length+1,y=[],w=0;w<_;w++)y[w]=I.i(w)<<1|I.i(w-1)>>>31;return new o(y,I.h)}function de(I,_){var y=_>>5;_%=32;for(var w=I.g.length-y,T=[],S=0;S<w;S++)T[S]=0<_?I.i(S+y)>>>_|I.i(S+y+1)<<32-_:I.i(S+y);return new o(T,I.h)}s.prototype.digest=s.prototype.v,s.prototype.reset=s.prototype.s,s.prototype.update=s.prototype.u,pm=s,o.prototype.add=o.prototype.add,o.prototype.multiply=o.prototype.j,o.prototype.modulo=o.prototype.A,o.prototype.compare=o.prototype.l,o.prototype.toNumber=o.prototype.m,o.prototype.toString=o.prototype.toString,o.prototype.getBits=o.prototype.i,o.fromNumber=h,o.fromString=d,Yn=o}).apply(typeof Ld<"u"?Ld:typeof self<"u"?self:typeof window<"u"?window:{});var Yr=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function j(n="Unexpected state"){const e=`FIRESTORE (${Zs}) INTERNAL ASSERTION FAILED: `+n;throw rn(e),new Error(e)}function re(n,e){n||j()}function Y(n,e){return n}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ut{constructor(e){this.fields=e,e.sort(qe.comparator)}static empty(){return new ut([])}unionWith(e){let t=new We(qe.comparator);for(const s of this.fields)t=t.add(s);for(const s of e)t=t.add(s);return new ut(t.toArray())}covers(e){for(const t of this.fields)if(t.isPrefixOf(e))return!0;return!1}isEqual(e){return Bs(this.fields,e.fields,(t,s)=>t.isEqual(s))}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class st{constructor(e){this.value=e}static empty(){return new st({mapValue:{}})}field(e){if(e.isEmpty())return this.value;{let t=this.value;for(let s=0;s<e.length-1;++s)if(t=(t.mapValue.fields||{})[e.get(s)],!ho(t))return null;return t=(t.mapValue.fields||{})[e.lastSegment()],t||null}}set(e,t){this.getFieldsMap(e.popLast())[e.lastSegment()]=Vi(t)}setAll(e){let t=qe.emptyPath(),s={},i=[];e.forEach((o,l)=>{if(!t.isImmediateParentOf(l)){const c=this.getFieldsMap(t);this.applyChanges(c,s,i),s={},i=[],t=l.popLast()}o?s[l.lastSegment()]=Vi(o):i.push(l.lastSegment())});const r=this.getFieldsMap(t);this.applyChanges(r,s,i)}delete(e){const t=this.field(e.popLast());ho(t)&&t.mapValue.fields&&delete t.mapValue.fields[e.lastSegment()]}isEqual(e){return Lt(this.value,e.value)}getFieldsMap(e){let t=this.value;t.mapValue.fields||(t.mapValue={fields:{}});for(let s=0;s<e.length;++s){let i=t.mapValue.fields[e.get(s)];ho(i)&&i.mapValue.fields||(i={mapValue:{fields:{}}},t.mapValue.fields[e.get(s)]=i),t=i}return t.mapValue.fields}applyChanges(e,t,s){ls(t,(i,r)=>e[i]=r);for(const i of s)delete e[i]}clone(){return new st(Vi(this.value))}}function Cm(n){const e=[];return ls(n.fields,(t,s)=>{const i=new qe([t]);if(ho(s)){const r=Cm(s.mapValue).fields;if(r.length===0)e.push(i);else for(const o of r)e.push(i.child(o))}else e.push(i)}),new ut(e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ve{constructor(e,t,s,i,r,o,l){this.key=e,this.documentType=t,this.version=s,this.readTime=i,this.createTime=r,this.data=o,this.documentState=l}static newInvalidDocument(e){return new Ve(e,0,H.min(),H.min(),H.min(),st.empty(),0)}static newFoundDocument(e,t,s,i){return new Ve(e,1,t,H.min(),s,i,0)}static newNoDocument(e,t){return new Ve(e,2,t,H.min(),H.min(),st.empty(),0)}static newUnknownDocument(e,t){return new Ve(e,3,t,H.min(),H.min(),st.empty(),2)}convertToFoundDocument(e,t){return!this.createTime.isEqual(H.min())||this.documentType!==2&&this.documentType!==0||(this.createTime=e),this.version=e,this.documentType=1,this.data=t,this.documentState=0,this}convertToNoDocument(e){return this.version=e,this.documentType=2,this.data=st.empty(),this.documentState=0,this}convertToUnknownDocument(e){return this.version=e,this.documentType=3,this.data=st.empty(),this.documentState=2,this}setHasCommittedMutations(){return this.documentState=2,this}setHasLocalMutations(){return this.documentState=1,this.version=H.min(),this}setReadTime(e){return this.readTime=e,this}get hasLocalMutations(){return this.documentState===1}get hasCommittedMutations(){return this.documentState===2}get hasPendingWrites(){return this.hasLocalMutations||this.hasCommittedMutations}isValidDocument(){return this.documentType!==0}isFoundDocument(){return this.documentType===1}isNoDocument(){return this.documentType===2}isUnknownDocument(){return this.documentType===3}isEqual(e){return e instanceof Ve&&this.key.isEqual(e.key)&&this.version.isEqual(e.version)&&this.documentType===e.documentType&&this.documentState===e.documentState&&this.data.isEqual(e.data)}mutableCopy(){return new Ve(this.key,this.documentType,this.version,this.readTime,this.createTime,this.data.clone(),this.documentState)}toString(){return`Document(${this.key}, ${this.version}, ${JSON.stringify(this.data.value)}, {createTime: ${this.createTime}}), {documentType: ${this.documentType}}), {documentState: ${this.documentState}})`}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Do{constructor(e,t){this.position=e,this.inclusive=t}}function $d(n,e,t){let s=0;for(let i=0;i<n.position.length;i++){const r=e[i],o=n.position[i];if(r.field.isKeyField()?s=W.comparator(W.fromName(o.referenceValue),t.key):s=Us(o,t.data.field(r.field)),r.dir==="desc"&&(s*=-1),s!==0)break}return s}function jd(n,e){if(n===null)return e===null;if(e===null||n.inclusive!==e.inclusive||n.position.length!==e.position.length)return!1;for(let t=0;t<n.position.length;t++)if(!Lt(n.position[t],e.position[t]))return!1;return!0}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xo{constructor(e,t="asc"){this.field=e,this.dir=t}}function GT(n,e){return n.dir===e.dir&&n.field.isEqual(e.field)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bm{}class Se extends bm{constructor(e,t,s){super(),this.field=e,this.op=t,this.value=s}static create(e,t,s){return e.isKeyField()?t==="in"||t==="not-in"?this.createKeyFieldInFilter(e,t,s):new KT(e,t,s):t==="array-contains"?new JT(e,s):t==="in"?new XT(e,s):t==="not-in"?new ZT(e,s):t==="array-contains-any"?new eI(e,s):new Se(e,t,s)}static createKeyFieldInFilter(e,t,s){return t==="in"?new QT(e,s):new YT(e,s)}matches(e){const t=e.data.field(this.field);return this.op==="!="?t!==null&&this.matchesComparison(Us(t,this.value)):t!==null&&ns(this.value)===ns(t)&&this.matchesComparison(Us(t,this.value))}matchesComparison(e){switch(this.op){case"<":return e<0;case"<=":return e<=0;case"==":return e===0;case"!=":return e!==0;case">":return e>0;case">=":return e>=0;default:return j()}}isInequality(){return["<","<=",">",">=","!=","not-in"].indexOf(this.op)>=0}getFlattenedFilters(){return[this]}getFilters(){return[this]}}class Rt extends bm{constructor(e,t){super(),this.filters=e,this.op=t,this.ae=null}static create(e,t){return new Rt(e,t)}matches(e){return Sm(this)?this.filters.find(t=>!t.matches(e))===void 0:this.filters.find(t=>t.matches(e))!==void 0}getFlattenedFilters(){return this.ae!==null||(this.ae=this.filters.reduce((e,t)=>e.concat(t.getFlattenedFilters()),[])),this.ae}getFilters(){return Object.assign([],this.filters)}}function Sm(n){return n.op==="and"}function Rm(n){return HT(n)&&Sm(n)}function HT(n){for(const e of n.filters)if(e instanceof Rt)return!1;return!0}function Gl(n){if(n instanceof Se)return n.field.canonicalString()+n.op.toString()+qs(n.value);if(Rm(n))return n.filters.map(e=>Gl(e)).join(",");{const e=n.filters.map(t=>Gl(t)).join(",");return`${n.op}(${e})`}}function Am(n,e){return n instanceof Se?function(s,i){return i instanceof Se&&s.op===i.op&&s.field.isEqual(i.field)&&Lt(s.value,i.value)}(n,e):n instanceof Rt?function(s,i){return i instanceof Rt&&s.op===i.op&&s.filters.length===i.filters.length?s.filters.reduce((r,o,l)=>r&&Am(o,i.filters[l]),!0):!1}(n,e):void j()}function km(n){return n instanceof Se?function(t){return`${t.field.canonicalString()} ${t.op} ${qs(t.value)}`}(n):n instanceof Rt?function(t){return t.op.toString()+" {"+t.getFilters().map(km).join(" ,")+"}"}(n):"Filter"}class KT extends Se{constructor(e,t,s){super(e,t,s),this.key=W.fromName(s.referenceValue)}matches(e){const t=W.comparator(e.key,this.key);return this.matchesComparison(t)}}class QT extends Se{constructor(e,t){super(e,"in",t),this.keys=Pm("in",t)}matches(e){return this.keys.some(t=>t.isEqual(e.key))}}class YT extends Se{constructor(e,t){super(e,"not-in",t),this.keys=Pm("not-in",t)}matches(e){return!this.keys.some(t=>t.isEqual(e.key))}}function Pm(n,e){var t;return(((t=e.arrayValue)===null||t===void 0?void 0:t.values)||[]).map(s=>W.fromName(s.referenceValue))}class JT extends Se{constructor(e,t){super(e,"array-contains",t)}matches(e){const t=e.data.field(this.field);return Wc(t)&&er(t.arrayValue,this.value)}}class XT extends Se{constructor(e,t){super(e,"in",t)}matches(e){const t=e.data.field(this.field);return t!==null&&er(this.value.arrayValue,t)}}class ZT extends Se{constructor(e,t){super(e,"not-in",t)}matches(e){if(er(this.value.arrayValue,{nullValue:"NULL_VALUE"}))return!1;const t=e.data.field(this.field);return t!==null&&!er(this.value.arrayValue,t)}}class eI extends Se{constructor(e,t){super(e,"array-contains-any",t)}matches(e){const t=e.data.field(this.field);return!(!Wc(t)||!t.arrayValue.values)&&t.arrayValue.values.some(s=>er(this.value.arrayValue,s))}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qI{constructor(e){this.ct=e}}function WI(n){const e=OI({parent:n.parent,structuredQuery:n.structuredQuery});return n.limitType==="LAST"?Lo(e,e.limit,"L"):e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class i0{constructor(){this.Gi=!1,this.zi=!1,this.ji=100,this.Hi=function(){return iv()?8:UT(Ze())>0?6:4}()}initialize(e,t){this.Ji=e,this.indexManager=t,this.Gi=!0}getDocumentsMatchingQuery(e,t,s,i){const r={result:null};return this.Yi(e,t).next(o=>{r.result=o}).next(()=>{if(!r.result)return this.Zi(e,t,i,s).next(o=>{r.result=o})}).next(()=>{if(r.result)return;const o=new s0;return this.Xi(e,t,o).next(l=>{if(r.result=l,this.zi)return this.es(e,t,o,l.size)})}).next(()=>r.result)}es(e,t,s,i){return s.documentReadCount<this.ji?(wi()<=te.DEBUG&&B("QueryEngine","SDK will not create cache indexes for query:",bs(t),"since it only creates cache indexes for collection contains","more than or equal to",this.ji,"documents"),N.resolve()):(wi()<=te.DEBUG&&B("QueryEngine","Query:",bs(t),"scans",s.documentReadCount,"local documents and returns",i,"documents as results."),s.documentReadCount>this.Hi*i?(wi()<=te.DEBUG&&B("QueryEngine","The SDK decides to create cache indexes for query:",bs(t),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,Dt(t))):N.resolve())}Yi(e,t){if(Gd(t))return N.resolve(null);let s=Dt(t);return this.indexManager.getIndexType(e,s).next(i=>i===0?null:(t.limit!==null&&i===1&&(t=Lo(t,null,"F"),s=Dt(t)),this.indexManager.getDocumentsMatchingTarget(e,s).next(r=>{const o=ne(...r);return this.Ji.getDocuments(e,o).next(l=>this.indexManager.getMinOffset(e,s).next(c=>{const h=this.ts(t,l);return this.ns(t,h,o,c.readTime)?this.Yi(e,Lo(t,null,"F")):this.rs(e,h,t,c)}))})))}Zi(e,t,s,i){return Gd(t)||i.isEqual(H.min())?N.resolve(null):this.Ji.getDocuments(e,s).next(r=>{const o=this.ts(t,r);return this.ns(t,o,s,i)?N.resolve(null):(wi()<=te.DEBUG&&B("QueryEngine","Re-using previous result from %s to execute query: %s",i.toString(),bs(t)),this.rs(e,o,t,OT(i,-1)).next(l=>l))})}ts(e,t){let s=new We(xm(e));return t.forEach((i,r)=>{da(e,r)&&(s=s.add(r))}),s}ns(e,t,s,i){if(e.limit===null)return!1;if(s.size!==t.size)return!0;const r=e.limitType==="F"?t.last():t.first();return!!r&&(r.hasPendingWrites||r.version.compareTo(i)>0)}Xi(e,t,s){return wi()<=te.DEBUG&&B("QueryEngine","Using full collection scan to execute query:",bs(t)),this.Ji.getDocumentsMatchingQuery(e,t,Nn.min(),s)}rs(e,t,s,i){return this.Ji.getDocumentsMatchingQuery(e,s,i).next(r=>(t.forEach(o=>{r=r.insert(o.key,o)}),r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ga(n){return new RI(n,!0)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class T0{constructor(e,t,s,i,r){this.localStore=e,this.datastore=t,this.asyncQueue=s,this.remoteSyncer={},this.O_=[],this.N_=new Map,this.L_=new Set,this.B_=[],this.k_=r,this.k_._o(o=>{s.enqueueAndForget(async()=>{cs(this)&&(B("RemoteStore","Restarting streams for network reachability change."),await async function(c){const h=Y(c);h.L_.add(4),await wr(h),h.q_.set("Unknown"),h.L_.delete(4),await _a(h)}(this))})}),this.q_=new w0(s,i)}}async function _a(n){if(cs(n))for(const e of n.B_)await e(!0)}async function wr(n){for(const e of n.B_)await e(!1)}function og(n,e){const t=Y(n);t.N_.has(e.targetId)||(t.N_.set(e.targetId,e),ih(t)?sh(t):ti(t).r_()&&nh(t,e))}function th(n,e){const t=Y(n),s=ti(t);t.N_.delete(e),s.r_()&&ag(t,e),t.N_.size===0&&(s.r_()?s.o_():cs(t)&&t.q_.set("Unknown"))}function nh(n,e){if(n.Q_.xe(e.targetId),e.resumeToken.approximateByteSize()>0||e.snapshotVersion.compareTo(H.min())>0){const t=n.remoteSyncer.getRemoteKeysForTarget(e.targetId).size;e=e.withExpectedCount(t)}ti(n).A_(e)}function ag(n,e){n.Q_.xe(e),ti(n).R_(e)}function sh(n){n.Q_=new II({getRemoteKeysForTarget:e=>n.remoteSyncer.getRemoteKeysForTarget(e),ot:e=>n.N_.get(e)||null,tt:()=>n.datastore.serializer.databaseId}),ti(n).start(),n.q_.v_()}function ih(n){return cs(n)&&!ti(n).n_()&&n.N_.size>0}function cs(n){return Y(n).L_.size===0}function lg(n){n.Q_=void 0}async function I0(n){n.q_.set("Online")}async function C0(n){n.N_.forEach((e,t)=>{nh(n,e)})}async function b0(n,e){lg(n),ih(n)?(n.q_.M_(e),sh(n)):n.q_.set("Unknown")}async function S0(n,e,t){if(n.q_.set("Online"),e instanceof Km&&e.state===2&&e.cause)try{await async function(i,r){const o=r.cause;for(const l of r.targetIds)i.N_.has(l)&&(await i.remoteSyncer.rejectListen(l,o),i.N_.delete(l),i.Q_.removeTarget(l))}(n,e)}catch(s){B("RemoteStore","Failed to remove targets %s: %s ",e.targetIds.join(","),s),await Bo(n,s)}else if(e instanceof fo?n.Q_.Ke(e):e instanceof Hm?n.Q_.He(e):n.Q_.We(e),!t.isEqual(H.min()))try{const s=await ig(n.localStore);t.compareTo(s)>=0&&await function(r,o){const l=r.Q_.rt(o);return l.targetChanges.forEach((c,h)=>{if(c.resumeToken.approximateByteSize()>0){const d=r.N_.get(h);d&&r.N_.set(h,d.withResumeToken(c.resumeToken,o))}}),l.targetMismatches.forEach((c,h)=>{const d=r.N_.get(c);if(!d)return;r.N_.set(c,d.withResumeToken($e.EMPTY_BYTE_STRING,d.snapshotVersion)),ag(r,c);const p=new En(d.target,c,h,d.sequenceNumber);nh(r,p)}),r.remoteSyncer.applyRemoteEvent(l)}(n,t)}catch(s){B("RemoteStore","Failed to raise snapshot:",s),await Bo(n,s)}}async function Bo(n,e,t){if(!gr(e))throw e;n.L_.add(1),await wr(n),n.q_.set("Offline"),t||(t=()=>ig(n.localStore)),n.asyncQueue.enqueueRetryable(async()=>{B("RemoteStore","Retrying IndexedDB access"),await t(),n.L_.delete(1),await _a(n)})}function cg(n,e){return e().catch(t=>Bo(n,t,e))}async function ya(n){const e=Y(n),t=xn(e);let s=e.O_.length>0?e.O_[e.O_.length-1].batchId:-1;for(;R0(e);)try{const i=await h0(e.localStore,s);if(i===null){e.O_.length===0&&t.o_();break}s=i.batchId,A0(e,i)}catch(i){await Bo(e,i)}hg(e)&&ug(e)}function R0(n){return cs(n)&&n.O_.length<10}function A0(n,e){n.O_.push(e);const t=xn(n);t.r_()&&t.V_&&t.m_(e.mutations)}function hg(n){return cs(n)&&!xn(n).n_()&&n.O_.length>0}function ug(n){xn(n).start()}async function k0(n){xn(n).p_()}async function P0(n){const e=xn(n);for(const t of n.O_)e.m_(t.mutations)}async function N0(n,e,t){const s=n.O_.shift(),i=Kc.from(s,e,t);await cg(n,()=>n.remoteSyncer.applySuccessfulWrite(i)),await ya(n)}async function D0(n,e){e&&xn(n).V_&&await async function(s,i){if(function(o){return zm(o)&&o!==P.ABORTED}(i.code)){const r=s.O_.shift();xn(s).s_(),await cg(s,()=>s.remoteSyncer.rejectFailedWrite(r.batchId,i)),await ya(s)}}(n,e),hg(n)&&ug(n)}async function af(n,e){const t=Y(n);t.asyncQueue.verifyOperationInProgress(),B("RemoteStore","RemoteStore received new credentials");const s=cs(t);t.L_.add(3),await wr(t),s&&t.q_.set("Unknown"),await t.remoteSyncer.handleCredentialChange(e),t.L_.delete(3),await _a(t)}async function x0(n,e){const t=Y(n);e?(t.L_.delete(2),await _a(t)):e||(t.L_.add(2),await wr(t),t.q_.set("Unknown"))}function ti(n){return n.K_||(n.K_=function(t,s,i){const r=Y(t);return r.w_(),new y0(s,r.connection,r.authCredentials,r.appCheckCredentials,r.serializer,i)}(n.datastore,n.asyncQueue,{Eo:I0.bind(null,n),Ro:C0.bind(null,n),mo:b0.bind(null,n),d_:S0.bind(null,n)}),n.B_.push(async e=>{e?(n.K_.s_(),ih(n)?sh(n):n.q_.set("Unknown")):(await n.K_.stop(),lg(n))})),n.K_}function xn(n){return n.U_||(n.U_=function(t,s,i){const r=Y(t);return r.w_(),new v0(s,r.connection,r.authCredentials,r.appCheckCredentials,r.serializer,i)}(n.datastore,n.asyncQueue,{Eo:()=>Promise.resolve(),Ro:k0.bind(null,n),mo:D0.bind(null,n),f_:P0.bind(null,n),g_:N0.bind(null,n)}),n.B_.push(async e=>{e?(n.U_.s_(),await ya(n)):(await n.U_.stop(),n.O_.length>0&&(B("RemoteStore",`Stopping write stream with ${n.O_.length} pending writes`),n.O_=[]))})),n.U_}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class L0{constructor(){this.z_=void 0,this.j_=[]}H_(){return this.j_.some(e=>e.J_())}}class O0{constructor(){this.queries=cf(),this.onlineState="Unknown",this.Y_=new Set}terminate(){(function(t,s){const i=Y(t),r=i.queries;i.queries=cf(),r.forEach((o,l)=>{for(const c of l.j_)c.onError(s)})})(this,new M(P.ABORTED,"Firestore shutting down"))}}function cf(){return new ei(n=>Dm(n),ua)}async function dg(n,e){const t=Y(n);let s=3;const i=e.query;let r=t.queries.get(i);r?!r.H_()&&e.J_()&&(s=2):(r=new L0,s=e.J_()?0:1);try{switch(s){case 0:r.z_=await t.onListen(i,!0);break;case 1:r.z_=await t.onListen(i,!1);break;case 2:await t.onFirstRemoteStoreListen(i)}}catch(o){const l=oh(o,`Initialization of query '${bs(e.query)}' failed`);return void e.onError(l)}t.queries.set(i,r),r.j_.push(e),e.Z_(t.onlineState),r.z_&&e.X_(r.z_)&&ah(t)}async function fg(n,e){const t=Y(n),s=e.query;let i=3;const r=t.queries.get(s);if(r){const o=r.j_.indexOf(e);o>=0&&(r.j_.splice(o,1),r.j_.length===0?i=e.J_()?0:1:!r.H_()&&e.J_()&&(i=2))}switch(i){case 0:return t.queries.delete(s),t.onUnlisten(s,!0);case 1:return t.queries.delete(s),t.onUnlisten(s,!1);case 2:return t.onLastRemoteStoreUnlisten(s);default:return}}function M0(n,e){const t=Y(n);let s=!1;for(const i of e){const r=i.query,o=t.queries.get(r);if(o){for(const l of o.j_)l.X_(i)&&(s=!0);o.z_=i}}s&&ah(t)}function V0(n,e,t){const s=Y(n),i=s.queries.get(e);if(i)for(const r of i.j_)r.onError(t);s.queries.delete(e)}function ah(n){n.Y_.forEach(e=>{e.next()})}var Zl,hf;(hf=Zl||(Zl={})).ea="default",hf.Cache="cache";class pg{constructor(e,t,s){this.query=e,this.ta=t,this.na=!1,this.ra=null,this.onlineState="Unknown",this.options=s||{}}X_(e){if(!this.options.includeMetadataChanges){const s=[];for(const i of e.docChanges)i.type!==3&&s.push(i);e=new $s(e.query,e.docs,e.oldDocs,s,e.mutatedKeys,e.fromCache,e.syncStateChanged,!0,e.hasCachedResults)}let t=!1;return this.na?this.ia(e)&&(this.ta.next(e),t=!0):this.sa(e,this.onlineState)&&(this.oa(e),t=!0),this.ra=e,t}onError(e){this.ta.error(e)}Z_(e){this.onlineState=e;let t=!1;return this.ra&&!this.na&&this.sa(this.ra,e)&&(this.oa(this.ra),t=!0),t}sa(e,t){if(!e.fromCache||!this.J_())return!0;const s=t!=="Offline";return(!this.options._a||!s)&&(!e.docs.isEmpty()||e.hasCachedResults||t==="Offline")}ia(e){if(e.docChanges.length>0)return!0;const t=this.ra&&this.ra.hasPendingWrites!==e.hasPendingWrites;return!(!e.syncStateChanged&&!t)&&this.options.includeMetadataChanges===!0}oa(e){e=$s.fromInitialDocuments(e.query,e.docs,e.mutatedKeys,e.fromCache,e.hasCachedResults),this.na=!0,this.ta.next(e)}J_(){return this.options.source!==Zl.Cache}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hs{constructor(e,t,s){this.converter=t,this._query=s,this.type="query",this.firestore=e}withConverter(e){return new hs(this.firestore,e,this._query)}}class Xe{constructor(e,t,s){this.converter=t,this._key=s,this.type="document",this.firestore=e}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new Sn(this.firestore,this.converter,this._key.path.popLast())}withConverter(e){return new Xe(this.firestore,e,this._key)}}class Sn extends hs{constructor(e,t,s){super(e,t,zc(s)),this._path=s,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const e=this._path.popLast();return e.isEmpty()?null:new Xe(this.firestore,null,new W(e))}withConverter(e){return new Sn(this.firestore,e,this._path)}}function eo(n,e,...t){if(n=ge(n),Sg("collection","path",e),n instanceof Ea){const s=me.fromString(e,...t);return gf(s),new Sn(n,null,s)}{if(!(n instanceof Xe||n instanceof Sn))throw new M(P.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const s=n._path.child(me.fromString(e,...t));return gf(s),new Sn(n.firestore,null,s)}}function Gt(n,e,...t){if(n=ge(n),arguments.length===1&&(e=wm.newId()),Sg("doc","path",e),n instanceof Ea){const s=me.fromString(e,...t);return mf(s),new Xe(n,null,new W(s))}{if(!(n instanceof Xe||n instanceof Sn))throw new M(P.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const s=n._path.child(me.fromString(e,...t));return mf(s),new Xe(n.firestore,n instanceof Sn?n.converter:null,new W(s))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Fg(n,e,t){let s;return s=n?t&&(t.merge||t.mergeFields)?n.toFirestore(e,t):n.toFirestore(e):e,s}class wC extends Vg{constructor(e){super(),this.firestore=e}convertBytes(e){return new ss(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new Xe(this.firestore,null,t)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function dl(n){n=Ot(n,Xe);const e=Ot(n.firestore,ni);return aC(wa(e),n._key).then(t=>CC(e,n,t))}class wh extends Vg{constructor(e){super(),this.firestore=e}convertBytes(e){return new ss(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new Xe(this.firestore,null,t)}}function fl(n){n=Ot(n,hs);const e=Ot(n.firestore,ni),t=wa(e),s=new wh(e);return vC(n._query),lC(t,n._query).then(i=>new TC(e,s,n,i))}function pl(n,e,t){n=Ot(n,Xe);const s=Ot(n.firestore,ni),i=Fg(n.converter,e,t);return Bg(s,[kg(Ta(s),"setDoc",n._key,i,n.converter!==null,t).toMutation(n._key,it.none())])}function If(n,e,t,...s){n=Ot(n,Xe);const i=Ot(n.firestore,ni),r=Ta(i);let o;return o=typeof(e=ge(e))=="string"||e instanceof Ir?Ng(r,"updateDoc",n._key,e,t,s):Pg(r,"updateDoc",n._key,e),Bg(i,[o.toMutation(n._key,it.exists(!0))])}function Bg(n,e){return function(s,i){const r=new Nt;return s.asyncQueue.enqueueAndForget(async()=>H0(await rC(s),i,r)),r.promise}(wa(n),e)}function CC(n,e,t){const s=t.docs.get(e._key),i=new wh(n);return new Eh(n,i,e._key,s,new As(t.hasPendingWrites,t.fromCache),e.converter)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class jC{constructor(e,t){this.appName_=e,this.appCheckProvider=t,this.appCheck=t==null?void 0:t.getImmediate({optional:!0}),this.appCheck||t==null||t.get().then(s=>this.appCheck=s)}getToken(e){return this.appCheck?this.appCheck.getToken(e):new Promise((t,s)=>{setTimeout(()=>{this.appCheck?this.getToken(e).then(t,s):t(null)},0)})}addTokenChangeListener(e){var t;(t=this.appCheckProvider)===null||t===void 0||t.get().then(s=>s.addTokenListener(e))}notifyForInvalidToken(){ot(`Provided AppCheck credentials for the app named "${this.appName_}" are invalid. This usually indicates your app was not initialized correctly.`)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sr{constructor(e){this.initTransports_(e)}static get ALL_TRANSPORTS(){return[ks,It]}static get IS_TRANSPORT_INITIALIZED(){return this.globalTransportInitialized_}initTransports_(e){const t=It&&It.isAvailable();let s=t&&!It.previouslyFailed();if(e.webSocketOnly&&(t||ot("wss:// URL used, but browser isn't known to support websockets.  Trying anyway."),s=!0),s)this.transports_=[It];else{const i=this.transports_=[];for(const r of sr.ALL_TRANSPORTS)r&&r.isAvailable()&&i.push(r);sr.globalTransportInitialized_=!0}}initialTransport(){if(this.transports_.length>0)return this.transports_[0];throw new Error("No transports available")}upgradeTransport(){return this.transports_.length>1?this.transports_[1]:null}}sr.globalTransportInitialized_=!1;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Rb(n,e){return us(n.name,e.name)}function Ph(n,e){return us(n,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Uf;class Le{constructor(e,t=Le.__childrenNodeConstructor.EMPTY_NODE){this.value_=e,this.priorityNode_=t,this.lazyHash_=null,D(this.value_!==void 0&&this.value_!==null,"LeafNode shouldn't be created with null/undefined value."),f_(this.priorityNode_)}static set __childrenNodeConstructor(e){Uf=e}static get __childrenNodeConstructor(){return Uf}isLeafNode(){return!0}getPriority(){return this.priorityNode_}updatePriority(e){return new Le(this.value_,e)}getImmediateChild(e){return e===".priority"?this.priorityNode_:Le.__childrenNodeConstructor.EMPTY_NODE}getChild(e){return X(e)?this:J(e)===".priority"?this.priorityNode_:Le.__childrenNodeConstructor.EMPTY_NODE}hasChild(){return!1}getPredecessorChildName(e,t){return null}updateImmediateChild(e,t){return e===".priority"?this.updatePriority(t):t.isEmpty()&&e!==".priority"?this:Le.__childrenNodeConstructor.EMPTY_NODE.updateImmediateChild(e,t).updatePriority(this.priorityNode_)}updateChild(e,t){const s=J(e);return s===null?t:t.isEmpty()&&s!==".priority"?this:(D(s!==".priority"||On(e)===1,".priority must be the last token in a path"),this.updateImmediateChild(s,Le.__childrenNodeConstructor.EMPTY_NODE.updateChild(ye(e),t)))}isEmpty(){return!1}numChildren(){return 0}forEachChild(e,t){return!1}val(e){return e&&!this.getPriority().isEmpty()?{".value":this.getValue(),".priority":this.getPriority().val()}:this.getValue()}hash(){if(this.lazyHash_===null){let e="";this.priorityNode_.isEmpty()||(e+="priority:"+d_(this.priorityNode_.val())+":");const t=typeof this.value_;e+=t+":",t==="number"?e+=jg(this.value_):e+=this.value_,this.lazyHash_=Wg(e)}return this.lazyHash_}getValue(){return this.value_}compareTo(e){return e===Le.__childrenNodeConstructor.EMPTY_NODE?1:e instanceof Le.__childrenNodeConstructor?-1:(D(e.isLeafNode(),"Unknown node type"),this.compareToLeafNode_(e))}compareToLeafNode_(e){const t=typeof e.value_,s=typeof this.value_,i=Le.VALUE_TYPE_ORDER.indexOf(t),r=Le.VALUE_TYPE_ORDER.indexOf(s);return D(i>=0,"Unknown leaf type: "+t),D(r>=0,"Unknown leaf type: "+s),i===r?s==="object"?0:this.value_<e.value_?-1:this.value_===e.value_?0:1:r-i}withIndex(){return this}isIndexed(){return!0}equals(e){if(e===this)return!0;if(e.isLeafNode()){const t=e;return this.value_===t.value_&&this.priorityNode_.equals(t.priorityNode_)}else return!1}}Le.VALUE_TYPE_ORDER=["object","boolean","number","string"];/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Db=Math.log(2);class xb{constructor(e){const t=r=>parseInt(Math.log(r)/Db,10),s=r=>parseInt(Array(r+1).join("1"),2);this.count=t(e+1),this.current_=this.count-1;const i=s(this.count);this.bits_=e+1&i}nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}}const zo=function(n,e,t,s){n.sort(e);const i=function(c,h){const d=h-c;let p,m;if(d===0)return null;if(d===1)return p=n[c],m=t?t(p):p,new Me(m,p.node,Me.BLACK,null,null);{const E=parseInt(d/2,10)+c,C=i(c,E),R=i(E+1,h);return p=n[E],m=t?t(p):p,new Me(m,p.node,Me.BLACK,C,R)}},r=function(c){let h=null,d=null,p=n.length;const m=function(C,R){const k=p-C,V=p;p-=C;const U=i(k+1,V),q=n[k],ee=t?t(q):q;E(new Me(ee,q.node,R,null,U))},E=function(C){h?(h.left=C,h=C):(d=C,h=C)};for(let C=0;C<c.count;++C){const R=c.nextBitIsOne(),k=Math.pow(2,c.count-(C+1));R?m(k,Me.BLACK):(m(k,Me.BLACK),m(k,Me.RED))}return d},o=new xb(n.length),l=r(o);return new lt(s||e,l)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ob=!0;function Pe(n,e=null){if(n===null)return z.EMPTY_NODE;if(typeof n=="object"&&".priority"in n&&(e=n[".priority"]),D(e===null||typeof e=="string"||typeof e=="number"||typeof e=="object"&&".sv"in e,"Invalid priority type found: "+typeof e),typeof n=="object"&&".value"in n&&n[".value"]!==null&&(n=n[".value"]),typeof n!="object"||".sv"in n){const t=n;return new Le(t,Pe(e))}if(!(n instanceof Array)&&Ob){const t=[];let s=!1;if(je(n,(o,l)=>{if(o.substring(0,1)!=="."){const c=Pe(l);c.isEmpty()||(s=s||!c.getPriority().isEmpty(),t.push(new Z(o,c)))}}),t.length===0)return z.EMPTY_NODE;const r=zo(t,Rb,o=>o.name,Ph);if(s){const o=zo(t,we.getCompare());return new z(r,Pe(e),new en({".priority":o},{".priority":we}))}else return new z(r,Pe(e),en.Default)}else{let t=z.EMPTY_NODE;return je(n,(s,i)=>{if(Vt(n,s)&&s.substring(0,1)!=="."){const r=Pe(i);(r.isLeafNode()||!r.isEmpty())&&(t=t.updateImmediateChild(s,r))}}),t.updatePriority(Pe(e))}}kb(Pe);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Ct;(function(n){n[n.OVERWRITE=0]="OVERWRITE",n[n.MERGE=1]="MERGE",n[n.ACK_USER_WRITE=2]="ACK_USER_WRITE",n[n.LISTEN_COMPLETE=3]="LISTEN_COMPLETE"})(Ct||(Ct={}));function Lh(){return{fromUser:!0,fromServer:!1,queryId:null,tagged:!1}}function Oh(){return{fromUser:!1,fromServer:!0,queryId:null,tagged:!1}}function Mh(n){return{fromUser:!1,fromServer:!0,queryId:n,tagged:!0}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ko{constructor(e,t,s){this.path=e,this.affectedTree=t,this.revert=s,this.type=Ct.ACK_USER_WRITE,this.source=Lh()}operationForChild(e){if(X(this.path)){if(this.affectedTree.value!=null)return D(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const t=this.affectedTree.subtree(new ue(e));return new Ko(le(),t,this.revert)}}else return D(J(this.path)===e,"operationForChild called for unrelated child."),new Ko(ye(this.path),this.affectedTree,this.revert)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class lr{constructor(e,t){this.source=e,this.path=t,this.type=Ct.LISTEN_COMPLETE}operationForChild(e){return X(this.path)?new lr(this.source,le()):new lr(this.source,ye(this.path))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rs{constructor(e,t,s){this.source=e,this.path=t,this.snap=s,this.type=Ct.OVERWRITE}operationForChild(e){return X(this.path)?new rs(this.source,le(),this.snap.getImmediateChild(e)):new rs(this.source,ye(this.path),this.snap)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Kb{constructor(e){this.query_=e,this.index_=this.query_._queryParams.getIndex()}}function Qb(n,e,t,s){const i=[],r=[];return e.forEach(o=>{o.type==="child_changed"&&n.index_.indexedValueChanged(o.oldSnap,o.snapshotNode)&&r.push(Vb(o.childName,o.snapshotNode))}),Si(n,i,"child_removed",e,s,t),Si(n,i,"child_added",e,s,t),Si(n,i,"child_moved",r,s,t),Si(n,i,"child_changed",e,s,t),Si(n,i,"value",e,s,t),i}function Si(n,e,t,s,i,r){const o=s.filter(l=>l.type===t);o.sort((l,c)=>Jb(n,l,c)),o.forEach(l=>{const c=Yb(n,l,r);i.forEach(h=>{h.respondsTo(l.type)&&e.push(h.createEvent(c,n.query_))})})}function Yb(n,e,t){return e.type==="value"||e.type==="child_removed"||(e.prevName=t.getPredecessorChildName(e.childName,e.snapshotNode,n.index_)),e}function Jb(n,e,t){if(e.childName==null||t.childName==null)throw Ys("Should only compare child_ events.");const s=new Z(e.childName,e.snapshotNode),i=new Z(t.childName,t.snapshotNode);return n.index_.compare(s,i)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Sa(n,e){return{eventCache:n,serverCache:e}}function ji(n,e,t,s){return Sa(new Mn(e,t,s),n.serverCache)}function v_(n,e,t,s){return Sa(n.eventCache,new Mn(e,t,s))}function Qo(n){return n.eventCache.isFullyInitialized()?n.eventCache.getNode():null}function os(n){return n.serverCache.isFullyInitialized()?n.serverCache.getNode():null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ra(n,e){return C_(e,n)}function Zb(n,e,t,s,i){D(s>n.lastWriteId,"Stacking an older write on top of newer ones"),i===void 0&&(i=!0),n.allWrites.push({path:e,snap:t,writeId:s,visible:i}),i&&(n.visibleWrites=zi(n.visibleWrites,e,t)),n.lastWriteId=s}function eS(n,e,t,s){D(s>n.lastWriteId,"Stacking an older merge on top of newer ones"),n.allWrites.push({path:e,children:t,writeId:s,visible:!0}),n.visibleWrites=ac(n.visibleWrites,e,t),n.lastWriteId=s}function tS(n,e){for(let t=0;t<n.allWrites.length;t++){const s=n.allWrites[t];if(s.writeId===e)return s}return null}function nS(n,e){const t=n.allWrites.findIndex(l=>l.writeId===e);D(t>=0,"removeWrite called with nonexistent writeId.");const s=n.allWrites[t];n.allWrites.splice(t,1);let i=s.visible,r=!1,o=n.allWrites.length-1;for(;i&&o>=0;){const l=n.allWrites[o];l.visible&&(o>=t&&sS(l,s.path)?i=!1:mt(s.path,l.path)&&(r=!0)),o--}if(i){if(r)return iS(n),!0;if(s.snap)n.visibleWrites=jf(n.visibleWrites,s.path);else{const l=s.children;je(l,c=>{n.visibleWrites=jf(n.visibleWrites,Ie(s.path,c))})}return!0}else return!1}function sS(n,e){if(n.snap)return mt(n.path,e);for(const t in n.children)if(n.children.hasOwnProperty(t)&&mt(Ie(n.path,t),e))return!0;return!1}function iS(n){n.visibleWrites=w_(n.allWrites,rS,le()),n.allWrites.length>0?n.lastWriteId=n.allWrites[n.allWrites.length-1].writeId:n.lastWriteId=-1}function rS(n){return n.visible}function w_(n,e,t){let s=St.empty();for(let i=0;i<n.length;++i){const r=n[i];if(e(r)){const o=r.path;let l;if(r.snap)mt(t,o)?(l=rt(t,o),s=zi(s,l,r.snap)):mt(o,t)&&(l=rt(o,t),s=zi(s,le(),r.snap.getChild(l)));else if(r.children){if(mt(t,o))l=rt(t,o),s=ac(s,l,r.children);else if(mt(o,t))if(l=rt(o,t),X(l))s=ac(s,le(),r.children);else{const c=Ms(r.children,J(l));if(c){const h=c.getChild(ye(l));s=zi(s,le(),h)}}}else throw Ys("WriteRecord should have .snap or .children")}}return s}function T_(n,e,t,s,i){if(!s&&!i){const r=ds(n.visibleWrites,e);if(r!=null)return r;{const o=Rn(n.visibleWrites,e);if(cc(o))return t;if(t==null&&!lc(o,le()))return null;{const l=t||z.EMPTY_NODE;return Gs(o,l)}}}else{const r=Rn(n.visibleWrites,e);if(!i&&cc(r))return t;if(!i&&t==null&&!lc(r,le()))return null;{const o=function(h){return(h.visible||i)&&(!s||!~s.indexOf(h.writeId))&&(mt(h.path,e)||mt(e,h.path))},l=w_(n.allWrites,o,e),c=t||z.EMPTY_NODE;return Gs(l,c)}}}function oS(n,e,t){let s=z.EMPTY_NODE;const i=ds(n.visibleWrites,e);if(i)return i.isLeafNode()||i.forEachChild(we,(r,o)=>{s=s.updateImmediateChild(r,o)}),s;if(t){const r=Rn(n.visibleWrites,e);return t.forEachChild(we,(o,l)=>{const c=Gs(Rn(r,new ue(o)),l);s=s.updateImmediateChild(o,c)}),zf(r).forEach(o=>{s=s.updateImmediateChild(o.name,o.node)}),s}else{const r=Rn(n.visibleWrites,e);return zf(r).forEach(o=>{s=s.updateImmediateChild(o.name,o.node)}),s}}function aS(n,e,t,s,i){D(s||i,"Either existingEventSnap or existingServerSnap must exist");const r=Ie(e,t);if(lc(n.visibleWrites,r))return null;{const o=Rn(n.visibleWrites,r);return cc(o)?i.getChild(t):Gs(o,i.getChild(t))}}function lS(n,e,t,s){const i=Ie(e,t),r=ds(n.visibleWrites,i);if(r!=null)return r;if(s.isCompleteForChild(t)){const o=Rn(n.visibleWrites,i);return Gs(o,s.getNode().getImmediateChild(t))}else return null}function cS(n,e){return ds(n.visibleWrites,e)}function hS(n,e,t,s,i,r,o){let l;const c=Rn(n.visibleWrites,e),h=ds(c,le());if(h!=null)l=h;else if(t!=null)l=Gs(c,t);else return[];if(l=l.withIndex(o),!l.isEmpty()&&!l.isLeafNode()){const d=[],p=o.getCompare(),m=r?l.getReverseIteratorFrom(s,o):l.getIteratorFrom(s,o);let E=m.getNext();for(;E&&d.length<i;)p(E,s)!==0&&d.push(E),E=m.getNext();return d}else return[]}function uS(){return{visibleWrites:St.empty(),allWrites:[],lastWriteId:-1}}function Yo(n,e,t,s){return T_(n.writeTree,n.treePath,e,t,s)}function Vh(n,e){return oS(n.writeTree,n.treePath,e)}function Gf(n,e,t,s){return aS(n.writeTree,n.treePath,e,t,s)}function Jo(n,e){return cS(n.writeTree,Ie(n.treePath,e))}function dS(n,e,t,s,i,r){return hS(n.writeTree,n.treePath,e,t,s,i,r)}function Fh(n,e,t){return lS(n.writeTree,n.treePath,e,t)}function I_(n,e){return C_(Ie(n.treePath,e),n.writeTree)}function C_(n,e){return{treePath:n,writeTree:e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class fS{constructor(){this.changeMap=new Map}trackChildChange(e){const t=e.type,s=e.childName;D(t==="child_added"||t==="child_changed"||t==="child_removed","Only child changes supported for tracking"),D(s!==".priority","Only non-priority child changes can be tracked.");const i=this.changeMap.get(s);if(i){const r=i.type;if(t==="child_added"&&r==="child_removed")this.changeMap.set(s,or(s,e.snapshotNode,i.snapshotNode));else if(t==="child_removed"&&r==="child_added")this.changeMap.delete(s);else if(t==="child_removed"&&r==="child_changed")this.changeMap.set(s,rr(s,i.oldSnap));else if(t==="child_changed"&&r==="child_added")this.changeMap.set(s,js(s,e.snapshotNode));else if(t==="child_changed"&&r==="child_changed")this.changeMap.set(s,or(s,e.snapshotNode,i.oldSnap));else throw Ys("Illegal combination of changes: "+e+" occurred after "+i)}else this.changeMap.set(s,e)}getChanges(){return Array.from(this.changeMap.values())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class pS{getCompleteChild(e){return null}getChildAfterChild(e,t,s){return null}}const b_=new pS;class Bh{constructor(e,t,s=null){this.writes_=e,this.viewCache_=t,this.optCompleteServerCache_=s}getCompleteChild(e){const t=this.viewCache_.eventCache;if(t.isCompleteForChild(e))return t.getNode().getImmediateChild(e);{const s=this.optCompleteServerCache_!=null?new Mn(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return Fh(this.writes_,e,s)}}getChildAfterChild(e,t,s){const i=this.optCompleteServerCache_!=null?this.optCompleteServerCache_:os(this.viewCache_),r=dS(this.writes_,i,t,1,s,e);return r.length===0?null:r[0]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class IS{constructor(e,t){this.query_=e,this.eventRegistrations_=[];const s=this.query_._queryParams,i=new Dh(s.getIndex()),r=Bb(s);this.processor_=mS(r);const o=t.serverCache,l=t.eventCache,c=i.updateFullNode(z.EMPTY_NODE,o.getNode(),null),h=r.updateFullNode(z.EMPTY_NODE,l.getNode(),null),d=new Mn(c,o.isFullyInitialized(),i.filtersNodes()),p=new Mn(h,l.isFullyInitialized(),r.filtersNodes());this.viewCache_=Sa(p,d),this.eventGenerator_=new Kb(this.query_)}get query(){return this.query_}}function CS(n){return n.viewCache_.serverCache.getNode()}function bS(n){return Qo(n.viewCache_)}function SS(n,e){const t=os(n.viewCache_);return t&&(n.query._queryParams.loadsAllData()||!X(e)&&!t.getImmediateChild(J(e)).isEmpty())?t.getChild(e):null}function Qf(n){return n.eventRegistrations_.length===0}function RS(n,e){n.eventRegistrations_.push(e)}function Yf(n,e,t){const s=[];if(t){D(e==null,"A cancel should cancel all event registrations.");const i=n.query._path;n.eventRegistrations_.forEach(r=>{const o=r.createCancelEvent(t,i);o&&s.push(o)})}if(e){let i=[];for(let r=0;r<n.eventRegistrations_.length;++r){const o=n.eventRegistrations_[r];if(!o.matches(e))i.push(o);else if(e.hasAnyCallback()){i=i.concat(n.eventRegistrations_.slice(r+1));break}}n.eventRegistrations_=i}else n.eventRegistrations_=[];return s}function Jf(n,e,t,s){e.type===Ct.MERGE&&e.source.queryId!==null&&(D(os(n.viewCache_),"We should always have a full cache before handling merges"),D(Qo(n.viewCache_),"Missing event cache, even though we have a server cache"));const i=n.viewCache_,r=_S(n.processor_,i,e,t,s);return gS(n.processor_,r.viewCache),D(r.viewCache.serverCache.isFullyInitialized()||!i.serverCache.isFullyInitialized(),"Once a server snap is complete, it should never go back"),n.viewCache_=r.viewCache,R_(n,r.changes,r.viewCache.eventCache.getNode(),null)}function AS(n,e){const t=n.viewCache_.eventCache,s=[];return t.getNode().isLeafNode()||t.getNode().forEachChild(we,(r,o)=>{s.push(js(r,o))}),t.isFullyInitialized()&&s.push(__(t.getNode())),R_(n,s,t.getNode(),e)}function R_(n,e,t,s){const i=s?[s]:n.eventRegistrations_;return Qb(n.eventGenerator_,e,t,i)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Zo;class A_{constructor(){this.views=new Map}}function kS(n){D(!Zo,"__referenceConstructor has already been defined"),Zo=n}function PS(){return D(Zo,"Reference.ts has not been loaded"),Zo}function NS(n){return n.views.size===0}function Uh(n,e,t,s){const i=e.source.queryId;if(i!==null){const r=n.views.get(i);return D(r!=null,"SyncTree gave us an op for an invalid query."),Jf(r,e,t,s)}else{let r=[];for(const o of n.views.values())r=r.concat(Jf(o,e,t,s));return r}}function k_(n,e,t,s,i){const r=e._queryIdentifier,o=n.views.get(r);if(!o){let l=Yo(t,i?s:null),c=!1;l?c=!0:s instanceof z?(l=Vh(t,s),c=!1):(l=z.EMPTY_NODE,c=!1);const h=Sa(new Mn(l,c,!1),new Mn(s,i,!1));return new IS(e,h)}return o}function DS(n,e,t,s,i,r){const o=k_(n,e,s,i,r);return n.views.has(e._queryIdentifier)||n.views.set(e._queryIdentifier,o),RS(o,t),AS(o,t)}function xS(n,e,t,s){const i=e._queryIdentifier,r=[];let o=[];const l=Vn(n);if(i==="default")for(const[c,h]of n.views.entries())o=o.concat(Yf(h,t,s)),Qf(h)&&(n.views.delete(c),h.query._queryParams.loadsAllData()||r.push(h.query));else{const c=n.views.get(i);c&&(o=o.concat(Yf(c,t,s)),Qf(c)&&(n.views.delete(i),c.query._queryParams.loadsAllData()||r.push(c.query)))}return l&&!Vn(n)&&r.push(new(PS())(e._repo,e._path)),{removed:r,events:o}}function P_(n){const e=[];for(const t of n.views.values())t.query._queryParams.loadsAllData()||e.push(t);return e}function An(n,e){let t=null;for(const s of n.views.values())t=t||SS(s,e);return t}function N_(n,e){if(e._queryParams.loadsAllData())return Aa(n);{const s=e._queryIdentifier;return n.views.get(s)}}function D_(n,e){return N_(n,e)!=null}function Vn(n){return Aa(n)!=null}function Aa(n){for(const e of n.views.values())if(e.query._queryParams.loadsAllData())return e;return null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let ea;function LS(n){D(!ea,"__referenceConstructor has already been defined"),ea=n}function OS(){return D(ea,"Reference.ts has not been loaded"),ea}let MS=1;class Xf{constructor(e){this.listenProvider_=e,this.syncPointTree_=new _e(null),this.pendingWriteTree_=uS(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function x_(n,e,t,s,i){return Zb(n.pendingWriteTree_,e,t,s,i),i?ii(n,new rs(Lh(),e,t)):[]}function VS(n,e,t,s){eS(n.pendingWriteTree_,e,t,s);const i=_e.fromObject(t);return ii(n,new zs(Lh(),e,i))}function wn(n,e,t=!1){const s=tS(n.pendingWriteTree_,e);if(nS(n.pendingWriteTree_,e)){let r=new _e(null);return s.snap!=null?r=r.set(le(),!0):je(s.children,o=>{r=r.set(new ue(o),!0)}),ii(n,new Ko(s.path,r,t))}else return[]}function Ar(n,e,t){return ii(n,new rs(Oh(),e,t))}function FS(n,e,t){const s=_e.fromObject(t);return ii(n,new zs(Oh(),e,s))}function BS(n,e){return ii(n,new lr(Oh(),e))}function US(n,e,t){const s=Wh(n,t);if(s){const i=$h(s),r=i.path,o=i.queryId,l=rt(r,e),c=new lr(Mh(o),l);return jh(n,r,c)}else return[]}function ta(n,e,t,s,i=!1){const r=e._path,o=n.syncPointTree_.get(r);let l=[];if(o&&(e._queryIdentifier==="default"||D_(o,e))){const c=xS(o,e,t,s);NS(o)&&(n.syncPointTree_=n.syncPointTree_.remove(r));const h=c.removed;if(l=c.events,!i){const d=h.findIndex(m=>m._queryParams.loadsAllData())!==-1,p=n.syncPointTree_.findOnPath(r,(m,E)=>Vn(E));if(d&&!p){const m=n.syncPointTree_.subtree(r);if(!m.isEmpty()){const E=$S(m);for(let C=0;C<E.length;++C){const R=E[C],k=R.query,V=V_(n,R);n.listenProvider_.startListening(Gi(k),cr(n,k),V.hashFn,V.onComplete)}}}!p&&h.length>0&&!s&&(d?n.listenProvider_.stopListening(Gi(e),null):h.forEach(m=>{const E=n.queryToTagMap.get(ka(m));n.listenProvider_.stopListening(Gi(m),E)}))}jS(n,h)}return l}function L_(n,e,t,s){const i=Wh(n,s);if(i!=null){const r=$h(i),o=r.path,l=r.queryId,c=rt(o,e),h=new rs(Mh(l),c,t);return jh(n,o,h)}else return[]}function qS(n,e,t,s){const i=Wh(n,s);if(i){const r=$h(i),o=r.path,l=r.queryId,c=rt(o,e),h=_e.fromObject(t),d=new zs(Mh(l),c,h);return jh(n,o,d)}else return[]}function dc(n,e,t,s=!1){const i=e._path;let r=null,o=!1;n.syncPointTree_.foreachOnPath(i,(m,E)=>{const C=rt(m,i);r=r||An(E,C),o=o||Vn(E)});let l=n.syncPointTree_.get(i);l?(o=o||Vn(l),r=r||An(l,le())):(l=new A_,n.syncPointTree_=n.syncPointTree_.set(i,l));let c;r!=null?c=!0:(c=!1,r=z.EMPTY_NODE,n.syncPointTree_.subtree(i).foreachChild((E,C)=>{const R=An(C,le());R&&(r=r.updateImmediateChild(E,R))}));const h=D_(l,e);if(!h&&!e._queryParams.loadsAllData()){const m=ka(e);D(!n.queryToTagMap.has(m),"View does not exist, but we have a tag");const E=zS();n.queryToTagMap.set(m,E),n.tagToQueryMap.set(E,m)}const d=Ra(n.pendingWriteTree_,i);let p=DS(l,e,t,d,r,c);if(!h&&!o&&!s){const m=N_(l,e);p=p.concat(GS(n,e,m))}return p}function qh(n,e,t){const i=n.pendingWriteTree_,r=n.syncPointTree_.findOnPath(e,(o,l)=>{const c=rt(o,e),h=An(l,c);if(h)return h});return T_(i,e,r,t,!0)}function WS(n,e){const t=e._path;let s=null;n.syncPointTree_.foreachOnPath(t,(h,d)=>{const p=rt(h,t);s=s||An(d,p)});let i=n.syncPointTree_.get(t);i?s=s||An(i,le()):(i=new A_,n.syncPointTree_=n.syncPointTree_.set(t,i));const r=s!=null,o=r?new Mn(s,!0,!1):null,l=Ra(n.pendingWriteTree_,e._path),c=k_(i,e,l,r?o.getNode():z.EMPTY_NODE,r);return bS(c)}function ii(n,e){return O_(e,n.syncPointTree_,null,Ra(n.pendingWriteTree_,le()))}function O_(n,e,t,s){if(X(n.path))return M_(n,e,t,s);{const i=e.get(le());t==null&&i!=null&&(t=An(i,le()));let r=[];const o=J(n.path),l=n.operationForChild(o),c=e.children.get(o);if(c&&l){const h=t?t.getImmediateChild(o):null,d=I_(s,o);r=r.concat(O_(l,c,h,d))}return i&&(r=r.concat(Uh(i,n,s,t))),r}}function M_(n,e,t,s){const i=e.get(le());t==null&&i!=null&&(t=An(i,le()));let r=[];return e.children.inorderTraversal((o,l)=>{const c=t?t.getImmediateChild(o):null,h=I_(s,o),d=n.operationForChild(o);d&&(r=r.concat(M_(d,l,c,h)))}),i&&(r=r.concat(Uh(i,n,s,t))),r}function V_(n,e){const t=e.query,s=cr(n,t);return{hashFn:()=>(CS(e)||z.EMPTY_NODE).hash(),onComplete:i=>{if(i==="ok")return s?US(n,t._path,s):BS(n,t._path);{const r=BC(i,t);return ta(n,t,null,r)}}}}function cr(n,e){const t=ka(e);return n.queryToTagMap.get(t)}function ka(n){return n._path.toString()+"$"+n._queryIdentifier}function Wh(n,e){return n.tagToQueryMap.get(e)}function $h(n){const e=n.indexOf("$");return D(e!==-1&&e<n.length-1,"Bad queryKey."),{queryId:n.substr(e+1),path:new ue(n.substr(0,e))}}function jh(n,e,t){const s=n.syncPointTree_.get(e);D(s,"Missing sync point for query tag that we're tracking");const i=Ra(n.pendingWriteTree_,e);return Uh(s,t,i,null)}function $S(n){return n.fold((e,t,s)=>{if(t&&Vn(t))return[Aa(t)];{let i=[];return t&&(i=P_(t)),je(s,(r,o)=>{i=i.concat(o)}),i}})}function Gi(n){return n._queryParams.loadsAllData()&&!n._queryParams.isDefault()?new(OS())(n._repo,n._path):n}function jS(n,e){for(let t=0;t<e.length;++t){const s=e[t];if(!s._queryParams.loadsAllData()){const i=ka(s),r=n.queryToTagMap.get(i);n.queryToTagMap.delete(i),n.tagToQueryMap.delete(r)}}}function zS(){return MS++}function GS(n,e,t){const s=e._path,i=cr(n,e),r=V_(n,t),o=n.listenProvider_.startListening(Gi(e),i,r.hashFn,r.onComplete),l=n.syncPointTree_.subtree(s);if(i)D(!Vn(l.value),"If we're adding a query, it shouldn't be shadowed");else{const c=l.fold((h,d,p)=>{if(!X(h)&&d&&Vn(d))return[Aa(d).query];{let m=[];return d&&(m=m.concat(P_(d).map(E=>E.query))),je(p,(E,C)=>{m=m.concat(C)}),m}});for(let h=0;h<c.length;++h){const d=c[h];n.listenProvider_.stopListening(Gi(d),cr(n,d))}}return o}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zh{constructor(e){this.node_=e}getImmediateChild(e){const t=this.node_.getImmediateChild(e);return new zh(t)}node(){return this.node_}}class Gh{constructor(e,t){this.syncTree_=e,this.path_=t}getImmediateChild(e){const t=Ie(this.path_,e);return new Gh(this.syncTree_,t)}node(){return qh(this.syncTree_,this.path_)}}const HS=function(n){return n=n||{},n.timestamp=n.timestamp||new Date().getTime(),n},Zf=function(n,e,t){if(!n||typeof n!="object")return n;if(D(".sv"in n,"Unexpected leaf node or priority contents"),typeof n[".sv"]=="string")return KS(n[".sv"],e,t);if(typeof n[".sv"]=="object")return QS(n[".sv"],e);D(!1,"Unexpected server value: "+JSON.stringify(n,null,2))},KS=function(n,e,t){switch(n){case"timestamp":return t.timestamp;default:D(!1,"Unexpected server value: "+n)}},QS=function(n,e,t){n.hasOwnProperty("increment")||D(!1,"Unexpected server value: "+JSON.stringify(n,null,2));const s=n.increment;typeof s!="number"&&D(!1,"Unexpected increment value: "+s);const i=e.node();if(D(i!==null&&typeof i<"u","Expected ChildrenNode.EMPTY_NODE for nulls"),!i.isLeafNode())return s;const o=i.getValue();return typeof o!="number"?s:o+s},F_=function(n,e,t,s){return Hh(e,new Gh(t,n),s)},B_=function(n,e,t){return Hh(n,new zh(e),t)};function Hh(n,e,t){const s=n.getPriority().val(),i=Zf(s,e.getImmediateChild(".priority"),t);let r;if(n.isLeafNode()){const o=n,l=Zf(o.getValue(),e,t);return l!==o.getValue()||i!==o.getPriority().val()?new Le(l,Pe(i)):n}else{const o=n;return r=o,i!==o.getPriority().val()&&(r=r.updatePriority(new Le(i))),o.forEachChild(we,(l,c)=>{const h=Hh(c,e.getImmediateChild(l),t);h!==c&&(r=r.updateImmediateChild(l,h))}),r}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ZS=/[\[\].#$\/\u0000-\u001F\u007F]/,eR=/[\[\].#$\u0000-\u001F\u007F]/,El=10*1024*1024,Yh=function(n){return typeof n=="string"&&n.length!==0&&!ZS.test(n)},$_=function(n){return typeof n=="string"&&n.length!==0&&!eR.test(n)},tR=function(n){return n&&(n=n.replace(/^\/*\.info(\/|$)/,"/")),$_(n)},pc=function(n){return n===null||typeof n=="string"||typeof n=="number"&&!Th(n)||n&&typeof n=="object"&&Vt(n,".sv")},Jh=function(n,e,t,s){s&&e===void 0||Na(ia(n,"value"),e,t)},Na=function(n,e,t){const s=t instanceof ue?new vb(t,n):t;if(e===void 0)throw new Error(n+"contains undefined "+zn(s));if(typeof e=="function")throw new Error(n+"contains a function "+zn(s)+" with contents = "+e.toString());if(Th(e))throw new Error(n+"contains "+e.toString()+" "+zn(s));if(typeof e=="string"&&e.length>El/3&&ra(e)>El)throw new Error(n+"contains a string greater than "+El+" utf8 bytes "+zn(s)+" ('"+e.substring(0,50)+"...')");if(e&&typeof e=="object"){let i=!1,r=!1;if(je(e,(o,l)=>{if(o===".value")i=!0;else if(o!==".priority"&&o!==".sv"&&(r=!0,!Yh(o)))throw new Error(n+" contains an invalid key ("+o+") "+zn(s)+`.  Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`);Eb(s,o),Na(n,l,s),wb(s)}),i&&r)throw new Error(n+' contains ".value" child '+zn(s)+" in addition to actual children.")}},nR=function(n,e){let t,s;for(t=0;t<e.length;t++){s=e[t];const r=ir(s);for(let o=0;o<r.length;o++)if(!(r[o]===".priority"&&o===r.length-1)){if(!Yh(r[o]))throw new Error(n+"contains an invalid key ("+r[o]+") in path "+s.toString()+`. Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`)}}e.sort(yb);let i=null;for(t=0;t<e.length;t++){if(s=e[t],i!==null&&mt(i,s))throw new Error(n+"contains a path "+i.toString()+" that is ancestor of another path "+s.toString());i=s}},sR=function(n,e,t,s){const i=ia(n,"values");if(!(e&&typeof e=="object")||Array.isArray(e))throw new Error(i+" must be an object containing the children to replace.");const r=[];je(e,(o,l)=>{const c=new ue(o);if(Na(i,l,Ie(t,c)),Rh(c)===".priority"&&!pc(l))throw new Error(i+"contains an invalid value for '"+c.toString()+"', which must be a valid Firebase priority (a string, finite number, server value, or null).");r.push(c)}),nR(i,r)},Xh=function(n,e,t,s){if(!$_(t))throw new Error(ia(n,e)+'was an invalid path = "'+t+`". Paths must be non-empty strings and can't contain ".", "#", "$", "[", or "]"`)},iR=function(n,e,t,s){t&&(t=t.replace(/^\/*\.info(\/|$)/,"/")),Xh(n,e,t)},j_=function(n,e){if(J(e)===".info")throw new Error(n+" failed = Can't modify data under /.info/")},rR=function(n,e){const t=e.path.toString();if(typeof e.repoInfo.host!="string"||e.repoInfo.host.length===0||!Yh(e.repoInfo.namespace)&&e.repoInfo.host.split(":")[0]!=="localhost"||t.length!==0&&!tR(t))throw new Error(ia(n,"url")+`must be a valid firebase URL and the path can't contain ".", "#", "$", "[", or "]".`)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class oR{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function Da(n,e){let t=null;for(let s=0;s<e.length;s++){const i=e[s],r=i.getPath();t!==null&&!Ah(r,t.path)&&(n.eventLists_.push(t),t=null),t===null&&(t={events:[],path:r}),t.events.push(i)}t&&n.eventLists_.push(t)}function z_(n,e,t){Da(n,t),G_(n,s=>Ah(s,e))}function gt(n,e,t){Da(n,t),G_(n,s=>mt(s,e)||mt(e,s))}function G_(n,e){n.recursionDepth_++;let t=!0;for(let s=0;s<n.eventLists_.length;s++){const i=n.eventLists_[s];if(i){const r=i.path;e(r)?(aR(n.eventLists_[s]),n.eventLists_[s]=null):t=!1}}t&&(n.eventLists_=[]),n.recursionDepth_--}function aR(n){for(let e=0;e<n.events.length;e++){const t=n.events[e];if(t!==null){n.events[e]=null;const s=t.getEventRunner();Wi&&Ue("event: "+t.toString()),si(s)}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const lR="repo_interrupt",cR=25;class hR{constructor(e,t,s,i){this.repoInfo_=e,this.forceRestClient_=t,this.authTokenProvider_=s,this.appCheckProvider_=i,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new oR,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=Ho(),this.transactionQueueTree_=new Kh,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function uR(n,e,t){if(n.stats_=bh(n.repoInfo_),n.forceRestClient_||$C())n.server_=new Go(n.repoInfo_,(s,i,r,o)=>{ep(n,s,i,r,o)},n.authTokenProvider_,n.appCheckProvider_),setTimeout(()=>tp(n,!0),0);else{if(typeof t<"u"&&t!==null){if(typeof t!="object")throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{Ne(t)}catch(s){throw new Error("Invalid authOverride provided: "+s)}}n.persistentConnection_=new tn(n.repoInfo_,e,(s,i,r,o)=>{ep(n,s,i,r,o)},s=>{tp(n,s)},s=>{dR(n,s)},n.authTokenProvider_,n.appCheckProvider_,t),n.server_=n.persistentConnection_}n.authTokenProvider_.addTokenChangeListener(s=>{n.server_.refreshAuthToken(s)}),n.appCheckProvider_.addTokenChangeListener(s=>{n.server_.refreshAppCheckToken(s.token)}),n.statsReporter_=KC(n.repoInfo_,()=>new Hb(n.stats_,n.server_)),n.infoData_=new Wb,n.infoSyncTree_=new Xf({startListening:(s,i,r,o)=>{let l=[];const c=n.infoData_.getNode(s._path);return c.isEmpty()||(l=Ar(n.infoSyncTree_,s._path,c),setTimeout(()=>{o("ok")},0)),l},stopListening:()=>{}}),Zh(n,"connected",!1),n.serverSyncTree_=new Xf({startListening:(s,i,r,o)=>(n.server_.listen(s,r,i,(l,c)=>{const h=o(l,c);gt(n.eventQueue_,s._path,h)}),[]),stopListening:(s,i)=>{n.server_.unlisten(s,i)}})}function H_(n){const t=n.infoData_.getNode(new ue(".info/serverTimeOffset")).val()||0;return new Date().getTime()+t}function xa(n){return HS({timestamp:H_(n)})}function ep(n,e,t,s,i){n.dataUpdateCount++;const r=new ue(e);t=n.interceptServerDataCallback_?n.interceptServerDataCallback_(e,t):t;let o=[];if(i)if(s){const c=Io(t,h=>Pe(h));o=qS(n.serverSyncTree_,r,c,i)}else{const c=Pe(t);o=L_(n.serverSyncTree_,r,c,i)}else if(s){const c=Io(t,h=>Pe(h));o=FS(n.serverSyncTree_,r,c)}else{const c=Pe(t);o=Ar(n.serverSyncTree_,r,c)}let l=r;o.length>0&&(l=Hs(n,r)),gt(n.eventQueue_,l,o)}function tp(n,e){Zh(n,"connected",e),e===!1&&gR(n)}function dR(n,e){je(e,(t,s)=>{Zh(n,t,s)})}function Zh(n,e,t){const s=new ue("/.info/"+e),i=Pe(t);n.infoData_.updateSnapshot(s,i);const r=Ar(n.infoSyncTree_,s,i);gt(n.eventQueue_,s,r)}function eu(n){return n.nextWriteId_++}function fR(n,e,t){const s=WS(n.serverSyncTree_,e);return s!=null?Promise.resolve(s):n.server_.get(e).then(i=>{const r=Pe(i).withIndex(e._queryParams.getIndex());dc(n.serverSyncTree_,e,t,!0);let o;if(e._queryParams.loadsAllData())o=Ar(n.serverSyncTree_,e._path,r);else{const l=cr(n.serverSyncTree_,e);o=L_(n.serverSyncTree_,e._path,r,l)}return gt(n.eventQueue_,e._path,o),ta(n.serverSyncTree_,e,t,null,!0),r},i=>(Pr(n,"get for query "+Ne(e)+" failed: "+i),Promise.reject(new Error(i))))}function pR(n,e,t,s,i){Pr(n,"set",{path:e.toString(),value:t,priority:s});const r=xa(n),o=Pe(t,s),l=qh(n.serverSyncTree_,e),c=B_(o,l,r),h=eu(n),d=x_(n.serverSyncTree_,e,c,h,!0);Da(n.eventQueue_,d),n.server_.put(e.toString(),o.val(!0),(m,E)=>{const C=m==="ok";C||ot("set at "+e+" failed: "+m);const R=wn(n.serverSyncTree_,h,!C);gt(n.eventQueue_,e,R),mc(n,i,m,E)});const p=nu(n,e);Hs(n,p),gt(n.eventQueue_,p,[])}function mR(n,e,t,s){Pr(n,"update",{path:e.toString(),value:t});let i=!0;const r=xa(n),o={};if(je(t,(l,c)=>{i=!1,o[l]=F_(Ie(e,l),Pe(c),n.serverSyncTree_,r)}),i)Ue("update() called with empty data.  Don't do anything."),mc(n,s,"ok",void 0);else{const l=eu(n),c=VS(n.serverSyncTree_,e,o,l);Da(n.eventQueue_,c),n.server_.merge(e.toString(),t,(h,d)=>{const p=h==="ok";p||ot("update at "+e+" failed: "+h);const m=wn(n.serverSyncTree_,l,!p),E=m.length>0?Hs(n,e):e;gt(n.eventQueue_,E,m),mc(n,s,h,d)}),je(t,h=>{const d=nu(n,Ie(e,h));Hs(n,d)}),gt(n.eventQueue_,e,[])}}function gR(n){Pr(n,"onDisconnectEvents");const e=xa(n),t=Ho();oc(n.onDisconnect_,le(),(i,r)=>{const o=F_(i,r,n.serverSyncTree_,e);y_(t,i,o)});let s=[];oc(t,le(),(i,r)=>{s=s.concat(Ar(n.serverSyncTree_,i,r));const o=nu(n,i);Hs(n,o)}),n.onDisconnect_=Ho(),gt(n.eventQueue_,le(),s)}function _R(n,e,t){let s;J(e._path)===".info"?s=dc(n.infoSyncTree_,e,t):s=dc(n.serverSyncTree_,e,t),z_(n.eventQueue_,e._path,s)}function yR(n,e,t){let s;J(e._path)===".info"?s=ta(n.infoSyncTree_,e,t):s=ta(n.serverSyncTree_,e,t),z_(n.eventQueue_,e._path,s)}function vR(n){n.persistentConnection_&&n.persistentConnection_.interrupt(lR)}function Pr(n,...e){let t="";n.persistentConnection_&&(t=n.persistentConnection_.id+":"),Ue(t,...e)}function mc(n,e,t,s){e&&si(()=>{if(t==="ok")e(null);else{const i=(t||"error").toUpperCase();let r=i;s&&(r+=": "+s);const o=new Error(r);o.code=i,e(o)}})}function K_(n,e,t){return qh(n.serverSyncTree_,e,t)||z.EMPTY_NODE}function tu(n,e=n.transactionQueueTree_){if(e||La(n,e),ri(e)){const t=Y_(n,e);D(t.length>0,"Sending zero length transaction queue"),t.every(i=>i.status===0)&&ER(n,kr(e),t)}else q_(e)&&Pa(e,t=>{tu(n,t)})}function ER(n,e,t){const s=t.map(h=>h.currentWriteId),i=K_(n,e,s);let r=i;const o=i.hash();for(let h=0;h<t.length;h++){const d=t[h];D(d.status===0,"tryToSendTransactionQueue_: items in queue should all be run."),d.status=1,d.retryCount++;const p=rt(e,d.path);r=r.updateChild(p,d.currentOutputSnapshotRaw)}const l=r.val(!0),c=e;n.server_.put(c.toString(),l,h=>{Pr(n,"transaction put response",{path:c.toString(),status:h});let d=[];if(h==="ok"){const p=[];for(let m=0;m<t.length;m++)t[m].status=2,d=d.concat(wn(n.serverSyncTree_,t[m].currentWriteId)),t[m].onComplete&&p.push(()=>t[m].onComplete(null,!0,t[m].currentOutputSnapshotResolved)),t[m].unwatcher();La(n,Qh(n.transactionQueueTree_,e)),tu(n,n.transactionQueueTree_),gt(n.eventQueue_,e,d);for(let m=0;m<p.length;m++)si(p[m])}else{if(h==="datastale")for(let p=0;p<t.length;p++)t[p].status===3?t[p].status=4:t[p].status=0;else{ot("transaction at "+c.toString()+" failed: "+h);for(let p=0;p<t.length;p++)t[p].status=4,t[p].abortReason=h}Hs(n,e)}},o)}function Hs(n,e){const t=Q_(n,e),s=kr(t),i=Y_(n,t);return wR(n,i,s),s}function wR(n,e,t){if(e.length===0)return;const s=[];let i=[];const o=e.filter(l=>l.status===0).map(l=>l.currentWriteId);for(let l=0;l<e.length;l++){const c=e[l],h=rt(t,c.path);let d=!1,p;if(D(h!==null,"rerunTransactionsUnderNode_: relativePath should not be null."),c.status===4)d=!0,p=c.abortReason,i=i.concat(wn(n.serverSyncTree_,c.currentWriteId,!0));else if(c.status===0)if(c.retryCount>=cR)d=!0,p="maxretry",i=i.concat(wn(n.serverSyncTree_,c.currentWriteId,!0));else{const m=K_(n,c.path,o);c.currentInputSnapshot=m;const E=e[l].update(m.val());if(E!==void 0){Na("transaction failed: Data returned ",E,c.path);let C=Pe(E);typeof E=="object"&&E!=null&&Vt(E,".priority")||(C=C.updatePriority(m.getPriority()));const k=c.currentWriteId,V=xa(n),U=B_(C,m,V);c.currentOutputSnapshotRaw=C,c.currentOutputSnapshotResolved=U,c.currentWriteId=eu(n),o.splice(o.indexOf(k),1),i=i.concat(x_(n.serverSyncTree_,c.path,U,c.currentWriteId,c.applyLocally)),i=i.concat(wn(n.serverSyncTree_,k,!0))}else d=!0,p="nodata",i=i.concat(wn(n.serverSyncTree_,c.currentWriteId,!0))}gt(n.eventQueue_,t,i),i=[],d&&(e[l].status=2,function(m){setTimeout(m,Math.floor(0))}(e[l].unwatcher),e[l].onComplete&&(p==="nodata"?s.push(()=>e[l].onComplete(null,!1,e[l].currentInputSnapshot)):s.push(()=>e[l].onComplete(new Error(p),!1,null))))}La(n,n.transactionQueueTree_);for(let l=0;l<s.length;l++)si(s[l]);tu(n,n.transactionQueueTree_)}function Q_(n,e){let t,s=n.transactionQueueTree_;for(t=J(e);t!==null&&ri(s)===void 0;)s=Qh(s,t),e=ye(e),t=J(e);return s}function Y_(n,e){const t=[];return J_(n,e,t),t.sort((s,i)=>s.order-i.order),t}function J_(n,e,t){const s=ri(e);if(s)for(let i=0;i<s.length;i++)t.push(s[i]);Pa(e,i=>{J_(n,i,t)})}function La(n,e){const t=ri(e);if(t){let s=0;for(let i=0;i<t.length;i++)t[i].status!==2&&(t[s]=t[i],s++);t.length=s,U_(e,t.length>0?t:void 0)}Pa(e,s=>{La(n,s)})}function nu(n,e){const t=kr(Q_(n,e)),s=Qh(n.transactionQueueTree_,e);return JS(s,i=>{wl(n,i)}),wl(n,s),W_(s,i=>{wl(n,i)}),t}function wl(n,e){const t=ri(e);if(t){const s=[];let i=[],r=-1;for(let o=0;o<t.length;o++)t[o].status===3||(t[o].status===1?(D(r===o-1,"All SENT items should be at beginning of queue."),r=o,t[o].status=3,t[o].abortReason="set"):(D(t[o].status===0,"Unexpected transaction status in abort"),t[o].unwatcher(),i=i.concat(wn(n.serverSyncTree_,t[o].currentWriteId,!0)),t[o].onComplete&&s.push(t[o].onComplete.bind(null,new Error("set"),!1,null))));r===-1?U_(e,void 0):t.length=r+1,gt(n.eventQueue_,kr(e),i);for(let o=0;o<s.length;o++)si(s[o])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function TR(n){let e="";const t=n.split("/");for(let s=0;s<t.length;s++)if(t[s].length>0){let i=t[s];try{i=decodeURIComponent(i.replace(/\+/g," "))}catch{}e+="/"+i}return e}function IR(n){const e={};n.charAt(0)==="?"&&(n=n.substring(1));for(const t of n.split("&")){if(t.length===0)continue;const s=t.split("=");s.length===2?e[decodeURIComponent(s[0])]=decodeURIComponent(s[1]):ot(`Invalid query segment '${t}' in query '${n}'`)}return e}const np=function(n,e){const t=CR(n),s=t.namespace;t.domain==="firebase.com"&&an(t.host+" is no longer supported. Please use <YOUR FIREBASE>.firebaseio.com instead"),(!s||s==="undefined")&&t.domain!=="localhost"&&an("Cannot parse Firebase url. Please use https://<YOUR FIREBASE>.firebaseio.com"),t.secure||LC();const i=t.scheme==="ws"||t.scheme==="wss";return{repoInfo:new e_(t.host,t.secure,s,i,e,"",s!==t.subdomain),path:new ue(t.pathString)}},CR=function(n){let e="",t="",s="",i="",r="",o=!0,l="https",c=443;if(typeof n=="string"){let h=n.indexOf("//");h>=0&&(l=n.substring(0,h-1),n=n.substring(h+2));let d=n.indexOf("/");d===-1&&(d=n.length);let p=n.indexOf("?");p===-1&&(p=n.length),e=n.substring(0,Math.min(d,p)),d<p&&(i=TR(n.substring(d,p)));const m=IR(n.substring(Math.min(n.length,p)));h=e.indexOf(":"),h>=0?(o=l==="https"||l==="wss",c=parseInt(e.substring(h+1),10)):h=e.length;const E=e.slice(0,h);if(E.toLowerCase()==="localhost")t="localhost";else if(E.split(".").length<=2)t=E;else{const C=e.indexOf(".");s=e.substring(0,C).toLowerCase(),t=e.substring(C+1),r=s}"ns"in m&&(r=m.ns)}return{host:e,port:c,domain:t,subdomain:s,secure:o,scheme:l,pathString:i,namespace:r}};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Nr{constructor(e,t,s,i){this._repo=e,this._path=t,this._queryParams=s,this._orderByCalled=i}get key(){return X(this._path)?null:Rh(this._path)}get ref(){return new Ft(this._repo,this._path)}get _queryIdentifier(){const e=Wf(this._queryParams),t=Ih(e);return t==="{}"?"default":t}get _queryObject(){return Wf(this._queryParams)}isEqual(e){if(e=ge(e),!(e instanceof Nr))return!1;const t=this._repo===e._repo,s=Ah(this._path,e._path),i=this._queryIdentifier===e._queryIdentifier;return t&&s&&i}toJSON(){return this.toString()}toString(){return this._repo.toString()+_b(this._path)}}function SR(n,e){if(n._orderByCalled===!0)throw new Error(e+": You can't combine multiple orderBy calls.")}function ty(n){let e=null,t=null;if(n.hasStart()&&(e=n.getIndexStartValue()),n.hasEnd()&&(t=n.getIndexEndValue()),n.getIndex()===Jn){const s="Query: When ordering by key, you may only pass one argument to startAt(), endAt(), or equalTo().",i="Query: When ordering by key, the argument passed to startAt(), startAfter(), endAt(), endBefore(), or equalTo() must be a string.";if(n.hasStart()){if(n.getIndexStartName()!==is)throw new Error(s);if(typeof e!="string")throw new Error(i)}if(n.hasEnd()){if(n.getIndexEndName()!==Ln)throw new Error(s);if(typeof t!="string")throw new Error(i)}}else if(n.getIndex()===we){if(e!=null&&!pc(e)||t!=null&&!pc(t))throw new Error("Query: When ordering by priority, the first argument passed to startAt(), startAfter() endAt(), endBefore(), or equalTo() must be a valid priority value (null, a number, or a string).")}else if(D(n.getIndex()instanceof Nh||n.getIndex()===g_,"unknown index type."),e!=null&&typeof e=="object"||t!=null&&typeof t=="object")throw new Error("Query: First argument passed to startAt(), startAfter(), endAt(), endBefore(), or equalTo() cannot be an object.")}function RR(n){if(n.hasStart()&&n.hasEnd()&&n.hasLimit()&&!n.hasAnchoredLimit())throw new Error("Query: Can't combine startAt(), startAfter(), endAt(), endBefore(), and limit(). Use limitToFirst() or limitToLast() instead.")}class Ft extends Nr{constructor(e,t){super(e,t,new xh,!1)}get parent(){const e=c_(this._path);return e===null?null:new Ft(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class Ks{constructor(e,t,s){this._node=e,this.ref=t,this._index=s}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new ue(e),s=Qs(this.ref,e);return new Ks(this._node.getChild(t),s,we)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(s,i)=>e(new Ks(i,Qs(this.ref,s),we)))}hasChild(e){const t=new ue(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function Tl(n,e){return n=ge(n),n._checkNotDeleted("ref"),Qs(n._root,e)}function Qs(n,e){return n=ge(n),J(n._path)===null?iR("child","path",e):Xh("child","path",e),new Ft(n._repo,Ie(n._path,e))}function AR(n,e){n=ge(n),j_("push",n._path),Jh("push",e,n._path,!0);const t=H_(n._repo),s=bR(t),i=Qs(n,s),r=Qs(n,s);let o;return e!=null?o=kR(r,e).then(()=>r):o=Promise.resolve(r),i.then=o.then.bind(o),i.catch=o.then.bind(o,void 0),i}function kR(n,e){n=ge(n),j_("set",n._path),Jh("set",e,n._path,!1);const t=new hr;return pR(n._repo,n._path,e,null,t.wrapCallback(()=>{})),t.promise}function PR(n,e){sR("update",e,n._path);const t=new hr;return mR(n._repo,n._path,e,t.wrapCallback(()=>{})),t.promise}function NR(n){n=ge(n);const e=new ey(()=>{}),t=new su(e);return fR(n._repo,n,t).then(s=>new Ks(s,new Ft(n._repo,n._path),n._queryParams.getIndex()))}class su{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,t){const s=t._queryParams.getIndex();return new X_("value",this,new Ks(e.snapshotNode,new Ft(t._repo,t._path),s))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new Z_(this,e,t):null}matches(e){return e instanceof su?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}class iu{constructor(e,t){this.eventType=e,this.callbackContext=t}respondsTo(e){let t=e==="children_added"?"child_added":e;return t=t==="children_removed"?"child_removed":t,this.eventType===t}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new Z_(this,e,t):null}createEvent(e,t){D(e.childName!=null,"Child events should have a childName.");const s=Qs(new Ft(t._repo,t._path),e.childName),i=t._queryParams.getIndex();return new X_(e.type,this,new Ks(e.snapshotNode,s,i),e.prevName)}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,e.prevName)}matches(e){return e instanceof iu?this.eventType===e.eventType&&(!this.callbackContext||!e.callbackContext||this.callbackContext.matches(e.callbackContext)):!1}hasAnyCallback(){return!!this.callbackContext}}function DR(n,e,t,s,i){const r=new ey(t,void 0),o=new iu(e,r);return _R(n._repo,n,o),()=>yR(n._repo,n,o)}function xR(n,e,t,s){return DR(n,"child_added",e)}class ny{}class LR extends ny{constructor(e,t){super(),this._value=e,this._key=t,this.type="endAt"}_apply(e){Jh("endAt",this._value,e._path,!0);const t=Ub(e._queryParams,this._value,this._key);if(RR(t),ty(t),e._queryParams.hasEnd())throw new Error("endAt: Starting point was already set (by another call to endAt, endBefore or equalTo).");return new Nr(e._repo,e._path,t,e._orderByCalled)}}function OR(n,e){return new LR(n,e)}class MR extends ny{constructor(e){super(),this._path=e,this.type="orderByChild"}_apply(e){SR(e,"orderByChild");const t=new ue(this._path);if(X(t))throw new Error("orderByChild: cannot pass in empty path. Use orderByValue() instead.");const s=new Nh(t),i=qb(e._queryParams,s);return ty(i),new Nr(e._repo,e._path,i,!0)}}function VR(n){return Xh("orderByChild","path",n),new MR(n)}function FR(n,...e){let t=ge(n);for(const s of e)t=s._apply(t);return t}kS(Ft);LS(Ft);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const BR="FIREBASE_DATABASE_EMULATOR_HOST",gc={};let UR=!1;function qR(n,e,t,s){n.repoInfo_=new e_(`${e}:${t}`,!1,n.repoInfo_.namespace,n.repoInfo_.webSocketOnly,n.repoInfo_.nodeAdmin,n.repoInfo_.persistenceKey,n.repoInfo_.includeNamespaceInQueryParams,!0),s&&(n.authTokenProvider_=s)}function WR(n,e,t,s,i){let r=s||n.options.databaseURL;r===void 0&&(n.options.projectId||an("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),Ue("Using default host for project ",n.options.projectId),r=`${n.options.projectId}-default-rtdb.firebaseio.com`);let o=np(r,i),l=o.repoInfo,c;typeof process<"u"&&Cf&&(c=Cf[BR]),c?(r=`http://${c}?ns=${l.namespace}`,o=np(r,i),l=o.repoInfo):o.repoInfo.secure;const h=new zC(n.name,n.options,e);rR("Invalid Firebase Database URL",o),X(o.path)||an("Database URL must point to the root of a Firebase Database (not including a child path).");const d=jR(l,n,h,new jC(n.name,t));return new zR(d,n)}function $R(n,e){const t=gc[e];(!t||t[n.key]!==n)&&an(`Database ${e}(${n.repoInfo_}) has already been deleted.`),vR(n),delete t[n.key]}function jR(n,e,t,s){let i=gc[e.name];i||(i={},gc[e.name]=i);let r=i[n.toURLString()];return r&&an("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call."),r=new hR(n,UR,t,s),i[n.toURLString()]=r,r}class zR{constructor(e,t){this._repoInternal=e,this.app=t,this.type="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||(uR(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new Ft(this._repo,le())),this._rootInternal}_delete(){return this._rootInternal!==null&&($R(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){this._rootInternal===null&&an("Cannot call "+e+" on a deleted database.")}}function GR(n=Sc(),e){const t=aa(n,"database").getImmediate({identifier:e});if(!t._instanceStarted){const s=Sp("database");s&&HR(t,...s)}return t}function HR(n,e,t,s={}){n=ge(n),n._checkNotDeleted("useEmulator"),n._instanceStarted&&an("Cannot call useEmulator() after instance has already been initialized.");const i=n._repoInternal;let r;if(i.repoInfo_.nodeAdmin)s.mockUserToken&&an('mockUserToken is not supported by the Admin SDK. For client access with mock users, please use the "firebase" package instead of "firebase-admin".'),r=new mo(mo.OWNER);else if(s.mockUserToken){const o=typeof s.mockUserToken=="string"?s.mockUserToken:kp(s.mockUserToken,n.app.options.projectId);r=new mo(o)}qR(i,e,t,r)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function KR(n){AC(as),Xn(new Pn("database",(e,{instanceIdentifier:t})=>{const s=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return WR(s,i,r,t)},"PUBLIC").setMultipleInstances(!0)),kt(bf,Sf,n),kt(bf,Sf,"esm2017")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const QR={".sv":"timestamp"};function YR(){return QR}tn.prototype.simpleListen=function(n,e){this.sendRequest("q",{p:n},e)};tn.prototype.echo=function(n,e){this.sendRequest("echo",{d:n},e)};KR();const gn=n=>atob(n),JR={apiKey:gn("QUl6YVN5Q2FUUWE2Sm9NajJNQmdEZ2Rwb25WQllfTkFlUU84X3Vz"),authDomain:gn("a2lja2VyaGF4LW9ubGluZS5maXJlYmFzZWFwcC5jb20="),databaseURL:gn("aHR0cHM6Ly9raWNrZXJoYXgtb25saW5lLWRlZmF1bHQtcnRkYi5maXJlYmFzZWlvLmNvbQ=="),projectId:gn("a2lja2VyaGF4LW9ubGluZQ=="),storageBucket:gn("a2lja2VyaGF4LW9ubGluZS5maXJlYmFzdG9yYWdlLmFwcA=="),messagingSenderId:gn("MzM3NTk4NDY1MTcw"),appId:gn("MTozMzc1OTg0NjUxNzA6d2ViOjE5MDU0YWI4NDBkODBkMmMyMDUyNGI="),measurementId:gn("Ry0xWjhWN0NWRkcw")},ru=Lp(JR),Il=CT(ru),ht=uC(ru),Cl=GR(ru),at={async loginWithGoogle(){const n=new Qt,e=await xw(Il,n),t=e.user,s=Gt(ht,"users",t.uid);if((await dl(s)).exists())await If(s,{lastLogin:new Date().toISOString()});else{const r=Math.floor(Math.random()*9e3)+1e3,l=`${(t.displayName||"Jogador").replace(/\s+/g,"").replace(/[^a-zA-Z0-9]/g,"").toLowerCase()}${r}`.substring(0,12),c={uid:t.uid,username:l,displayName:l,badge:"👤",bio:"",level:1,xp:0,isNewUser:!0,dateCreated:new Date().toISOString(),lastLogin:new Date().toISOString(),settings:{volume:80,quality:"high",fieldSize:"medium"}},h={uid:t.uid,matchesPlayed:0,wins:0,losses:0,draws:0,goals:0,assists:0,saves:0};await pl(Gt(ht,"users",t.uid),c),await pl(Gt(ht,"stats",t.uid),h)}return e},async logout(){return await fw(Il)},subscribeToAuth(n){return dw(Il,n)},async getUserProfile(n){const e=Gt(ht,"users",n),t=await dl(e);return t.exists()?t.data():null},async updateUserProfile(n,e){const t=Gt(ht,"users",n);await If(t,e)},async getUserStats(n){const e=Gt(ht,"stats",n),t=await dl(e);return t.exists()?t.data():null},async saveMatchResult(n,e,t,s,i,r,o,l){const c=Gt(ht,"stats",n),h=Gt(ht,"users",n);await RC(ht,async d=>{const p=await d.get(c),m=await d.get(h);if(!p.exists()||!m.exists())throw new Error("Documento não encontrado");const E=p.data(),C=m.data(),R={matchesPlayed:(E.matchesPlayed||0)+1,wins:(E.wins||0)+(e?1:0),losses:(E.losses||0)+(t?1:0),draws:(E.draws||0)+(s?1:0),goals:(E.goals||0)+i,assists:(E.assists||0)+r,saves:(E.saves||0)+o};let k=(C.xp||0)+l,V=C.level||1,U=V*100;for(;k>=U;)k-=U,V++,U=V*100;d.update(c,R),d.update(h,{xp:k,level:V,lastLogin:new Date().toISOString()})})},async addMatchToHistory(n){const e=Gt(eo(ht,"history"));await pl(e,n)},async getRecentHistory(n,e=5){const t=eo(ht,"history"),s=vf(t,Ef("playerUids","array-contains",n),EC(20)),i=await fl(s),r=[];return i.forEach(o=>r.push({id:o.id,...o.data()})),r.sort((o,l)=>new Date(l.date)-new Date(o.date)),r.slice(0,e)},async getGlobalRanking(n="wins",e=10){try{const t=eo(ht,"users"),s=await fl(t),i=[];for(const r of s.docs){const o=r.data();if(!o.uid)continue;const l=await this.getUserStats(o.uid)||{};i.push({username:o.username,displayName:o.username,badge:o.badge||"🏳️",level:o.level||1,wins:l.wins||0,losses:l.losses||0,goals:l.goals||0,xp:o.xp||0})}return n==="level"?i.sort((r,o)=>o.level!==r.level?o.level-r.level:o.xp-r.xp):n==="wins"?i.sort((r,o)=>o.wins-r.wins):n==="goals"&&i.sort((r,o)=>o.goals-r.goals),i.slice(0,e)}catch(t){throw console.error("[Firestore] Error fetching ranking:",t),t}},async isUsernameUnique(n,e){const t=vf(eo(ht,"users"),Ef("username","==",n.toLowerCase())),s=await fl(t);let i=!0;return s.forEach(r=>{r.id!==e&&(i=!1)}),i},async pruneOldChatMessages(){try{const n=Tl(Cl,"globalChat"),e=Date.now()-72e5,t=FR(n,VR("timestamp"),OR(e)),s=await NR(t);if(s.exists()){const i={};s.forEach(r=>{i[r.key]=null}),await PR(n,i)}}catch(n){console.warn("Pruning skipped or unauthorized:",n)}},async sendGlobalChatMessage(n,e){this.pruneOldChatMessages().catch(s=>console.warn(s));const t=Tl(Cl,"globalChat");await AR(t,{uid:n.uid,username:n.username,badge:n.badge||"👤",text:e,timestamp:YR()})},subscribeToGlobalChat(n){const e=Tl(Cl,"globalChat");xR(e,t=>{n(t.val())})}};function ce(n,e="info"){if(!document.getElementById("toast-style")){const r=document.createElement("style");r.id="toast-style",r.textContent=`
      .toast-container {
        position: fixed;
        bottom: 24px;
        right: 24px;
    ...
    `,document.head.appendChild(r)}let t=document.querySelector(".toast-container");t||(t=document.createElement("div"),t.className="toast-container",document.body.appendChild(t));const s=document.createElement("div");s.className=`toast toast-${e}`;let i="ℹ️";e==="success"&&(i="✅"),e==="error"&&(i="❌"),s.innerHTML=`<span>${i}</span> <span>${n}</span>`,t.appendChild(s),setTimeout(()=>s.classList.add("show"),50),setTimeout(()=>{s.classList.remove("show"),setTimeout(()=>s.remove(),250)},3500)}const XR={init(){const n=document.getElementById("btn-google-login");n&&n.addEventListener("click",async()=>{try{ce("Iniciando login com Google...","info"),await at.loginWithGoogle(),ce("Login realizado com sucesso!","success")}catch(e){ce(e.message||"Erro ao entrar com Google.","error")}})}};function ZR(n){const e=(n??"").toString();if(!e)return[];try{const t=new Intl.Segmenter(void 0,{granularity:"grapheme"});return Array.from(t.segment(e),s=>s.segment)}catch{return Array.from(e)}}function eA(n){return new RegExp("\\p{Extended_Pictographic}","u").test(n||"")}const Be={currentUser:null,profileData:null,async init(n){if(this.currentUser=n,!n)return;const e=document.getElementById("menu-btn-play");e&&(e.onclick=()=>$.show("mode-select-screen"));const t=document.getElementById("menu-btn-profile");t&&(t.onclick=()=>$.show("profile-screen"));const s=document.getElementById("menu-quick-profile");s&&(s.onclick=()=>$.show("profile-screen"));const i=document.getElementById("menu-btn-ranking");i&&(i.onclick=()=>$.show("ranking-screen"));const r=document.getElementById("menu-btn-settings");r&&(r.onclick=()=>$.show("settings-screen"));const o=document.getElementById("menu-btn-controls");o&&(o.onclick=()=>$.show("controls-screen"));const l=document.getElementById("menu-btn-credits");l&&(l.onclick=()=>$.show("credits-screen"));const c=document.getElementById("menu-btn-logout");c&&(c.onclick=async()=>{try{await at.logout(),ce("Desconectado com sucesso.","info")}catch{ce("Erro ao sair da conta.","error")}});const h=document.getElementById("credits-btn-back");h&&(h.onclick=()=>$.show("menu-screen")),$.register("menu-screen",{onEnter:()=>this.refreshQuickProfile()}),$.register("profile-screen",{onEnter:()=>this.loadProfileScreen()});const d=document.getElementById("profile-btn-back");d&&(d.onclick=()=>$.show("menu-screen"));const p=document.getElementById("profile-btn-save");p&&(p.onclick=async()=>{await this.saveProfileEdits()});const m=document.getElementById("profile-badge-select"),E=document.getElementById("profile-avatar-display");m&&E&&m.addEventListener("change",C=>{this.updateAvatarDisplay(E,C.target.value)}),await this.refreshQuickProfile()},async refreshQuickProfile(){if(this.currentUser)try{if(this.profileData=await at.getUserProfile(this.currentUser.uid),!this.profileData)return;const n=document.getElementById("quick-profile-flag"),e=document.getElementById("quick-profile-name"),t=document.getElementById("quick-profile-level"),s=document.getElementById("quick-avatar-char"),i=document.querySelector(".quick-xp-fill");if(n&&(n.textContent=this.profileData.badge||"🇧🇷"),e&&(e.textContent=this.profileData.displayName||this.profileData.username),t&&(t.textContent=this.profileData.level||1),s&&(s.textContent=this.profileData.badge||"👤"),i){const r=this.profileData.level||1,o=this.profileData.xp||0,l=r*100,c=Math.min(100,Math.max(0,o/l*100));i.style.width=`${c}%`}}catch(n){console.error("Erro ao carregar perfil rápido:",n)}},async loadProfileScreen(){if(!this.currentUser||!this.profileData)return;this.profileData=await at.getUserProfile(this.currentUser.uid);const n=document.getElementById("profile-username-input"),e=document.getElementById("profile-badge-select"),t=document.getElementById("profile-bio-input"),s=document.getElementById("profile-avatar-display");n&&(n.value=this.profileData.username||""),e&&(e.value=this.profileData.badge||"👤"),t&&(t.value=this.profileData.bio||""),s&&this.updateAvatarDisplay(s,this.profileData.badge);const i=await at.getUserStats(this.currentUser.uid);if(i){const o=i.matchesPlayed>0?Math.round(i.wins/i.matchesPlayed*100):0;document.getElementById("stats-played").textContent=i.matchesPlayed||0,document.getElementById("stats-wins").textContent=i.wins||0,document.getElementById("stats-losses").textContent=i.losses||0,document.getElementById("stats-winrate").textContent=`${o}%`,document.getElementById("stats-goals").textContent=i.goals||0,document.getElementById("stats-assists").textContent=i.assists||0,document.getElementById("stats-saves").textContent=i.saves||0,document.getElementById("stats-level").textContent=this.profileData.level||1,document.getElementById("stats-xp").textContent=this.profileData.xp||0}const r=document.getElementById("profile-match-history");if(r){r.innerHTML='<div class="subtext">Carregando histórico...</div>';try{const o=await at.getRecentHistory(this.currentUser.uid);o.length===0?r.innerHTML='<div class="subtext">Nenhuma partida recente.</div>':(r.innerHTML="",o.forEach(l=>{const c=document.createElement("div");c.className="history-item";let h="draw",d="Empate";l.winner==="draw"?(h="draw",d="Empate"):l.winner===l.playerTeams[this.currentUser.uid]?(h="win",d="Vitória"):(h="loss",d="Derrota");const p=new Date(l.date).toLocaleDateString("pt-BR");c.innerHTML=`
      ...
      `,e.appendChild(s);const r=document.getElementById(`join-btn-${t.code}`);r&&(r.onclick=()=>{if(t.hasPassword){const o=prompt("Digite a senha da sala:");o!==null&&this.joinRoomWithCode(t.code,o)}else this.joinRoomWithCode(t.code,"")})})}},joinRoomWithCode(n,e){const t={uid:this.currentUser.uid,username:Be.profileData.username,badge:Be.profileData.badge||"🏳️"};K.joinRoom(n,e,t),K.getSocket().once("joinSuccess",()=>{ce("Entrou na sala!","success"),$.show("lobby-screen")}),K.getSocket().once("joinError",s=>{ce(s,"error")})},updateLobbyView(n){if(!n)return;this.fieldSize=n.fieldSize||"medium",this.showReplay=n.showReplay!==void 0?n.showReplay:!0,document.getElementById("lobby-room-name").textContent=n.name,document.getElementById("lobby-room-code").textContent=n.code,document.getElementById("lobby-setting-time").textContent=`${n.duration}m`,document.getElementById("lobby-setting-goals").textContent=n.goalLimit===0?"Sem Limite":n.goalLimit;const e={small:"Pequeno",medium:"Médio",large:"Grande"},t=document.getElementById("lobby-setting-size");t&&(t.textContent=e[this.fieldSize]||"Médio");const s=document.getElementById("lobby-setting-replay");s&&(s.textContent=this.showReplay?"Sim":"Não");const i=K.getSocket().id,r=n.hostId===i;this.isHost=r;const o=document.getElementById("lobby-btn-start"),l=document.getElementById("lobby-host-bot-controls");o&&o.classList.toggle("hidden",!r),l&&l.classList.toggle("hidden",!r);const c=document.getElementById("lobby-red-players"),h=document.getElementById("lobby-blue-players"),d=document.getElementById("lobby-spec-players");c&&(c.innerHTML=""),h&&(h.innerHTML=""),d&&(d.innerHTML=""),n.players.forEach(m=>{const E=document.createElement("div");E.className="lobby-player-row";const R=m.team==="spectator"?"":`<span class="ready-badge ${m.ready?"ready":""}">${m.ready?"Pronto":"Aguardando"}</span>`,k=r&&m.id!==i&&!m.cpu?`<button class="kick-btn" id="kick-btn-${m.id}">❌</button>`:"",V=r&&m.cpu?`<button class="kick-btn" id="remove-bot-btn-${m.id}">❌</button>`:"";E.innerHTML=`
      ...
      `,i.appendChild(o),i.scrollTop=i.scrollHeight}))}};function dk(){console.log("[Kicker Hax SPA] Inicializando...");const n=document.getElementById("match-btn-fullscreen");n&&(n.onclick=()=>fk()),XR.init(),Hi.loadSettings(),uk.init(),document.querySelectorAll("button, .btn").forEach(t=>{t.addEventListener("click",s=>{const i=document.createElement("span");i.className="ripple";const r=t.getBoundingClientRect(),o=Math.max(r.width,r.height);i.style.width=i.style.height=`${o}px`,i.style.left=`${s.clientX-r.left-o/2}px`,i.style.top=`${s.clientY-r.top-o/2}px`,t.appendChild(i),setTimeout(()=>i.remove(),500)})});const e=document.getElementById("splash-status");at.subscribeToAuth(async t=>{if(t)if(e&&(e.textContent="Conectando ao banco de dados..."),await Be.init(t),await Ep.init(t),Hi.init(),Be.profileData&&Be.profileData.isNewUser){ce("Escolha seu apelido de jogador antes de começar!","info");const s=document.getElementById("profile-btn-back");s&&(s.style.display="none"),$.show("profile-screen")}else{const s=document.getElementById("profile-btn-back");s&&(s.style.display=""),$.show("menu-screen")}else Be.currentUser=null,Ep.currentUser=null,$.show("login-screen")})}function fk(){document.fullscreenElement?document.exitFullscreen():document.documentElement.requestFullscreen().catch(n=>{console.warn(`Erro ao ativar tela cheia: ${n.message}`)})}window.addEventListener("DOMContentLoaded",dk);
