 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const D=function(n,e){if(!n)throw Qs(e)},Qs=function(n){return new Error("Firebase Database ("+wp.SDK_VERSION+") INTERNAL ASSERT FAILED: "+n)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const av="FirebaseError";class cn extends Error{constructor(e,t,s){super(t),this.code=e,this.customData=s,this.name=av,Object.setPrototypeOf(this,cn.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,hr.prototype.create)}}class hr{constructor(e,t,s){this.service=e,this.serviceName=t,this.errors=s}create(e,...t){const s=t[0]||{},i=`${this.service}/${e}`,r=this.errors[e],o=r?lv(r,s):"Error",l=`${this.serviceName}: ${o} (${i}).`;return new cn(i,l,s)}}function lv(n,e){return n.replace(cv,(t,s)=>{const i=e[s];return i!=null?String(i):`<${s}?>`})}const cv=/\{\$([^}]+)}/g;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Np=function(n){let e={},t={},s={},i="";try{const r=n.split(".");e=Hi(To(r[0])||""),t=Hi(To(r[1])||""),i=r[2],s=t.d||{},delete t.d}catch{}return{header:e,claims:t,data:s,signature:i}},hv=function(n){const e=Np(n),t=e.claims;return!!t&&typeof t=="object"&&t.hasOwnProperty("iat")},uv=function(n){const e=Np(n).claims;return typeof e=="object"&&e.admin===!0};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bo=new Map,dE=new Map,Fl=new Map;function fd(n,e){try{n.container.addComponent(e)}catch(t){sn.debug(`Component ${e.name} failed to register with FirebaseApp ${n.name}`,t)}}function Xn(n){const e=n.name;if(Fl.has(e))return sn.debug(`There were multiple attempts to register component ${e}.`),!1;Fl.set(e,n);for(const t of bo.values())fd(t,n);for(const t of dE.values())fd(t,n);return!0}function aa(n,e){const t=n.container.getProvider("heartbeat").getImmediate({optional:!0});return t&&t.triggerHeartbeat(),n.container.getProvider(e)}function Jt(n){return n.settings!==void 0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const mE="firebase-heartbeat-database",gE=1,Ki="firebase-heartbeat-store";let ol=null;function Op(){return ol||(ol=Lv(mE,gE,{upgrade:(n,e)=>{switch(e){case 0:try{n.createObjectStore(Ki)}catch(t){console.warn(t)}}}}).catch(n=>{throw Cn.create("idb-open",{originalErrorMessage:n.message})})),ol}async function _E(n){try{const t=(await Op()).transaction(Ki),s=await t.objectStore(Ki).get(Mp(n));return await t.done,s}catch(e){if(e instanceof cn)sn.warn(e.message);else{const t=Cn.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});sn.warn(t.message)}}}async function pd(n,e){try{const s=(await Op()).transaction(Ki,"readwrite");await s.objectStore(Ki).put(e,Mp(n)),await s.done}catch(t){if(t instanceof cn)sn.warn(t.message);else{const s=Cn.create("idb-set",{originalErrorMessage:t==null?void 0:t.message});sn.warn(s.message)}}}function Mp(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const yE=1024,vE=30*24*60*60*1e3;class EE{constructor(e){this.container=e,this._heartbeatsCache=null;const t=this.container.getProvider("app").getImmediate();this._storage=new TE(t),this._heartbeatsCachePromise=this._storage.read().then(s=>(this._heartbeatsCache=s,s))}async triggerHeartbeat(){var e,t;try{const i=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),r=md();return((e=this._heartbeatsCache)===null||e===void 0?void 0:e.heartbeats)==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,((t=this._heartbeatsCache)===null||t===void 0?void 0:t.heartbeats)==null)||this._heartbeatsCache.lastSentHeartbeatDate===r||this._heartbeatsCache.heartbeats.some(o=>o.date===r)?void 0:(this._heartbeatsCache.heartbeats.push({date:r,agent:i}),this._heartbeatsCache.heartbeats=this._heartbeatsCache.heartbeats.filter(o=>{const l=new Date(o.date).valueOf();return Date.now()-l<=vE}),this._storage.overwrite(this._heartbeatsCache))}catch(s){sn.warn(s)}}async getHeartbeatsHeader(){var e;try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,((e=this._heartbeatsCache)===null||e===void 0?void 0:e.heartbeats)==null||this._heartbeatsCache.heartbeats.length===0)return"";const t=md(),{heartbeatsToSend:s,unsentEntries:i}=wE(this._heartbeatsCache.heartbeats),r=wo(JSON.stringify({version:2,heartbeats:s}));return this._heartbeatsCache.lastSentHeartbeatDate=t,i.length>0?(this._heartbeatsCache.heartbeats=i,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),r}catch(t){return sn.warn(t),""}}}function md(){return new Date().toISOString().substring(0,10)}function wE(n,e=yE){const t=[];let s=n.slice();for(const i of n){const r=t.find(o=>o.agent===i.agent);if(r){if(r.dates.push(i.date),gd(t)>e){r.dates.pop();break}}else if(t.push({agent:i.agent,dates:[i.date]}),gd(t)>e){t.pop();break}s=s.slice(1)}return{heartbeatsToSend:t,unsentEntries:s}}class TE{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return rv()?ov().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const t=await _E(this.app);return t!=null&&t.heartbeats?t:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(e){var t;if(await this._canUseIndexedDBPromise){const i=await this.read();return pd(this.app,{lastSentHeartbeatDate:(t=e.lastSentHeartbeatDate)!==null&&t!==void 0?t:i.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){var t;if(await this._canUseIndexedDBPromise){const i=await this.read();return pd(this.app,{lastSentHeartbeatDate:(t=e.lastSentHeartbeatDate)!==null&&t!==void 0?t:i.lastSentHeartbeatDate,heartbeats:[...i.heartbeats,...e.heartbeats]})}else return}}function gd(n){return wo(JSON.stringify({version:2,heartbeats:n})).length}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function IE(n){Xn(new Pn("platform-logger",e=>new Mv(e),"PRIVATE")),Xn(new Pn("heartbeat",e=>new EE(e),"PRIVATE")),Nt(Ml,dd,n),Nt(Ml,dd,"esm2017"),Nt("fire-js","")}IE("");var CE="firebase",bE="10.14.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Nt(CE,bE,"app");function Sc(n,e){var t={};for(var s in n)Object.prototype.hasOwnProperty.call(n,s)&&e.indexOf(s)<0&&(t[s]=n[s]);if(n!=null&&typeof Object.getOwnPropertySymbols=="function")for(var i=0,s=Object.getOwnPropertySymbols(n);i<s.length;i++)e.indexOf(s[i])<0&&Object.prototype.propertyIsEnumerable.call(n,s[i])&&(t[s[i]]=n[s[i]]);return t}function Vp(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const RE=Vp,Fp=new hr("auth","Firebase",Vp());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ro=new oa("@firebase/auth");function SE(n,...e){Ro.logLevel<=ne.WARN&&Ro.warn(`Auth (${as}): ${n}`,...e)}function ro(n,...e){Ro.logLevel<=ne.ERROR&&Ro.error(`Auth (${as}): ${n}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ot(n,...e){throw kc(n,...e)}function It(n,...e){return kc(n,...e)}function Ac(n,e,t){const s=Object.assign(Object.assign({},RE()),{[e]:t});return new hr("auth","Firebase",s).create(e,{appName:n.name})}function Qn(n){return Ac(n,"operation-not-supported-in-this-environment","Operations that alter the current user are not supported in conjunction with FirebaseServerApp")}function AE(n,e,t){const s=t;if(!(e instanceof s))throw s.name!==e.constructor.name&&Ot(n,"argument-error"),Ac(n,"argument-error",`Type of ${e.constructor.name} does not match expected instance.Did you pass a reference from a different Auth SDK?`)}function kc(n,...e){if(typeof n!="string"){const t=e[0],s=[...e.slice(1)];return s[0]&&(s[0].appName=n.name),n._errorFactory.create(t,...s)}return Fp.create(n,...e)}function H(n,e,...t){if(!n)throw kc(e,...t)}function Xt(n){const e="INTERNAL ASSERTION FAILED: "+n;throw ro(e),new Error(e)}function rn(n,e){n||Xt(e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ur{constructor(e,t){this.shortDelay=e,this.longDelay=t,rn(t>e,"Short delay should be less than long delay!"),this.isMobile=Cc()||Pp()}get(){return PE()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Pc(n,e){rn(n.emulator,"Emulator should always be set here");const{url:t}=n.emulator;return e?`${t}${e.startsWith("/")?e.slice(1):e}`:t}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const LE=new ur(3e4,6e4);function Nc(n,e){return n.tenantId&&!e.tenantId?Object.assign(Object.assign({},e),{tenantId:n.tenantId}):e}async function Js(n,e,t,s,i={}){return Up(n,i,async()=>{let r={},o={};s&&(e==="GET"?o=s:r={body:JSON.stringify(s)});const l=Ys(Object.assign({key:n.config.apiKey},o)).slice(1),c=await n._getAdditionalHeaders();c["Content-Type"]="application/json",n.languageCode&&(c["X-Firebase-Locale"]=n.languageCode);const h=Object.assign({method:e,headers:c},r);return ev()||(h.referrerPolicy="no-referrer"),Bp.fetch()(qp(n,n.config.apiHost,t,l),h)})}async function Up(n,e,t){n._canInitEmulator=!1;const s=Object.assign(Object.assign({},DE),e);try{const i=new OE(n),r=await Promise.race([t(),i.promise]);i.clearNetworkTimeout();const o=await r.json();if("needConfirmation"in o)throw Qr(n,"account-exists-with-different-credential",o);if(r.ok&&!("errorMessage"in o))return o;{const l=r.ok?o.errorMessage:o.error.message,[c,h]=l.split(" : ");if(c==="FEDERATED_USER_ID_ALREADY_LINKED")throw Qr(n,"credential-already-in-use",o);if(c==="EMAIL_EXISTS")throw Qr(n,"email-already-in-use",o);if(c==="USER_DISABLED")throw Qr(n,"user-disabled",o);const d=s[c]||c.toLowerCase().replace(/[_\s]+/g,"-");if(h)throw Ac(n,d,h);Ot(n,d)}}catch(i){if(i instanceof cn)throw i;Ot(n,"network-request-failed",{message:String(i)})}}async function xE(n,e,t,s,i={}){const r=await Js(n,e,t,s,i);return"mfaPendingCredential"in r&&Ot(n,"multi-factor-auth-required",{_serverResponse:r}),r}function qp(n,e,t,s){const i=`${e}${t}?${s}`;return n.config.emulator?Pc(n.config,i):`${n.config.apiScheme}://${i}`}class OE{constructor(e){this.auth=e,this.timer=null,this.promise=new Promise((t,s)=>{this.timer=setTimeout(()=>s(It(this.auth,"network-request-failed")),LE.get())})}clearNetworkTimeout(){clearTimeout(this.timer)}}function Qr(n,e,t){const s={appName:n.name};t.email&&(s.email=t.email),t.phoneNumber&&(s.phoneNumber=t.phoneNumber);const i=It(n,e,s);return i.customData._tokenResponse=t,i}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ME(n,e){return Js(n,"POST","/v1/accounts:delete",e)}async function Wp(n,e){return Js(n,"POST","/v1/accounts:lookup",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Qi(n,e,t=!1){if(t)return e;try{return await e}catch(s){throw s instanceof cn&&FE(s)&&n.auth.currentUser===n&&await n.auth.signOut(),s}}function FE({code:n}){return n==="auth/user-disabled"||n==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function WE(n,e){const t=await Up(n,{},async()=>{const s=Ys({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:i,apiKey:r}=n.config,o=qp(n,i,"/v1/token",`key=${r}`),l=await n._getAdditionalHeaders();return l["Content-Type"]="application/x-www-form-urlencoded",Bp.fetch()(o,{method:"POST",headers:l,body:s})});return{accessToken:t.access_token,expiresIn:t.expires_in,refreshToken:t.refresh_token}}async function $E(n,e){return Js(n,"POST","/v2/accounts:revokeToken",Nc(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ks{constructor(){this.refreshToken=null,this.accessToken=null,this.expirationTime=null}get isExpired(){return!this.expirationTime||Date.now()>this.expirationTime-3e4}updateFromServerResponse(e){H(e.idToken,"internal-error"),H(typeof e.idToken<"u","internal-error"),H(typeof e.refreshToken<"u","internal-error");const t="expiresIn"in e&&typeof e.expiresIn<"u"?Number(e.expiresIn):yd(e.idToken);this.updateTokensAndExpiration(e.idToken,e.refreshToken,t)}updateFromIdToken(e){H(e.length!==0,"internal-error");const t=yd(e);this.updateTokensAndExpiration(e,null,t)}async getToken(e,t=!1){return!t&&this.accessToken&&!this.isExpired?this.accessToken:(H(this.refreshToken,e,"user-token-expired"),this.refreshToken?(await this.refresh(e,this.refreshToken),this.accessToken):null)}clearRefreshToken(){this.refreshToken=null}async refresh(e,t){const{accessToken:s,refreshToken:i,expiresIn:r}=await WE(e,t);this.updateTokensAndExpiration(s,i,Number(r))}updateTokensAndExpiration(e,t,s){this.refreshToken=t||null,this.accessToken=e||null,this.expirationTime=Date.now()+s*1e3}static fromJSON(e,t){const{refreshToken:s,accessToken:i,expirationTime:r}=t,o=new ks;return s&&(H(typeof s=="string","internal-error",{appName:e}),o.refreshToken=s),i&&(H(typeof i=="string","internal-error",{appName:e}),o.accessToken=i),r&&(H(typeof r=="number","internal-error",{appName:e}),o.expirationTime=r),o}toJSON(){return{refreshToken:this.refreshToken,accessToken:this.accessToken,expirationTime:this.expirationTime}}_assign(e){this.accessToken=e.accessToken,this.refreshToken=e.refreshToken,this.expirationTime=e.expirationTime}_clone(){return Object.assign(new ks,this.toJSON())}_performRefresh(){return Xt("not implemented")}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function mn(n,e){H(typeof n=="string"||typeof n>"u","internal-error",{appName:e})}class Zt{constructor(e){var{uid:t,auth:s,stsTokenManager:i}=e,r=Sc(e,["uid","auth","stsTokenManager"]);this.providerId="firebase",this.proactiveRefresh=new BE(this),this.reloadUserInfo=null,this.reloadListener=null,this.uid=t,this.auth=s,this.stsTokenManager=i,this.accessToken=i.accessToken,this.displayName=r.displayName||null,this.email=r.email||null,this.emailVerified=r.emailVerified||!1,this.phoneNumber=r.phoneNumber||null,this.photoURL=r.photoURL||null,this.isAnonymous=r.isAnonymous||!1,this.tenantId=r.tenantId||null,this.providerData=r.providerData?[...r.providerData]:[],this.metadata=new Ul(r.createdAt||void 0,r.lastLoginAt||void 0)}async getIdToken(e){const t=await Qi(this,this.stsTokenManager.getToken(this.auth,e));return H(t,this.auth,"internal-error"),this.accessToken!==t&&(this.accessToken=t,await this.auth._persistUserIfCurrent(this),this.auth._notifyListenersIfCurrent(this)),t}getIdTokenResult(e){return VE(this,e)}reload(){return UE(this)}_assign(e){this!==e&&(H(this.uid===e.uid,this.auth,"internal-error"),this.displayName=e.displayName,this.photoURL=e.photoURL,this.email=e.email,this.emailVerified=e.emailVerified,this.phoneNumber=e.phoneNumber,this.isAnonymous=e.isAnonymous,this.tenantId=e.tenantId,this.providerData=e.providerData.map(t=>Object.assign({},t)),this.metadata._copy(e.metadata),this.stsTokenManager._assign(e.stsTokenManager))}_clone(e){const t=new Zt(Object.assign(Object.assign({},this),{auth:e,stsTokenManager:this.stsTokenManager._clone()}));return t.metadata._copy(this.metadata),t}_onReload(e){H(!this.reloadListener,this.auth,"internal-error"),this.reloadListener=e,this.reloadUserInfo&&(this._notifyReloadListener(this.reloadUserInfo),this.reloadUserInfo=null)}_notifyReloadListener(e){this.reloadListener?this.reloadListener(e):this.reloadUserInfo=e}_startProactiveRefresh(){this.proactiveRefresh._start()}_stopProactiveRefresh(){this.proactiveRefresh._stop()}async _updateTokensIfNecessary(e,t=!1){let s=!1;e.idToken&&e.idToken!==this.stsTokenManager.accessToken&&(this.stsTokenManager.updateFromServerResponse(e),s=!0),t&&await So(this),await this.auth._persistUserIfCurrent(this),s&&this.auth._notifyListenersIfCurrent(this)}async delete(){if(Jt(this.auth.app))return Promise.reject(Qn(this.auth));const e=await this.getIdToken();return await Qi(this,ME(this.auth,{idToken:e})),this.stsTokenManager.clearRefreshToken(),this.auth.signOut()}toJSON(){return Object.assign(Object.assign({uid:this.uid,email:this.email||void 0,emailVerified:this.emailVerified,displayName:this.displayName||void 0,isAnonymous:this.isAnonymous,photoURL:this.photoURL||void 0,phoneNumber:this.phoneNumber||void 0,tenantId:this.tenantId||void 0,providerData:this.providerData.map(e=>Object.assign({},e)),stsTokenManager:this.stsTokenManager.toJSON(),_redirectEventId:this._redirectEventId},this.metadata.toJSON()),{apiKey:this.auth.config.apiKey,appName:this.auth.name})}get refreshToken(){return this.stsTokenManager.refreshToken||""}static _fromJSON(e,t){var s,i,r,o,l,c,h,d;const p=(s=t.displayName)!==null&&s!==void 0?s:void 0,m=(i=t.email)!==null&&i!==void 0?i:void 0,E=(r=t.phoneNumber)!==null&&r!==void 0?r:void 0,C=(o=t.photoURL)!==null&&o!==void 0?o:void 0,A=(l=t.tenantId)!==null&&l!==void 0?l:void 0,k=(c=t._redirectEventId)!==null&&c!==void 0?c:void 0,F=(h=t.createdAt)!==null&&h!==void 0?h:void 0,q=(d=t.lastLoginAt)!==null&&d!==void 0?d:void 0,{uid:U,emailVerified:te,isAnonymous:ve,providerData:de,stsTokenManager:I}=t;H(U&&I,e,"internal-error");const _=ks.fromJSON(this.name,I);H(typeof U=="string",e,"internal-error"),mn(p,e.name),mn(m,e.name),H(typeof te=="boolean",e,"internal-error"),H(typeof ve=="boolean",e,"internal-error"),mn(E,e.name),mn(C,e.name),mn(A,e.name),mn(k,e.name),mn(F,e.name),mn(q,e.name);const y=new Zt({uid:U,auth:e,email:m,emailVerified:te,displayName:p,isAnonymous:ve,photoURL:C,phoneNumber:E,tenantId:A,stsTokenManager:_,createdAt:F,lastLoginAt:q});return de&&Array.isArray(de)&&(y.providerData=de.map(w=>Object.assign({},w))),k&&(y._redirectEventId=k),y}static async _fromIdTokenResponse(e,t,s=!1){const i=new ks;i.updateFromServerResponse(t);const r=new Zt({uid:t.localId,auth:e,stsTokenManager:i,isAnonymous:s});return await So(r),r}static async _fromGetAccountInfoResponse(e,t,s){const i=t.users[0];H(i.localId!==void 0,"internal-error");const r=i.providerUserInfo!==void 0?$p(i.providerUserInfo):[],o=!(i.email&&i.passwordHash)&&!(r!=null&&r.length),l=new ks;l.updateFromIdToken(s);const c=new Zt({uid:i.localId,auth:e,stsTokenManager:l,isAnonymous:o}),h={uid:i.localId,displayName:i.displayName||null,photoURL:i.photoUrl||null,email:i.email||null,emailVerified:i.emailVerified||!1,phoneNumber:i.phoneNumber||null,tenantId:i.tenantId||null,providerData:r,metadata:new Ul(i.createdAt,i.lastLoginAt),isAnonymous:!(i.email&&i.passwordHash)&&!(r!=null&&r.length)};return Object.assign(c,h),c}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const vd=new Map;function en(n){rn(n instanceof Function,"Expected a class definition");let e=vd.get(n);return e?(rn(e instanceof n,"Instance stored in cache mismatched with class"),e):(e=new n,vd.set(n,e),e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function oo(n,e,t){return`firebase:${n}:${e}:${t}`}class Ps{constructor(e,t,s){this.persistence=e,this.auth=t,this.userKey=s;const{config:i,name:r}=this.auth;this.fullUserKey=oo(this.userKey,i.apiKey,r),this.fullPersistenceKey=oo("persistence",i.apiKey,r),this.boundEventHandler=t._onStorageEvent.bind(t),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(e){return this.persistence._set(this.fullUserKey,e.toJSON())}async getCurrentUser(){const e=await this.persistence._get(this.fullUserKey);return e?Zt._fromJSON(this.auth,e):null}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(e){if(this.persistence===e)return;const t=await this.getCurrentUser();if(await this.removeCurrentUser(),this.persistence=e,t)return this.setCurrentUser(t)}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(e,t,s="authUser"){if(!t.length)return new Ps(en(Ed),e,s);const i=(await Promise.all(t.map(async h=>{if(await h._isAvailable())return h}))).filter(h=>h);let r=i[0]||en(Ed);const o=oo(s,e.config.apiKey,e.name);let l=null;for(const h of t)try{const d=await h._get(o);if(d){const p=Zt._fromJSON(e,d);h!==r&&(l=p),r=h;break}}catch{}const c=i.filter(h=>h._shouldAllowMigration);return!r._shouldAllowMigration||!c.length?new Ps(r,e,s):(r=c[0],l&&await r._set(o,l.toJSON()),await Promise.all(t.map(async h=>{if(h!==r)try{await h._remove(o)}catch{}})),new Ps(r,e,s))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function HE(n,e={}){return Js(n,"GET","/v2/passwordPolicy",Nc(n,e))}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class YE{constructor(e,t,s,i){this.app=e,this.heartbeatServiceProvider=t,this.appCheckServiceProvider=s,this.config=i,this.currentUser=null,this.emulatorConfig=null,this.operations=Promise.resolve(),this.authStateSubscription=new Td(this),this.idTokenSubscription=new Td(this),this.beforeStateQueue=new GE(this),this.redirectUser=null,this.isProactiveRefreshEnabled=!1,this.EXPECTED_PASSWORD_POLICY_SCHEMA_VERSION=1,this._canInitEmulator=!0,this._isInitialized=!1,this._deleted=!1,this._initializationPromise=null,this._popupRedirectResolver=null,this._errorFactory=Fp,this._agentRecaptchaConfig=null,this._tenantRecaptchaConfigs={},this._projectPasswordPolicy=null,this._tenantPasswordPolicies={},this.lastNotifiedUid=void 0,this.languageCode=null,this.tenantId=null,this.settings={appVerificationDisabledForTesting:!1},this.frameworks=[],this.name=e.name,this.clientVersion=i.sdkClientVersion}_initializeWithPersistence(e,t){return t&&(this._popupRedirectResolver=en(t)),this._initializationPromise=this.queue(async()=>{var s,i;if(!this._deleted&&(this.persistenceManager=await Ps.create(this,e),!this._deleted)){if(!((s=this._popupRedirectResolver)===null||s===void 0)&&s._shouldInitProactively)try{await this._popupRedirectResolver._initialize(this)}catch{}await this.initializeCurrentUser(t),this.lastNotifiedUid=((i=this.currentUser)===null||i===void 0?void 0:i.uid)||null,!this._deleted&&(this._isInitialized=!0)}}),this._initializationPromise}async _onStorageEvent(){if(this._deleted)return;const e=await this.assertedPersistence.getCurrentUser();if(!(!this.currentUser&&!e)){if(this.currentUser&&e&&this.currentUser.uid===e.uid){this._currentUser._assign(e),await this.currentUser.getIdToken();return}await this._updateCurrentUser(e,!0)}}async initializeCurrentUserFromIdToken(e){try{const t=await Wp(this,{idToken:e}),s=await Zt._fromGetAccountInfoResponse(this,t,e);await this.directlySetCurrentUser(s)}catch(t){console.warn("FirebaseServerApp could not login user with provided authIdToken: ",t),await this.directlySetCurrentUser(null)}}async initializeCurrentUser(e){var t;if(Jt(this.app)){const o=this.app.settings.authIdToken;return o?new Promise(l=>{setTimeout(()=>this.initializeCurrentUserFromIdToken(o).then(l,l))}):this.directlySetCurrentUser(null)}const s=await this.assertedPersistence.getCurrentUser();let i=s,r=!1;if(e&&this.config.authDomain){await this.getOrInitRedirectPersistenceManager();const o=(t=this.redirectUser)===null||t===void 0?void 0:t._redirectEventId,l=i==null?void 0:i._redirectEventId,c=await this.tryRedirectSignIn(e);(!o||o===l)&&(c!=null&&c.user)&&(i=c.user,r=!0)}if(!i)return this.directlySetCurrentUser(null);if(!i._redirectEventId){if(r)try{await this.beforeStateQueue.runMiddleware(i)}catch(o){i=s,this._popupRedirectResolver._overrideRedirectResult(this,()=>Promise.reject(o))}return i?this.reloadAndSetCurrentUserOrClear(i):this.directlySetCurrentUser(null)}return H(this._popupRedirectResolver,this,"argument-error"),await this.getOrInitRedirectPersistenceManager(),this.redirectUser&&this.redirectUser._redirectEventId===i._redirectEventId?this.directlySetCurrentUser(i):this.reloadAndSetCurrentUserOrClear(i)}async tryRedirectSignIn(e){let t=null;try{t=await this._popupRedirectResolver._completeRedirectFn(this,e,!0)}catch{await this._setRedirectUser(null)}return t}async reloadAndSetCurrentUserOrClear(e){try{await So(e)}catch(t){if((t==null?void 0:t.code)!=="auth/network-request-failed")return this.directlySetCurrentUser(null)}return this.directlySetCurrentUser(e)}useDeviceLanguage(){this.languageCode=NE()}async _delete(){this._deleted=!0}async updateCurrentUser(e){if(Jt(this.app))return Promise.reject(Qn(this));const t=e?ge(e):null;return t&&H(t.auth.config.apiKey===this.config.apiKey,this,"invalid-user-token"),this._updateCurrentUser(t&&t._clone(this))}async _updateCurrentUser(e,t=!1){if(!this._deleted)return e&&H(this.tenantId===e.tenantId,this,"tenant-id-mismatch"),t||await this.beforeStateQueue.runMiddleware(e),this.queue(async()=>{await this.directlySetCurrentUser(e),this.notifyAuthListeners()})}async signOut(){return Jt(this.app)?Promise.reject(Qn(this)):(await this.beforeStateQueue.runMiddleware(null),(this.redirectPersistenceManager||this._popupRedirectResolver)&&await this._setRedirectUser(null),this._updateCurrentUser(null,!0))}setPersistence(e){return Jt(this.app)?Promise.reject(Qn(this)):this.queue(async()=>{await this.assertedPersistence.setPersistence(en(e))})}_getRecaptchaConfig(){return this.tenantId==null?this._agentRecaptchaConfig:this._tenantRecaptchaConfigs[this.tenantId]}async validatePassword(e){this._getPasswordPolicyInternal()||await this._updatePasswordPolicy();const t=this._getPasswordPolicyInternal();return t.schemaVersion!==this.EXPECTED_PASSWORD_POLICY_SCHEMA_VERSION?Promise.reject(this._errorFactory.create("unsupported-password-policy-schema-version",{})):t.validatePassword(e)}_getPasswordPolicyInternal(){return this.tenantId===null?this._projectPasswordPolicy:this._tenantPasswordPolicies[this.tenantId]}async _updatePasswordPolicy(){const e=await HE(this),t=new QE(e);this.tenantId===null?this._projectPasswordPolicy=t:this._tenantPasswordPolicies[this.tenantId]=t}_getPersistence(){return this.assertedPersistence.persistence.type}_updateErrorMap(e){this._errorFactory=new hr("auth","Firebase",e())}onAuthStateChanged(e,t,s){return this.registerStateListener(this.authStateSubscription,e,t,s)}beforeAuthStateChanged(e,t){return this.beforeStateQueue.pushCallback(e,t)}onIdTokenChanged(e,t,s){return this.registerStateListener(this.idTokenSubscription,e,t,s)}authStateReady(){return new Promise((e,t)=>{if(this.currentUser)e();else{const s=this.onAuthStateChanged(()=>{s(),e()},t)}})}async revokeAccessToken(e){if(this.currentUser){const t=await this.currentUser.getIdToken(),s={providerId:"apple.com",tokenType:"ACCESS_TOKEN",token:e,idToken:t};this.tenantId!=null&&(s.tenantId=this.tenantId),await $E(this,s)}}toJSON(){var e;return{apiKey:this.config.apiKey,authDomain:this.config.authDomain,appName:this.name,currentUser:(e=this._currentUser)===null||e===void 0?void 0:e.toJSON()}}async _setRedirectUser(e,t){const s=await this.getOrInitRedirectPersistenceManager(t);return e===null?s.removeCurrentUser():s.setCurrentUser(e)}async getOrInitRedirectPersistenceManager(e){if(!this.redirectPersistenceManager){const t=e&&en(e)||this._popupRedirectResolver;H(t,this,"argument-error"),this.redirectPersistenceManager=await Ps.create(this,[en(t._redirectPersistence)],"redirectUser"),this.redirectUser=await this.redirectPersistenceManager.getCurrentUser()}return this.redirectPersistenceManager}async _redirectUserForId(e){var t,s;return this._isInitialized&&await this.queue(async()=>{}),((t=this._currentUser)===null||t===void 0?void 0:t._redirectEventId)===e?this._currentUser:((s=this.redirectUser)===null||s===void 0?void 0:s._redirectEventId)===e?this.redirectUser:null}async _persistUserIfCurrent(e){if(e===this.currentUser)return this.queue(async()=>this.directlySetCurrentUser(e))}_notifyListenersIfCurrent(e){e===this.currentUser&&this.notifyAuthListeners()}_key(){return`${this.config.authDomain}:${this.config.apiKey}:${this.name}`}_startProactiveRefresh(){this.isProactiveRefreshEnabled=!0,this.currentUser&&this._currentUser._startProactiveRefresh()}_stopProactiveRefresh(){this.isProactiveRefreshEnabled=!1,this.currentUser&&this._currentUser._stopProactiveRefresh()}get _currentUser(){return this.currentUser}notifyAuthListeners(){var e,t;if(!this._isInitialized)return;this.idTokenSubscription.next(this.currentUser);const s=(t=(e=this.currentUser)===null||e===void 0?void 0:e.uid)!==null&&t!==void 0?t:null;this.lastNotifiedUid!==s&&(this.lastNotifiedUid=s,this.authStateSubscription.next(this.currentUser))}registerStateListener(e,t,s,i){if(this._deleted)return()=>{};const r=typeof t=="function"?t:t.next.bind(t);let o=!1;const l=this._isInitialized?Promise.resolve():this._initializationPromise;if(H(l,this,"internal-error"),l.then(()=>{o||r(this.currentUser)}),typeof t=="function"){const c=e.addObserver(t,s,i);return()=>{o=!0,c()}}else{const c=e.addObserver(t);return()=>{o=!0,c()}}}async directlySetCurrentUser(e){this.currentUser&&this.currentUser!==e&&this._currentUser._stopProactiveRefresh(),e&&this.isProactiveRefreshEnabled&&e._startProactiveRefresh(),this.currentUser=e,e?await this.assertedPersistence.setCurrentUser(e):await this.assertedPersistence.removeCurrentUser()}queue(e){return this.operations=this.operations.then(e,e),this.operations}get assertedPersistence(){return H(this.persistenceManager,this,"internal-error"),this.persistenceManager}_logFramework(e){!e||this.frameworks.includes(e)||(this.frameworks.push(e),this.frameworks.sort(),this.clientVersion=Zp(this.config.clientPlatform,this._getFrameworks()))}_getFrameworks(){return this.frameworks}async _getAdditionalHeaders(){var e;const t={"X-Client-Version":this.clientVersion};this.app.options.appId&&(t["X-Firebase-gmpid"]=this.app.options.appId);const s=await((e=this.heartbeatServiceProvider.getImmediate({optional:!0}))===null||e===void 0?void 0:e.getHeartbeatsHeader());s&&(t["X-Firebase-Client"]=s);const i=await this._getAppCheckToken();return i&&(t["X-Firebase-AppCheck"]=i),t}async _getAppCheckToken(){var e;const t=await((e=this.appCheckServiceProvider.getImmediate({optional:!0}))===null||e===void 0?void 0:e.getToken());return t!=null&&t.error&&SE(`Error while retrieving App Check token: ${t.error}`),t==null?void 0:t.token}}function la(n){return ge(n)}class Td{constructor(e){this.auth=e,this.observer=null,this.addObserver=fv(t=>this.observer=t)}get next(){return H(this.observer,this.auth,"internal-error"),this.observer.next.bind(this.observer)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function tw(n,e){const t=aa(n,"auth");if(t.isInitialized()){const i=t.getImmediate(),r=t.getOptions();if(Co(r,e??{}))return i;Ot(i,"already-initialized")}return t.initialize({options:e})}function nw(n,e){const t=(e==null?void 0:e.persistence)||[],s=(Array.isArray(t)?t:[t]).map(en);e!=null&&e.errorMap&&n._updateErrorMap(e.errorMap),n._initializeWithPersistence(s,e==null?void 0:e.popupRedirectResolver)}function sw(n,e,t){const s=la(n);H(s._canInitEmulator,s,"emulator-config-failed"),H(/^https?:\/\//.test(e),s,"invalid-emulator-scheme");const i=!1,r=em(e),{host:o,port:l}=iw(e),c=l===null?"":`:${l}`;s.config.emulator={url:`${r}//${o}${c}/`},s.settings.appVerificationDisabledForTesting=!0,s.emulatorConfig=Object.freeze({host:o,port:l,protocol:r.replace(":",""),options:Object.freeze({disableWarnings:i})}),rw()}function em(n){const e=n.indexOf(":");return e<0?"":n.substr(0,e+1)}function iw(n){const e=em(n),t=/(\/\/)?([^?#/]+)/.exec(n.substr(e.length));if(!t)return{host:"",port:null};const s=t[2].split("@").pop()||"",i=/^(\[[^\]]+\])(:|$)/.exec(s);if(i){const r=i[1];return{host:r,port:Id(s.substr(r.length+1))}}else{const[r,o]=s.split(":");return{host:r,port:Id(o)}}}function Id(n){if(!n)return null;const e=Number(n);return isNaN(e)?null:e}function rw(){function n(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",n):n())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tm{constructor(e,t){this.providerId=e,this.signInMethod=t}toJSON(){return Xt("not implemented")}_getIdTokenResponse(e){return Xt("not implemented")}_linkToIdToken(e,t){return Xt("not implemented")}_getReauthenticationResolver(e){return Xt("not implemented")}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ns(n,e){return xE(n,"POST","/v1/accounts:signInWithIdp",Nc(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class dr extends Oc{constructor(){super(...arguments),this.scopes=[]}addScope(e){return this.scopes.includes(e)||this.scopes.push(e),this}getScopes(){return[...this.scopes]}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ms{constructor(e){this.user=e.user,this.providerId=e.providerId,this._tokenResponse=e._tokenResponse,this.operationType=e.operationType}static async _fromIdTokenResponse(e,t,s,i=!1){const r=await Zt._fromIdTokenResponse(e,s,i),o=Cd(s);return new Ms({user:r,providerId:o,_tokenResponse:s,operationType:t})}static async _forOperation(e,t,s){await e._updateTokensIfNecessary(s,!0);const i=Cd(s);return new Ms({user:e,providerId:i,_tokenResponse:s,operationType:t})}}function Cd(n){return n.providerId?n.providerId:"phoneNumber"in n?"phone":null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function cw(n,e,t=!1){if(Jt(n.app))return Promise.reject(Qn(n));const s="signIn",i=await nm(n,s,e),r=await Ms._fromIdTokenResponse(n,s,i);return t||await n._updateCurrentUser(r.user),r}function hw(n,e,t,s){return ge(n).onIdTokenChanged(e,t,s)}function uw(n,e,t){return ge(n).beforeAuthStateChanged(e,t)}function dw(n,e,t,s){return ge(n).onAuthStateChanged(e,t,s)}function fw(n){return ge(n).signOut()}const ko="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Dt(){return window}function vw(n){Dt().location.href=n}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function am(){return typeof Dt().WorkerGlobalScope<"u"&&typeof Dt().importScripts=="function"}async function Ew(){if(!(navigator!=null&&navigator.serviceWorker))return null;try{return(await navigator.serviceWorker.ready).active}catch{return null}}function ww(){var n;return((n=navigator==null?void 0:navigator.serviceWorker)===null||n===void 0?void 0:n.controller)||null}function Tw(){return am()?self:null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function um(n,e){return e?en(e):(H(n._popupRedirectResolver,n,"argument-error"),n._popupRedirectResolver)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class dm{constructor(e,t,s,i,r=!1){this.auth=e,this.resolver=s,this.user=i,this.bypassAuthState=r,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(t)?t:[t]}execute(){return new Promise(async(e,t)=>{this.pendingPromise={resolve:e,reject:t};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(s){this.reject(s)}})}async onAuthEvent(e){const{urlResponse:t,sessionId:s,postBody:i,tenantId:r,error:o,type:l}=e;if(o){this.reject(o);return}const c={auth:this.auth,requestUri:t,sessionId:s,tenantId:r||void 0,postBody:i||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(l)(c))}catch(h){this.reject(h)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return kw;case"linkViaPopup":case"linkViaRedirect":return Nw;case"reauthViaPopup":case"reauthViaRedirect":return Pw;default:Ot(this.auth,"internal-error")}}resolve(e){rn(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){rn(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Dw=new ur(2e3,1e4);async function Lw(n,e,t){if(Jt(n.app))return Promise.reject(It(n,"operation-not-supported-in-this-environment"));const s=la(n);AE(n,e,Oc);const i=um(s,t);return new Gn(s,"signInViaPopup",e,i).executeNotNull()}class Gn extends dm{constructor(e,t,s,i,r){super(e,t,i,r),this.provider=s,this.authWindow=null,this.pollId=null,Gn.currentPopupAction&&Gn.currentPopupAction.cancel(),Gn.currentPopupAction=this}async executeNotNull(){const e=await this.execute();return H(e,this.auth,"internal-error"),e}async onExecution(){rn(this.filter.length===1,"Popup operations only handle one event");const e=Mc();this.authWindow=await this.resolver._openPopup(this.auth,this.provider,this.filter[0],e),this.authWindow.associatedEvent=e,this.resolver._originValidation(this.auth).catch(t=>{this.reject(t)}),this.resolver._isIframeWebStorageSupported(this.auth,t=>{t||this.reject(It(this.auth,"web-storage-unsupported"))}),this.pollUserCancellation()}get eventId(){var e;return((e=this.authWindow)===null||e===void 0?void 0:e.associatedEvent)||null}cancel(){this.reject(It(this.auth,"cancelled-popup-request"))}cleanUp(){this.authWindow&&this.authWindow.close(),this.pollId&&window.clearTimeout(this.pollId),this.authWindow=null,this.pollId=null,Gn.currentPopupAction=null}pollUserCancellation(){const e=()=>{var t,s;if(!((s=(t=this.authWindow)===null||t===void 0?void 0:t.window)===null||s===void 0)&&s.closed){this.pollId=window.setTimeout(()=>{this.pollId=null,this.reject(It(this.auth,"popup-closed-by-user"))},8e3);return}this.pollId=window.setTimeout(e,Dw.get())};e()}}Gn.currentPopupAction=null;/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function jw(n,e={}){return Js(n,"GET","/v1/projects",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qw=new ur(3e4,6e4);function Ad(){const n=Dt().___jsl;if(n!=null&&n.H){for(const e of Object.keys(n.H))if(n.H[e].r=n.H[e].r||[],n.H[e].L=n.H[e].L||[],n.H[e].r=[...n.H[e].L],n.CP)for(let t=0;t<n.CP.length;t++)n.CP[t]=null}}function Yw(n){return new Promise((e,t)=>{var s,i,r;function o(){Ad(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{Ad(),t(It(n,"network-request-failed"))},timeout:Qw.get()})}if(!((i=(s=Dt().gapi)===null||s===void 0?void 0:s.iframes)===null||i===void 0)&&i.Iframe)e(gapi.iframes.getContext());else if(!((r=Dt().gapi)===null||r===void 0)&&r.load)o();else{const l=ew("iframefcb");return Dt()[l]=()=>{gapi.load?o():t(It(n,"network-request-failed"))},XE(`${ZE()}?onload=${l}`).catch(c=>t(c))}}).catch(e=>{throw lo=null,e})}let lo=null;function Jw(n){return lo=lo||Yw(n),lo}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xw=new ur(5e3,15e3),Zw="__/auth/iframe",eT="emulator/auth/iframe",tT={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},nT=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function sT(n){const e=n.config;H(e.authDomain,n,"auth-domain-config-required");const t=e.emulator?Pc(e,eT):`https://${n.config.authDomain}/${Zw}`,s={apiKey:e.apiKey,appName:n.name,v:as},i=nT.get(n.config.apiHost);i&&(s.eid=i);const r=n._getFrameworks();return r.length&&(s.fw=r.join(",")),`${t}?${Ys(s).slice(1)}`}async function iT(n){const e=await Jw(n),t=Dt().gapi;return H(t,n,"internal-error"),e.open({where:document.body,url:sT(n),messageHandlersFilter:t.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:tT,dontclear:!0},s=>new Promise(async(i,r)=>{await s.restyle({setHideOnLeave:!1});const o=It(n,"network-request-failed"),l=Dt().setTimeout(()=>{r(o)},Xw.get());function c(){Dt().clearTimeout(l),i(s)}s.ping(c).then(c,()=>{r(o)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const dT="__/auth/handler",fT="emulator/auth/handler",pT=encodeURIComponent("fac");async function Pd(n,e,t,s,i,r){H(n.config.authDomain,n,"auth-domain-config-required"),H(n.config.apiKey,n,"invalid-api-key");const o={apiKey:n.config.apiKey,appName:n.name,authType:t,redirectUrl:s,v:as,eventId:i};if(e instanceof Oc){e.setDefaultLanguage(n.languageCode),o.providerId=e.providerId||"",Ll(e.getCustomParameters())||(o.customParameters=JSON.stringify(e.getCustomParameters()));for(const[d,p]of Object.entries({}))o[d]=p}if(e instanceof dr){const d=e.getScopes().filter(p=>p!=="");d.length>0&&(o.scopes=d.join(","))}n.tenantId&&(o.tid=n.tenantId);const l=o;for(const d of Object.keys(l))l[d]===void 0&&delete l[d];const c=await n._getAppCheckToken(),h=c?`#${pT}=${encodeURIComponent(c)}`:"";return`${mT(n)}?${Ys(l).slice(1)}${h}`}function mT({config:n}){return n.emulator?Pc(n,fT):`https://${n.authDomain}/${dT}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ll="webStorageSupport";class gT{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=om,this._completeRedirectFn=Uw,this._overrideRedirectResult=Vw}async _openPopup(e,t,s,i){var r;rn((r=this.eventManagers[e._key()])===null||r===void 0?void 0:r.manager,"_initialize() not called before _openPopup()");const o=await Pd(e,t,s,Bl(),i);return hT(e,o,Mc())}async _openRedirect(e,t,s,i){await this._originValidation(e);const r=await Pd(e,t,s,Bl(),i);return vw(r),new Promise(()=>{})}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:i,promise:r}=this.eventManagers[t];return i?Promise.resolve(i):(rn(r,"If manager is not set, promise should be"),r)}const s=this.initAndGetManager(e);return this.eventManagers[t]={promise:s},s.catch(()=>{delete this.eventManagers[t]}),s}async initAndGetManager(e){const t=await iT(e),s=new Ww(e);return t.register("authEvent",i=>(H(i==null?void 0:i.authEvent,e,"invalid-auth-event"),{status:s.onEvent(i.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:s},this.iframes[e._key()]=t,s}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send(ll,{type:ll},i=>{var r;const o=(r=i==null?void 0:i[0])===null||r===void 0?void 0:r[ll];o!==void 0&&t(!!o),Ot(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=Hw(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return Xp()||Gp()||Lc()}}const _T=gT;var Nd="@firebase/auth",Dd="1.7.9";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function vT(n){switch(n){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function ET(n){Xn(new Pn("auth",(e,{options:t})=>{const s=e.getProvider("app").getImmediate(),i=e.getProvider("heartbeat"),r=e.getProvider("app-check-internal"),{apiKey:o,authDomain:l}=s.options;H(o&&!o.includes(":"),"invalid-api-key",{appName:s.name});const c={apiKey:o,authDomain:l,clientPlatform:n,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:Zp(n)},h=new YE(s,i,r,c);return nw(h,t),h},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,t,s)=>{e.getProvider("auth-internal").initialize()})),Xn(new Pn("auth-internal",e=>{const t=la(e.getProvider("auth").getImmediate());return(s=>new yT(s))(t)},"PRIVATE").setInstantiationMode("EXPLICIT")),Nt(Nd,Dd,vT(n)),Nt(Nd,Dd,"esm2017")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
*/var Yn,pm;(function(){var n;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(I,_){function y(){}y.prototype=_.prototype,I.D=_.prototype,I.prototype=new y,I.prototype.constructor=I,I.C=function(w,T,R){for(var v=Array(arguments.length-2),ze=2;ze<arguments.length;ze++)v[ze-2]=arguments[ze];return _.prototype[T].apply(w,v)}}function t(){this.blockSize=-1}function s(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}e(s,t),s.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function i(I,_,y){y||(y=0);var w=Array(16);if(typeof _=="string")for(var T=0;16>T;++T)w[T]=_.charCodeAt(y++)|_.charCodeAt(y++)<<8|_.charCodeAt(y++)<<16|_.charCodeAt(y++)<<24;else for(T=0;16>T;++T)w[T]=_[y++]|_[y++]<<8|_[y++]<<16|_[y++]<<24;_=I.g[0],y=I.g[1],T=I.g[2];var R=I.g[3],v=_+(R^y&(T^R))+w[0]+3614090360&4294967295;_=y+(v<<7&4294967295|v>>>25),v=R+(T^_&(y^T))+w[1]+3905402710&4294967295,R=_+(v<<12&4294967295|v>>>20),v=T+(y^R&(_^y))+w[2]+606105819&4294967295,T=R+(v<<17&4294967295|v>>>15),v=y+(_^T&(R^_))+w[3]+3250441966&4294967295,y=T+(v<<22&4294967295|v>>>10),v=_+(R^y&(T^R))+w[4]+4118548399&4294967295,_=y+(v<<7&4294967295|v>>>25),v=R+(T^_&(y^T))+w[5]+1200080426&4294967295,R=_+(v<<12&4294967295|v>>>20),v=T+(y^R&(_^y))+w[6]+2821735955&4294967295,T=R+(v<<17&4294967295|v>>>15),v=y+(_^T&(R^_))+w[7]+4249261313&4294967295,y=T+(v<<22&4294967295|v>>>10),v=_+(R^y&(T^R))+w[8]+1770035416&4294967295,_=y+(v<<7&4294967295|v>>>25),v=R+(T^_&(y^T))+w[9]+2336552879&4294967295,R=_+(v<<12&4294967295|v>>>20),v=T+(y^R&(_^y))+w[10]+4294925233&4294967295,T=R+(v<<17&4294967295|v>>>15),v=y+(_^T&(R^_))+w[11]+2304563134&4294967295,y=T+(v<<22&4294967295|v>>>10),v=_+(R^y&(T^R))+w[12]+1804603682&4294967295,_=y+(v<<7&4294967295|v>>>25),v=R+(T^_&(y^T))+w[13]+4254626195&4294967295,R=_+(v<<12&4294967295|v>>>20),v=T+(y^R&(_^y))+w[14]+2792965006&4294967295,T=R+(v<<17&4294967295|v>>>15),v=y+(_^T&(R^_))+w[15]+1236535329&4294967295,y=T+(v<<22&4294967295|v>>>10),v=_+(T^R&(y^T))+w[1]+4129170786&4294967295,_=y+(v<<5&4294967295|v>>>27),v=R+(y^T&(_^y))+w[6]+3225465664&4294967295,R=_+(v<<9&4294967295|v>>>23),v=T+(_^y&(R^_))+w[11]+643717713&4294967295,T=R+(v<<14&4294967295|v>>>18),v=y+(R^_&(T^R))+w[0]+3921069994&4294967295,y=T+(v<<20&4294967295|v>>>12),v=_+(T^R&(y^T))+w[5]+3593408605&4294967295,_=y+(v<<5&4294967295|v>>>27),v=R+(y^T&(_^y))+w[10]+38016083&4294967295,R=_+(v<<9&4294967295|v>>>23),v=T+(_^y&(R^_))+w[15]+3634488961&4294967295,T=R+(v<<14&4294967295|v>>>18),v=y+(R^_&(T^R))+w[4]+3889429448&4294967295,y=T+(v<<20&4294967295|v>>>12),v=_+(T^R&(y^T))+w[9]+568446438&4294967295,_=y+(v<<5&4294967295|v>>>27),v=R+(y^T&(_^y))+w[14]+3275163606&4294967295,R=_+(v<<9&4294967295|v>>>23),v=T+(_^y&(R^_))+w[3]+4107603335&4294967295,T=R+(v<<14&4294967295|v>>>18),v=y+(R^_&(T^R))+w[8]+1163531501&4294967295,y=T+(v<<20&4294967295|v>>>12),v=_+(T^R&(y^T))+w[13]+2850285829&4294967295,_=y+(v<<5&4294967295|v>>>27),v=R+(y^T&(_^y))+w[2]+4243563512&4294967295,R=_+(v<<9&4294967295|v>>>23),v=T+(_^y&(R^_))+w[7]+1735328473&4294967295,T=R+(v<<14&4294967295|v>>>18),v=y+(R^_&(T^R))+w[12]+2368359562&4294967295,y=T+(v<<20&4294967295|v>>>12),v=_+(y^T^R)+w[5]+4294588738&4294967295,_=y+(v<<4&4294967295|v>>>28),v=R+(_^y^T)+w[8]+2272392833&4294967295,R=_+(v<<11&4294967295|v>>>21),v=T+(R^_^y)+w[11]+1839030562&4294967295,T=R+(v<<16&4294967295|v>>>16),v=y+(T^R^_)+w[14]+4259657740&4294967295,y=T+(v<<23&4294967295|v>>>9),v=_+(y^T^R)+w[1]+2763975236&4294967295,_=y+(v<<4&4294967295|v>>>28),v=R+(_^y^T)+w[4]+1272893353&4294967295,R=_+(v<<11&4294967295|v>>>21),v=T+(R^_^y)+w[7]+4139469664&4294967295,T=R+(v<<16&4294967295|v>>>16),v=y+(T^R^_)+w[10]+3200236656&4294967295,y=T+(v<<23&4294967295|v>>>9),v=_+(y^T^R)+w[13]+681279174&4294967295,_=y+(v<<4&4294967295|v>>>28),v=R+(_^y^T)+w[0]+3936430074&4294967295,R=_+(v<<11&4294967295|v>>>21),v=T+(R^_^y)+w[3]+3572445317&4294967295,T=R+(v<<16&4294967295|v>>>16),v=y+(T^R^_)+w[6]+76029189&4294967295,y=T+(v<<23&4294967295|v>>>9),v=_+(y^T^R)+w[9]+3654602809&4294967295,_=y+(v<<4&4294967295|v>>>28),v=R+(_^y^T)+w[12]+3873151461&4294967295,R=_+(v<<11&4294967295|v>>>21),v=T+(R^_^y)+w[15]+530742520&4294967295,T=R+(v<<16&4294967295|v>>>16),v=y+(T^R^_)+w[2]+3299628645&4294967295,y=T+(v<<23&4294967295|v>>>9),v=_+(T^(y|~R))+w[0]+4096336452&4294967295,_=y+(v<<6&4294967295|v>>>26),v=R+(y^(_|~T))+w[7]+1126891415&4294967295,R=_+(v<<10&4294967295|v>>>22),v=T+(_^(R|~y))+w[14]+2878612391&4294967295,T=R+(v<<15&4294967295|v>>>17),v=y+(R^(T|~_))+w[5]+4237533241&4294967295,y=T+(v<<21&4294967295|v>>>11),v=_+(T^(y|~R))+w[12]+1700485571&4294967295,_=y+(v<<6&4294967295|v>>>26),v=R+(y^(_|~T))+w[3]+2399980690&4294967295,R=_+(v<<10&4294967295|v>>>22),v=T+(_^(R|~y))+w[10]+4293915773&4294967295,T=R+(v<<15&4294967295|v>>>17),v=y+(R^(T|~_))+w[1]+2240044497&4294967295,y=T+(v<<21&4294967295|v>>>11),v=_+(T^(y|~R))+w[8]+1873313359&4294967295,_=y+(v<<6&4294967295|v>>>26),v=R+(y^(_|~T))+w[15]+4264355552&4294967295,R=_+(v<<10&4294967295|v>>>22),v=T+(_^(R|~y))+w[6]+2734768916&4294967295,T=R+(v<<15&4294967295|v>>>17),v=y+(R^(T|~_))+w[13]+1309151649&4294967295,y=T+(v<<21&4294967295|v>>>11),v=_+(T^(y|~R))+w[4]+4149444226&4294967295,_=y+(v<<6&4294967295|v>>>26),v=R+(y^(_|~T))+w[11]+3174756917&4294967295,R=_+(v<<10&4294967295|v>>>22),v=T+(_^(R|~y))+w[2]+718787259&4294967295,T=R+(v<<15&4294967295|v>>>17),v=y+(R^(T|~_))+w[9]+3951481745&4294967295,I.g[0]=I.g[0]+_&4294967295,I.g[1]=I.g[1]+(T+(v<<21&4294967295|v>>>11))&4294967295,I.g[2]=I.g[2]+T&4294967295,I.g[3]=I.g[3]+R&4294967295}s.prototype.u=function(I,_){_===void 0&&(_=I.length);for(var y=_-this.blockSize,w=this.B,T=this.h,R=0;R<_;){if(T==0)for(;R<=y;)i(this,I,R),R+=this.blockSize;if(typeof I=="string"){for(;R<_;)if(w[T++]=I.charCodeAt(R++),T==this.blockSize){i(this,w),T=0;break}}else for(;R<_;)if(w[T++]=I[R++],T==this.blockSize){i(this,w),T=0;break}}this.h=T,this.o+=_},s.prototype.v=function(){var I=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);I[0]=128;for(var _=1;_<I.length-8;++_)I[_]=0;var y=8*this.o;for(_=I.length-8;_<I.length;++_)I[_]=y&255,y/=256;for(this.u(I),I=Array(16),_=y=0;4>_;++_)for(var w=0;32>w;w+=8)I[y++]=this.g[_]>>>w&255;return I};function r(I,_){var y=l;return Object.prototype.hasOwnProperty.call(y,I)?y[I]:y[I]=_(I)}function o(I,_){this.h=_;for(var y=[],w=!0,T=I.length-1;0<=T;T--){var R=I[T]|0;w&&R==_||(y[T]=R,w=!1)}this.g=y}var l={};function c(I){return-128<=I&&128>I?r(I,function(_){return new o([_|0],0>_?-1:0)}):new o([I|0],0>I?-1:0)}function h(I){if(isNaN(I)||!isFinite(I))return p;if(0>I)return k(h(-I));for(var _=[],y=1,w=0;I>=y;w++)_[w]=I/y|0,y*=4294967296;return new o(_,0)}function d(I,_){if(I.length==0)throw Error("number format error: empty string");if(_=_||10,2>_||36<_)throw Error("radix out of range: "+_);if(I.charAt(0)=="-")return k(d(I.substring(1),_));if(0<=I.indexOf("-"))throw Error('number format error: interior "-" character');for(var y=h(Math.pow(_,8)),w=p,T=0;T<I.length;T+=8){var R=Math.min(8,I.length-T),v=parseInt(I.substring(T,T+R),_);8>R?(R=h(Math.pow(_,R)),w=w.j(R).add(h(v))):(w=w.j(y),w=w.add(h(v)))}return w}var p=c(0),m=c(1),E=c(16777216);n=o.prototype,n.m=function(){if(A(this))return-k(this).m();for(var I=0,_=1,y=0;y<this.g.length;y++){var w=this.i(y);I+=(0<=w?w:4294967296+w)*_,_*=4294967296}return I},n.toString=function(I){if(I=I||10,2>I||36<I)throw Error("radix out of range: "+I);if(C(this))return"0";if(A(this))return"-"+k(this).toString(I);for(var _=h(Math.pow(I,6)),y=this,w="";;){var T=te(y,_).g;y=F(y,T.j(_));var R=((0<y.g.length?y.g[0]:y.h)>>>0).toString(I);if(y=T,C(y))return R+w;for(;6>R.length;)R="0"+R;w=R+w}},n.i=function(I){return 0>I?0:I<this.g.length?this.g[I]:this.h};function C(I){if(I.h!=0)return!1;for(var _=0;_<I.g.length;_++)if(I.g[_]!=0)return!1;return!0}function A(I){return I.h==-1}n.l=function(I){return I=F(this,I),A(I)?-1:C(I)?0:1};function k(I){for(var _=I.g.length,y=[],w=0;w<_;w++)y[w]=~I.g[w];return new o(y,~I.h).add(m)}n.abs=function(){return A(this)?k(this):this},n.add=function(I){for(var _=Math.max(this.g.length,I.g.length),y=[],w=0,T=0;T<=_;T++){var R=w+(this.i(T)&65535)+(I.i(T)&65535),v=(R>>>16)+(this.i(T)>>>16)+(I.i(T)>>>16);w=v>>>16,R&=65535,v&=65535,y[T]=v<<16|R}return new o(y,y[y.length-1]&-2147483648?-1:0)};function F(I,_){return I.add(k(_))}n.j=function(I){if(C(this)||C(I))return p;if(A(this))return A(I)?k(this).j(k(I)):k(k(this).j(I));if(A(I))return k(this.j(k(I)));if(0>this.l(E)&&0>I.l(E))return h(this.m()*I.m());for(var _=this.g.length+I.g.length,y=[],w=0;w<2*_;w++)y[w]=0;for(w=0;w<this.g.length;w++)for(var T=0;T<I.g.length;T++){var R=this.i(w)>>>16,v=this.i(w)&65535,ze=I.i(T)>>>16,Rt=I.i(T)&65535;y[2*w+2*T]+=v*Rt,q(y,2*w+2*T),y[2*w+2*T+1]+=R*Rt,q(y,2*w+2*T+1),y[2*w+2*T+1]+=v*ze,q(y,2*w+2*T+1),y[2*w+2*T+2]+=R*ze,q(y,2*w+2*T+2)}for(w=0;w<_;w++)y[w]=y[2*w+1]<<16|y[2*w];for(w=_;w<2*_;w++)y[w]=0;return new o(y,0)};function q(I,_){for(;(I[_]&65535)!=I[_];)I[_+1]+=I[_]>>>16,I[_]&=65535,_++}function U(I,_){this.g=I,this.h=_}function te(I,_){if(C(_))throw Error("division by zero");if(C(I))return new U(p,p);if(A(I))return _=te(k(I),_),new U(k(_.g),k(_.h));if(A(_))return _=te(I,k(_)),new U(k(_.g),_.h);if(30<I.g.length){if(A(I)||A(_))throw Error("slowDivide_ only works with positive integers.");for(var y=m,w=_;0>=w.l(I);)y=ve(y),w=ve(w);var T=de(y,1),R=de(w,1);for(w=de(w,2),y=de(y,2);!C(w);){var v=R.add(w);0>=v.l(I)&&(T=T.add(y),R=v),w=de(w,1),y=de(y,1)}return _=F(I,T.j(_)),new U(T,_)}for(T=p;0<=I.l(_);){for(y=Math.max(1,Math.floor(I.m()/_.m())),w=Math.ceil(Math.log(y)/Math.LN2),w=48>=w?1:Math.pow(2,w-48),R=h(y),v=R.j(_);A(v)||0<v.l(I);)y-=w,R=h(y),v=R.j(_);C(R)&&(R=m),T=T.add(R),I=F(I,v)}return new U(T,I)}n.A=function(I){return te(this,I).h},n.and=function(I){for(var _=Math.max(this.g.length,I.g.length),y=[],w=0;w<_;w++)y[w]=this.i(w)&I.i(w);return new o(y,this.h&I.h)},n.or=function(I){for(var _=Math.max(this.g.length,I.g.length),y=[],w=0;w<_;w++)y[w]=this.i(w)|I.i(w);return new o(y,this.h|I.h)},n.xor=function(I){for(var _=Math.max(this.g.length,I.g.length),y=[],w=0;w<_;w++)y[w]=this.i(w)^I.i(w);return new o(y,this.h^I.h)};function ve(I){for(var _=I.g.length+1,y=[],w=0;w<_;w++)y[w]=I.i(w)<<1|I.i(w-1)>>>31;return new o(y,I.h)}function de(I,_){var y=_>>5;_%=32;for(var w=I.g.length-y,T=[],R=0;R<w;R++)T[R]=0<_?I.i(R+y)>>>_|I.i(R+y+1)<<32-_:I.i(R+y);return new o(T,I.h)}s.prototype.digest=s.prototype.v,s.prototype.reset=s.prototype.s,s.prototype.update=s.prototype.u,pm=s,o.prototype.add=o.prototype.add,o.prototype.multiply=o.prototype.j,o.prototype.modulo=o.prototype.A,o.prototype.compare=o.prototype.l,o.prototype.toNumber=o.prototype.m,o.prototype.toString=o.prototype.toString,o.prototype.getBits=o.prototype.i,o.fromNumber=h,o.fromString=d,Yn=o}).apply(typeof xd<"u"?xd:typeof self<"u"?self:typeof window<"u"?window:{});var Yr=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
*/var mm,Ni,gm,co,Wl,_m,ym,vm;(function(){var n,e=typeof Object.defineProperties=="function"?Object.defineProperty:function(a,u,f){return a==Array.prototype||a==Object.prototype||(a[u]=f.value),a};function t(a){a=[typeof globalThis=="object"&&globalThis,a,typeof window=="object"&&window,typeof self=="object"&&self,typeof Yr=="object"&&Yr];for(var u=0;u<a.length;++u){var f=a[u];if(f&&f.Math==Math)return f}throw Error("Cannot find global object")}var s=t(this);function i(a,u){if(u)e:{var f=s;a=a.split(".");for(var g=0;g<a.length-1;g++){var b=a[g];if(!(b in f))break e;f=f[b]}a=a[a.length-1],g=f[a],u=u(g),u!=g&&u!=null&&e(f,a,{configurable:!0,writable:!0,value:u})}}function r(a,u){a instanceof String&&(a+="");var f=0,g=!1,b={next:function(){if(!g&&f<a.length){var S=f++;return{value:u(S,a[S]),done:!1}}return g=!0,{done:!0,value:void 0}}};return b[Symbol.iterator]=function(){return b},b}i("Array.prototype.values",function(a){return a||function(){return r(this,function(u,f){return f})}});/** @license

 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var o=o||{},l=this||self;function c(a){var u=typeof a;return u=u!="object"?u:a?Array.isArray(a)?"array":u:"null",u=="array"||u=="object"&&typeof a.length=="number"}function h(a){var u=typeof a;return u=="object"&&a!=null||u=="function"}function d(a,u,f){return a.call.apply(a.bind,arguments)}function p(a,u,f){if(!a)throw Error();if(2<arguments.length){var g=Array.prototype.slice.call(arguments,2);return function(){var b=Array.prototype.slice.call(arguments);return Array.prototype.unshift.apply(b,g),a.apply(u,b)}}return function(){return a.apply(u,arguments)}}function m(a,u,f){return m=Function.prototype.bind&&Function.prototype.bind.toString().indexOf("native code")!=-1?d:p,m.apply(null,arguments)}function E(a,u){var f=Array.prototype.slice.call(arguments,1);return function(){var g=f.slice();return g.push.apply(g,arguments),a.apply(this,g)}}function C(a,u){function f(){}f.prototype=u.prototype,a.aa=u.prototype,a.prototype=new f,a.prototype.constructor=a,a.Qb=function(g,b,S){for(var O=Array(arguments.length-2),pe=2;pe<arguments.length;pe++)O[pe-2]=arguments[pe];return u.prototype[b].apply(g,O)}}function A(a){const u=a.length;if(0<u){const f=Array(u);for(let g=0;g<u;g++)f[g]=a[g];return f}return[]}function k(a,u){for(let f=1;f<arguments.length;f++){const g=arguments[f];if(c(g)){const b=a.length||0,S=g.length||0;a.length=b+S;for(let O=0;O<S;O++)a[b+O]=g[O]}else a.push(g)}}class F{constructor(u,f){this.i=u,this.j=f,this.h=0,this.g=null}get(){let u;return 0<this.h?(this.h--,u=this.g,this.g=u.next,u.next=null):u=this.i(),u}}function q(a){return/^[\s\xa0]*$/.test(a)}function U(){var a=l.navigator;return a&&(a=a.userAgent)?a:""}function te(a){return te[" "](a),a}te[" "]=function(){};var ve=U().indexOf("Gecko")!=-1&&!(U().toLowerCase().indexOf("webkit")!=-1&&U().indexOf("Edge")==-1)&&!(U().indexOf("Trident")!=-1||U().indexOf("MSIE")!=-1)&&U().indexOf("Edge")==-1;function de(a,u,f){for(const g in a)u.call(f,a[g],g,a)}function I(a,u){for(const f in a)u.call(void 0,a[f],f,a)}function _(a){const u={};for(const f in a)u[f]=a[f];return u}const y="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function w(a,u){let f,g;for(let b=1;b<arguments.length;b++){g=arguments[b];for(f in g)a[f]=g[f];for(let S=0;S<y.length;S++)f=y[S],Object.prototype.hasOwnProperty.call(g,f)&&(a[f]=g[f])}}function T(a){var u=1;a=a.split(":");const f=[];for(;0<u&&a.length;)f.push(a.shift()),u--;return a.length&&f.push(a.join(":")),f}function R(a){l.setTimeout(()=>{throw a},0)}function v(){var a=qt;let u=null;return a.g&&(u=a.g,a.g=a.g.next,a.g||(a.h=null),u.next=null),u}class ze{constructor(){this.h=this.g=null}add(u,f){const g=Rt.get();g.set(u,f),this.h?this.h.next=g:this.g=g,this.h=g}}var Rt=new F(()=>new Nr,a=>a.reset());class Nr{constructor(){this.next=this.g=this.h=null}set(u,f){this.h=u,this.g=f,this.next=null}reset(){this.next=this.g=this.h=null}}let St,At=!1,qt=new ze,fs=()=>{const a=l.Promise.resolve(void 0);St=()=>{a.then(Dr)}};var Dr=()=>{for(var a;a=v();){try{a.h.call(a.g)}catch(f){R(f)}var u=Rt;u.j(a),100>u.h&&(u.h++,a.next=u.g,u.g=a)}At=!1};function Y(){this.s=this.s,this.C=this.C}Y.prototype.s=!1,Y.prototype.ma=function(){this.s||(this.s=!0,this.N())},Y.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function ee(a,u){this.type=a,this.g=this.target=u,this.defaultPrevented=!1}ee.prototype.h=function(){this.defaultPrevented=!0};var kt=function(){if(!l.addEventListener||!Object.defineProperty)return!1;var a=!1,u=Object.defineProperty({},"passive",{get:function(){a=!0}});try{const f=()=>{};l.addEventListener("test",f,u),l.removeEventListener("test",f,u)}catch{}return a}();function hn(a,u){if(ee.call(this,a?a.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,a){var f=this.type=a.type,g=a.changedTouches&&a.changedTouches.length?a.changedTouches[0]:null;if(this.target=a.target||a.srcElement,this.g=u,u=a.relatedTarget){if(ve){e:{try{te(u.nodeName);var b=!0;break e}catch{}b=!1}b||(u=null)}}else f=="mouseover"?u=a.fromElement:f=="mouseout"&&(u=a.toElement);this.relatedTarget=u,g?(this.clientX=g.clientX!==void 0?g.clientX:g.pageX,this.clientY=g.clientY!==void 0?g.clientY:g.pageY,this.screenX=g.screenX||0,this.screenY=g.screenY||0):(this.clientX=a.clientX!==void 0?a.clientX:a.pageX,this.clientY=a.clientY!==void 0?a.clientY:a.pageY,this.screenX=a.screenX||0,this.screenY=a.screenY||0),this.button=a.button,this.key=a.key||"",this.ctrlKey=a.ctrlKey,this.altKey=a.altKey,this.shiftKey=a.shiftKey,this.metaKey=a.metaKey,this.pointerId=a.pointerId||0,this.pointerType=typeof a.pointerType=="string"?a.pointerType:x[a.pointerType]||"",this.state=a.state,this.i=a,a.defaultPrevented&&hn.aa.h.call(this)}}C(hn,ee);var x={2:"touch",3:"pen",4:"mouse"};hn.prototype.h=function(){hn.aa.h.call(this);var a=this.i;a.preventDefault?a.preventDefault():a.returnValue=!1};var we="closure_listenable_"+(1e6*Math.random()|0),fe=0;function Ge(a,u,f,g,b){this.listener=a,this.proxy=null,this.src=u,this.type=f,this.capture=!!g,this.ha=b,this.key=++fe,this.da=this.fa=!1}function un(a){a.da=!0,a.listener=null,a.proxy=null,a.src=null,a.ha=null}function Wt(a){this.src=a,this.g={},this.h=0}Wt.prototype.add=function(a,u,f,g,b){var S=a.toString();a=this.g[S],a||(a=this.g[S]=[],this.h++);var O=ms(a,u,g,b);return-1<O?(u=a[O],f||(u.fa=!1)):(u=new Ge(u,this.src,S,!!g,b),u.fa=f,a.push(u)),u};function ps(a,u){var f=u.type;if(f in a.g){var g=a.g[f],b=Array.prototype.indexOf.call(g,u,void 0),S;(S=0<=b)&&Array.prototype.splice.call(g,b,1),S&&(un(u),a.g[f].length==0&&(delete a.g[f],a.h--))}}function ms(a,u,f,g){for(var b=0;b<a.length;++b){var S=a[b];if(!S.da&&S.listener==u&&S.capture==!!f&&S.ha==g)return b}return-1}var gs="closure_lm_"+(1e6*Math.random()|0),_s={};function Bn(a,u,f,g,b){if(Array.isArray(u)){for(var S=0;S<u.length;S++)Bn(a,u[S],f,g,b);return null}return f=uu(f),a&&a[we]?a.K(u,f,h(g)?!!g.capture:!1,b):$t(a,u,f,!1,g,b)}function $t(a,u,f,g,b,S){if(!u)throw Error("Invalid event type");var O=h(b)?!!b.capture:!!b,pe=Fa(a);if(pe||(a[gs]=pe=new Wt(a)),f=pe.add(u,f,g,O,S),f.proxy)return f;if(g=Va(),f.proxy=g,g.src=a,g.listener=f,a.addEventListener)kt||(b=O),b===void 0&&(b=!1),a.addEventListener(u.toString(),g,b);else if(a.attachEvent)a.attachEvent(oi(u.toString()),g);else if(a.addListener&&a.removeListener)a.addListener(g);else throw Error("addEventListener and attachEvent are unavailable.");return f}function Va(){function a(f){return u.call(a.src,a.listener,f)}const u=_y;return a}function _t(a,u,f,g,b){if(Array.isArray(u))for(var S=0;S<u.length;S++)_t(a,u[S],f,g,b);else g=h(g)?!!g.capture:!!g,f=uu(f),a&&a[we]?(a=a.i,u=String(u).toString(),u in a.g&&(S=a.g[u],f=ms(S,f,g,b),-1<f&&(un(S[f]),Array.prototype.splice.call(S,f,1),S.length==0&&(delete a.g[u],a.h--)))):a&&(a=Fa(a))&&(u=a.g[u.toString()],a=-1,u&&(a=ms(u,f,g,b)),(f=-1<a?u[a]:null)&&jt(f))}function jt(a){if(typeof a!="number"&&a&&!a.da){var u=a.src;if(u&&u[we])ps(u.i,a);else{var f=a.type,g=a.proxy;u.removeEventListener?u.removeEventListener(f,g,a.capture):u.detachEvent?u.detachEvent(oi(f),g):u.addListener&&u.removeListener&&u.removeListener(g),(f=Fa(u))?(ps(f,a),f.h==0&&(f.src=null,u[gs]=null)):un(a)}}}function oi(a){return a in _s?_s[a]:_s[a]="on"+a}function _y(a,u){if(a.da)a=!0;else{u=new hn(u,this);var f=a.listener,g=a.ha||a.src;a.fa&&jt(a),a=f.call(g,u)}return a}function Fa(a){return a=a[gs],a instanceof Wt?a:null}var Ba="__closure_events_fn_"+(1e9*Math.random()>>>0);function uu(a){return typeof a=="function"?a:(a[Ba]||(a[Ba]=function(u){return a.handleEvent(u)}),a[Ba])}function He(){Y.call(this),this.i=new Wt(this),this.M=this,this.F=null}C(He,Y),He.prototype[we]=!0,He.prototype.removeEventListener=function(a,u,f,g){_t(this,a,u,f,g)};function tt(a,u){var f,g=a.F;if(g)for(f=[];g;g=g.F)f.push(g);if(a=a.M,g=u.type||u,typeof u=="string")u=new ee(u,a);else if(u instanceof ee)u.target=u.target||a;else{var b=u;u=new ee(g,a),w(u,b)}if(b=!0,f)for(var S=f.length-1;0<=S;S--){var O=u.g=f[S];b=Lr(O,g,!0,u)&&b}if(O=u.g=a,b=Lr(O,g,!0,u)&&b,b=Lr(O,g,!1,u)&&b,f)for(S=0;S<f.length;S++)O=u.g=f[S],b=Lr(O,g,!1,u)&&b}He.prototype.N=function(){if(He.aa.N.call(this),this.i){var a=this.i,u;for(u in a.g){for(var f=a.g[u],g=0;g<f.length;g++)un(f[g]);delete a.g[u],a.h--}}this.F=null},He.prototype.K=function(a,u,f,g){return this.i.add(String(a),u,!1,f,g)},He.prototype.L=function(a,u,f,g){return this.i.add(String(a),u,!0,f,g)};function Lr(a,u,f,g){if(u=a.i.g[String(u)],!u)return!0;u=u.concat();for(var b=!0,S=0;S<u.length;++S){var O=u[S];if(O&&!O.da&&O.capture==f){var pe=O.listener,Fe=O.ha||O.src;O.fa&&ps(a.i,O),b=pe.call(Fe,g)!==!1&&b}}return b&&!g.defaultPrevented}function du(a,u,f){if(typeof a=="function")f&&(a=m(a,f));else if(a&&typeof a.handleEvent=="function")a=m(a.handleEvent,a);else throw Error("Invalid listener argument");return 2147483647<Number(u)?-1:l.setTimeout(a,u||0)}function fu(a){a.g=du(()=>{a.g=null,a.i&&(a.i=!1,fu(a))},a.l);const u=a.h;a.h=null,a.m.apply(null,u)}class yy extends Y{constructor(u,f){super(),this.m=u,this.l=f,this.h=null,this.i=!1,this.g=null}j(u){this.h=arguments,this.g?this.i=!0:fu(this)}N(){super.N(),this.g&&(l.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function ai(a){Y.call(this),this.h=a,this.g={}}C(ai,Y);var pu=[];function mu(a){de(a.g,function(u,f){this.g.hasOwnProperty(f)&&jt(u)},a),a.g={}}ai.prototype.N=function(){ai.aa.N.call(this),mu(this)},ai.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var Ua=l.JSON.stringify,vy=l.JSON.parse,Ey=class{stringify(a){return l.JSON.stringify(a,void 0)}parse(a){return l.JSON.parse(a,void 0)}};function qa(){}qa.prototype.h=null;function gu(a){return a.h||(a.h=a.i())}function _u(){}var li={OPEN:"a",kb:"b",Ja:"c",wb:"d"};function Wa(){ee.call(this,"d")}C(Wa,ee);function $a(){ee.call(this,"c")}C($a,ee);var Un={},yu=null;function xr(){return yu=yu||new He}Un.La="serverreachability";function vu(a){ee.call(this,Un.La,a)}C(vu,ee);function ci(a){const u=xr();tt(u,new vu(u))}Un.STAT_EVENT="statevent";function Eu(a,u){ee.call(this,Un.STAT_EVENT,a),this.stat=u}C(Eu,ee);function nt(a){const u=xr();tt(u,new Eu(u,a))}Un.Ma="timingevent";function wu(a,u){ee.call(this,Un.Ma,a),this.size=u}C(wu,ee);function hi(a,u){if(typeof a!="function")throw Error("Fn must not be null and must be a function");return l.setTimeout(function(){a()},u)}function ui(){this.g=!0}ui.prototype.xa=function(){this.g=!1};function wy(a,u,f,g,b,S){a.info(function(){if(a.g)if(S)for(var O="",pe=S.split("&"),Fe=0;Fe<pe.length;Fe++){var ae=pe[Fe].split("=");if(1<ae.length){var Ke=ae[0];ae=ae[1];var Qe=Ke.split("_");O=2<=Qe.length&&Qe[1]=="type"?O+(Ke+"="+ae+"&"):O+(Ke+"=redacted&")}}else O=null;else O=S;return"XMLHTTP REQ ("+g+") [attempt "+b+"]: "+u+`
`+f+`
`+O})}function Ty(a,u,f,g,b,S,O){a.info(function(){return"XMLHTTP RESP ("+g+") [ attempt "+b+"]: "+u+`
`+f+`
`+S+" "+O})}function ys(a,u,f,g){a.info(function(){return"XMLHTTP TEXT ("+u+"): "+Cy(a,f)+(g?" "+g:"")})}function Iy(a,u){a.info(function(){return"TIMEOUT: "+u})}ui.prototype.info=function(){};function Cy(a,u){if(!a.g)return u;if(!u)return null;try{var f=JSON.parse(u);if(f){for(a=0;a<f.length;a++)if(Array.isArray(f[a])){var g=f[a];if(!(2>g.length)){var b=g[1];if(Array.isArray(b)&&!(1>b.length)){var S=b[0];if(S!="noop"&&S!="stop"&&S!="close")for(var O=1;O<b.length;O++)b[O]=""}}}}return Ua(f)}catch{return u}}var Or={NO_ERROR:0,gb:1,tb:2,sb:3,nb:4,rb:5,ub:6,Ia:7,TIMEOUT:8,xb:9},Tu={lb:"complete",Hb:"success",Ja:"error",Ia:"abort",zb:"ready",Ab:"readystatechange",TIMEOUT:"timeout",vb:"incrementaldata",yb:"progress",ob:"downloadprogress",Pb:"uploadprogress"},ja;function Mr(){}C(Mr,qa),Mr.prototype.g=function(){return new XMLHttpRequest},Mr.prototype.i=function(){return{}},ja=new Mr;function dn(a,u,f,g){this.j=a,this.i=u,this.l=f,this.R=g||1,this.U=new ai(this),this.I=45e3,this.H=null,this.o=!1,this.m=this.A=this.v=this.L=this.F=this.S=this.B=null,this.D=[],this.g=null,this.C=0,this.s=this.u=null,this.X=-1,this.J=!1,this.O=0,this.M=null,this.W=this.K=this.T=this.P=!1,this.h=new Iu}function Iu(){this.i=null,this.g="",this.h=!1}var Cu={},za={};function Ga(a,u,f){a.L=1,a.v=Ur(zt(u)),a.m=f,a.P=!0,bu(a,null)}function bu(a,u){a.F=Date.now(),Vr(a),a.A=zt(a.v);var f=a.A,g=a.R;Array.isArray(g)||(g=[String(g)]),Bu(f.i,"t",g),a.C=0,f=a.j.J,a.h=new Iu,a.g=sd(a.j,f?u:null,!a.m),0<a.O&&(a.M=new yy(m(a.Y,a,a.g),a.O)),u=a.U,f=a.g,g=a.ca;var b="readystatechange";Array.isArray(b)||(b&&(pu[0]=b.toString()),b=pu);for(var S=0;S<b.length;S++){var O=Bn(f,b[S],g||u.handleEvent,!1,u.h||u);if(!O)break;u.g[O.key]=O}u=a.H?_(a.H):{},a.m?(a.u||(a.u="POST"),u["Content-Type"]="application/x-www-form-urlencoded",a.g.ea(a.A,a.u,a.m,u)):(a.u="GET",a.g.ea(a.A,a.u,null,u)),ci(),wy(a.i,a.u,a.A,a.l,a.R,a.m)}dn.prototype.ca=function(a){a=a.target;const u=this.M;u&&Gt(a)==3?u.j():this.Y(a)},dn.prototype.Y=function(a){try{if(a==this.g)e:{const Qe=Gt(this.g);var u=this.g.Ba();const ws=this.g.Z();if(!(3>Qe)&&(Qe!=3||this.g&&(this.h.h||this.g.oa()||Gu(this.g)))){this.J||Qe!=4||u==7||(u==8||0>=ws?ci(3):ci(2)),Ha(this);var f=this.g.Z();this.X=f;t:if(Ru(this)){var g=Gu(this.g);a="";var b=g.length,S=Gt(this.g)==4;if(!this.h.i){if(typeof TextDecoder>"u"){qn(this),di(this);var O="";break t}this.h.i=new l.TextDecoder}for(u=0;u<b;u++)this.h.h=!0,a+=this.h.i.decode(g[u],{stream:!(S&&u==b-1)});g.length=0,this.h.g+=a,this.C=0,O=this.h.g}else O=this.g.oa();if(this.o=f==200,Ty(this.i,this.u,this.A,this.l,this.R,Qe,f),this.o){if(this.T&&!this.K){t:{if(this.g){var pe,Fe=this.g;if((pe=Fe.g?Fe.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!q(pe)){var ae=pe;break t}}ae=null}if(f=ae)ys(this.i,this.l,f,"Initial handshake response via X-HTTP-Initial-Response"),this.K=!0,Ka(this,f);else{this.o=!1,this.s=3,nt(12),qn(this),di(this);break e}}if(this.P){f=!0;let yt;for(;!this.J&&this.C<O.length;)if(yt=by(this,O),yt==za){Qe==4&&(this.s=4,nt(14),f=!1),ys(this.i,this.l,null,"[Incomplete Response]");break}else if(yt==Cu){this.s=4,nt(15),ys(this.i,this.l,O,"[Invalid Chunk]"),f=!1;break}else ys(this.i,this.l,yt,null),Ka(this,yt);if(Ru(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),Qe!=4||O.length!=0||this.h.h||(this.s=1,nt(16),f=!1),this.o=this.o&&f,!f)ys(this.i,this.l,O,"[Invalid Chunked Response]"),qn(this),di(this);else if(0<O.length&&!this.W){this.W=!0;var Ke=this.j;Ke.g==this&&Ke.ba&&!Ke.M&&(Ke.j.info("Great, no buffering proxy detected. Bytes received: "+O.length),el(Ke),Ke.M=!0,nt(11))}}else ys(this.i,this.l,O,null),Ka(this,O);Qe==4&&qn(this),this.o&&!this.J&&(Qe==4?Zu(this.j,this):(this.o=!1,Vr(this)))}else Wy(this.g),f==400&&0<O.indexOf("Unknown SID")?(this.s=3,nt(12)):(this.s=0,nt(13)),qn(this),di(this)}}}catch{}finally{}};function Ru(a){return a.g?a.u=="GET"&&a.L!=2&&a.j.Ca:!1}function by(a,u){var f=a.C,g=u.indexOf(`
`,f);return g==-1?za:(f=Number(u.substring(f,g)),isNaN(f)?Cu:(g+=1,g+f>u.length?za:(u=u.slice(g,g+f),a.C=g+f,u)))}dn.prototype.cancel=function(){this.J=!0,qn(this)};function Vr(a){a.S=Date.now()+a.I,Su(a,a.I)}function Su(a,u){if(a.B!=null)throw Error("WatchDog timer not null");a.B=hi(m(a.ba,a),u)}function Ha(a){a.B&&(l.clearTimeout(a.B),a.B=null)}dn.prototype.ba=function(){this.B=null;const a=Date.now();0<=a-this.S?(Iy(this.i,this.A),this.L!=2&&(ci(),nt(17)),qn(this),this.s=2,di(this)):Su(this,this.S-a)};function di(a){a.j.G==0||a.J||Zu(a.j,a)}function qn(a){Ha(a);var u=a.M;u&&typeof u.ma=="function"&&u.ma(),a.M=null,mu(a.U),a.g&&(u=a.g,a.g=null,u.abort(),u.ma())}function Ka(a,u){try{var f=a.j;if(f.G!=0&&(f.g==a||Qa(f.h,a))){if(!a.K&&Qa(f.h,a)&&f.G==3){try{var g=f.Da.g.parse(u)}catch{g=null}if(Array.isArray(g)&&g.length==3){var b=g;if(b[0]==0){e:if(!f.u){if(f.g)if(f.g.F+3e3<a.F)Gr(f),jr(f);else break e;Za(f),nt(18)}}else f.za=b[1],0<f.za-f.T&&37500>b[2]&&f.F&&f.v==0&&!f.C&&(f.C=hi(m(f.Za,f),6e3));if(1>=Pu(f.h)&&f.ca){try{f.ca()}catch{}f.ca=void 0}}else $n(f,11)}else if((a.K||f.g==a)&&Gr(f),!q(u))for(b=f.Da.g.parse(u),u=0;u<b.length;u++){let ae=b[u];if(f.T=ae[0],ae=ae[1],f.G==2)if(ae[0]=="c"){f.K=ae[1],f.ia=ae[2];const Ke=ae[3];Ke!=null&&(f.la=Ke,f.j.info("VER="+f.la));const Qe=ae[4];Qe!=null&&(f.Aa=Qe,f.j.info("SVER="+f.Aa));const ws=ae[5];ws!=null&&typeof ws=="number"&&0<ws&&(g=1.5*ws,f.L=g,f.j.info("backChannelRequestTimeoutMs_="+g)),g=f;const yt=a.g;if(yt){const Kr=yt.g?yt.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(Kr){var S=g.h;S.g||Kr.indexOf("spdy")==-1&&Kr.indexOf("quic")==-1&&Kr.indexOf("h2")==-1||(S.j=S.l,S.g=new Set,S.h&&(Ya(S,S.h),S.h=null))}if(g.D){const tl=yt.g?yt.g.getResponseHeader("X-HTTP-Session-Id"):null;tl&&(g.ya=tl,Ee(g.I,g.D,tl))}}f.G=3,f.l&&f.l.ua(),f.ba&&(f.R=Date.now()-a.F,f.j.info("Handshake RTT: "+f.R+"ms")),g=f;var O=a;if(g.qa=nd(g,g.J?g.ia:null,g.W),O.K){Nu(g.h,O);var pe=O,Fe=g.L;Fe&&(pe.I=Fe),pe.B&&(Ha(pe),Vr(pe)),g.g=O}else Ju(g);0<f.i.length&&zr(f)}else ae[0]!="stop"&&ae[0]!="close"||$n(f,7);else f.G==3&&(ae[0]=="stop"||ae[0]=="close"?ae[0]=="stop"?$n(f,7):Xa(f):ae[0]!="noop"&&f.l&&f.l.ta(ae),f.v=0)}}ci(4)}catch{}}var Ry=class{constructor(a,u){this.g=a,this.map=u}};function Au(a){this.l=a||10,l.PerformanceNavigationTiming?(a=l.performance.getEntriesByType("navigation"),a=0<a.length&&(a[0].nextHopProtocol=="hq"||a[0].nextHopProtocol=="h2")):a=!!(l.chrome&&l.chrome.loadTimes&&l.chrome.loadTimes()&&l.chrome.loadTimes().wasFetchedViaSpdy),this.j=a?this.l:1,this.g=null,1<this.j&&(this.g=new Set),this.h=null,this.i=[]}function ku(a){return a.h?!0:a.g?a.g.size>=a.j:!1}function Pu(a){return a.h?1:a.g?a.g.size:0}function Qa(a,u){return a.h?a.h==u:a.g?a.g.has(u):!1}function Ya(a,u){a.g?a.g.add(u):a.h=u}function Nu(a,u){a.h&&a.h==u?a.h=null:a.g&&a.g.has(u)&&a.g.delete(u)}Au.prototype.cancel=function(){if(this.i=Du(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const a of this.g.values())a.cancel();this.g.clear()}};function Du(a){if(a.h!=null)return a.i.concat(a.h.D);if(a.g!=null&&a.g.size!==0){let u=a.i;for(const f of a.g.values())u=u.concat(f.D);return u}return A(a.i)}function Sy(a){if(a.V&&typeof a.V=="function")return a.V();if(typeof Map<"u"&&a instanceof Map||typeof Set<"u"&&a instanceof Set)return Array.from(a.values());if(typeof a=="string")return a.split("");if(c(a)){for(var u=[],f=a.length,g=0;g<f;g++)u.push(a[g]);return u}u=[],f=0;for(g in a)u[f++]=a[g];return u}function Ay(a){if(a.na&&typeof a.na=="function")return a.na();if(!a.V||typeof a.V!="function"){if(typeof Map<"u"&&a instanceof Map)return Array.from(a.keys());if(!(typeof Set<"u"&&a instanceof Set)){if(c(a)||typeof a=="string"){var u=[];a=a.length;for(var f=0;f<a;f++)u.push(f);return u}u=[],f=0;for(const g in a)u[f++]=g;return u}}}function Lu(a,u){if(a.forEach&&typeof a.forEach=="function")a.forEach(u,void 0);else if(c(a)||typeof a=="string")Array.prototype.forEach.call(a,u,void 0);else for(var f=Ay(a),g=Sy(a),b=g.length,S=0;S<b;S++)u.call(void 0,g[S],f&&f[S],a)}var xu=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function ky(a,u){if(a){a=a.split("&");for(var f=0;f<a.length;f++){var g=a[f].indexOf("="),b=null;if(0<=g){var S=a[f].substring(0,g);b=a[f].substring(g+1)}else S=a[f];u(S,b?decodeURIComponent(b.replace(/\+/g," ")):"")}}}function Wn(a){if(this.g=this.o=this.j="",this.s=null,this.m=this.l="",this.h=!1,a instanceof Wn){this.h=a.h,Fr(this,a.j),this.o=a.o,this.g=a.g,Br(this,a.s),this.l=a.l;var u=a.i,f=new mi;f.i=u.i,u.g&&(f.g=new Map(u.g),f.h=u.h),Ou(this,f),this.m=a.m}else a&&(u=String(a).match(xu))?(this.h=!1,Fr(this,u[1]||"",!0),this.o=fi(u[2]||""),this.g=fi(u[3]||"",!0),Br(this,u[4]),this.l=fi(u[5]||"",!0),Ou(this,u[6]||"",!0),this.m=fi(u[7]||"")):(this.h=!1,this.i=new mi(null,this.h))}Wn.prototype.toString=function(){var a=[],u=this.j;u&&a.push(pi(u,Mu,!0),":");var f=this.g;return(f||u=="file")&&(a.push("//"),(u=this.o)&&a.push(pi(u,Mu,!0),"@"),a.push(encodeURIComponent(String(f)).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),f=this.s,f!=null&&a.push(":",String(f))),(f=this.l)&&(this.g&&f.charAt(0)!="/"&&a.push("/"),a.push(pi(f,f.charAt(0)=="/"?Dy:Ny,!0))),(f=this.i.toString())&&a.push("?",f),(f=this.m)&&a.push("#",pi(f,xy)),a.join("")};function zt(a){return new Wn(a)}function Fr(a,u,f){a.j=f?fi(u,!0):u,a.j&&(a.j=a.j.replace(/:$/,""))}function Br(a,u){if(u){if(u=Number(u),isNaN(u)||0>u)throw Error("Bad port number "+u);a.s=u}else a.s=null}function Ou(a,u,f){u instanceof mi?(a.i=u,Oy(a.i,a.h)):(f||(u=pi(u,Ly)),a.i=new mi(u,a.h))}function Ee(a,u,f){a.i.set(u,f)}function Ur(a){return Ee(a,"zx",Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^Date.now()).toString(36)),a}function fi(a,u){return a?u?decodeURI(a.replace(/%25/g,"%2525")):decodeURIComponent(a):""}function pi(a,u,f){return typeof a=="string"?(a=encodeURI(a).replace(u,Py),f&&(a=a.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),a):null}function Py(a){return a=a.charCodeAt(0),"%"+(a>>4&15).toString(16)+(a&15).toString(16)}var Mu=/[#\/\?@]/g,Ny=/[#\?:]/g,Dy=/[#\?]/g,Ly=/[#\?@]/g,xy=/#/g;function mi(a,u){this.h=this.g=null,this.i=a||null,this.j=!!u}function fn(a){a.g||(a.g=new Map,a.h=0,a.i&&ky(a.i,function(u,f){a.add(decodeURIComponent(u.replace(/\+/g," ")),f)}))}n=mi.prototype,n.add=function(a,u){fn(this),this.i=null,a=vs(this,a);var f=this.g.get(a);return f||this.g.set(a,f=[]),f.push(u),this.h+=1,this};function Vu(a,u){fn(a),u=vs(a,u),a.g.has(u)&&(a.i=null,a.h-=a.g.get(u).length,a.g.delete(u))}function Fu(a,u){return fn(a),u=vs(a,u),a.g.has(u)}n.forEach=function(a,u){fn(this),this.g.forEach(function(f,g){f.forEach(function(b){a.call(u,b,g,this)},this)},this)},n.na=function(){fn(this);const a=Array.from(this.g.values()),u=Array.from(this.g.keys()),f=[];for(let g=0;g<u.length;g++){const b=a[g];for(let S=0;S<b.length;S++)f.push(u[g])}return f},n.V=function(a){fn(this);let u=[];if(typeof a=="string")Fu(this,a)&&(u=u.concat(this.g.get(vs(this,a))));else{a=Array.from(this.g.values());for(let f=0;f<a.length;f++)u=u.concat(a[f])}return u},n.set=function(a,u){return fn(this),this.i=null,a=vs(this,a),Fu(this,a)&&(this.h-=this.g.get(a).length),this.g.set(a,[u]),this.h+=1,this},n.get=function(a,u){return a?(a=this.V(a),0<a.length?String(a[0]):u):u};function Bu(a,u,f){Vu(a,u),0<f.length&&(a.i=null,a.g.set(vs(a,u),A(f)),a.h+=f.length)}n.toString=function(){if(this.i)return this.i;if(!this.g)return"";const a=[],u=Array.from(this.g.keys());for(var f=0;f<u.length;f++){var g=u[f];const S=encodeURIComponent(String(g)),O=this.V(g);for(g=0;g<O.length;g++){var b=S;O[g]!==""&&(b+="="+encodeURIComponent(String(O[g]))),a.push(b)}}return this.i=a.join("&")};function vs(a,u){return u=String(u),a.j&&(u=u.toLowerCase()),u}function Oy(a,u){u&&!a.j&&(fn(a),a.i=null,a.g.forEach(function(f,g){var b=g.toLowerCase();g!=b&&(Vu(this,g),Bu(this,b,f))},a)),a.j=u}function My(a,u){const f=new ui;if(l.Image){const g=new Image;g.onload=E(pn,f,"TestLoadImage: loaded",!0,u,g),g.onerror=E(pn,f,"TestLoadImage: error",!1,u,g),g.onabort=E(pn,f,"TestLoadImage: abort",!1,u,g),g.ontimeout=E(pn,f,"TestLoadImage: timeout",!1,u,g),l.setTimeout(function(){g.ontimeout&&g.ontimeout()},1e4),g.src=a}else u(!1)}function Vy(a,u){const f=new ui,g=new AbortController,b=setTimeout(()=>{g.abort(),pn(f,"TestPingServer: timeout",!1,u)},1e4);fetch(a,{signal:g.signal}).then(S=>{clearTimeout(b),S.ok?pn(f,"TestPingServer: ok",!0,u):pn(f,"TestPingServer: server error",!1,u)}).catch(()=>{clearTimeout(b),pn(f,"TestPingServer: error",!1,u)})}function pn(a,u,f,g,b){try{b&&(b.onload=null,b.onerror=null,b.onabort=null,b.ontimeout=null),g(f)}catch{}}function Fy(){this.g=new Ey}function By(a,u,f){const g=f||"";try{Lu(a,function(b,S){let O=b;h(b)&&(O=Ua(b)),u.push(g+S+"="+encodeURIComponent(O))})}catch(b){throw u.push(g+"type="+encodeURIComponent("_badmap")),b}}function qr(a){this.l=a.Ub||null,this.j=a.eb||!1}C(qr,qa),qr.prototype.g=function(){return new Wr(this.l,this.j)},qr.prototype.i=function(a){return function(){return a}}({});function Wr(a,u){He.call(this),this.D=a,this.o=u,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.u=new Headers,this.h=null,this.B="GET",this.A="",this.g=!1,this.v=this.j=this.l=null}C(Wr,He),n=Wr.prototype,n.open=function(a,u){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.B=a,this.A=u,this.readyState=1,_i(this)},n.send=function(a){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");this.g=!0;const u={headers:this.u,method:this.B,credentials:this.m,cache:void 0};a&&(u.body=a),(this.D||l).fetch(new Request(this.A,u)).then(this.Sa.bind(this),this.ga.bind(this))},n.abort=function(){this.response=this.responseText="",this.u=new Headers,this.status=0,this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),1<=this.readyState&&this.g&&this.readyState!=4&&(this.g=!1,gi(this)),this.readyState=0},n.Sa=function(a){if(this.g&&(this.l=a,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=a.headers,this.readyState=2,_i(this)),this.g&&(this.readyState=3,_i(this),this.g)))if(this.responseType==="arraybuffer")a.arrayBuffer().then(this.Qa.bind(this),this.ga.bind(this));else if(typeof l.ReadableStream<"u"&&"body"in a){if(this.j=a.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.v=new TextDecoder;Uu(this)}else a.text().then(this.Ra.bind(this),this.ga.bind(this))};function Uu(a){a.j.read().then(a.Pa.bind(a)).catch(a.ga.bind(a))}n.Pa=function(a){if(this.g){if(this.o&&a.value)this.response.push(a.value);else if(!this.o){var u=a.value?a.value:new Uint8Array(0);(u=this.v.decode(u,{stream:!a.done}))&&(this.response=this.responseText+=u)}a.done?gi(this):_i(this),this.readyState==3&&Uu(this)}},n.Ra=function(a){this.g&&(this.response=this.responseText=a,gi(this))},n.Qa=function(a){this.g&&(this.response=a,gi(this))},n.ga=function(){this.g&&gi(this)};function gi(a){a.readyState=4,a.l=null,a.j=null,a.v=null,_i(a)}n.setRequestHeader=function(a,u){this.u.append(a,u)},n.getResponseHeader=function(a){return this.h&&this.h.get(a.toLowerCase())||""},n.getAllResponseHeaders=function(){if(!this.h)return"";const a=[],u=this.h.entries();for(var f=u.next();!f.done;)f=f.value,a.push(f[0]+": "+f[1]),f=u.next();return a.join(`\r
`)};function _i(a){a.onreadystatechange&&a.onreadystatechange.call(a)}Object.defineProperty(Wr.prototype,"withCredentials",{get:function(){return this.m==="include"},set:function(a){this.m=a?"include":"same-origin"}});function qu(a){let u="";return de(a,function(f,g){u+=g,u+=":",u+=f,u+=`\r
`}),u}function Ja(a,u,f){e:{for(g in f){var g=!1;break e}g=!0}g||(f=qu(f),typeof a=="string"?f!=null&&encodeURIComponent(String(f)):Ee(a,u,f))}function Ie(a){He.call(this),this.headers=new Map,this.o=a||null,this.h=!1,this.v=this.g=null,this.D="",this.m=0,this.l="",this.j=this.B=this.u=this.A=!1,this.I=null,this.H="",this.J=!1}C(Ie,He);var Uy=/^https?$/i,qy=["POST","PUT"];n=Ie.prototype,n.Ha=function(a){this.J=a},n.ea=function(a,u,f,g){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+a);u=u?u.toUpperCase():"GET",this.D=a,this.l="",this.m=0,this.A=!1,this.h=!0,this.g=this.o?this.o.g():ja.g(),this.v=this.o?gu(this.o):gu(ja),this.g.onreadystatechange=m(this.Ea,this);try{this.B=!0,this.g.open(u,String(a),!0),this.B=!1}catch(S){Wu(this,S);return}if(a=f||"",f=new Map(this.headers),g)if(Object.getPrototypeOf(g)===Object.prototype)for(var b in g)f.set(b,g[b]);else if(typeof g.keys=="function"&&typeof g.get=="function")for(const S of g.keys())f.set(S,g.get(S));else throw Error("Unknown input type for opt_headers: "+String(g));g=Array.from(f.keys()).find(S=>S.toLowerCase()=="content-type"),b=l.FormData&&a instanceof l.FormData,!(0<=Array.prototype.indexOf.call(qy,u,void 0))||g||b||f.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[S,O]of f)this.g.setRequestHeader(S,O);this.H&&(this.g.responseType=this.H),"withCredentials"in this.g&&this.g.withCredentials!==this.J&&(this.g.withCredentials=this.J);try{zu(this),this.u=!0,this.g.send(a),this.u=!1}catch(S){Wu(this,S)}};function Wu(a,u){a.h=!1,a.g&&(a.j=!0,a.g.abort(),a.j=!1),a.l=u,a.m=5,$u(a),$r(a)}function $u(a){a.A||(a.A=!0,tt(a,"complete"),tt(a,"error"))}n.abort=function(a){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.m=a||7,tt(this,"complete"),tt(this,"abort"),$r(this))},n.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),$r(this,!0)),Ie.aa.N.call(this)},n.Ea=function(){this.s||(this.B||this.u||this.j?ju(this):this.bb())},n.bb=function(){ju(this)};function ju(a){if(a.h&&typeof o<"u"&&(!a.v[1]||Gt(a)!=4||a.Z()!=2)){if(a.u&&Gt(a)==4)du(a.Ea,0,a);else if(tt(a,"readystatechange"),Gt(a)==4){a.h=!1;try{const O=a.Z();e:switch(O){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var u=!0;break e;default:u=!1}var f;if(!(f=u)){var g;if(g=O===0){var b=String(a.D).match(xu)[1]||null;!b&&l.self&&l.self.location&&(b=l.self.location.protocol.slice(0,-1)),g=!Uy.test(b?b.toLowerCase():"")}f=g}if(f)tt(a,"complete"),tt(a,"success");else{a.m=6;try{var S=2<Gt(a)?a.g.statusText:""}catch{S=""}a.l=S+" ["+a.Z()+"]",$u(a)}}finally{$r(a)}}}}function $r(a,u){if(a.g){zu(a);const f=a.g,g=a.v[0]?()=>{}:null;a.g=null,a.v=null,u||tt(a,"ready");try{f.onreadystatechange=g}catch{}}}function zu(a){a.I&&(l.clearTimeout(a.I),a.I=null)}n.isActive=function(){return!!this.g};function Gt(a){return a.g?a.g.readyState:0}n.Z=function(){try{return 2<Gt(this)?this.g.status:-1}catch{return-1}},n.oa=function(){try{return this.g?this.g.responseText:""}catch{return""}},n.Oa=function(a){if(this.g){var u=this.g.responseText;return a&&u.indexOf(a)==0&&(u=u.substring(a.length)),vy(u)}};function Gu(a){try{if(!a.g)return null;if("response"in a.g)return a.g.response;switch(a.H){case"":case"text":return a.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in a.g)return a.g.mozResponseArrayBuffer}return null}catch{return null}}function Wy(a){const u={};a=(a.g&&2<=Gt(a)&&a.g.getAllResponseHeaders()||"").split(`\r
`);for(let g=0;g<a.length;g++){if(q(a[g]))continue;var f=T(a[g]);const b=f[0];if(f=f[1],typeof f!="string")continue;f=f.trim();const S=u[b]||[];u[b]=S,S.push(f)}I(u,function(g){return g.join(", ")})}n.Ba=function(){return this.m},n.Ka=function(){return typeof this.l=="string"?this.l:String(this.l)};function yi(a,u,f){return f&&f.internalChannelParams&&f.internalChannelParams[a]||u}function Hu(a){this.Aa=0,this.i=[],this.j=new ui,this.ia=this.qa=this.I=this.W=this.g=this.ya=this.D=this.H=this.m=this.S=this.o=null,this.Ya=this.U=0,this.Va=yi("failFast",!1,a),this.F=this.C=this.u=this.s=this.l=null,this.X=!0,this.za=this.T=-1,this.Y=this.v=this.B=0,this.Ta=yi("baseRetryDelayMs",5e3,a),this.cb=yi("retryDelaySeedMs",1e4,a),this.Wa=yi("forwardChannelMaxRetries",2,a),this.wa=yi("forwardChannelRequestTimeoutMs",2e4,a),this.pa=a&&a.xmlHttpFactory||void 0,this.Xa=a&&a.Tb||void 0,this.Ca=a&&a.useFetchStreams||!1,this.L=void 0,this.J=a&&a.supportsCrossDomainXhr||!1,this.K="",this.h=new Au(a&&a.concurrentRequestLimit),this.Da=new Fy,this.P=a&&a.fastHandshake||!1,this.O=a&&a.encodeInitMessageHeaders||!1,this.P&&this.O&&(this.O=!1),this.Ua=a&&a.Rb||!1,a&&a.xa&&this.j.xa(),a&&a.forceLongPolling&&(this.X=!1),this.ba=!this.P&&this.X&&a&&a.detectBufferingProxy||!1,this.ja=void 0,a&&a.longPollingTimeout&&0<a.longPollingTimeout&&(this.ja=a.longPollingTimeout),this.ca=void 0,this.R=0,this.M=!1,this.ka=this.A=null}n=Hu.prototype,n.la=8,n.G=1,n.connect=function(a,u,f,g){nt(0),this.W=a,this.H=u||{},f&&g!==void 0&&(this.H.OSID=f,this.H.OAID=g),this.F=this.X,this.I=nd(this,null,this.W),zr(this)};function Xa(a){if(Ku(a),a.G==3){var u=a.U++,f=zt(a.I);if(Ee(f,"SID",a.K),Ee(f,"RID",u),Ee(f,"TYPE","terminate"),vi(a,f),u=new dn(a,a.j,u),u.L=2,u.v=Ur(zt(f)),f=!1,l.navigator&&l.navigator.sendBeacon)try{f=l.navigator.sendBeacon(u.v.toString(),"")}catch{}!f&&l.Image&&(new Image().src=u.v,f=!0),f||(u.g=sd(u.j,null),u.g.ea(u.v)),u.F=Date.now(),Vr(u)}td(a)}function jr(a){a.g&&(el(a),a.g.cancel(),a.g=null)}function Ku(a){jr(a),a.u&&(l.clearTimeout(a.u),a.u=null),Gr(a),a.h.cancel(),a.s&&(typeof a.s=="number"&&l.clearTimeout(a.s),a.s=null)}function zr(a){if(!ku(a.h)&&!a.s){a.s=!0;var u=a.Ga;St||fs(),At||(St(),At=!0),qt.add(u,a),a.B=0}}function $y(a,u){return Pu(a.h)>=a.h.j-(a.s?1:0)?!1:a.s?(a.i=u.D.concat(a.i),!0):a.G==1||a.G==2||a.B>=(a.Va?0:a.Wa)?!1:(a.s=hi(m(a.Ga,a,u),ed(a,a.B)),a.B++,!0)}n.Ga=function(a){if(this.s)if(this.s=null,this.G==1){if(!a){this.U=Math.floor(1e5*Math.random()),a=this.U++;const b=new dn(this,this.j,a);let S=this.o;if(this.S&&(S?(S=_(S),w(S,this.S)):S=this.S),this.m!==null||this.O||(b.H=S,S=null),this.P)e:{for(var u=0,f=0;f<this.i.length;f++){t:{var g=this.i[f];if("__data__"in g.map&&(g=g.map.__data__,typeof g=="string")){g=g.length;break t}g=void 0}if(g===void 0)break;if(u+=g,4096<u){u=f;break e}if(u===4096||f===this.i.length-1){u=f+1;break e}}u=1e3}else u=1e3;u=Yu(this,b,u),f=zt(this.I),Ee(f,"RID",a),Ee(f,"CVER",22),this.D&&Ee(f,"X-HTTP-Session-Id",this.D),vi(this,f),S&&(this.O?u="headers="+encodeURIComponent(String(qu(S)))+"&"+u:this.m&&Ja(f,this.m,S)),Ya(this.h,b),this.Ua&&Ee(f,"TYPE","init"),this.P?(Ee(f,"$req",u),Ee(f,"SID","null"),b.T=!0,Ga(b,f,null)):Ga(b,f,u),this.G=2}}else this.G==3&&(a?Qu(this,a):this.i.length==0||ku(this.h)||Qu(this))};function Qu(a,u){var f;u?f=u.l:f=a.U++;const g=zt(a.I);Ee(g,"SID",a.K),Ee(g,"RID",f),Ee(g,"AID",a.T),vi(a,g),a.m&&a.o&&Ja(g,a.m,a.o),f=new dn(a,a.j,f,a.B+1),a.m===null&&(f.H=a.o),u&&(a.i=u.D.concat(a.i)),u=Yu(a,f,1e3),f.I=Math.round(.5*a.wa)+Math.round(.5*a.wa*Math.random()),Ya(a.h,f),Ga(f,g,u)}function vi(a,u){a.H&&de(a.H,function(f,g){Ee(u,g,f)}),a.l&&Lu({},function(f,g){Ee(u,g,f)})}function Yu(a,u,f){f=Math.min(a.i.length,f);var g=a.l?m(a.l.Na,a.l,a):null;e:{var b=a.i;let S=-1;for(;;){const O=["count="+f];S==-1?0<f?(S=b[0].g,O.push("ofs="+S)):S=0:O.push("ofs="+S);let pe=!0;for(let Fe=0;Fe<f;Fe++){let ae=b[Fe].g;const Ke=b[Fe].map;if(ae-=S,0>ae)S=Math.max(0,b[Fe].g-100),pe=!1;else try{By(Ke,O,"req"+ae+"_")}catch{g&&g(Ke)}}if(pe){g=O.join("&");break e}}}return a=a.i.splice(0,f),u.D=a,g}function Ju(a){if(!a.g&&!a.u){a.Y=1;var u=a.Fa;St||fs(),At||(St(),At=!0),qt.add(u,a),a.v=0}}function Za(a){return a.g||a.u||3<=a.v?!1:(a.Y++,a.u=hi(m(a.Fa,a),ed(a,a.v)),a.v++,!0)}n.Fa=function(){if(this.u=null,Xu(this),this.ba&&!(this.M||this.g==null||0>=this.R)){var a=2*this.R;this.j.info("BP detection timer enabled: "+a),this.A=hi(m(this.ab,this),a)}},n.ab=function(){this.A&&(this.A=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.M=!0,nt(10),jr(this),Xu(this))};function el(a){a.A!=null&&(l.clearTimeout(a.A),a.A=null)}function Xu(a){a.g=new dn(a,a.j,"rpc",a.Y),a.m===null&&(a.g.H=a.o),a.g.O=0;var u=zt(a.qa);Ee(u,"RID","rpc"),Ee(u,"SID",a.K),Ee(u,"AID",a.T),Ee(u,"CI",a.F?"0":"1"),!a.F&&a.ja&&Ee(u,"TO",a.ja),Ee(u,"TYPE","xmlhttp"),vi(a,u),a.m&&a.o&&Ja(u,a.m,a.o),a.L&&(a.g.I=a.L);var f=a.g;a=a.ia,f.L=1,f.v=Ur(zt(u)),f.m=null,f.P=!0,bu(f,a)}n.Za=function(){this.C!=null&&(this.C=null,jr(this),Za(this),nt(19))};function Gr(a){a.C!=null&&(l.clearTimeout(a.C),a.C=null)}function Zu(a,u){var f=null;if(a.g==u){Gr(a),el(a),a.g=null;var g=2}else if(Qa(a.h,u))f=u.D,Nu(a.h,u),g=1;else return;if(a.G!=0){if(u.o)if(g==1){f=u.m?u.m.length:0,u=Date.now()-u.F;var b=a.B;g=xr(),tt(g,new wu(g,f)),zr(a)}else Ju(a);else if(b=u.s,b==3||b==0&&0<u.X||!(g==1&&$y(a,u)||g==2&&Za(a)))switch(f&&0<f.length&&(u=a.h,u.i=u.i.concat(f)),b){case 1:$n(a,5);break;case 4:$n(a,10);break;case 3:$n(a,6);break;default:$n(a,2)}}}function ed(a,u){let f=a.Ta+Math.floor(Math.random()*a.cb);return a.isActive()||(f*=2),f*u}function $n(a,u){if(a.j.info("Error code "+u),u==2){var f=m(a.fb,a),g=a.Xa;const b=!g;g=new Wn(g||"//www.google.com/images/cleardot.gif"),l.location&&l.location.protocol=="http"||Fr(g,"https"),Ur(g),b?My(g.toString(),f):Vy(g.toString(),f)}else nt(2);a.G=0,a.l&&a.l.sa(u),td(a),Ku(a)}n.fb=function(a){a?(this.j.info("Successfully pinged google.com"),nt(2)):(this.j.info("Failed to ping google.com"),nt(1))};function td(a){if(a.G=0,a.ka=[],a.l){const u=Du(a.h);(u.length!=0||a.i.length!=0)&&(k(a.ka,u),k(a.ka,a.i),a.h.i.length=0,A(a.i),a.i.length=0),a.l.ra()}}function nd(a,u,f){var g=f instanceof Wn?zt(f):new Wn(f);if(g.g!="")u&&(g.g=u+"."+g.g),Br(g,g.s);else{var b=l.location;g=b.protocol,u=u?u+"."+b.hostname:b.hostname,b=+b.port;var S=new Wn(null);g&&Fr(S,g),u&&(S.g=u),b&&Br(S,b),f&&(S.l=f),g=S}return f=a.D,u=a.ya,f&&u&&Ee(g,f,u),Ee(g,"VER",a.la),vi(a,g),g}function sd(a,u,f){if(u&&!a.J)throw Error("Can't create secondary domain capable XhrIo object.");return u=a.Ca&&!a.pa?new Ie(new qr({eb:f})):new Ie(a.pa),u.Ha(a.J),u}n.isActive=function(){return!!this.l&&this.l.isActive(this)};function id(){}n=id.prototype,n.ua=function(){},n.ta=function(){},n.sa=function(){},n.ra=function(){},n.isActive=function(){return!0},n.Na=function(){};function Hr(){}Hr.prototype.g=function(a,u){return new ht(a,u)};function ht(a,u){He.call(this),this.g=new Hu(u),this.l=a,this.h=u&&u.messageUrlParams||null,a=u&&u.messageHeaders||null,u&&u.clientProtocolHeaderRequired&&(a?a["X-Client-Protocol"]="webchannel":a={"X-Client-Protocol":"webchannel"}),this.g.o=a,a=u&&u.initMessageHeaders||null,u&&u.messageContentType&&(a?a["X-WebChannel-Content-Type"]=u.messageContentType:a={"X-WebChannel-Content-Type":u.messageContentType}),u&&u.va&&(a?a["X-WebChannel-Client-Profile"]=u.va:a={"X-WebChannel-Client-Profile":u.va}),this.g.S=a,(a=u&&u.Sb)&&!q(a)&&(this.g.m=a),this.v=u&&u.supportsCrossDomainXhr||!1,this.u=u&&u.sendRawJson||!1,(u=u&&u.httpSessionIdParam)&&!q(u)&&(this.g.D=u,a=this.h,a!==null&&u in a&&(a=this.h,u in a&&delete a[u])),this.j=new Es(this)}C(ht,He),ht.prototype.m=function(){this.g.l=this.j,this.v&&(this.g.J=!0),this.g.connect(this.l,this.h||void 0)},ht.prototype.close=function(){Xa(this.g)},ht.prototype.o=function(a){var u=this.g;if(typeof a=="string"){var f={};f.__data__=a,a=f}else this.u&&(f={},f.__data__=Ua(a),a=f);u.i.push(new Ry(u.Ya++,a)),u.G==3&&zr(u)},ht.prototype.N=function(){this.g.l=null,delete this.j,Xa(this.g),delete this.g,ht.aa.N.call(this)};function rd(a){Wa.call(this),a.__headers__&&(this.headers=a.__headers__,this.statusCode=a.__status__,delete a.__headers__,delete a.__status__);var u=a.__sm__;if(u){e:{for(const f in u){a=f;break e}a=void 0}(this.i=a)&&(a=this.i,u=u!==null&&a in u?u[a]:void 0),this.data=u}else this.data=a}C(rd,Wa);function od(){$a.call(this),this.status=1}C(od,$a);function Es(a){this.g=a}C(Es,id),Es.prototype.ua=function(){tt(this.g,"a")},Es.prototype.ta=function(a){tt(this.g,new rd(a))},Es.prototype.sa=function(a){tt(this.g,new od)},Es.prototype.ra=function(){tt(this.g,"b")},Hr.prototype.createWebChannel=Hr.prototype.g,ht.prototype.send=ht.prototype.o,ht.prototype.open=ht.prototype.m,ht.prototype.close=ht.prototype.close,vm=function(){return new Hr},ym=function(){return xr()},_m=Un,Wl={mb:0,pb:1,qb:2,Jb:3,Ob:4,Lb:5,Mb:6,Kb:7,Ib:8,Nb:9,PROXY:10,NOPROXY:11,Gb:12,Cb:13,Db:14,Bb:15,Eb:16,Fb:17,ib:18,hb:19,jb:20},Or.NO_ERROR=0,Or.TIMEOUT=8,Or.HTTP_ERROR=6,co=Or,Tu.COMPLETE="complete",gm=Tu,_u.EventType=li,li.OPEN="a",li.CLOSE="b",li.ERROR="c",li.MESSAGE="d",He.prototype.listen=He.prototype.K,Ni=_u,Ie.prototype.listenOnce=Ie.prototype.L,Ie.prototype.getLastError=Ie.prototype.Ka,Ie.prototype.getLastErrorCode=Ie.prototype.Ba,Ie.prototype.getStatus=Ie.prototype.Z,Ie.prototype.getResponseJson=Ie.prototype.Oa,Ie.prototype.getResponseText=Ie.prototype.oa,Ie.prototype.send=Ie.prototype.ea,Ie.prototype.setWithCredentials=Ie.prototype.Ha,mm=Ie}).apply(typeof Yr<"u"?Yr:typeof self<"u"?self:typeof window<"u"?window:{});const Od="@firebase/firestore";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const es=new oa("@firebase/firestore");function Ei(){return es.logLevel}function B(n,...e){if(es.logLevel<=ne.DEBUG){const t=e.map(Fc);es.debug(`Firestore (${Xs}): ${n}`,...t)}}function on(n,...e){if(es.logLevel<=ne.ERROR){const t=e.map(Fc);es.error(`Firestore (${Xs}): ${n}`,...t)}}function Vs(n,...e){if(es.logLevel<=ne.WARN){const t=e.map(Fc);es.warn(`Firestore (${Xs}): ${n}`,...t)}}function Fc(n){if(typeof n=="string")return n;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function j(n="Unexpected state"){const e=`FIRESTORE (${Xs}) INTERNAL ASSERTION FAILED: `+n;throw on(e),new Error(e)}function oe(n,e){n||j()}function K(n,e){return n}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Em{constructor(e,t){this.user=t,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${e}`)}}class RT{getToken(){return Promise.resolve(null)}invalidateToken(){}start(e,t){e.enqueueRetryable(()=>t(Je.UNAUTHENTICATED))}shutdown(){}}class ST{constructor(e){this.token=e,this.changeListener=null}getToken(){return Promise.resolve(this.token)}invalidateToken(){}start(e,t){this.changeListener=t,e.enqueueRetryable(()=>t(this.token.user))}shutdown(){this.changeListener=null}}class AT{constructor(e){this.t=e,this.currentUser=Je.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}start(e,t){oe(this.o===void 0);let s=this.i;const i=c=>this.i!==s?(s=this.i,t(c)):Promise.resolve();let r=new Lt;this.o=()=>{this.i++,this.currentUser=this.u(),r.resolve(),r=new Lt,e.enqueueRetryable(()=>i(this.currentUser))};const o=()=>{const c=r;e.enqueueRetryable(async()=>{await c.promise,await i(this.currentUser)})},l=c=>{B("FirebaseAuthCredentialsProvider","Auth detected"),this.auth=c,this.o&&(this.auth.addAuthTokenListener(this.o),o())};this.t.onInit(c=>l(c)),setTimeout(()=>{if(!this.auth){const c=this.t.getImmediate({optional:!0});c?l(c):(B("FirebaseAuthCredentialsProvider","Auth not yet detected"),r.resolve(),r=new Lt)}},0),o()}getToken(){const e=this.i,t=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(t).then(s=>this.i!==e?(B("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),this.getToken()):s?(oe(typeof s.accessToken=="string"),new Em(s.accessToken,this.currentUser)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.o&&this.auth.removeAuthTokenListener(this.o),this.o=void 0}u(){const e=this.auth&&this.auth.getUid();return oe(e===null||typeof e=="string"),new Je(e)}}class kT{constructor(e,t,s){this.l=e,this.h=t,this.P=s,this.type="FirstParty",this.user=Je.FIRST_PARTY,this.I=new Map}T(){return this.P?this.P():null}get headers(){this.I.set("X-Goog-AuthUser",this.l);const e=this.T();return e&&this.I.set("Authorization",e),this.h&&this.I.set("X-Goog-Iam-Authorization-Token",this.h),this.I}}class PT{constructor(e,t,s){this.l=e,this.h=t,this.P=s}getToken(){return Promise.resolve(new kT(this.l,this.h,this.P))}start(e,t){e.enqueueRetryable(()=>t(Je.FIRST_PARTY))}shutdown(){}invalidateToken(){}}class NT{constructor(e){this.value=e,this.type="AppCheck",this.headers=new Map,e&&e.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class DT{constructor(e){this.A=e,this.forceRefresh=!1,this.appCheck=null,this.R=null}start(e,t){oe(this.o===void 0);const s=r=>{r.error!=null&&B("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${r.error.message}`);const o=r.token!==this.R;return this.R=r.token,B("FirebaseAppCheckTokenProvider",`Received ${o?"new":"existing"} token.`),o?t(r.token):Promise.resolve()};this.o=r=>{e.enqueueRetryable(()=>s(r))};const i=r=>{B("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=r,this.o&&this.appCheck.addTokenListener(this.o)};this.A.onInit(r=>i(r)),setTimeout(()=>{if(!this.appCheck){const r=this.A.getImmediate({optional:!0});r?i(r):B("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}},0)}getToken(){const e=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(e).then(t=>t?(oe(typeof t.token=="string"),this.R=t.token,new NT(t.token)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.o&&this.appCheck.removeTokenListener(this.o),this.o=void 0}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class De{constructor(e,t){if(this.seconds=e,this.nanoseconds=t,t<0)throw new M(P.INVALID_ARGUMENT,"Timestamp nanoseconds out of range: "+t);if(t>=1e9)throw new M(P.INVALID_ARGUMENT,"Timestamp nanoseconds out of range: "+t);if(e<-62135596800)throw new M(P.INVALID_ARGUMENT,"Timestamp seconds out of range: "+e);if(e>=253402300800)throw new M(P.INVALID_ARGUMENT,"Timestamp seconds out of range: "+e)}static now(){return De.fromMillis(Date.now())}static fromDate(e){return De.fromMillis(e.getTime())}static fromMillis(e){const t=Math.floor(e/1e3),s=Math.floor(1e6*(e-1e3*t));return new De(t,s)}toDate(){return new Date(this.toMillis())}toMillis(){return 1e3*this.seconds+this.nanoseconds/1e6}_compareTo(e){return this.seconds===e.seconds?le(this.nanoseconds,e.nanoseconds):le(this.seconds,e.seconds)}isEqual(e){return e.seconds===this.seconds&&e.nanoseconds===this.nanoseconds}toString(){return"Timestamp(seconds="+this.seconds+", nanoseconds="+this.nanoseconds+")"}toJSON(){return{seconds:this.seconds,nanoseconds:this.nanoseconds}}valueOf(){const e=this.seconds- -62135596800;return String(e).padStart(12,"0")+"."+String(this.nanoseconds).padStart(9,"0")}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function pr(n){if(n.code!==P.FAILED_PRECONDITION||n.message!==FT)throw n;B("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bc{constructor(e,t){this.previousValue=e,t&&(t.sequenceNumberHandler=s=>this.ie(s),this.se=s=>t.writeSequenceNumber(s))}ie(e){return this.previousValue=Math.max(e,this.previousValue),this.previousValue}next(){const e=++this.previousValue;return this.se&&this.se(e),e}}Bc.oe=-1;function gr(n){return n==null}function No(n){return n===0&&1/n==-1/0}function qT(n){return typeof n=="number"&&Number.isInteger(n)&&!No(n)&&n<=Number.MAX_SAFE_INTEGER&&n>=Number.MIN_SAFE_INTEGER}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Uc(n){var e,t;return((t=(((e=n==null?void 0:n.mapValue)===null||e===void 0?void 0:e.fields)||{}).__type__)===null||t===void 0?void 0:t.stringValue)==="server_timestamp"}function qc(n){const e=n.mapValue.fields.__previous_value__;return Uc(e)?qc(e):e}function Ji(n){const e=Dn(n.mapValue.fields.__local_write_time__.timestampValue);return new De(e.seconds,e.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xr={mapValue:{}};function ns(n){return"nullValue"in n?0:"booleanValue"in n?1:"integerValue"in n||"doubleValue"in n?2:"timestampValue"in n?3:"stringValue"in n?5:"bytesValue"in n?6:"referenceValue"in n?7:"geoPointValue"in n?8:"arrayValue"in n?9:"mapValue"in n?Uc(n)?4:zT(n)?9007199254740991:jT(n)?10:11:j()}function Mt(n,e){if(n===e)return!0;const t=ns(n);if(t!==ns(e))return!1;switch(t){case 0:case 9007199254740991:return!0;case 1:return n.booleanValue===e.booleanValue;case 4:return Ji(n).isEqual(Ji(e));case 3:return function(i,r){if(typeof i.timestampValue=="string"&&typeof r.timestampValue=="string"&&i.timestampValue.length===r.timestampValue.length)return i.timestampValue===r.timestampValue;const o=Dn(i.timestampValue),l=Dn(r.timestampValue);return o.seconds===l.seconds&&o.nanos===l.nanos}(n,e);case 5:return n.stringValue===e.stringValue;case 6:return function(i,r){return ts(i.bytesValue).isEqual(ts(r.bytesValue))}(n,e);case 7:return n.referenceValue===e.referenceValue;case 8:return function(i,r){return be(i.geoPointValue.latitude)===be(r.geoPointValue.latitude)&&be(i.geoPointValue.longitude)===be(r.geoPointValue.longitude)}(n,e);case 2:return function(i,r){if("integerValue"in i&&"integerValue"in r)return be(i.integerValue)===be(r.integerValue);if("doubleValue"in i&&"doubleValue"in r){const o=be(i.doubleValue),l=be(r.doubleValue);return o===l?No(o)===No(l):isNaN(o)&&isNaN(l)}return!1}(n,e);case 9:return Fs(n.arrayValue.values||[],e.arrayValue.values||[],Mt);case 10:case 11:return function(i,r){const o=i.mapValue.fields||{},l=r.mapValue.fields||{};if(Md(o)!==Md(l))return!1;for(const c in o)if(o.hasOwnProperty(c)&&(l[c]===void 0||!Mt(o[c],l[c])))return!1;return!0}(n,e);default:return j()}}function Zi(n,e){return(n.values||[]).find(t=>Mt(t,e))!==void 0}function Bs(n,e){if(n===e)return 0;const t=ns(n),s=ns(e);if(t!==s)return le(t,s);switch(t){case 0:case 9007199254740991:return 0;case 1:return le(n.booleanValue,e.booleanValue);case 2:return function(r,o){const l=be(r.integerValue||r.doubleValue),c=be(o.integerValue||o.doubleValue);return l<c?-1:l>c?1:l===c?0:isNaN(l)?isNaN(c)?0:-1:1}(n,e);case 3:return Fd(n.timestampValue,e.timestampValue);case 4:return Fd(Ji(n),Ji(e));case 5:return le(n.stringValue,e.stringValue);case 6:return function(r,o){const l=ts(r),c=ts(o);return l.compareTo(c)}(n.bytesValue,e.bytesValue);case 7:return function(r,o){const l=r.split("/"),c=o.split("/");for(let h=0;h<l.length&&h<c.length;h++){const d=le(l[h],c[h]);if(d!==0)return d}return le(l.length,c.length)}(n.referenceValue,e.referenceValue);case 8:return function(r,o){const l=le(be(r.latitude),be(o.latitude));return l!==0?l:le(be(r.longitude),be(o.longitude))}(n.geoPointValue,e.geoPointValue);case 9:return Bd(n.arrayValue,e.arrayValue);case 10:return function(r,o){var l,c,h,d;const p=r.fields||{},m=o.fields||{},E=(l=p.value)===null||l===void 0?void 0:l.arrayValue,C=(c=m.value)===null||c===void 0?void 0:c.arrayValue,A=le(((h=E==null?void 0:E.values)===null||h===void 0?void 0:h.length)||0,((d=C==null?void 0:C.values)===null||d===void 0?void 0:d.length)||0);return A!==0?A:Bd(E,C)}(n.mapValue,e.mapValue);case 11:return function(r,o){if(r===Xr.mapValue&&o===Xr.mapValue)return 0;if(r===Xr.mapValue)return 1;if(o===Xr.mapValue)return-1;const l=r.fields||{},c=Object.keys(l),h=o.fields||{},d=Object.keys(h);c.sort(),d.sort();for(let p=0;p<c.length&&p<d.length;++p){const m=le(c[p],d[p]);if(m!==0)return m;const E=Bs(l[c[p]],h[d[p]]);if(E!==0)return E}return le(c.length,d.length)}(n.mapValue,e.mapValue);default:throw j()}}function Fd(n,e){if(typeof n=="string"&&typeof e=="string"&&n.length===e.length)return le(n,e);const t=Dn(n),s=Dn(e),i=le(t.seconds,s.seconds);return i!==0?i:le(t.nanos,s.nanos)}function Bd(n,e){const t=n.values||[],s=e.values||[];for(let i=0;i<t.length&&i<s.length;++i){const r=Bs(t[i],s[i]);if(r)return r}return le(t.length,s.length)}function Us(n){return jl(n)}function jl(n){return"nullValue"in n?"null":"booleanValue"in n?""+n.booleanValue:"integerValue"in n?""+n.integerValue:"doubleValue"in n?""+n.doubleValue:"timestampValue"in n?function(t){const s=Dn(t);return`time(${s.seconds},${s.nanos})`}(n.timestampValue):"stringValue"in n?n.stringValue:"bytesValue"in n?function(t){return ts(t).toBase64()}(n.bytesValue):"referenceValue"in n?function(t){return W.fromName(t).toString()}(n.referenceValue):"geoPointValue"in n?function(t){return`geo(${t.latitude},${t.longitude})`}(n.geoPointValue):"arrayValue"in n?function(t){let s="[",i=!0;for(const r of t.values||[])i?i=!1:s+=",",s+=jl(r);return s+"]"}(n.arrayValue):"mapValue"in n?function(t){const s=Object.keys(t.fields||{}).sort();let i="{",r=!0;for(const o of s)r?r=!1:i+=",",i+=`${o}:${jl(t.fields[o])}`;return i+"}"}(n.mapValue):j()}function Ud(n,e){return{referenceValue:`projects/${n.projectId}/databases/${n.database}/documents/${e.path.canonicalString()}`}}function zl(n){return!!n&&"integerValue"in n}function Wc(n){return!!n&&"arrayValue"in n}function qd(n){return!!n&&"nullValue"in n}function Wd(n){return!!n&&"doubleValue"in n&&isNaN(Number(n.doubleValue))}function ho(n){return!!n&&"mapValue"in n}function jT(n){var e,t;return((t=(((e=n==null?void 0:n.mapValue)===null||e===void 0?void 0:e.fields)||{}).__type__)===null||t===void 0?void 0:t.stringValue)==="__vector__"}function Mi(n){if(n.geoPointValue)return{geoPointValue:Object.assign({},n.geoPointValue)};if(n.timestampValue&&typeof n.timestampValue=="object")return{timestampValue:Object.assign({},n.timestampValue)};if(n.mapValue){const e={mapValue:{fields:{}}};return ls(n.mapValue.fields,(t,s)=>e.mapValue.fields[t]=Mi(s)),e}if(n.arrayValue){const e={arrayValue:{values:[]}};for(let t=0;t<(n.arrayValue.values||[]).length;++t)e.arrayValue.values[t]=Mi(n.arrayValue.values[t]);return e}return Object.assign({},n)}function zT(n){return(((n.mapValue||{}).fields||{}).__type__||{}).stringValue==="__max__"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class it{constructor(e){this.value=e}static empty(){return new it({mapValue:{}})}field(e){if(e.isEmpty())return this.value;{let t=this.value;for(let s=0;s<e.length-1;++s)if(t=(t.mapValue.fields||{})[e.get(s)],!ho(t))return null;return t=(t.mapValue.fields||{})[e.lastSegment()],t||null}}set(e,t){this.getFieldsMap(e.popLast())[e.lastSegment()]=Mi(t)}setAll(e){let t=qe.emptyPath(),s={},i=[];e.forEach((o,l)=>{if(!t.isImmediateParentOf(l)){const c=this.getFieldsMap(t);this.applyChanges(c,s,i),s={},i=[],t=l.popLast()}o?s[l.lastSegment()]=Mi(o):i.push(l.lastSegment())});const r=this.getFieldsMap(t);this.applyChanges(r,s,i)}delete(e){const t=this.field(e.popLast());ho(t)&&t.mapValue.fields&&delete t.mapValue.fields[e.lastSegment()]}isEqual(e){return Mt(this.value,e.value)}getFieldsMap(e){let t=this.value;t.mapValue.fields||(t.mapValue={fields:{}});for(let s=0;s<e.length;++s){let i=t.mapValue.fields[e.get(s)];ho(i)&&i.mapValue.fields||(i={mapValue:{fields:{}}},t.mapValue.fields[e.get(s)]=i),t=i}return t.mapValue.fields}applyChanges(e,t,s){ls(t,(i,r)=>e[i]=r);for(const i of s)delete e[i]}clone(){return new it(Mi(this.value))}}function Cm(n){const e=[];return ls(n.fields,(t,s)=>{const i=new qe([t]);if(ho(s)){const r=Cm(s.mapValue).fields;if(r.length===0)e.push(i);else for(const o of r)e.push(i.child(o))}else e.push(i)}),new dt(e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ve{constructor(e,t,s,i,r,o,l){this.key=e,this.documentType=t,this.version=s,this.readTime=i,this.createTime=r,this.data=o,this.documentState=l}static newInvalidDocument(e){return new Ve(e,0,G.min(),G.min(),G.min(),it.empty(),0)}static newFoundDocument(e,t,s,i){return new Ve(e,1,t,G.min(),s,i,0)}static newNoDocument(e,t){return new Ve(e,2,t,G.min(),G.min(),it.empty(),0)}static newUnknownDocument(e,t){return new Ve(e,3,t,G.min(),G.min(),it.empty(),2)}convertToFoundDocument(e,t){return!this.createTime.isEqual(G.min())||this.documentType!==2&&this.documentType!==0||(this.createTime=e),this.version=e,this.documentType=1,this.data=t,this.documentState=0,this}convertToNoDocument(e){return this.version=e,this.documentType=2,this.data=it.empty(),this.documentState=0,this}convertToUnknownDocument(e){return this.version=e,this.documentType=3,this.data=it.empty(),this.documentState=2,this}setHasCommittedMutations(){return this.documentState=2,this}setHasLocalMutations(){return this.documentState=1,this.version=G.min(),this}setReadTime(e){return this.readTime=e,this}get hasLocalMutations(){return this.documentState===1}get hasCommittedMutations(){return this.documentState===2}get hasPendingWrites(){return this.hasLocalMutations||this.hasCommittedMutations}isValidDocument(){return this.documentType!==0}isFoundDocument(){return this.documentType===1}isNoDocument(){return this.documentType===2}isUnknownDocument(){return this.documentType===3}isEqual(e){return e instanceof Ve&&this.key.isEqual(e.key)&&this.version.isEqual(e.version)&&this.documentType===e.documentType&&this.documentState===e.documentState&&this.data.isEqual(e.data)}mutableCopy(){return new Ve(this.key,this.documentType,this.version,this.readTime,this.createTime,this.data.clone(),this.documentState)}toString(){return`Document(${this.key}, ${this.version}, ${JSON.stringify(this.data.value)}, {createTime: ${this.createTime}}), {documentType: ${this.documentType}}), {documentState: ${this.documentState}})`}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Do{constructor(e,t){this.position=e,this.inclusive=t}}function $d(n,e,t){let s=0;for(let i=0;i<n.position.length;i++){const r=e[i],o=n.position[i];if(r.field.isKeyField()?s=W.comparator(W.fromName(o.referenceValue),t.key):s=Bs(o,t.data.field(r.field)),r.dir==="desc"&&(s*=-1),s!==0)break}return s}function jd(n,e){if(n===null)return e===null;if(e===null||n.inclusive!==e.inclusive||n.position.length!==e.position.length)return!1;for(let t=0;t<n.position.length;t++)if(!Mt(n.position[t],e.position[t]))return!1;return!0}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bm{}class Se extends bm{constructor(e,t,s){super(),this.field=e,this.op=t,this.value=s}static create(e,t,s){return e.isKeyField()?t==="in"||t==="not-in"?this.createKeyFieldInFilter(e,t,s):new KT(e,t,s):t==="array-contains"?new JT(e,s):t==="in"?new XT(e,s):t==="not-in"?new ZT(e,s):t==="array-contains-any"?new eI(e,s):new Se(e,t,s)}static createKeyFieldInFilter(e,t,s){return t==="in"?new QT(e,s):new YT(e,s)}matches(e){const t=e.data.field(this.field);return this.op==="!="?t!==null&&this.matchesComparison(Bs(t,this.value)):t!==null&&ns(this.value)===ns(t)&&this.matchesComparison(Bs(t,this.value))}matchesComparison(e){switch(this.op){case"<":return e<0;case"<=":return e<=0;case"==":return e===0;case"!=":return e!==0;case">":return e>0;case">=":return e>=0;default:return j()}}isInequality(){return["<","<=",">",">=","!=","not-in"].indexOf(this.op)>=0}getFlattenedFilters(){return[this]}getFilters(){return[this]}}class bt extends bm{constructor(e,t){super(),this.filters=e,this.op=t,this.ae=null}static create(e,t){return new bt(e,t)}matches(e){return Rm(this)?this.filters.find(t=>!t.matches(e))===void 0:this.filters.find(t=>t.matches(e))!==void 0}getFlattenedFilters(){return this.ae!==null||(this.ae=this.filters.reduce((e,t)=>e.concat(t.getFlattenedFilters()),[])),this.ae}getFilters(){return Object.assign([],this.filters)}}function Rm(n){return n.op==="and"}function Sm(n){return HT(n)&&Rm(n)}function HT(n){for(const e of n.filters)if(e instanceof bt)return!1;return!0}function Gl(n){if(n instanceof Se)return n.field.canonicalString()+n.op.toString()+Us(n.value);if(Sm(n))return n.filters.map(e=>Gl(e)).join(",");{const e=n.filters.map(t=>Gl(t)).join(",");return`${n.op}(${e})`}}function Am(n,e){return n instanceof Se?function(s,i){return i instanceof Se&&s.op===i.op&&s.field.isEqual(i.field)&&Mt(s.value,i.value)}(n,e):n instanceof bt?function(s,i){return i instanceof bt&&s.op===i.op&&s.filters.length===i.filters.length?s.filters.reduce((r,o,l)=>r&&Am(o,i.filters[l]),!0):!1}(n,e):void j()}function km(n){return n instanceof Se?function(t){return`${t.field.canonicalString()} ${t.op} ${Us(t.value)}`}(n):n instanceof bt?function(t){return t.op.toString()+" {"+t.getFilters().map(km).join(" ,")+"}"}(n):"Filter"}class KT extends Se{constructor(e,t,s){super(e,t,s),this.key=W.fromName(s.referenceValue)}matches(e){const t=W.comparator(e.key,this.key);return this.matchesComparison(t)}}class QT extends Se{constructor(e,t){super(e,"in",t),this.keys=Pm("in",t)}matches(e){return this.keys.some(t=>t.isEqual(e.key))}}class YT extends Se{constructor(e,t){super(e,"not-in",t),this.keys=Pm("not-in",t)}matches(e){return!this.keys.some(t=>t.isEqual(e.key))}}function Pm(n,e){var t;return(((t=e.arrayValue)===null||t===void 0?void 0:t.values)||[]).map(s=>W.fromName(s.referenceValue))}class JT extends Se{constructor(e,t){super(e,"array-contains",t)}matches(e){const t=e.data.field(this.field);return Wc(t)&&Zi(t.arrayValue,this.value)}}class XT extends Se{constructor(e,t){super(e,"in",t)}matches(e){const t=e.data.field(this.field);return t!==null&&Zi(this.value.arrayValue,t)}}class ZT extends Se{constructor(e,t){super(e,"not-in",t)}matches(e){if(Zi(this.value.arrayValue,{nullValue:"NULL_VALUE"}))return!1;const t=e.data.field(this.field);return t!==null&&!Zi(this.value.arrayValue,t)}}class eI extends Se{constructor(e,t){super(e,"array-contains-any",t)}matches(e){const t=e.data.field(this.field);return!(!Wc(t)||!t.arrayValue.values)&&t.arrayValue.values.some(s=>Zi(this.value.arrayValue,s))}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _r{constructor(e,t=null,s=[],i=[],r=null,o="F",l=null,c=null){this.path=e,this.collectionGroup=t,this.explicitOrderBy=s,this.filters=i,this.limit=r,this.limitType=o,this.startAt=l,this.endAt=c,this.ce=null,this.le=null,this.he=null,this.startAt,this.endAt}}function nI(n,e,t,s,i,r,o,l){return new _r(n,e,t,s,i,r,o,l)}function zc(n){return new _r(n)}function Gd(n){return n.filters.length===0&&n.limit===null&&n.startAt==null&&n.endAt==null&&(n.explicitOrderBy.length===0||n.explicitOrderBy.length===1&&n.explicitOrderBy[0].field.isKeyField())}function Nm(n){return n.collectionGroup!==null}function Vi(n){const e=K(n);if(e.ce===null){e.ce=[];const t=new Set;for(const r of e.explicitOrderBy)e.ce.push(r),t.add(r.field.canonicalString());const s=e.explicitOrderBy.length>0?e.explicitOrderBy[e.explicitOrderBy.length-1].dir:"asc";(function(o){let l=new We(qe.comparator);return o.filters.forEach(c=>{c.getFlattenedFilters().forEach(h=>{h.isInequality()&&(l=l.add(h.field))})}),l})(e).forEach(r=>{t.has(r.canonicalString())||r.isKeyField()||e.ce.push(new Lo(r,s))}),t.has(qe.keyField().canonicalString())||e.ce.push(new Lo(qe.keyField(),s))}return e.ce}function xt(n){const e=K(n);return e.le||(e.le=sI(e,Vi(n))),e.le}function sI(n,e){if(n.limitType==="F")return zd(n.path,n.collectionGroup,e,n.filters,n.limit,n.startAt,n.endAt);{e=e.map(i=>{const r=i.dir==="desc"?"asc":"desc";return new Lo(i.field,r)});const t=n.endAt?new Do(n.endAt.position,n.endAt.inclusive):null,s=n.startAt?new Do(n.startAt.position,n.startAt.inclusive):null;return zd(n.path,n.collectionGroup,e,n.filters,n.limit,t,s)}}function Kl(n,e){const t=n.filters.concat([e]);return new _r(n.path,n.collectionGroup,n.explicitOrderBy.slice(),t,n.limit,n.limitType,n.startAt,n.endAt)}function xo(n,e,t){return new _r(n.path,n.collectionGroup,n.explicitOrderBy.slice(),n.filters.slice(),e,t,n.startAt,n.endAt)}function ua(n,e){return jc(xt(n),xt(e))&&n.limitType===e.limitType}function Dm(n){return`${$c(xt(n))}|lt:${n.limitType}`}function Cs(n){return`Query(target=${function(t){let s=t.path.canonicalString();return t.collectionGroup!==null&&(s+=" collectionGroup="+t.collectionGroup),t.filters.length>0&&(s+=`, filters: [${t.filters.map(i=>km(i)).join(", ")}]`),gr(t.limit)||(s+=", limit: "+t.limit),t.orderBy.length>0&&(s+=`, orderBy: [${t.orderBy.map(i=>function(o){return`${o.field.canonicalString()} (${o.dir})`}(i)).join(", ")}]`),t.startAt&&(s+=", startAt: ",s+=t.startAt.inclusive?"b:":"a:",s+=t.startAt.position.map(i=>Us(i)).join(",")),t.endAt&&(s+=", endAt: ",s+=t.endAt.inclusive?"a:":"b:",s+=t.endAt.position.map(i=>Us(i)).join(",")),`Target(${s})`}(xt(n))}; limitType=${n.limitType})`}function da(n,e){return e.isFoundDocument()&&function(s,i){const r=i.key.path;return s.collectionGroup!==null?i.key.hasCollectionId(s.collectionGroup)&&s.path.isPrefixOf(r):W.isDocumentKey(s.path)?s.path.isEqual(r):s.path.isImmediateParentOf(r)}(n,e)&&function(s,i){for(const r of Vi(s))if(!r.field.isKeyField()&&i.data.field(r.field)===null)return!1;return!0}(n,e)&&function(s,i){for(const r of s.filters)if(!r.matches(i))return!1;return!0}(n,e)&&function(s,i){return!(s.startAt&&!function(o,l,c){const h=$d(o,l,c);return o.inclusive?h<=0:h<0}(s.startAt,Vi(s),i)||s.endAt&&!function(o,l,c){const h=$d(o,l,c);return o.inclusive?h>=0:h>0}(s.endAt,Vi(s),i))}(n,e)}function iI(n){return n.collectionGroup||(n.path.length%2==1?n.path.lastSegment():n.path.get(n.path.length-2))}function Lm(n){return(e,t)=>{let s=!1;for(const i of Vi(n)){const r=rI(i,e,t);if(r!==0)return r;s=s||i.field.isKeyField()}return 0}}function rI(n,e,t){const s=n.field.isKeyField()?W.comparator(e.key,t.key):function(r,o,l){const c=o.data.field(r),h=l.data.field(r);return c!==null&&h!==null?Bs(c,h):j()}(n.field,e,t);switch(n.dir){case"asc":return s;case"desc":return-1*s;default:return j()}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const oI=new ke(W.comparator);function an(){return oI}const xm=new ke(W.comparator);function Di(...n){let e=xm;for(const t of n)e=e.insert(t.key,t);return e}function Om(n){let e=xm;return n.forEach((t,s)=>e=e.insert(t,s.overlayedDocument)),e}function Hn(){return Fi()}function Mm(){return Fi()}function Fi(){return new Zs(n=>n.toString(),(n,e)=>n.isEqual(e))}const aI=new ke(W.comparator),lI=new We(W.comparator);function se(...n){let e=lI;for(const t of n)e=e.add(t);return e}const cI=new We(le);function hI(){return cI}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class fa{constructor(){this._=void 0}}function dI(n,e,t){return n instanceof Oo?function(i,r){const o={fields:{__type__:{stringValue:"server_timestamp"},__local_write_time__:{timestampValue:{seconds:i.seconds,nanos:i.nanoseconds}}}};return r&&Uc(r)&&(r=qc(r)),r&&(o.fields.__previous_value__=r),{mapValue:o}}(t,e):n instanceof er?Bm(n,e):n instanceof tr?Um(n,e):function(i,r){const o=Fm(i,r),l=Hd(o)+Hd(i.Pe);return zl(o)&&zl(i.Pe)?Vm(l):Gc(i.serializer,l)}(n,e)}function fI(n,e,t){return n instanceof er?Bm(n,e):n instanceof tr?Um(n,e):t}function Fm(n,e){return n instanceof Mo?function(s){return zl(s)||function(r){return!!r&&"doubleValue"in r}(s)}(e)?e:{integerValue:0}:null}class Oo extends fa{}class er extends fa{constructor(e){super(),this.elements=e}}function Bm(n,e){const t=qm(e);for(const s of n.elements)t.some(i=>Mt(i,s))||t.push(s);return{arrayValue:{values:t}}}class tr extends fa{constructor(e){super(),this.elements=e}}function Um(n,e){let t=qm(e);for(const s of n.elements)t=t.filter(i=>!Mt(i,s));return{arrayValue:{values:t}}}class Mo extends fa{constructor(e,t){super(),this.serializer=e,this.Pe=t}}function Hd(n){return be(n.integerValue||n.doubleValue)}function qm(n){return Wc(n)&&n.arrayValue.values?n.arrayValue.values.slice():[]}function pI(n,e){return n.field.isEqual(e.field)&&function(s,i){return s instanceof er&&i instanceof er||s instanceof tr&&i instanceof tr?Fs(s.elements,i.elements,Mt):s instanceof Mo&&i instanceof Mo?Mt(s.Pe,i.Pe):s instanceof Oo&&i instanceof Oo}(n.transform,e.transform)}class mI{constructor(e,t){this.version=e,this.transformResults=t}}class rt{constructor(e,t){this.updateTime=e,this.exists=t}static none(){return new rt}static exists(e){return new rt(void 0,e)}static updateTime(e){return new rt(e)}get isNone(){return this.updateTime===void 0&&this.exists===void 0}isEqual(e){return this.exists===e.exists&&(this.updateTime?!!e.updateTime&&this.updateTime.isEqual(e.updateTime):!e.updateTime)}}function uo(n,e){return n.updateTime!==void 0?e.isFoundDocument()&&e.version.isEqual(n.updateTime):n.exists===void 0||n.exists===e.isFoundDocument()}class pa{}function Wm(n,e){if(!n.hasLocalMutations||e&&e.fields.length===0)return null;if(e===null)return n.isNoDocument()?new Hc(n.key,rt.none()):new yr(n.key,n.data,rt.none());{const t=n.data,s=it.empty();let i=new We(qe.comparator);for(let r of e.fields)if(!i.has(r)){let o=t.field(r);o===null&&r.length>1&&(r=r.popLast(),o=t.field(r)),o===null?s.delete(r):s.set(r,o),i=i.add(r)}return new Fn(n.key,s,new dt(i.toArray()),rt.none())}}function gI(n,e,t){n instanceof yr?function(i,r,o){const l=i.value.clone(),c=Qd(i.fieldTransforms,r,o.transformResults);l.setAll(c),r.convertToFoundDocument(o.version,l).setHasCommittedMutations()}(n,e,t):n instanceof Fn?function(i,r,o){if(!uo(i.precondition,r))return void r.convertToUnknownDocument(o.version);const l=Qd(i.fieldTransforms,r,o.transformResults),c=r.data;c.setAll($m(i)),c.setAll(l),r.convertToFoundDocument(o.version,c).setHasCommittedMutations()}(n,e,t):function(i,r,o){r.convertToNoDocument(o.version).setHasCommittedMutations()}(0,e,t)}function Bi(n,e,t,s){return n instanceof yr?function(r,o,l,c){if(!uo(r.precondition,o))return l;const h=r.value.clone(),d=Yd(r.fieldTransforms,c,o);return h.setAll(d),o.convertToFoundDocument(o.version,h).setHasLocalMutations(),null}(n,e,t,s):n instanceof Fn?function(r,o,l,c){if(!uo(r.precondition,o))return l;const h=Yd(r.fieldTransforms,c,o),d=o.data;return d.setAll($m(r)),d.setAll(h),o.convertToFoundDocument(o.version,d).setHasLocalMutations(),l===null?null:l.unionWith(r.fieldMask.fields).unionWith(r.fieldTransforms.map(p=>p.field))}(n,e,t,s):function(r,o,l){return uo(r.precondition,o)?(o.convertToNoDocument(o.version).setHasLocalMutations(),null):l}(n,e,t)}function _I(n,e){let t=null;for(const s of n.fieldTransforms){const i=e.data.field(s.field),r=Fm(s.transform,i||null);r!=null&&(t===null&&(t=it.empty()),t.set(s.field,r))}return t||null}function Kd(n,e){return n.type===e.type&&!!n.key.isEqual(e.key)&&!!n.precondition.isEqual(e.precondition)&&!!function(s,i){return s===void 0&&i===void 0||!(!s||!i)&&Fs(s,i,(r,o)=>pI(r,o))}(n.fieldTransforms,e.fieldTransforms)&&(n.type===0?n.value.isEqual(e.value):n.type!==1||n.data.isEqual(e.data)&&n.fieldMask.isEqual(e.fieldMask))}class yr extends pa{constructor(e,t,s,i=[]){super(),this.key=e,this.value=t,this.precondition=s,this.fieldTransforms=i,this.type=0}getFieldMask(){return null}}class Fn extends pa{constructor(e,t,s,i,r=[]){super(),this.key=e,this.data=t,this.fieldMask=s,this.precondition=i,this.fieldTransforms=r,this.type=1}getFieldMask(){return this.fieldMask}}function $m(n){const e=new Map;return n.fieldMask.fields.forEach(t=>{if(!t.isEmpty()){const s=n.data.field(t);e.set(t,s)}}),e}function Qd(n,e,t){const s=new Map;oe(n.length===t.length);for(let i=0;i<t.length;i++){const r=n[i],o=r.transform,l=e.data.field(r.field);s.set(r.field,fI(o,l,t[i]))}return s}function Yd(n,e,t){const s=new Map;for(const i of n){const r=i.transform,o=t.data.field(i.field);s.set(i.field,dI(r,o,e))}return s}class Hc extends pa{constructor(e,t){super(),this.key=e,this.precondition=t,this.type=2,this.fieldTransforms=[]}getFieldMask(){return null}}class jm extends pa{constructor(e,t){super(),this.key=e,this.precondition=t,this.type=3,this.fieldTransforms=[]}getFieldMask(){return null}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class yI{constructor(e,t,s,i){this.batchId=e,this.localWriteTime=t,this.baseMutations=s,this.mutations=i}applyToRemoteDocument(e,t){const s=t.mutationResults;for(let i=0;i<this.mutations.length;i++){const r=this.mutations[i];r.key.isEqual(e.key)&&gI(r,e,s[i])}}applyToLocalView(e,t){for(const s of this.baseMutations)s.key.isEqual(e.key)&&(t=Bi(s,e,t,this.localWriteTime));for(const s of this.mutations)s.key.isEqual(e.key)&&(t=Bi(s,e,t,this.localWriteTime));return t}applyToLocalDocumentSet(e,t){const s=Mm();return this.mutations.forEach(i=>{const r=e.get(i.key),o=r.overlayedDocument;let l=this.applyToLocalView(o,r.mutatedFields);l=t.has(i.key)?null:l;const c=Wm(o,l);c!==null&&s.set(i.key,c),o.isValidDocument()||o.convertToNoDocument(G.min())}),s}keys(){return this.mutations.reduce((e,t)=>e.add(t.key),se())}isEqual(e){return this.batchId===e.batchId&&Fs(this.mutations,e.mutations,(t,s)=>Kd(t,s))&&Fs(this.baseMutations,e.baseMutations,(t,s)=>Kd(t,s))}}class Kc{constructor(e,t,s,i){this.batch=e,this.commitVersion=t,this.mutationResults=s,this.docVersions=i}static from(e,t,s){oe(e.mutations.length===s.length);let i=function(){return aI}();const r=e.mutations;for(let o=0;o<r.length;o++)i=i.insert(r[o].key,s[o].version);return new Kc(e,t,s,i)}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ma{constructor(e,t,s,i,r){this.snapshotVersion=e,this.targetChanges=t,this.targetMismatches=s,this.documentUpdates=i,this.resolvedLimboDocuments=r}static createSynthesizedRemoteEventForCurrentChange(e,t,s){const i=new Map;return i.set(e,vr.createSynthesizedTargetChangeForCurrentChange(e,t,s)),new ma(G.min(),i,new ke(le),an(),se())}}class vr{constructor(e,t,s,i,r){this.resumeToken=e,this.current=t,this.addedDocuments=s,this.modifiedDocuments=i,this.removedDocuments=r}static createSynthesizedTargetChangeForCurrentChange(e,t,s){return new vr(s,t,se(),se(),se())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class fo{constructor(e,t,s,i){this.Re=e,this.removedTargetIds=t,this.key=s,this.Ve=i}}class Hm{constructor(e,t){this.targetId=e,this.me=t}}class Km{constructor(e,t,s=$e.EMPTY_BYTE_STRING,i=null){this.state=e,this.targetIds=t,this.resumeToken=s,this.cause=i}}class Zd{constructor(){this.fe=0,this.ge=tf(),this.pe=$e.EMPTY_BYTE_STRING,this.ye=!1,this.we=!0}get current(){return this.ye}get resumeToken(){return this.pe}get Se(){return this.fe!==0}get be(){return this.we}De(e){e.approximateByteSize()>0&&(this.we=!0,this.pe=e)}ve(){let e=se(),t=se(),s=se();return this.ge.forEach((i,r)=>{switch(r){case 0:e=e.add(i);break;case 2:t=t.add(i);break;case 1:s=s.add(i);break;default:j()}}),new vr(this.pe,this.ye,e,t,s)}Ce(){this.we=!1,this.ge=tf()}Fe(e,t){this.we=!0,this.ge=this.ge.insert(e,t)}Me(e){this.we=!0,this.ge=this.ge.remove(e)}xe(){this.fe+=1}Oe(){this.fe-=1,oe(this.fe>=0)}Ne(){this.we=!0,this.ye=!0}}class II{constructor(e){this.Le=e,this.Be=new Map,this.ke=an(),this.qe=ef(),this.Qe=new ke(le)}Ke(e){for(const t of e.Re)e.Ve&&e.Ve.isFoundDocument()?this.$e(t,e.Ve):this.Ue(t,e.key,e.Ve);for(const t of e.removedTargetIds)this.Ue(t,e.key,e.Ve)}We(e){this.forEachTarget(e,t=>{const s=this.Ge(t);switch(e.state){case 0:this.ze(t)&&s.De(e.resumeToken);break;case 1:s.Oe(),s.Se||s.Ce(),s.De(e.resumeToken);break;case 2:s.Oe(),s.Se||this.removeTarget(t);break;case 3:this.ze(t)&&(s.Ne(),s.De(e.resumeToken));break;case 4:this.ze(t)&&(this.je(t),s.De(e.resumeToken));break;default:j()}})}forEachTarget(e,t){e.targetIds.length>0?e.targetIds.forEach(t):this.Be.forEach((s,i)=>{this.ze(i)&&t(i)})}He(e){const t=e.targetId,s=e.me.count,i=this.Je(t);if(i){const r=i.target;if(Hl(r))if(s===0){const o=new W(r.path);this.Ue(t,o,Ve.newNoDocument(o,G.min()))}else oe(s===1);else{const o=this.Ye(t);if(o!==s){const l=this.Ze(e),c=l?this.Xe(l,e,o):1;if(c!==0){this.je(t);const h=c===2?"TargetPurposeExistenceFilterMismatchBloom":"TargetPurposeExistenceFilterMismatch";this.Qe=this.Qe.insert(t,h)}}}}}Ze(e){const t=e.me.unchangedNames;if(!t||!t.bits)return null;const{bits:{bitmap:s="",padding:i=0},hashCount:r=0}=t;let o,l;try{o=ts(s).toUint8Array()}catch(c){if(c instanceof Im)return Vs("Decoding the base64 bloom filter in existence filter failed ("+c.message+"); ignoring the bloom filter and falling back to full re-query."),null;throw c}try{l=new Qc(o,i,r)}catch(c){return Vs(c instanceof Li?"BloomFilter error: ":"Applying bloom filter failed: ",c),null}return l.Ie===0?null:l}Xe(e,t,s){return t.me.count===s-this.nt(e,t.targetId)?0:2}nt(e,t){const s=this.Le.getRemoteKeysForTarget(t);let i=0;return s.forEach(r=>{const o=this.Le.tt(),l=`projects/${o.projectId}/databases/${o.database}/documents/${r.path.canonicalString()}`;e.mightContain(l)||(this.Ue(t,r,null),i++)}),i}rt(e){const t=new Map;this.Be.forEach((r,o)=>{const l=this.Je(o);if(l){if(r.current&&Hl(l.target)){const c=new W(l.target.path);this.ke.get(c)!==null||this.it(o,c)||this.Ue(o,c,Ve.newNoDocument(c,e))}r.be&&(t.set(o,r.ve()),r.Ce())}});let s=se();this.qe.forEach((r,o)=>{let l=!0;o.forEachWhile(c=>{const h=this.Je(c);return!h||h.purpose==="TargetPurposeLimboResolution"||(l=!1,!1)}),l&&(s=s.add(r))}),this.ke.forEach((r,o)=>o.setReadTime(e));const i=new ma(e,t,this.Qe,this.ke,s);return this.ke=an(),this.qe=ef(),this.Qe=new ke(le),i}$e(e,t){if(!this.ze(e))return;const s=this.it(e,t.key)?2:0;this.Ge(e).Fe(t.key,s),this.ke=this.ke.insert(t.key,t),this.qe=this.qe.insert(t.key,this.st(t.key).add(e))}Ue(e,t,s){if(!this.ze(e))return;const i=this.Ge(e);this.it(e,t)?i.Fe(t,1):i.Me(t),this.qe=this.qe.insert(t,this.st(t).delete(e)),s&&(this.ke=this.ke.insert(t,s))}removeTarget(e){this.Be.delete(e)}Ye(e){const t=this.Ge(e).ve();return this.Le.getRemoteKeysForTarget(e).size+t.addedDocuments.size-t.removedDocuments.size}xe(e){this.Ge(e).xe()}Ge(e){let t=this.Be.get(e);return t||(t=new Zd,this.Be.set(e,t)),t}st(e){let t=this.qe.get(e);return t||(t=new We(le),this.qe=this.qe.insert(e,t)),t}ze(e){const t=this.Je(e)!==null;return t||B("WatchChangeAggregator","Detected inactive target",e),t}Je(e){const t=this.Be.get(e);return t&&t.Se?null:this.Le.ot(e)}je(e){this.Be.set(e,new Zd),this.Le.getRemoteKeysForTarget(e).forEach(t=>{this.Ue(e,t,null)})}it(e,t){return this.Le.getRemoteKeysForTarget(e).has(t)}}function ef(){return new ke(W.comparator)}function tf(){return new ke(W.comparator)}const CI={asc:"ASCENDING",desc:"DESCENDING"},bI={"<":"LESS_THAN","<=":"LESS_THAN_OR_EQUAL",">":"GREATER_THAN",">=":"GREATER_THAN_OR_EQUAL","==":"EQUAL","!=":"NOT_EQUAL","array-contains":"ARRAY_CONTAINS",in:"IN","not-in":"NOT_IN","array-contains-any":"ARRAY_CONTAINS_ANY"},RI={and:"AND",or:"OR"};class SI{constructor(e,t){this.databaseId=e,this.useProto3Json=t}}function Ql(n,e){return n.useProto3Json||gr(e)?e:{value:e}}function Vo(n,e){return n.useProto3Json?`${new Date(1e3*e.seconds).toISOString().replace(/\.\d*/,"").replace("Z","")}.${("000000000"+e.nanoseconds).slice(-9)}Z`:{seconds:""+e.seconds,nanos:e.nanoseconds}}function Qm(n,e){return n.useProto3Json?e.toBase64():e.toUint8Array()}function AI(n,e){return Vo(n,e.toTimestamp())}function ft(n){return oe(!!n),G.fromTimestamp(function(t){const s=Dn(t);return new De(s.seconds,s.nanos)}(n))}function Yc(n,e){return Yl(n,e).canonicalString()}function Yl(n,e){const t=function(i){return new me(["projects",i.projectId,"databases",i.database])}(n).child("documents");return e===void 0?t:t.child(e)}function Ym(n){const e=me.fromString(n);return oe(ng(e)),e}function Fo(n,e){return Yc(n.databaseId,e.path)}function Ui(n,e){const t=Ym(e);if(t.get(1)!==n.databaseId.projectId)throw new M(P.INVALID_ARGUMENT,"Tried to deserialize key from different project: "+t.get(1)+" vs "+n.databaseId.projectId);if(t.get(3)!==n.databaseId.database)throw new M(P.INVALID_ARGUMENT,"Tried to deserialize key from different database: "+t.get(3)+" vs "+n.databaseId.database);return new W(Xm(t))}function Jm(n,e){return Yc(n.databaseId,e)}function kI(n){const e=Ym(n);return e.length===4?me.emptyPath():Xm(e)}function Jl(n){return new me(["projects",n.databaseId.projectId,"databases",n.databaseId.database]).canonicalString()}function Xm(n){return oe(n.length>4&&n.get(4)==="documents"),n.popFirst(5)}function nf(n,e,t){return{name:Fo(n,e),fields:t.value.mapValue.fields}}function PI(n,e){return"found"in e?function(s,i){oe(!!i.found),i.found.name,i.found.updateTime;const r=Ui(s,i.found.name),o=ft(i.found.updateTime),l=i.found.createTime?ft(i.found.createTime):G.min(),c=new it({mapValue:{fields:i.found.fields}});return Ve.newFoundDocument(r,o,l,c)}(n,e):"missing"in e?function(s,i){oe(!!i.missing),oe(!!i.readTime);const r=Ui(s,i.missing),o=ft(i.readTime);return Ve.newNoDocument(r,o)}(n,e):j()}function NI(n,e){let t;if("targetChange"in e){e.targetChange;const s=function(h){return h==="NO_CHANGE"?0:h==="ADD"?1:h==="REMOVE"?2:h==="CURRENT"?3:h==="RESET"?4:j()}(e.targetChange.targetChangeType||"NO_CHANGE"),i=e.targetChange.targetIds||[],r=function(h,d){return h.useProto3Json?(oe(d===void 0||typeof d=="string"),$e.fromBase64String(d||"")):(oe(d===void 0||d instanceof Buffer||d instanceof Uint8Array),$e.fromUint8Array(d||new Uint8Array))}(n,e.targetChange.resumeToken),o=e.targetChange.cause,l=o&&function(h){const d=h.code===void 0?P.UNKNOWN:Gm(h.code);return new M(d,h.message||"")}(o);t=new Km(s,i,r,l||null)}else if("documentChange"in e){e.documentChange;const s=e.documentChange;s.document,s.document.name,s.document.updateTime;const i=Ui(n,s.document.name),r=ft(s.document.updateTime),o=s.document.createTime?ft(s.document.createTime):G.min(),l=new it({mapValue:{fields:s.document.fields}}),c=Ve.newFoundDocument(i,r,o,l),h=s.targetIds||[],d=s.removedTargetIds||[];t=new fo(h,d,c.key,c)}else if("documentDelete"in e){e.documentDelete;const s=e.documentDelete;s.document;const i=Ui(n,s.document),r=s.readTime?ft(s.readTime):G.min(),o=Ve.newNoDocument(i,r),l=s.removedTargetIds||[];t=new fo([],l,o.key,o)}else if("documentRemove"in e){e.documentRemove;const s=e.documentRemove;s.document;const i=Ui(n,s.document),r=s.removedTargetIds||[];t=new fo([],r,i,null)}else{if(!("filter"in e))return j();{e.filter;const s=e.filter;s.targetId;const{count:i=0,unchangedNames:r}=s,o=new EI(i,r),l=s.targetId;t=new Hm(l,o)}}return t}function Zm(n,e){let t;if(e instanceof yr)t={update:nf(n,e.key,e.value)};else if(e instanceof Hc)t={delete:Fo(n,e.key)};else if(e instanceof Fn)t={update:nf(n,e.key,e.data),updateMask:UI(e.fieldMask)};else{if(!(e instanceof jm))return j();t={verify:Fo(n,e.key)}}return e.fieldTransforms.length>0&&(t.updateTransforms=e.fieldTransforms.map(s=>function(r,o){const l=o.transform;if(l instanceof Oo)return{fieldPath:o.field.canonicalString(),setToServerValue:"REQUEST_TIME"};if(l instanceof er)return{fieldPath:o.field.canonicalString(),appendMissingElements:{values:l.elements}};if(l instanceof tr)return{fieldPath:o.field.canonicalString(),removeAllFromArray:{values:l.elements}};if(l instanceof Mo)return{fieldPath:o.field.canonicalString(),increment:l.Pe};throw j()}(0,s))),e.precondition.isNone||(t.currentDocument=function(i,r){return r.updateTime!==void 0?{updateTime:AI(i,r.updateTime)}:r.exists!==void 0?{exists:r.exists}:j()}(n,e.precondition)),t}function DI(n,e){return n&&n.length>0?(oe(e!==void 0),n.map(t=>function(i,r){let o=i.updateTime?ft(i.updateTime):ft(r);return o.isEqual(G.min())&&(o=ft(r)),new mI(o,i.transformResults||[])}(t,e))):[]}function LI(n,e){return{documents:[Jm(n,e.path)]}}function xI(n,e){const t={structuredQuery:{}},s=e.path;let i;e.collectionGroup!==null?(i=s,t.structuredQuery.from=[{collectionId:e.collectionGroup,allDescendants:!0}]):(i=s.popLast(),t.structuredQuery.from=[{collectionId:s.lastSegment()}]),t.parent=Jm(n,i);const r=function(h){if(h.length!==0)return tg(bt.create(h,"and"))}(e.filters);r&&(t.structuredQuery.where=r);const o=function(h){if(h.length!==0)return h.map(d=>function(m){return{field:bs(m.field),direction:VI(m.dir)}}(d))}(e.orderBy);o&&(t.structuredQuery.orderBy=o);const l=Ql(n,e.limit);return l!==null&&(t.structuredQuery.limit=l),e.startAt&&(t.structuredQuery.startAt=function(h){return{before:h.inclusive,values:h.position}}(e.startAt)),e.endAt&&(t.structuredQuery.endAt=function(h){return{before:!h.inclusive,values:h.position}}(e.endAt)),{_t:t,parent:i}}function OI(n){let e=kI(n.parent);const t=n.structuredQuery,s=t.from?t.from.length:0;let i=null;if(s>0){oe(s===1);const d=t.from[0];d.allDescendants?i=d.collectionId:e=e.child(d.collectionId)}let r=[];t.where&&(r=function(p){const m=eg(p);return m instanceof bt&&Sm(m)?m.getFilters():[m]}(t.where));let o=[];t.orderBy&&(o=function(p){return p.map(m=>function(C){return new Lo(Rs(C.field),function(k){switch(k){case"ASCENDING":return"asc";case"DESCENDING":return"desc";default:return}}(C.direction))}(m))}(t.orderBy));let l=null;t.limit&&(l=function(p){let m;return m=typeof p=="object"?p.value:p,gr(m)?null:m}(t.limit));let c=null;t.startAt&&(c=function(p){const m=!!p.before,E=p.values||[];return new Do(E,m)}(t.startAt));let h=null;return t.endAt&&(h=function(p){const m=!p.before,E=p.values||[];return new Do(E,m)}(t.endAt)),nI(e,i,o,r,l,"F",c,h)}function MI(n,e){const t=function(i){switch(i){case"TargetPurposeListen":return null;case"TargetPurposeExistenceFilterMismatch":return"existence-filter-mismatch";case"TargetPurposeExistenceFilterMismatchBloom":return"existence-filter-mismatch-bloom";case"TargetPurposeLimboResolution":return"limbo-document";default:return j()}}(e.purpose);return t==null?null:{"goog-listen-tags":t}}function eg(n){return n.unaryFilter!==void 0?function(t){switch(t.unaryFilter.op){case"IS_NAN":const s=Rs(t.unaryFilter.field);return Se.create(s,"==",{doubleValue:NaN});case"IS_NULL":const i=Rs(t.unaryFilter.field);return Se.create(i,"==",{nullValue:"NULL_VALUE"});case"IS_NOT_NAN":const r=Rs(t.unaryFilter.field);return Se.create(r,"!=",{doubleValue:NaN});case"IS_NOT_NULL":const o=Rs(t.unaryFilter.field);return Se.create(o,"!=",{nullValue:"NULL_VALUE"});default:return j()}}(n):n.fieldFilter!==void 0?function(t){return Se.create(Rs(t.fieldFilter.field),function(i){switch(i){case"EQUAL":return"==";case"NOT_EQUAL":return"!=";case"GREATER_THAN":return">";case"GREATER_THAN_OR_EQUAL":return">=";case"LESS_THAN":return"<";case"LESS_THAN_OR_EQUAL":return"<=";case"ARRAY_CONTAINS":return"array-contains";case"IN":return"in";case"NOT_IN":return"not-in";case"ARRAY_CONTAINS_ANY":return"array-contains-any";default:return j()}}(t.fieldFilter.op),t.fieldFilter.value)}(n):n.compositeFilter!==void 0?function(t){return bt.create(t.compositeFilter.filters.map(s=>eg(s)),function(i){switch(i){case"AND":return"and";case"OR":return"or";default:return j()}}(t.compositeFilter.op))}(n):j()}function VI(n){return CI[n]}function FI(n){return bI[n]}function BI(n){return RI[n]}function bs(n){return{fieldPath:n.canonicalString()}}function Rs(n){return qe.fromServerFormat(n.fieldPath)}function tg(n){return n instanceof Se?function(t){if(t.op==="=="){if(Wd(t.value))return{unaryFilter:{field:bs(t.field),op:"IS_NAN"}};if(qd(t.value))return{unaryFilter:{field:bs(t.field),op:"IS_NULL"}}}else if(t.op==="!="){if(Wd(t.value))return{unaryFilter:{field:bs(t.field),op:"IS_NOT_NAN"}};if(qd(t.value))return{unaryFilter:{field:bs(t.field),op:"IS_NOT_NULL"}}}return{fieldFilter:{field:bs(t.field),op:FI(t.op),value:t.value}}}(n):n instanceof bt?function(t){const s=t.getFilters().map(i=>tg(i));return s.length===1?s[0]:{compositeFilter:{op:BI(t.op),filters:s}}}(n):j()}function UI(n){const e=[];return n.fields.forEach(t=>e.push(t.canonicalString())),{fieldPaths:e}}function ng(n){return n.length>=4&&n.get(0)==="projects"&&n.get(2)==="databases"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zI{constructor(){this.changes=new Zs(e=>e.toString(),(e,t)=>e.isEqual(t)),this.changesApplied=!1}addEntry(e){this.assertNotApplied(),this.changes.set(e.key,e)}removeEntry(e,t){this.assertNotApplied(),this.changes.set(e,Ve.newInvalidDocument(e).setReadTime(t))}getEntry(e,t){this.assertNotApplied();const s=this.changes.get(t);return s!==void 0?N.resolve(s):this.getFromCache(e,t)}getEntries(e,t){return this.getAllFromCache(e,t)}apply(e){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(e)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class HI{constructor(e,t,s,i){this.remoteDocumentCache=e,this.mutationQueue=t,this.documentOverlayCache=s,this.indexManager=i}getDocument(e,t){let s=null;return this.documentOverlayCache.getOverlay(e,t).next(i=>(s=i,this.remoteDocumentCache.getEntry(e,t))).next(i=>(s!==null&&Bi(s.mutation,i,dt.empty(),De.now()),i))}getDocuments(e,t){return this.remoteDocumentCache.getEntries(e,t).next(s=>this.getLocalViewOfDocuments(e,s,se()).next(()=>s))}getLocalViewOfDocuments(e,t,s=se()){const i=Hn();return this.populateOverlays(e,i,t).next(()=>this.computeViews(e,t,i,s).next(r=>{let o=Di();return r.forEach((l,c)=>{o=o.insert(l,c.overlayedDocument)}),o}))}getOverlayedDocuments(e,t){const s=Hn();return this.populateOverlays(e,s,t).next(()=>this.computeViews(e,t,s,se()))}populateOverlays(e,t,s){const i=[];return s.forEach(r=>{t.has(r)||i.push(r)}),this.documentOverlayCache.getOverlays(e,i).next(r=>{r.forEach((o,l)=>{t.set(o,l)})})}computeViews(e,t,s,i){let r=an();const o=Fi(),l=function(){return Fi()}();return t.forEach((c,h)=>{const d=s.get(h.key);i.has(h.key)&&(d===void 0||d.mutation instanceof Fn)?r=r.insert(h.key,h):d!==void 0?(o.set(h.key,d.mutation.getFieldMask()),Bi(d.mutation,h,d.mutation.getFieldMask(),De.now())):o.set(h.key,dt.empty())}),this.recalculateAndSaveOverlays(e,r).next(c=>(c.forEach((h,d)=>o.set(h,d)),t.forEach((h,d)=>{var p;return l.set(h,new GI(d,(p=o.get(h))!==null&&p!==void 0?p:null))}),l))}recalculateAndSaveOverlays(e,t){const s=Fi();let i=new ke((o,l)=>o-l),r=se();return this.mutationQueue.getAllMutationBatchesAffectingDocumentKeys(e,t).next(o=>{for(const l of o)l.keys().forEach(c=>{const h=t.get(c);if(h===null)return;let d=s.get(c)||dt.empty();d=l.applyToLocalView(h,d),s.set(c,d);const p=(i.get(l.batchId)||se()).add(c);i=i.insert(l.batchId,p)})}).next(()=>{const o=[],l=i.getReverseIterator();for(;l.hasNext();){const c=l.getNext(),h=c.key,d=c.value,p=Mm();d.forEach(m=>{if(!r.has(m)){const E=Wm(t.get(m),s.get(m));E!==null&&p.set(m,E),r=r.add(m)}}),o.push(this.documentOverlayCache.saveOverlays(e,h,p))}return N.waitFor(o)}).next(()=>s)}recalculateAndSaveOverlaysForDocumentKeys(e,t){return this.remoteDocumentCache.getEntries(e,t).next(s=>this.recalculateAndSaveOverlays(e,s))}getDocumentsMatchingQuery(e,t,s,i){return function(o){return W.isDocumentKey(o.path)&&o.collectionGroup===null&&o.filters.length===0}(t)?this.getDocumentsMatchingDocumentQuery(e,t.path):Nm(t)?this.getDocumentsMatchingCollectionGroupQuery(e,t,s,i):this.getDocumentsMatchingCollectionQuery(e,t,s,i)}getNextDocuments(e,t,s,i){return this.remoteDocumentCache.getAllFromCollectionGroup(e,t,s,i).next(r=>{const o=i-r.size>0?this.documentOverlayCache.getOverlaysForCollectionGroup(e,t,s.largestBatchId,i-r.size):N.resolve(Hn());let l=-1,c=r;return o.next(h=>N.forEach(h,(d,p)=>(l<p.largestBatchId&&(l=p.largestBatchId),r.get(d)?N.resolve():this.remoteDocumentCache.getEntry(e,d).next(m=>{c=c.insert(d,m)}))).next(()=>this.populateOverlays(e,h,r)).next(()=>this.computeViews(e,c,h,se())).next(d=>({batchId:l,changes:Om(d)})))})}getDocumentsMatchingDocumentQuery(e,t){return this.getDocument(e,new W(t)).next(s=>{let i=Di();return s.isFoundDocument()&&(i=i.insert(s.key,s)),i})}getDocumentsMatchingCollectionGroupQuery(e,t,s,i){const r=t.collectionGroup;let o=Di();return this.indexManager.getCollectionParents(e,r).next(l=>N.forEach(l,c=>{const h=function(p,m){return new _r(m,null,p.explicitOrderBy.slice(),p.filters.slice(),p.limit,p.limitType,p.startAt,p.endAt)}(t,c.child(r));return this.getDocumentsMatchingCollectionQuery(e,h,s,i).next(d=>{d.forEach((p,m)=>{o=o.insert(p,m)})})}).next(()=>o))}getDocumentsMatchingCollectionQuery(e,t,s,i){let r;return this.documentOverlayCache.getOverlaysForCollection(e,t.path,s.largestBatchId).next(o=>(r=o,this.remoteDocumentCache.getDocumentsMatchingQuery(e,t,s,r,i))).next(o=>{r.forEach((c,h)=>{const d=h.getKey();o.get(d)===null&&(o=o.insert(d,Ve.newInvalidDocument(d)))});let l=Di();return o.forEach((c,h)=>{const d=r.get(c);d!==void 0&&Bi(d.mutation,h,dt.empty(),De.now()),da(t,h)&&(l=l.insert(c,h))}),l})}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class QI{constructor(){this.overlays=new ke(W.comparator),this.Ir=new Map}getOverlay(e,t){return N.resolve(this.overlays.get(t))}getOverlays(e,t){const s=Hn();return N.forEach(t,i=>this.getOverlay(e,i).next(r=>{r!==null&&s.set(i,r)})).next(()=>s)}saveOverlays(e,t,s){return s.forEach((i,r)=>{this.ht(e,t,r)}),N.resolve()}removeOverlaysForBatchId(e,t,s){const i=this.Ir.get(s);return i!==void 0&&(i.forEach(r=>this.overlays=this.overlays.remove(r)),this.Ir.delete(s)),N.resolve()}getOverlaysForCollection(e,t,s){const i=Hn(),r=t.length+1,o=new W(t.child("")),l=this.overlays.getIteratorFrom(o);for(;l.hasNext();){const c=l.getNext().value,h=c.getKey();if(!t.isPrefixOf(h.path))break;h.path.length===r&&c.largestBatchId>s&&i.set(c.getKey(),c)}return N.resolve(i)}getOverlaysForCollectionGroup(e,t,s,i){let r=new ke((h,d)=>h-d);const o=this.overlays.getIterator();for(;o.hasNext();){const h=o.getNext().value;if(h.getKey().getCollectionGroup()===t&&h.largestBatchId>s){let d=r.get(h.largestBatchId);d===null&&(d=Hn(),r=r.insert(h.largestBatchId,d)),d.set(h.getKey(),h)}}const l=Hn(),c=r.getIterator();for(;c.hasNext()&&(c.getNext().value.forEach((h,d)=>l.set(h,d)),!(l.size()>=i)););return N.resolve(l)}ht(e,t,s){const i=this.overlays.get(s.key);if(i!==null){const o=this.Ir.get(i.largestBatchId).delete(s.key);this.Ir.set(i.largestBatchId,o)}this.overlays=this.overlays.insert(s.key,new vI(t,s));let r=this.Ir.get(t);r===void 0&&(r=se(),this.Ir.set(t,r)),this.Ir.set(t,r.add(s.key))}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Jc{constructor(){this.Tr=new We(Oe.Er),this.dr=new We(Oe.Ar)}isEmpty(){return this.Tr.isEmpty()}addReference(e,t){const s=new Oe(e,t);this.Tr=this.Tr.add(s),this.dr=this.dr.add(s)}Rr(e,t){e.forEach(s=>this.addReference(s,t))}removeReference(e,t){this.Vr(new Oe(e,t))}mr(e,t){e.forEach(s=>this.removeReference(s,t))}gr(e){const t=new W(new me([])),s=new Oe(t,e),i=new Oe(t,e+1),r=[];return this.dr.forEachInRange([s,i],o=>{this.Vr(o),r.push(o.key)}),r}pr(){this.Tr.forEach(e=>this.Vr(e))}Vr(e){this.Tr=this.Tr.delete(e),this.dr=this.dr.delete(e)}yr(e){const t=new W(new me([])),s=new Oe(t,e),i=new Oe(t,e+1);let r=se();return this.dr.forEachInRange([s,i],o=>{r=r.add(o.key)}),r}containsKey(e){const t=new Oe(e,0),s=this.Tr.firstAfterOrEqual(t);return s!==null&&e.isEqual(s.key)}}class Oe{constructor(e,t){this.key=e,this.wr=t}static Er(e,t){return W.comparator(e.key,t.key)||le(e.wr,t.wr)}static Ar(e,t){return le(e.wr,t.wr)||W.comparator(e.key,t.key)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Zc{constructor(e,t,s,i){this.targetId=e,this.fromCache=t,this.$i=s,this.Ui=i}static Wi(e,t){let s=se(),i=se();for(const r of t.docChanges)switch(r.type){case 0:s=s.add(r.doc.key);break;case 1:i=i.add(r.doc.key)}return new Zc(e,t.fromCache,s,i)}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class i0{constructor(){this.Gi=!1,this.zi=!1,this.ji=100,this.Hi=function(){return iv()?8:UT(et())>0?6:4}()}initialize(e,t){this.Ji=e,this.indexManager=t,this.Gi=!0}getDocumentsMatchingQuery(e,t,s,i){const r={result:null};return this.Yi(e,t).next(o=>{r.result=o}).next(()=>{if(!r.result)return this.Zi(e,t,i,s).next(o=>{r.result=o})}).next(()=>{if(r.result)return;const o=new s0;return this.Xi(e,t,o).next(l=>{if(r.result=l,this.zi)return this.es(e,t,o,l.size)})}).next(()=>r.result)}es(e,t,s,i){return s.documentReadCount<this.ji?(Ei()<=ne.DEBUG&&B("QueryEngine","SDK will not create cache indexes for query:",Cs(t),"since it only creates cache indexes for collection contains","more than or equal to",this.ji,"documents"),N.resolve()):(Ei()<=ne.DEBUG&&B("QueryEngine","Query:",Cs(t),"scans",s.documentReadCount,"local documents and returns",i,"documents as results."),s.documentReadCount>this.Hi*i?(Ei()<=ne.DEBUG&&B("QueryEngine","The SDK decides to create cache indexes for query:",Cs(t),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,xt(t))):N.resolve())}Yi(e,t){if(Gd(t))return N.resolve(null);let s=xt(t);return this.indexManager.getIndexType(e,s).next(i=>i===0?null:(t.limit!==null&&i===1&&(t=xo(t,null,"F"),s=xt(t)),this.indexManager.getDocumentsMatchingTarget(e,s).next(r=>{const o=se(...r);return this.Ji.getDocuments(e,o).next(l=>this.indexManager.getMinOffset(e,s).next(c=>{const h=this.ts(t,l);return this.ns(t,h,o,c.readTime)?this.Yi(e,xo(t,null,"F")):this.rs(e,h,t,c)}))})))}Zi(e,t,s,i){return Gd(t)||i.isEqual(G.min())?N.resolve(null):this.Ji.getDocuments(e,s).next(r=>{const o=this.ts(t,r);return this.ns(t,o,s,i)?N.resolve(null):(Ei()<=ne.DEBUG&&B("QueryEngine","Re-using previous result from %s to execute query: %s",i.toString(),Cs(t)),this.rs(e,o,t,OT(i,-1)).next(l=>l))})}ts(e,t){let s=new We(Lm(e));return t.forEach((i,r)=>{da(e,r)&&(s=s.add(r))}),s}ns(e,t,s,i){if(e.limit===null)return!1;if(s.size!==t.size)return!0;const r=e.limitType==="F"?t.last():t.first();return!!r&&(r.hasPendingWrites||r.version.compareTo(i)>0)}Xi(e,t,s){return Ei()<=ne.DEBUG&&B("QueryEngine","Using full collection scan to execute query:",Cs(t)),this.Ji.getDocumentsMatchingQuery(e,t,Nn.min(),s)}rs(e,t,s,i){return this.Ji.getDocumentsMatchingQuery(e,s,i).next(r=>(t.forEach(o=>{r=r.insert(o.key,o)}),r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class r0{constructor(e,t,s,i){this.persistence=e,this.ss=t,this.serializer=i,this.os=new ke(le),this._s=new Zs(r=>$c(r),jc),this.us=new Map,this.cs=e.getRemoteDocumentCache(),this.Ur=e.getTargetCache(),this.Gr=e.getBundleCache(),this.ls(s)}ls(e){this.documentOverlayCache=this.persistence.getDocumentOverlayCache(e),this.indexManager=this.persistence.getIndexManager(e),this.mutationQueue=this.persistence.getMutationQueue(e,this.indexManager),this.localDocuments=new HI(this.cs,this.mutationQueue,this.documentOverlayCache,this.indexManager),this.cs.setIndexManager(this.indexManager),this.ss.initialize(this.localDocuments,this.indexManager)}collectGarbage(e){return this.persistence.runTransaction("Collect garbage","readwrite-primary",t=>e.collect(t,this.os))}}function o0(n,e,t,s){return new r0(n,e,t,s)}async function sg(n,e){const t=K(n);return await t.persistence.runTransaction("Handle user change","readonly",s=>{let i;return t.mutationQueue.getAllMutationBatches(s).next(r=>(i=r,t.ls(e),t.mutationQueue.getAllMutationBatches(s))).next(r=>{const o=[],l=[];let c=se();for(const h of i){o.push(h.batchId);for(const d of h.mutations)c=c.add(d.key)}for(const h of r){l.push(h.batchId);for(const d of h.mutations)c=c.add(d.key)}return t.localDocuments.getDocuments(s,c).next(h=>({hs:h,removedBatchIds:o,addedBatchIds:l}))})})}function a0(n,e){const t=K(n);return t.persistence.runTransaction("Acknowledge batch","readwrite-primary",s=>{const i=e.batch.keys(),r=t.cs.newChangeBuffer({trackRemovals:!0});return function(l,c,h,d){const p=h.batch,m=p.keys();let E=N.resolve();return m.forEach(C=>{E=E.next(()=>d.getEntry(c,C)).next(A=>{const k=h.docVersions.get(C);oe(k!==null),A.version.compareTo(k)<0&&(p.applyToRemoteDocument(A,h),A.isValidDocument()&&(A.setReadTime(h.commitVersion),d.addEntry(A)))})}),E.next(()=>l.mutationQueue.removeMutationBatch(c,p))}(t,s,e,r).next(()=>r.apply(s)).next(()=>t.mutationQueue.performConsistencyCheck(s)).next(()=>t.documentOverlayCache.removeOverlaysForBatchId(s,i,e.batch.batchId)).next(()=>t.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(s,function(l){let c=se();for(let h=0;h<l.mutationResults.length;++h)l.mutationResults[h].transformResults.length>0&&(c=c.add(l.batch.mutations[h].key));return c}(e))).next(()=>t.localDocuments.getDocuments(s,i))})}function ig(n){const e=K(n);return e.persistence.runTransaction("Get last remote snapshot version","readonly",t=>e.Ur.getLastRemoteSnapshotVersion(t))}function l0(n,e){const t=K(n),s=e.snapshotVersion;let i=t.os;return t.persistence.runTransaction("Apply remote event","readwrite-primary",r=>{const o=t.cs.newChangeBuffer({trackRemovals:!0});i=t.os;const l=[];e.targetChanges.forEach((d,p)=>{const m=i.get(p);if(!m)return;l.push(t.Ur.removeMatchingKeys(r,d.removedDocuments,p).next(()=>t.Ur.addMatchingKeys(r,d.addedDocuments,p)));let E=m.withSequenceNumber(r.currentSequenceNumber);e.targetMismatches.get(p)!==null?E=E.withResumeToken($e.EMPTY_BYTE_STRING,G.min()).withLastLimboFreeSnapshotVersion(G.min()):d.resumeToken.approximateByteSize()>0&&(E=E.withResumeToken(d.resumeToken,s)),i=i.insert(p,E),function(A,k,F){return A.resumeToken.approximateByteSize()===0||k.snapshotVersion.toMicroseconds()-A.snapshotVersion.toMicroseconds()>=3e8?!0:F.addedDocuments.size+F.modifiedDocuments.size+F.removedDocuments.size>0}(m,E,d)&&l.push(t.Ur.updateTargetData(r,E))});let c=an(),h=se();if(e.documentUpdates.forEach(d=>{e.resolvedLimboDocuments.has(d)&&l.push(t.persistence.referenceDelegate.updateLimboDocument(r,d))}),l.push(c0(r,o,e.documentUpdates).next(d=>{c=d.Ps,h=d.Is})),!s.isEqual(G.min())){const d=t.Ur.getLastRemoteSnapshotVersion(r).next(p=>t.Ur.setTargetsMetadata(r,r.currentSequenceNumber,s));l.push(d)}return N.waitFor(l).next(()=>o.apply(r)).next(()=>t.localDocuments.getLocalViewOfDocuments(r,c,h)).next(()=>c)}).then(r=>(t.os=i,r))}function c0(n,e,t){let s=se(),i=se();return t.forEach(r=>s=s.add(r)),e.getEntries(n,s).next(r=>{let o=an();return t.forEach((l,c)=>{const h=r.get(l);c.isFoundDocument()!==h.isFoundDocument()&&(i=i.add(l)),c.isNoDocument()&&c.version.isEqual(G.min())?(e.removeEntry(l,c.readTime),o=o.insert(l,c)):!h.isValidDocument()||c.version.compareTo(h.version)>0||c.version.compareTo(h.version)===0&&h.hasPendingWrites?(e.addEntry(c),o=o.insert(l,c)):B("LocalStore","Ignoring outdated watch update for ",l,". Current version:",h.version," Watch version:",c.version)}),{Ps:o,Is:i}})}function h0(n,e){const t=K(n);return t.persistence.runTransaction("Get next mutation batch","readonly",s=>(e===void 0&&(e=-1),t.mutationQueue.getNextMutationBatchAfterBatchId(s,e)))}function u0(n,e){const t=K(n);return t.persistence.runTransaction("Allocate target","readwrite",s=>{let i;return t.Ur.getTargetData(s,e).next(r=>r?(i=r,N.resolve(i)):t.Ur.allocateTargetId(s).next(o=>(i=new En(e,o,"TargetPurposeListen",s.currentSequenceNumber),t.Ur.addTargetData(s,i).next(()=>i))))}).then(s=>{const i=t.os.get(s.targetId);return(i===null||s.snapshotVersion.compareTo(i.snapshotVersion)>0)&&(t.os=t.os.insert(s.targetId,s),t._s.set(e,s.targetId)),s})}async function Xl(n,e,t){const s=K(n),i=s.os.get(e),r=t?"readwrite":"readwrite-primary";try{t||await s.persistence.runTransaction("Release target",r,o=>s.persistence.referenceDelegate.removeTarget(o,i))}catch(o){if(!mr(o))throw o;B("LocalStore",`Failed to update sequence numbers for target ${e}: ${o}`)}s.os=s.os.remove(e),s._s.delete(i.target)}function sf(n,e,t){const s=K(n);let i=G.min(),r=se();return s.persistence.runTransaction("Execute query","readwrite",o=>function(c,h,d){const p=K(c),m=p._s.get(d);return m!==void 0?N.resolve(p.os.get(m)):p.Ur.getTargetData(h,d)}(s,o,xt(e)).next(l=>{if(l)return i=l.lastLimboFreeSnapshotVersion,s.Ur.getMatchingKeysForTargetId(o,l.targetId).next(c=>{r=c})}).next(()=>s.ss.getDocumentsMatchingQuery(o,e,t?i:G.min(),t?r:se())).next(l=>(d0(s,iI(e),l),{documents:l,Ts:r})))}function d0(n,e,t){let s=n.us.get(e)||G.min();t.forEach((i,r)=>{r.readTime.compareTo(s)>0&&(s=r.readTime)}),n.us.set(e,s)}class rf{constructor(){this.activeTargetIds=hI()}fs(e){this.activeTargetIds=this.activeTargetIds.add(e)}gs(e){this.activeTargetIds=this.activeTargetIds.delete(e)}Vs(){const e={activeTargetIds:this.activeTargetIds.toArray(),updateTimeMs:Date.now()};return JSON.stringify(e)}}class f0{constructor(){this.so=new rf,this.oo={},this.onlineStateHandler=null,this.sequenceNumberHandler=null}addPendingMutation(e){}updateMutationState(e,t,s){}addLocalQueryTarget(e,t=!0){return t&&this.so.fs(e),this.oo[e]||"not-current"}updateQueryState(e,t,s){this.oo[e]=t}removeLocalQueryTarget(e){this.so.gs(e)}isLocalQueryTarget(e){return this.so.activeTargetIds.has(e)}clearQueryState(e){delete this.oo[e]}getAllActiveQueryTargets(){return this.so.activeTargetIds}isActiveQueryTarget(e){return this.so.activeTargetIds.has(e)}start(){return this.so=new rf,Promise.resolve()}handleUserChange(e,t,s){}setOnlineState(e){}shutdown(){}writeSequenceNumber(e){}notifyBundleLoaded(e){}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ye="WebChannelConnection";class _0 extends class{constructor(t){this.databaseInfo=t,this.databaseId=t.databaseId;const s=t.ssl?"https":"http",i=encodeURIComponent(this.databaseId.projectId),r=encodeURIComponent(this.databaseId.database);this.Do=s+"://"+t.host,this.vo=`projects/${i}/databases/${r}`,this.Co=this.databaseId.database==="(default)"?`project_id=${i}`:`project_id=${i}&database_id=${r}`}get Fo(){return!1}Mo(t,s,i,r,o){const l=cl(),c=this.xo(t,s.toUriEncodedString());B("RestConnection",`Sending RPC '${t}' ${l}:`,c,i);const h={"google-cloud-resource-prefix":this.vo,"x-goog-request-params":this.Co};return this.Oo(h,r,o),this.No(t,c,h,i).then(d=>(B("RestConnection",`Received RPC '${t}' ${l}: `,d),d),d=>{throw Vs("RestConnection",`RPC '${t}' ${l} failed with error: `,d,"url: ",c,"request:",i),d})}Lo(t,s,i,r,o,l){return this.Mo(t,s,i,r,o)}Oo(t,s,i){t["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+Xs}(),t["Content-Type"]="text/plain",this.databaseInfo.appId&&(t["X-Firebase-GMPID"]=this.databaseInfo.appId),s&&s.headers.forEach((r,o)=>t[o]=r),i&&i.headers.forEach((r,o)=>t[o]=r)}xo(t,s){const i=m0[t];return`${this.Do}/v1/${s}:${i}`}terminate(){}}{constructor(e){super(e),this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}No(e,t,s,i){const r=cl();return new Promise((o,l)=>{const c=new mm;c.setWithCredentials(!0),c.listenOnce(gm.COMPLETE,()=>{try{switch(c.getLastErrorCode()){case co.NO_ERROR:const d=c.getResponseJson();B(Ye,`XHR for RPC '${e}' ${r} received:`,JSON.stringify(d)),o(d);break;case co.TIMEOUT:B(Ye,`RPC '${e}' ${r} timed out`),l(new M(P.DEADLINE_EXCEEDED,"Request time out"));break;case co.HTTP_ERROR:const p=c.getStatus();if(B(Ye,`RPC '${e}' ${r} failed with status:`,p,"response text:",c.getResponseText()),p>0){let m=c.getResponseJson();Array.isArray(m)&&(m=m[0]);const E=m==null?void 0:m.error;if(E&&E.status&&E.message){const C=function(k){const F=k.toLowerCase().replace(/_/g,"-");return Object.values(P).indexOf(F)>=0?F:P.UNKNOWN}(E.status);l(new M(C,E.message))}else l(new M(P.UNKNOWN,"Server responded with status "+c.getStatus()))}else l(new M(P.UNAVAILABLE,"Connection failed."));break;default:j()}}finally{B(Ye,`RPC '${e}' ${r} completed.`)}});const h=JSON.stringify(i);B(Ye,`RPC '${e}' ${r} sending request:`,i),c.send(t,"POST",h,s,15)})}Bo(e,t,s){const i=cl(),r=[this.Do,"/","google.firestore.v1.Firestore","/",e,"/channel"],o=vm(),l=ym(),c={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},h=this.longPollingOptions.timeoutSeconds;h!==void 0&&(c.longPollingTimeout=Math.round(1e3*h)),this.useFetchStreams&&(c.useFetchStreams=!0),this.Oo(c.initMessageHeaders,t,s),c.encodeInitMessageHeaders=!0;const d=r.join("");B(Ye,`Creating RPC '${e}' stream ${i}: ${d}`,c);const p=o.createWebChannel(d,c);let m=!1,E=!1;const C=new g0({Io:k=>{E?B(Ye,`Not sending because RPC '${e}' stream ${i} is closed:`,k):(m||(B(Ye,`Opening RPC '${e}' stream ${i} transport.`),p.open(),m=!0),B(Ye,`RPC '${e}' stream ${i} sending:`,k),p.send(k))},To:()=>p.close()}),A=(k,F,q)=>{k.listen(F,U=>{try{q(U)}catch(te){setTimeout(()=>{throw te},0)}})};return A(p,Ni.EventType.OPEN,()=>{E||(B(Ye,`RPC '${e}' stream ${i} transport opened.`),C.yo())}),A(p,Ni.EventType.CLOSE,()=>{E||(E=!0,B(Ye,`RPC '${e}' stream ${i} transport closed`),C.So())}),A(p,Ni.EventType.ERROR,k=>{E||(E=!0,Vs(Ye,`RPC '${e}' stream ${i} transport errored:`,k),C.So(new M(P.UNAVAILABLE,"The operation could not be completed")))}),A(p,Ni.EventType.MESSAGE,k=>{var F;if(!E){const q=k.data[0];oe(!!q);const U=q,te=U.error||((F=U[0])===null||F===void 0?void 0:F.error);if(te){B(Ye,`RPC '${e}' stream ${i} received error:`,te);const ve=te.status;let de=function(y){const w=Re[y];if(w!==void 0)return Gm(w)}(ve),I=te.message;de===void 0&&(de=P.INTERNAL,I="Unknown error status: "+ve+" with message "+te.message),E=!0,C.So(new M(de,I)),p.close()}else B(Ye,`RPC '${e}' stream ${i} received:`,q),C.bo(q)}}),A(l,_m.STAT_EVENT,k=>{k.stat===Wl.PROXY?B(Ye,`RPC '${e}' stream ${i} detected buffering proxy`):k.stat===Wl.NOPROXY&&B(Ye,`RPC '${e}' stream ${i} detected no buffering proxy`)}),setTimeout(()=>{C.wo()},0),C}}function hl(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rg{constructor(e,t,s,i,r,o,l,c){this.ui=e,this.Ho=s,this.Jo=i,this.connection=r,this.authCredentialsProvider=o,this.appCheckCredentialsProvider=l,this.listener=c,this.state=0,this.Yo=0,this.Zo=null,this.Xo=null,this.stream=null,this.e_=0,this.t_=new eh(e,t)}n_(){return this.state===1||this.state===5||this.r_()}r_(){return this.state===2||this.state===3}start(){this.e_=0,this.state!==4?this.auth():this.i_()}async stop(){this.n_()&&await this.close(0)}s_(){this.state=0,this.t_.reset()}o_(){this.r_()&&this.Zo===null&&(this.Zo=this.ui.enqueueAfterDelay(this.Ho,6e4,()=>this.__()))}a_(e){this.u_(),this.stream.send(e)}async __(){if(this.r_())return this.close(0)}u_(){this.Zo&&(this.Zo.cancel(),this.Zo=null)}c_(){this.Xo&&(this.Xo.cancel(),this.Xo=null)}async close(e,t){this.u_(),this.c_(),this.t_.cancel(),this.Yo++,e!==4?this.t_.reset():t&&t.code===P.RESOURCE_EXHAUSTED?(on(t.toString()),on("Using maximum backoff delay to prevent overloading the backend."),this.t_.Wo()):t&&t.code===P.UNAUTHENTICATED&&this.state!==3&&(this.authCredentialsProvider.invalidateToken(),this.appCheckCredentialsProvider.invalidateToken()),this.stream!==null&&(this.l_(),this.stream.close(),this.stream=null),this.state=e,await this.listener.mo(t)}l_(){}auth(){this.state=1;const e=this.h_(this.Yo),t=this.Yo;Promise.all([this.authCredentialsProvider.getToken(),this.appCheckCredentialsProvider.getToken()]).then(([s,i])=>{this.Yo===t&&this.P_(s,i)},s=>{e(()=>{const i=new M(P.UNKNOWN,"Fetching auth token failed: "+s.message);return this.I_(i)})})}P_(e,t){const s=this.h_(this.Yo);this.stream=this.T_(e,t),this.stream.Eo(()=>{s(()=>this.listener.Eo())}),this.stream.Ro(()=>{s(()=>(this.state=2,this.Xo=this.ui.enqueueAfterDelay(this.Jo,1e4,()=>(this.r_()&&(this.state=3),Promise.resolve())),this.listener.Ro()))}),this.stream.mo(i=>{s(()=>this.I_(i))}),this.stream.onMessage(i=>{s(()=>++this.e_==1?this.E_(i):this.onNext(i))})}i_(){this.state=5,this.t_.Go(async()=>{this.state=0,this.start()})}I_(e){return B("PersistentStream",`close with error: ${e}`),this.stream=null,this.close(4,e)}h_(e){return t=>{this.ui.enqueueAndForget(()=>this.Yo===e?t():(B("PersistentStream","stream callback skipped by getCloseGuardedDispatcher."),Promise.resolve()))}}}class y0 extends rg{constructor(e,t,s,i,r,o){super(e,"listen_stream_connection_backoff","listen_stream_idle","health_check_timeout",t,s,i,o),this.serializer=r}T_(e,t){return this.connection.Bo("Listen",e,t)}E_(e){return this.onNext(e)}onNext(e){this.t_.reset();const t=NI(this.serializer,e),s=function(r){if(!("targetChange"in r))return G.min();const o=r.targetChange;return o.targetIds&&o.targetIds.length?G.min():o.readTime?ft(o.readTime):G.min()}(e);return this.listener.d_(t,s)}A_(e){const t={};t.database=Jl(this.serializer),t.addTarget=function(r,o){let l;const c=o.target;if(l=Hl(c)?{documents:LI(r,c)}:{query:xI(r,c)._t},l.targetId=o.targetId,o.resumeToken.approximateByteSize()>0){l.resumeToken=Qm(r,o.resumeToken);const h=Ql(r,o.expectedCount);h!==null&&(l.expectedCount=h)}else if(o.snapshotVersion.compareTo(G.min())>0){l.readTime=Vo(r,o.snapshotVersion.toTimestamp());const h=Ql(r,o.expectedCount);h!==null&&(l.expectedCount=h)}return l}(this.serializer,e);const s=MI(this.serializer,e);s&&(t.labels=s),this.a_(t)}R_(e){const t={};t.database=Jl(this.serializer),t.removeTarget=e,this.a_(t)}}class v0 extends rg{constructor(e,t,s,i,r,o){super(e,"write_stream_connection_backoff","write_stream_idle","health_check_timeout",t,s,i,o),this.serializer=r}get V_(){return this.e_>0}start(){this.lastStreamToken=void 0,super.start()}l_(){this.V_&&this.m_([])}T_(e,t){return this.connection.Bo("Write",e,t)}E_(e){return oe(!!e.streamToken),this.lastStreamToken=e.streamToken,oe(!e.writeResults||e.writeResults.length===0),this.listener.f_()}onNext(e){oe(!!e.streamToken),this.lastStreamToken=e.streamToken,this.t_.reset();const t=DI(e.writeResults,e.commitTime),s=ft(e.commitTime);return this.listener.g_(s,t)}p_(){const e={};e.database=Jl(this.serializer),this.a_(e)}m_(e){const t={streamToken:this.lastStreamToken,writes:e.map(s=>Zm(this.serializer,s))};this.a_(t)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class lf{constructor(){this.W_=new ke(W.comparator)}track(e){const t=e.doc.key,s=this.W_.get(t);s?e.type!==0&&s.type===3?this.W_=this.W_.insert(t,e):e.type===3&&s.type!==1?this.W_=this.W_.insert(t,{type:s.type,doc:e.doc}):e.type===2&&s.type===2?this.W_=this.W_.insert(t,{type:2,doc:e.doc}):e.type===2&&s.type===0?this.W_=this.W_.insert(t,{type:0,doc:e.doc}):e.type===1&&s.type===0?this.W_=this.W_.remove(t):e.type===1&&s.type===2?this.W_=this.W_.insert(t,{type:1,doc:s.doc}):e.type===0&&s.type===1?this.W_=this.W_.insert(t,{type:2,doc:e.doc}):j():this.W_=this.W_.insert(t,e)}G_(){const e=[];return this.W_.inorderTraversal((t,s)=>{e.push(s)}),e}}class Ws{constructor(e,t,s,i,r,o,l,c,h){this.query=e,this.docs=t,this.oldDocs=s,this.docChanges=i,this.mutatedKeys=r,this.fromCache=o,this.syncStateChanged=l,this.excludesMetadataChanges=c,this.hasCachedResults=h}static fromInitialDocuments(e,t,s,i,r){const o=[];return t.forEach(l=>{o.push({type:0,doc:l})}),new Ws(e,t,Ds.emptySet(t),o,s,i,!0,!1,r)}get hasPendingWrites(){return!this.mutatedKeys.isEmpty()}isEqual(e){if(!(this.fromCache===e.fromCache&&this.hasCachedResults===e.hasCachedResults&&this.syncStateChanged===e.syncStateChanged&&this.mutatedKeys.isEqual(e.mutatedKeys)&&ua(this.query,e.query)&&this.docs.isEqual(e.docs)&&this.oldDocs.isEqual(e.oldDocs)))return!1;const t=this.docChanges,s=e.docChanges;if(t.length!==s.length)return!1;for(let i=0;i<t.length;i++)if(t[i].type!==s[i].type||!t[i].doc.isEqual(s[i].doc))return!1;return!0}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class x0{constructor(){this.z_=void 0,this.j_=[]}H_(){return this.j_.some(e=>e.J_())}}class O0{constructor(){this.queries=cf(),this.onlineState="Unknown",this.Y_=new Set}terminate(){(function(t,s){const i=K(t),r=i.queries;i.queries=cf(),r.forEach((o,l)=>{for(const c of l.j_)c.onError(s)})})(this,new M(P.ABORTED,"Firestore shutting down"))}}function cf(){return new Zs(n=>Dm(n),ua)}async function dg(n,e){const t=K(n);let s=3;const i=e.query;let r=t.queries.get(i);r?!r.H_()&&e.J_()&&(s=2):(r=new x0,s=e.J_()?0:1);try{switch(s){case 0:r.z_=await t.onListen(i,!0);break;case 1:r.z_=await t.onListen(i,!1);break;case 2:await t.onFirstRemoteStoreListen(i)}}catch(o){const l=oh(o,`Initialization of query '${Cs(e.query)}' failed`);return void e.onError(l)}t.queries.set(i,r),r.j_.push(e),e.Z_(t.onlineState),r.z_&&e.X_(r.z_)&&ah(t)}async function fg(n,e){const t=K(n),s=e.query;let i=3;const r=t.queries.get(s);if(r){const o=r.j_.indexOf(e);o>=0&&(r.j_.splice(o,1),r.j_.length===0?i=e.J_()?0:1:!r.H_()&&e.J_()&&(i=2))}switch(i){case 0:return t.queries.delete(s),t.onUnlisten(s,!0);case 1:return t.queries.delete(s),t.onUnlisten(s,!1);case 2:return t.onLastRemoteStoreUnlisten(s);default:return}}function M0(n,e){const t=K(n);let s=!1;for(const i of e){const r=i.query,o=t.queries.get(r);if(o){for(const l of o.j_)l.X_(i)&&(s=!0);o.z_=i}}s&&ah(t)}function V0(n,e,t){const s=K(n),i=s.queries.get(e);if(i)for(const r of i.j_)r.onError(t);s.queries.delete(e)}function ah(n){n.Y_.forEach(e=>{e.next()})}var Zl,hf;(hf=Zl||(Zl={})).ea="default",hf.Cache="cache";class pg{constructor(e,t,s){this.query=e,this.ta=t,this.na=!1,this.ra=null,this.onlineState="Unknown",this.options=s||{}}X_(e){if(!this.options.includeMetadataChanges){const s=[];for(const i of e.docChanges)i.type!==3&&s.push(i);e=new Ws(e.query,e.docs,e.oldDocs,s,e.mutatedKeys,e.fromCache,e.syncStateChanged,!0,e.hasCachedResults)}let t=!1;return this.na?this.ia(e)&&(this.ta.next(e),t=!0):this.sa(e,this.onlineState)&&(this.oa(e),t=!0),this.ra=e,t}onError(e){this.ta.error(e)}Z_(e){this.onlineState=e;let t=!1;return this.ra&&!this.na&&this.sa(this.ra,e)&&(this.oa(this.ra),t=!0),t}sa(e,t){if(!e.fromCache||!this.J_())return!0;const s=t!=="Offline";return(!this.options._a||!s)&&(!e.docs.isEmpty()||e.hasCachedResults||t==="Offline")}ia(e){if(e.docChanges.length>0)return!0;const t=this.ra&&this.ra.hasPendingWrites!==e.hasPendingWrites;return!(!e.syncStateChanged&&!t)&&this.options.includeMetadataChanges===!0}oa(e){e=Ws.fromInitialDocuments(e.query,e.docs,e.mutatedKeys,e.fromCache,e.hasCachedResults),this.na=!0,this.ta.next(e)}J_(){return this.options.source!==Zl.Cache}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class mg{constructor(e){this.key=e}}class gg{constructor(e){this.key=e}}class F0{constructor(e,t){this.query=e,this.Ta=t,this.Ea=null,this.hasCachedResults=!1,this.current=!1,this.da=se(),this.mutatedKeys=se(),this.Aa=Lm(e),this.Ra=new Ds(this.Aa)}get Va(){return this.Ta}ma(e,t){const s=t?t.fa:new lf,i=t?t.Ra:this.Ra;let r=t?t.mutatedKeys:this.mutatedKeys,o=i,l=!1;const c=this.query.limitType==="F"&&i.size===this.query.limit?i.last():null,h=this.query.limitType==="L"&&i.size===this.query.limit?i.first():null;if(e.inorderTraversal((d,p)=>{const m=i.get(d),E=da(this.query,p)?p:null,C=!!m&&this.mutatedKeys.has(m.key),A=!!E&&(E.hasLocalMutations||this.mutatedKeys.has(E.key)&&E.hasCommittedMutations);let k=!1;m&&E?m.data.isEqual(E.data)?C!==A&&(s.track({type:3,doc:E}),k=!0):this.ga(m,E)||(s.track({type:2,doc:E}),k=!0,(c&&this.Aa(E,c)>0||h&&this.Aa(E,h)<0)&&(l=!0)):!m&&E?(s.track({type:0,doc:E}),k=!0):m&&!E&&(s.track({type:1,doc:m}),k=!0,(c||h)&&(l=!0)),k&&(E?(o=o.add(E),r=A?r.add(d):r.delete(d)):(o=o.delete(d),r=r.delete(d)))}),this.query.limit!==null)for(;o.size>this.query.limit;){const d=this.query.limitType==="F"?o.last():o.first();o=o.delete(d.key),r=r.delete(d.key),s.track({type:1,doc:d})}return{Ra:o,fa:s,ns:l,mutatedKeys:r}}ga(e,t){return e.hasLocalMutations&&t.hasCommittedMutations&&!t.hasLocalMutations}applyChanges(e,t,s,i){const r=this.Ra;this.Ra=e.Ra,this.mutatedKeys=e.mutatedKeys;const o=e.fa.G_();o.sort((d,p)=>function(E,C){const A=k=>{switch(k){case 0:return 1;case 2:case 3:return 2;case 1:return 0;default:return j()}};return A(E)-A(C)}(d.type,p.type)||this.Aa(d.doc,p.doc)),this.pa(s),i=i!=null&&i;const l=t&&!i?this.ya():[],c=this.da.size===0&&this.current&&!i?1:0,h=c!==this.Ea;return this.Ea=c,o.length!==0||h?{snapshot:new Ws(this.query,e.Ra,r,o,e.mutatedKeys,c===0,h,!1,!!s&&s.resumeToken.approximateByteSize()>0),wa:l}:{wa:l}}Z_(e){return this.current&&e==="Offline"?(this.current=!1,this.applyChanges({Ra:this.Ra,fa:new lf,mutatedKeys:this.mutatedKeys,ns:!1},!1)):{wa:[]}}Sa(e){return!this.Ta.has(e)&&!!this.Ra.has(e)&&!this.Ra.get(e).hasLocalMutations}pa(e){e&&(e.addedDocuments.forEach(t=>this.Ta=this.Ta.add(t)),e.modifiedDocuments.forEach(t=>{}),e.removedDocuments.forEach(t=>this.Ta=this.Ta.delete(t)),this.current=e.current)}ya(){if(!this.current)return[];const e=this.da;this.da=se(),this.Ra.forEach(s=>{this.Sa(s.key)&&(this.da=this.da.add(s.key))});const t=[];return e.forEach(s=>{this.da.has(s)||t.push(new gg(s))}),this.da.forEach(s=>{e.has(s)||t.push(new mg(s))}),t}ba(e){this.Ta=e.Ts,this.da=se();const t=this.ma(e.documents);return this.applyChanges(t,!0)}Da(){return Ws.fromInitialDocuments(this.query,this.Ra,this.mutatedKeys,this.Ea===0,this.hasCachedResults)}}class B0{constructor(e,t,s){this.query=e,this.targetId=t,this.view=s}}class U0{constructor(e){this.key=e,this.va=!1}}class q0{constructor(e,t,s,i,r,o){this.localStore=e,this.remoteStore=t,this.eventManager=s,this.sharedClientState=i,this.currentUser=r,this.maxConcurrentLimboResolutions=o,this.Ca={},this.Fa=new Zs(l=>Dm(l),ua),this.Ma=new Map,this.xa=new Set,this.Oa=new ke(W.comparator),this.Na=new Map,this.La=new Jc,this.Ba={},this.ka=new Map,this.qa=qs.kn(),this.onlineState="Unknown",this.Qa=void 0}get isPrimaryClient(){return this.Qa===!0}}async function W0(n,e,t=!0){const s=Tg(n);let i;const r=s.Fa.get(e);return r?(s.sharedClientState.addLocalQueryTarget(r.targetId),i=r.view.Da()):i=await _g(s,e,t,!0),i}async function $0(n,e){const t=Tg(n);await _g(t,e,!0,!1)}async function _g(n,e,t,s){const i=await u0(n.localStore,xt(e)),r=i.targetId,o=n.sharedClientState.addLocalQueryTarget(r,t);let l;return s&&(l=await j0(n,e,r,o==="current",i.resumeToken)),n.isPrimaryClient&&t&&og(n.remoteStore,i),l}async function j0(n,e,t,s,i){n.Ka=(p,m,E)=>async function(A,k,F,q){let U=k.view.ma(F);U.ns&&(U=await sf(A.localStore,k.query,!1).then(({documents:I})=>k.view.ma(I,U)));const te=q&&q.targetChanges.get(k.targetId),ve=q&&q.targetMismatches.get(k.targetId)!=null,de=k.view.applyChanges(U,A.isPrimaryClient,te,ve);return df(A,k.targetId,de.wa),de.snapshot}(n,p,m,E);const r=await sf(n.localStore,e,!0),o=new F0(e,r.Ts),l=o.ma(r.documents),c=vr.createSynthesizedTargetChangeForCurrentChange(t,s&&n.onlineState!=="Offline",i),h=o.applyChanges(l,n.isPrimaryClient,c);df(n,t,h.wa);const d=new B0(e,t,o);return n.Fa.set(e,d),n.Ma.has(t)?n.Ma.get(t).push(e):n.Ma.set(t,[e]),h.snapshot}async function z0(n,e,t){const s=K(n),i=s.Fa.get(e),r=s.Ma.get(i.targetId);if(r.length>1)return s.Ma.set(i.targetId,r.filter(o=>!ua(o,e))),void s.Fa.delete(e);s.isPrimaryClient?(s.sharedClientState.removeLocalQueryTarget(i.targetId),s.sharedClientState.isActiveQueryTarget(i.targetId)||await Xl(s.localStore,i.targetId,!1).then(()=>{s.sharedClientState.clearQueryState(i.targetId),t&&th(s.remoteStore,i.targetId),ec(s,i.targetId)}).catch(pr)):(ec(s,i.targetId),await Xl(s.localStore,i.targetId,!0))}async function G0(n,e){const t=K(n),s=t.Fa.get(e),i=t.Ma.get(s.targetId);t.isPrimaryClient&&i.length===1&&(t.sharedClientState.removeLocalQueryTarget(s.targetId),th(t.remoteStore,s.targetId))}async function H0(n,e,t){const s=eC(n);try{const i=await function(o,l){const c=K(o),h=De.now(),d=l.reduce((E,C)=>E.add(C.key),se());let p,m;return c.persistence.runTransaction("Locally write mutations","readwrite",E=>{let C=an(),A=se();return c.cs.getEntries(E,d).next(k=>{C=k,C.forEach((F,q)=>{q.isValidDocument()||(A=A.add(F))})}).next(()=>c.localDocuments.getOverlayedDocuments(E,C)).next(k=>{p=k;const F=[];for(const q of l){const U=_I(q,p.get(q.key).overlayedDocument);U!=null&&F.push(new Fn(q.key,U,Cm(U.value.mapValue),rt.exists(!0)))}return c.mutationQueue.addMutationBatch(E,h,F,l)}).next(k=>{m=k;const F=k.applyToLocalDocumentSet(p,A);return c.documentOverlayCache.saveOverlays(E,k.batchId,F)})}).then(()=>({batchId:m.batchId,changes:Om(p)}))}(s.localStore,e);s.sharedClientState.addPendingMutation(i.batchId),function(o,l,c){let h=o.Ba[o.currentUser.toKey()];h||(h=new ke(le)),h=h.insert(l,c),o.Ba[o.currentUser.toKey()]=h}(s,i.batchId,t),await wr(s,i.changes),await ya(s.remoteStore)}catch(i){const r=oh(i,"Failed to persist write");t.reject(r)}}async function yg(n,e){const t=K(n);try{const s=await l0(t.localStore,e);e.targetChanges.forEach((i,r)=>{const o=t.Na.get(r);o&&(oe(i.addedDocuments.size+i.modifiedDocuments.size+i.removedDocuments.size<=1),i.addedDocuments.size>0?o.va=!0:i.modifiedDocuments.size>0?oe(o.va):i.removedDocuments.size>0&&(oe(o.va),o.va=!1))}),await wr(t,s,e)}catch(s){await pr(s)}}function uf(n,e,t){const s=K(n);if(s.isPrimaryClient&&t===0||!s.isPrimaryClient&&t===1){const i=[];s.Fa.forEach((r,o)=>{const l=o.view.Z_(e);l.snapshot&&i.push(l.snapshot)}),function(o,l){const c=K(o);c.onlineState=l;let h=!1;c.queries.forEach((d,p)=>{for(const m of p.j_)m.Z_(l)&&(h=!0)}),h&&ah(c)}(s.eventManager,e),i.length&&s.Ca.d_(i),s.onlineState=e,s.isPrimaryClient&&s.sharedClientState.setOnlineState(e)}}async function K0(n,e,t){const s=K(n);s.sharedClientState.updateQueryState(e,"rejected",t);const i=s.Na.get(e),r=i&&i.key;if(r){let o=new ke(W.comparator);o=o.insert(r,Ve.newNoDocument(r,G.min()));const l=se().add(r),c=new ma(G.min(),new Map,new ke(le),o,l);await yg(s,c),s.Oa=s.Oa.remove(r),s.Na.delete(e),lh(s)}else await Xl(s.localStore,e,!1).then(()=>ec(s,e,t)).catch(pr)}async function Q0(n,e){const t=K(n),s=e.batch.batchId;try{const i=await a0(t.localStore,e);Eg(t,s,null),vg(t,s),t.sharedClientState.updateMutationState(s,"acknowledged"),await wr(t,i)}catch(i){await pr(i)}}async function Y0(n,e,t){const s=K(n);try{const i=await function(o,l){const c=K(o);return c.persistence.runTransaction("Reject batch","readwrite-primary",h=>{let d;return c.mutationQueue.lookupMutationBatch(h,l).next(p=>(oe(p!==null),d=p.keys(),c.mutationQueue.removeMutationBatch(h,p))).next(()=>c.mutationQueue.performConsistencyCheck(h)).next(()=>c.documentOverlayCache.removeOverlaysForBatchId(h,d,l)).next(()=>c.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(h,d)).next(()=>c.localDocuments.getDocuments(h,d))})}(s.localStore,e);Eg(s,e,t),vg(s,e),s.sharedClientState.updateMutationState(e,"rejected",t),await wr(s,i)}catch(i){await pr(i)}}function vg(n,e){(n.ka.get(e)||[]).forEach(t=>{t.resolve()}),n.ka.delete(e)}function Eg(n,e,t){const s=K(n);let i=s.Ba[s.currentUser.toKey()];if(i){const r=i.get(e);r&&(t?r.reject(t):r.resolve(),i=i.remove(e)),s.Ba[s.currentUser.toKey()]=i}}function ec(n,e,t=null){n.sharedClientState.removeLocalQueryTarget(e);for(const s of n.Ma.get(e))n.Fa.delete(s),t&&n.Ca.$a(s,t);n.Ma.delete(e),n.isPrimaryClient&&n.La.gr(e).forEach(s=>{n.La.containsKey(s)||wg(n,s)})}function wg(n,e){n.xa.delete(e.path.canonicalString());const t=n.Oa.get(e);t!==null&&(th(n.remoteStore,t),n.Oa=n.Oa.remove(e),n.Na.delete(t),lh(n))}function df(n,e,t){for(const s of t)s instanceof mg?(n.La.addReference(s.key,e),J0(n,s)):s instanceof gg?(B("SyncEngine","Document no longer in limbo: "+s.key),n.La.removeReference(s.key,e),n.La.containsKey(s.key)||wg(n,s.key)):j()}function J0(n,e){const t=e.key,s=t.path.canonicalString();n.Oa.get(t)||n.xa.has(s)||(B("SyncEngine","New document in limbo: "+t),n.xa.add(s),lh(n))}function lh(n){for(;n.xa.size>0&&n.Oa.size<n.maxConcurrentLimboResolutions;){const e=n.xa.values().next().value;n.xa.delete(e);const t=new W(me.fromString(e)),s=n.qa.next();n.Na.set(s,new U0(t)),n.Oa=n.Oa.insert(t,s),og(n.remoteStore,new En(xt(zc(t.path)),s,"TargetPurposeLimboResolution",Bc.oe))}}async function wr(n,e,t){const s=K(n),i=[],r=[],o=[];s.Fa.isEmpty()||(s.Fa.forEach((l,c)=>{o.push(s.Ka(c,e,t).then(h=>{var d;if((h||t)&&s.isPrimaryClient){const p=h?!h.fromCache:(d=t==null?void 0:t.targetChanges.get(c.targetId))===null||d===void 0?void 0:d.current;s.sharedClientState.updateQueryState(c.targetId,p?"current":"not-current")}if(h){i.push(h);const p=Zc.Wi(c.targetId,h);r.push(p)}}))}),await Promise.all(o),s.Ca.d_(i),await async function(c,h){const d=K(c);try{await d.persistence.runTransaction("notifyLocalViewChanges","readwrite",p=>N.forEach(h,m=>N.forEach(m.$i,E=>d.persistence.referenceDelegate.addReference(p,m.targetId,E)).next(()=>N.forEach(m.Ui,E=>d.persistence.referenceDelegate.removeReference(p,m.targetId,E)))))}catch(p){if(!mr(p))throw p;B("LocalStore","Failed to update sequence numbers: "+p)}for(const p of h){const m=p.targetId;if(!p.fromCache){const E=d.os.get(m),C=E.snapshotVersion,A=E.withLastLimboFreeSnapshotVersion(C);d.os=d.os.insert(m,A)}}}(s.localStore,r))}async function X0(n,e){const t=K(n);if(!t.currentUser.isEqual(e)){B("SyncEngine","User change. New user:",e.toKey());const s=await sg(t.localStore,e);t.currentUser=e,function(r,o){r.ka.forEach(l=>{l.forEach(c=>{c.reject(new M(P.CANCELLED,o))})}),r.ka.clear()}(t,"'waitForPendingWrites' promise is rejected due to a user change."),t.sharedClientState.handleUserChange(e,s.removedBatchIds,s.addedBatchIds),await wr(t,s.hs)}}function Z0(n,e){const t=K(n),s=t.Na.get(e);if(s&&s.va)return se().add(s.key);{let i=se();const r=t.Ma.get(e);if(!r)return i;for(const o of r){const l=t.Fa.get(o);i=i.unionWith(l.view.Va)}return i}}function Tg(n){const e=K(n);return e.remoteStore.remoteSyncer.applyRemoteEvent=yg.bind(null,e),e.remoteStore.remoteSyncer.getRemoteKeysForTarget=Z0.bind(null,e),e.remoteStore.remoteSyncer.rejectListen=K0.bind(null,e),e.Ca.d_=M0.bind(null,e.eventManager),e.Ca.$a=V0.bind(null,e.eventManager),e}function eC(n){const e=K(n);return e.remoteStore.remoteSyncer.applySuccessfulWrite=Q0.bind(null,e),e.remoteStore.remoteSyncer.rejectFailedWrite=Y0.bind(null,e),e}class Uo{constructor(){this.kind="memory",this.synchronizeTabs=!1}async initialize(e){this.serializer=ga(e.databaseInfo.databaseId),this.sharedClientState=this.Wa(e),this.persistence=this.Ga(e),await this.persistence.start(),this.localStore=this.za(e),this.gcScheduler=this.ja(e,this.localStore),this.indexBackfillerScheduler=this.Ha(e,this.localStore)}ja(e,t){return null}Ha(e,t){return null}za(e){return o0(this.persistence,new i0,e.initialUser,this.serializer)}Ga(e){return new t0(Xc.Zr,this.serializer)}Wa(e){return new f0}async terminate(){var e,t;(e=this.gcScheduler)===null||e===void 0||e.stop(),(t=this.indexBackfillerScheduler)===null||t===void 0||t.stop(),this.sharedClientState.shutdown(),await this.persistence.shutdown()}}Uo.provider={build:()=>new Uo};class tc{async initialize(e,t){this.localStore||(this.localStore=e.localStore,this.sharedClientState=e.sharedClientState,this.datastore=this.createDatastore(t),this.remoteStore=this.createRemoteStore(t),this.eventManager=this.createEventManager(t),this.syncEngine=this.createSyncEngine(t,!e.synchronizeTabs),this.sharedClientState.onlineStateHandler=s=>uf(this.syncEngine,s,1),this.remoteStore.remoteSyncer.handleCredentialChange=X0.bind(null,this.syncEngine),await L0(this.remoteStore,this.syncEngine.isPrimaryClient))}createEventManager(e){return function(){return new O0}()}createDatastore(e){const t=ga(e.databaseInfo.databaseId),s=function(r){return new _0(r)}(e.databaseInfo);return function(r,o,l,c){return new E0(r,o,l,c)}(e.authCredentials,e.appCheckCredentials,s,t)}createRemoteStore(e){return function(s,i,r,o,l){return new T0(s,i,r,o,l)}(this.localStore,this.datastore,e.asyncQueue,t=>uf(this.syncEngine,t,0),function(){return of.D()?new of:new p0}())}createSyncEngine(e,t){return function(i,r,o,l,c,h,d){const p=new q0(i,r,o,l,c,h);return d&&(p.Qa=!0),p}(this.localStore,this.remoteStore,this.eventManager,this.sharedClientState,e.initialUser,e.maxConcurrentLimboResolutions,t)}async terminate(){var e,t;await async function(i){const r=K(i);B("RemoteStore","RemoteStore shutting down."),r.L_.add(5),await Er(r),r.k_.shutdown(),r.q_.set("Unknown")}(this.remoteStore),(e=this.datastore)===null||e===void 0||e.terminate(),(t=this.eventManager)===null||t===void 0||t.terminate()}}tc.provider={build:()=>new tc};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ig{constructor(e){this.observer=e,this.muted=!1}next(e){this.muted||this.observer.next&&this.Ya(this.observer.next,e)}error(e){this.muted||(this.observer.error?this.Ya(this.observer.error,e):on("Uncaught Error in snapshot listener:",e.toString()))}Za(){this.muted=!0}Ya(e,t){setTimeout(()=>{this.muted||e(t)},0)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tC{constructor(e){this.datastore=e,this.readVersions=new Map,this.mutations=[],this.committed=!1,this.lastTransactionError=null,this.writtenDocs=new Set}async lookup(e){if(this.ensureCommitNotCalled(),this.mutations.length>0)throw this.lastTransactionError=new M(P.INVALID_ARGUMENT,"Firestore transactions require all reads to be executed before all writes."),this.lastTransactionError;const t=await async function(i,r){const o=K(i),l={documents:r.map(p=>Fo(o.serializer,p))},c=await o.Lo("BatchGetDocuments",o.serializer.databaseId,me.emptyPath(),l,r.length),h=new Map;c.forEach(p=>{const m=PI(o.serializer,p);h.set(m.key.toString(),m)});const d=[];return r.forEach(p=>{const m=h.get(p.toString());oe(!!m),d.push(m)}),d}(this.datastore,e);return t.forEach(s=>this.recordVersion(s)),t}set(e,t){this.write(t.toMutation(e,this.precondition(e))),this.writtenDocs.add(e.toString())}update(e,t){try{this.write(t.toMutation(e,this.preconditionForUpdate(e)))}catch(s){this.lastTransactionError=s}this.writtenDocs.add(e.toString())}delete(e){this.write(new Hc(e,this.precondition(e))),this.writtenDocs.add(e.toString())}async commit(){if(this.ensureCommitNotCalled(),this.lastTransactionError)throw this.lastTransactionError;const e=this.readVersions;this.mutations.forEach(t=>{e.delete(t.key.toString())}),e.forEach((t,s)=>{const i=W.fromPath(s);this.mutations.push(new jm(i,this.precondition(i)))}),await async function(s,i){const r=K(s),o={writes:i.map(l=>Zm(r.serializer,l))};await r.Mo("Commit",r.serializer.databaseId,me.emptyPath(),o)}(this.datastore,this.mutations),this.committed=!0}recordVersion(e){let t;if(e.isFoundDocument())t=e.version;else{if(!e.isNoDocument())throw j();t=G.min()}const s=this.readVersions.get(e.key.toString());if(s){if(!t.isEqual(s))throw new M(P.ABORTED,"Document version changed between two reads.")}else this.readVersions.set(e.key.toString(),t)}precondition(e){const t=this.readVersions.get(e.toString());return!this.writtenDocs.has(e.toString())&&t?t.isEqual(G.min())?rt.exists(!1):rt.updateTime(t):rt.none()}preconditionForUpdate(e){const t=this.readVersions.get(e.toString());if(!this.writtenDocs.has(e.toString())&&t){if(t.isEqual(G.min()))throw new M(P.INVALID_ARGUMENT,"Can't update a document that doesn't exist.");return rt.updateTime(t)}return rt.exists(!0)}write(e){this.ensureCommitNotCalled(),this.mutations.push(e)}ensureCommitNotCalled(){}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Tr{constructor(...e){for(let t=0;t<e.length;++t)if(e[t].length===0)throw new M(P.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new qe(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class uh{constructor(e,t){if(!isFinite(e)||e<-90||e>90)throw new M(P.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(t)||t<-180||t>180)throw new M(P.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+t);this._lat=e,this._long=t}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}toJSON(){return{latitude:this._lat,longitude:this._long}}_compareTo(e){return le(this._lat,e._lat)||le(this._long,e._long)}}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ss{constructor(e,t){this.hasPendingWrites=e,this.fromCache=t}isEqual(e){return this.hasPendingWrites===e.hasPendingWrites&&this.fromCache===e.fromCache}}class Eh extends Wo{constructor(e,t,s,i,r,o){super(e,t,s,i,o),this._firestore=e,this._firestoreImpl=e,this.metadata=r}exists(){return super.exists()}data(e={}){if(this._document){if(this._converter){const t=new po(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(t,e)}return this._userDataWriter.convertValue(this._document.data.value,e.serverTimestamps)}}get(e,t={}){if(this._document){const s=this._document.data.field(gh("DocumentSnapshot.get",e));if(s!==null)return this._userDataWriter.convertValue(s,t.serverTimestamps)}}}class po extends Eh{data(e={}){return super.data(e)}}class TC{constructor(e,t,s,i){this._firestore=e,this._userDataWriter=t,this._snapshot=i,this.metadata=new Ss(i.hasPendingWrites,i.fromCache),this.query=s}get docs(){const e=[];return this.forEach(t=>e.push(t)),e}get size(){return this._snapshot.docs.size}get empty(){return this.size===0}forEach(e,t){this._snapshot.docs.forEach(s=>{e.call(t,new po(this._firestore,this._userDataWriter,s.key,s,new Ss(this._snapshot.mutatedKeys.has(s.key),this._snapshot.fromCache),this.query.converter))})}docChanges(e={}){const t=!!e.includeMetadataChanges;if(t&&this._snapshot.excludesMetadataChanges)throw new M(P.INVALID_ARGUMENT,"To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");return this._cachedChanges&&this._cachedChangesIncludeMetadataChanges===t||(this._cachedChanges=function(i,r){if(i._snapshot.oldDocs.isEmpty()){let o=0;return i._snapshot.docChanges.map(l=>{const c=new po(i._firestore,i._userDataWriter,l.doc.key,l.doc,new Ss(i._snapshot.mutatedKeys.has(l.doc.key),i._snapshot.fromCache),i.query.converter);return l.doc,{type:"added",doc:c,oldIndex:-1,newIndex:o++}})}{let o=i._snapshot.oldDocs;return i._snapshot.docChanges.filter(l=>r||l.type!==3).map(l=>{const c=new po(i._firestore,i._userDataWriter,l.doc.key,l.doc,new Ss(i._snapshot.mutatedKeys.has(l.doc.key),i._snapshot.fromCache),i.query.converter);let h=-1,d=-1;return l.type!==0&&(h=o.indexOf(l.doc.key),o=o.delete(l.doc.key)),l.type!==1&&(o=o.add(l.doc),d=o.indexOf(l.doc.key)),{type:IC(l.type),doc:c,oldIndex:h,newIndex:d}})}}(this,t),this._cachedChangesIncludeMetadataChanges=t),this._cachedChanges}}function IC(n){switch(n){case 0:return"added";case 2:case 3:return"modified";case 1:return"removed";default:return j()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function dl(n){n=Vt(n,Ze);const e=Vt(n.firestore,ti);return aC(wa(e),n._key).then(t=>CC(e,n,t))}class wh extends Vg{constructor(e){super(),this.firestore=e}convertBytes(e){return new ss(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new Ze(this.firestore,null,t)}}function fl(n){n=Vt(n,hs);const e=Vt(n.firestore,ti),t=wa(e),s=new wh(e);return vC(n._query),lC(t,n._query).then(i=>new TC(e,s,n,i))}function pl(n,e,t){n=Vt(n,Ze);const s=Vt(n.firestore,ti),i=Fg(n.converter,e,t);return Bg(s,[kg(Ta(s),"setDoc",n._key,i,n.converter!==null,t).toMutation(n._key,rt.none())])}function If(n,e,t,...s){n=Vt(n,Ze);const i=Vt(n.firestore,ti),r=Ta(i);let o;return o=typeof(e=ge(e))=="string"||e instanceof Tr?Ng(r,"updateDoc",n._key,e,t,s):Pg(r,"updateDoc",n._key,e),Bg(i,[o.toMutation(n._key,rt.exists(!0))])}function Bg(n,e){return function(s,i){const r=new Lt;return s.asyncQueue.enqueueAndForget(async()=>H0(await rC(s),i,r)),r.promise}(wa(n),e)}function CC(n,e,t){const s=t.docs.get(e._key),i=new wh(n);return new Eh(n,i,e._key,s,new Ss(t.hasPendingWrites,t.fromCache),e.converter)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bC={maxAttempts:5};function wi(n,e){if((n=ge(n)).firestore!==e)throw new M(P.INVALID_ARGUMENT,"Provided document reference is from a different Firestore instance.");return n}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class RC extends class{constructor(t,s){this._firestore=t,this._transaction=s,this._dataReader=Ta(t)}get(t){const s=wi(t,this._firestore),i=new wC(this._firestore);return this._transaction.lookup([s._key]).then(r=>{if(!r||r.length!==1)return j();const o=r[0];if(o.isFoundDocument())return new Wo(this._firestore,i,o.key,o,s.converter);if(o.isNoDocument())return new Wo(this._firestore,i,s._key,null,s.converter);throw j()})}set(t,s,i){const r=wi(t,this._firestore),o=Fg(r.converter,s,i),l=kg(this._dataReader,"Transaction.set",r._key,o,r.converter!==null,i);return this._transaction.set(r._key,l),this}update(t,s,i,...r){const o=wi(t,this._firestore);let l;return l=typeof(s=ge(s))=="string"||s instanceof Tr?Ng(this._dataReader,"Transaction.update",o._key,s,i,r):Pg(this._dataReader,"Transaction.update",o._key,s),this._transaction.update(o._key,l),this}delete(t){const s=wi(t,this._firestore);return this._transaction.delete(s._key),this}}{constructor(e,t){super(e,t),this._firestore=e}get(e){const t=wi(e,this._firestore),s=new wh(this._firestore);return super.get(e).then(i=>new Eh(this._firestore,s,t._key,i._document,new Ss(!1,!1),t.converter))}}function SC(n,e,t){n=Vt(n,ti);const s=Object.assign(Object.assign({},bC),t);return function(r){if(r.maxAttempts<1)throw new M(P.INVALID_ARGUMENT,"Max attempts must be at least 1")}(s),function(r,o,l){const c=new Lt;return r.asyncQueue.enqueueAndForget(async()=>{const h=await oC(r);new nC(r.asyncQueue,h,l,o,c).au()}),c.promise}(wa(n),i=>e(new RC(n,i)),s)}(function(e,t=!0){(function(i){Xs=i})(as),Xn(new Pn("firestore",(s,{instanceIdentifier:i,options:r})=>{const o=s.getProvider("app").getImmediate(),l=new ti(new AT(s.getProvider("auth-internal")),new DT(s.getProvider("app-check-internal")),function(h,d){if(!Object.prototype.hasOwnProperty.apply(h.options,["projectId"]))throw new M(P.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Xi(h.options.projectId,d)}(o,i),o);return r=Object.assign({useFetchStreams:t},r),l._setSettings(r),l},"PUBLIC").setMultipleInstances(!0)),Nt(Od,"4.7.3",e),Nt(Od,"4.7.3","esm2017")})();var Cf={};const bf="@firebase/database",Rf="1.0.8";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class PC{constructor(){this.cache_={},this.isInMemoryStorage=!0}set(e,t){t==null?delete this.cache_[e]:this.cache_[e]=t}get(e){return Bt(this.cache_,e)?this.cache_[e]:null}remove(e){delete this.cache_[e]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class HC{constructor(){this.counters_={}}incrementCounter(e,t=1){Bt(this.counters_,e)||(this.counters_[e]=0),this.counters_[e]+=t}get(){return Hy(this.counters_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class QC{constructor(e){this.onMessage_=e,this.pendingResponses=[],this.currentResponseNum=0,this.closeAfterResponse=-1,this.onClose=null}closeAfter(e,t){this.closeAfterResponse=e,this.onClose=t,this.closeAfterResponse<this.currentResponseNum&&(this.onClose(),this.onClose=null)}handleResponse(e,t){for(this.pendingResponses[e]=t;this.pendingResponses[this.currentResponseNum];){const s=this.pendingResponses[this.currentResponseNum];delete this.pendingResponses[this.currentResponseNum];for(let i=0;i<s.length;++i)s[i]&&ni(()=>{this.onMessage_(s[i])});if(this.currentResponseNum===this.closeAfterResponse){this.onClose&&(this.onClose(),this.onClose=null);break}this.currentResponseNum++}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nr{constructor(e){this.initTransports_(e)}static get ALL_TRANSPORTS(){return[As,wt]}static get IS_TRANSPORT_INITIALIZED(){return this.globalTransportInitialized_}initTransports_(e){const t=wt&&wt.isAvailable();let s=t&&!wt.previouslyFailed();if(e.webSocketOnly&&(t||at("wss:// URL used, but browser isn't known to support websockets.  Trying anyway."),s=!0),s)this.transports_=[wt];else{const i=this.transports_=[];for(const r of nr.ALL_TRANSPORTS)r&&r.isAvailable()&&i.push(r);nr.globalTransportInitialized_=!0}}initialTransport(){if(this.transports_.length>0)return this.transports_[0];throw new Error("No transports available")}upgradeTransport(){return this.transports_.length>1?this.transports_[1]:null}}nr.globalTransportInitialized_=!1;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Mf=32,Vf=768;class ue{constructor(e,t){if(t===void 0){this.pieces_=e.split("/");let s=0;for(let i=0;i<this.pieces_.length;i++)this.pieces_[i].length>0&&(this.pieces_[s]=this.pieces_[i],s++);this.pieces_.length=s,this.pieceNum_=0}else this.pieces_=e,this.pieceNum_=t}toString(){let e="";for(let t=this.pieceNum_;t<this.pieces_.length;t++)this.pieces_[t]!==""&&(e+="/"+this.pieces_[t]);return e||"/"}}function ce(){return new ue("")}function J(n){return n.pieceNum_>=n.pieces_.length?null:n.pieces_[n.pieceNum_]}function On(n){return n.pieces_.length-n.pieceNum_}function ye(n){let e=n.pieceNum_;return e<n.pieces_.length&&e++,new ue(n.pieces_,e)}function Sh(n){return n.pieceNum_<n.pieces_.length?n.pieces_[n.pieces_.length-1]:null}function _b(n){let e="";for(let t=n.pieceNum_;t<n.pieces_.length;t++)n.pieces_[t]!==""&&(e+="/"+encodeURIComponent(String(n.pieces_[t])));return e||"/"}function sr(n,e=0){return n.pieces_.slice(n.pieceNum_+e)}function c_(n){if(n.pieceNum_>=n.pieces_.length)return null;const e=[];for(let t=n.pieceNum_;t<n.pieces_.length-1;t++)e.push(n.pieces_[t]);return new ue(e,0)}function Ce(n,e){const t=[];for(let s=n.pieceNum_;s<n.pieces_.length;s++)t.push(n.pieces_[s]);if(e instanceof ue)for(let s=e.pieceNum_;s<e.pieces_.length;s++)t.push(e.pieces_[s]);else{const s=e.split("/");for(let i=0;i<s.length;i++)s[i].length>0&&t.push(s[i])}return new ue(t,0)}function X(n){return n.pieceNum_>=n.pieces_.length}function ot(n,e){const t=J(n),s=J(e);if(t===null)return e;if(t===s)return ot(ye(n),ye(e));throw new Error("INTERNAL ERROR: innerPath ("+e+") is not within outerPath ("+n+")")}function yb(n,e){const t=sr(n,0),s=sr(e,0);for(let i=0;i<t.length&&i<s.length;i++){const r=us(t[i],s[i]);if(r!==0)return r}return t.length===s.length?0:t.length<s.length?-1:1}function Ah(n,e){if(On(n)!==On(e))return!1;for(let t=n.pieceNum_,s=e.pieceNum_;t<=n.pieces_.length;t++,s++)if(n.pieces_[t]!==e.pieces_[s])return!1;return!0}function mt(n,e){let t=n.pieceNum_,s=e.pieceNum_;if(On(n)>On(e))return!1;for(;t<n.pieces_.length;){if(n.pieces_[t]!==e.pieces_[s])return!1;++t,++s}return!0}class vb{constructor(e,t){this.errorPrefix_=t,this.parts_=sr(e,0),this.byteLength_=Math.max(1,this.parts_.length);for(let s=0;s<this.parts_.length;s++)this.byteLength_+=ra(this.parts_[s]);h_(this)}}function Eb(n,e){n.parts_.length>0&&(n.byteLength_+=1),n.parts_.push(e),n.byteLength_+=ra(e),h_(n)}function wb(n){const e=n.parts_.pop();n.byteLength_-=ra(e),n.parts_.length>0&&(n.byteLength_-=1)}function h_(n){if(n.byteLength_>Vf)throw new Error(n.errorPrefix_+"has a key path longer than "+Vf+" bytes ("+n.byteLength_+").");if(n.parts_.length>Mf)throw new Error(n.errorPrefix_+"path specified exceeds the maximum depth that can be written ("+Mf+") or object contains a cycle "+zn(n))}function zn(n){return n.parts_.length===0?"":"in property '"+n.parts_.join(".")+"'"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let rc;function Ab(n){rc=n}const d_=function(n){return typeof n=="number"?"number:"+jg(n):"string:"+n},f_=function(n){if(n.isLeafNode()){const e=n.val();D(typeof e=="string"||typeof e=="number"||typeof e=="object"&&Bt(e,".sv"),"Priority must be a string or number.")}else D(n===rc||n.isEmpty(),"priority of unexpected type.");D(n===rc||n.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let yl;const Ts={};class tn{constructor(e,t){this.indexes_=e,this.indexSet_=t}static get Default(){return D(Ts&&Te,"ChildrenNode.ts has not been loaded"),yl=yl||new tn({".priority":Ts},{".priority":Te}),yl}get(e){const t=Os(this.indexes_,e);if(!t)throw new Error("No index defined for "+e);return t instanceof ct?t:null}hasIndex(e){return Bt(this.indexSet_,e.toString())}addIndex(e,t){D(e!==Jn,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const s=[];let i=!1;const r=t.getIterator(Z.Wrap);let o=r.getNext();for(;o;)i=i||e.isDefinedOn(o.node),s.push(o),o=r.getNext();let l;i?l=zo(s,e.getCompare()):l=Ts;const c=e.toString(),h=Object.assign({},this.indexSet_);h[c]=e;const d=Object.assign({},this.indexes_);return d[c]=l,new tn(d,h)}addToIndexes(e,t){const s=Io(this.indexes_,(i,r)=>{const o=Os(this.indexSet_,r);if(D(o,"Missing index implementation for "+r),i===Ts)if(o.isDefinedOn(e.node)){const l=[],c=t.getIterator(Z.Wrap);let h=c.getNext();for(;h;)h.name!==e.name&&l.push(h),h=c.getNext();return l.push(e),zo(l,o.getCompare())}else return Ts;else{const l=t.get(e.name);let c=i;return l&&(c=c.remove(new Z(e.name,l))),c.insert(e,e.node)}});return new tn(s,this.indexSet_)}removeFromIndexes(e,t){const s=Io(this.indexes_,i=>{if(i===Ts)return i;{const r=t.get(e.name);return r?i.remove(new Z(e.name,r)):i}});return new tn(s,this.indexSet_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ci;class z{constructor(e,t,s){this.children_=e,this.priorityNode_=t,this.indexMap_=s,this.lazyHash_=null,this.priorityNode_&&f_(this.priorityNode_),this.children_.isEmpty()&&D(!this.priorityNode_||this.priorityNode_.isEmpty(),"An empty node cannot have a priority")}static get EMPTY_NODE(){return Ci||(Ci=new z(new ct(Ph),null,tn.Default))}isLeafNode(){return!1}getPriority(){return this.priorityNode_||Ci}updatePriority(e){return this.children_.isEmpty()?this:new z(this.children_,e,this.indexMap_)}getImmediateChild(e){if(e===".priority")return this.getPriority();{const t=this.children_.get(e);return t===null?Ci:t}}getChild(e){const t=J(e);return t===null?this:this.getImmediateChild(t).getChild(ye(e))}hasChild(e){return this.children_.get(e)!==null}updateImmediateChild(e,t){if(D(t,"We should always be passing snapshot nodes"),e===".priority")return this.updatePriority(t);{const s=new Z(e,t);let i,r;t.isEmpty()?(i=this.children_.remove(e),r=this.indexMap_.removeFromIndexes(s,this.children_)):(i=this.children_.insert(e,t),r=this.indexMap_.addToIndexes(s,this.children_));const o=i.isEmpty()?Ci:this.priorityNode_;return new z(i,o,r)}}updateChild(e,t){const s=J(e);if(s===null)return t;{D(J(e)!==".priority"||On(e)===1,".priority must be the last token in a path");const i=this.getImmediateChild(s).updateChild(ye(e),t);return this.updateImmediateChild(s,i)}}isEmpty(){return this.children_.isEmpty()}numChildren(){return this.children_.count()}val(e){if(this.isEmpty())return null;const t={};let s=0,i=0,r=!0;if(this.forEachChild(Te,(o,l)=>{t[o]=l.val(e),s++,r&&z.INTEGER_REGEXP_.test(o)?i=Math.max(i,Number(o)):r=!1}),!e&&r&&i<2*s){const o=[];for(const l in t)o[l]=t[l];return o}else return e&&!this.getPriority().isEmpty()&&(t[".priority"]=this.getPriority().val()),t}hash(){if(this.lazyHash_===null){let e="";this.getPriority().isEmpty()||(e+="priority:"+d_(this.getPriority().val())+":"),this.forEachChild(Te,(t,s)=>{const i=s.hash();i!==""&&(e+=":"+t+":"+i)}),this.lazyHash_=e===""?"":Wg(e)}return this.lazyHash_}getPredecessorChildName(e,t,s){const i=this.resolveIndex_(s);if(i){const r=i.getPredecessorKey(new Z(e,t));return r?r.name:null}else return this.children_.getPredecessorKey(e)}getFirstChildName(e){const t=this.resolveIndex_(e);if(t){const s=t.minKey();return s&&s.name}else return this.children_.minKey()}getFirstChild(e){const t=this.getFirstChildName(e);return t?new Z(t,this.children_.get(t)):null}getLastChildName(e){const t=this.resolveIndex_(e);if(t){const s=t.maxKey();return s&&s.name}else return this.children_.maxKey()}getLastChild(e){const t=this.getLastChildName(e);return t?new Z(t,this.children_.get(t)):null}forEachChild(e,t){const s=this.resolveIndex_(e);return s?s.inorderTraversal(i=>t(i.name,i.node)):this.children_.inorderTraversal(t)}getIterator(e){return this.getIteratorFrom(e.minPost(),e)}getIteratorFrom(e,t){const s=this.resolveIndex_(t);if(s)return s.getIteratorFrom(e,i=>i);{const i=this.children_.getIteratorFrom(e.name,Z.Wrap);let r=i.peek();for(;r!=null&&t.compare(r,e)<0;)i.getNext(),r=i.peek();return i}}getReverseIterator(e){return this.getReverseIteratorFrom(e.maxPost(),e)}getReverseIteratorFrom(e,t){const s=this.resolveIndex_(t);if(s)return s.getReverseIteratorFrom(e,i=>i);{const i=this.children_.getReverseIteratorFrom(e.name,Z.Wrap);let r=i.peek();for(;r!=null&&t.compare(r,e)>0;)i.getNext(),r=i.peek();return i}}compareTo(e){return this.isEmpty()?e.isEmpty()?0:-1:e.isLeafNode()||e.isEmpty()?1:e===Rr?-1:0}withIndex(e){if(e===Jn||this.indexMap_.hasIndex(e))return this;{const t=this.indexMap_.addIndex(e,this.children_);return new z(this.children_,this.priorityNode_,t)}}isIndexed(e){return e===Jn||this.indexMap_.hasIndex(e)}equals(e){if(e===this)return!0;if(e.isLeafNode())return!1;{const t=e;if(this.getPriority().equals(t.getPriority()))if(this.children_.count()===t.children_.count()){const s=this.getIterator(Te),i=t.getIterator(Te);let r=s.getNext(),o=i.getNext();for(;r&&o;){if(r.name!==o.name||!r.node.equals(o.node))return!1;r=s.getNext(),o=i.getNext()}return r===null&&o===null}else return!1;else return!1}}resolveIndex_(e){return e===Jn?null:this.indexMap_.get(e.toString())}}z.INTEGER_REGEXP_=/^(0|[1-9]\d*)$/;class xb extends z{constructor(){super(new ct(Ph),z.EMPTY_NODE,tn.Default)}compareTo(e){return e===this?0:1}equals(e){return e===this}getPriority(){return this}getImmediateChild(e){return z.EMPTY_NODE}isEmpty(){return!1}}const Rr=new xb;Object.defineProperties(Z,{MIN:{value:new Z(is,z.EMPTY_NODE)},MAX:{value:new Z(xn,Rr)}});u_.__EMPTY_NODE=z.EMPTY_NODE;xe.__childrenNodeConstructor=z;Ab(Rr);Pb(Rr);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function __(n){return{type:"value",snapshotNode:n}}function $s(n,e){return{type:"child_added",snapshotNode:e,childName:n}}function ir(n,e){return{type:"child_removed",snapshotNode:e,childName:n}}function rr(n,e,t){return{type:"child_changed",snapshotNode:e,childName:n,oldSnap:t}}function Vb(n,e){return{type:"child_moved",snapshotNode:e,childName:n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Dh{constructor(e){this.index_=e}updateChild(e,t,s,i,r,o){D(e.isIndexed(this.index_),"A node must be indexed if only a child is updated");const l=e.getImmediateChild(t);return l.getChild(i).equals(s.getChild(i))&&l.isEmpty()===s.isEmpty()||(o!=null&&(s.isEmpty()?e.hasChild(t)?o.trackChildChange(ir(t,l)):D(e.isLeafNode(),"A child remove without an old child only makes sense on a leaf node"):l.isEmpty()?o.trackChildChange($s(t,s)):o.trackChildChange(rr(t,s,l))),e.isLeafNode()&&s.isEmpty())?e:e.updateImmediateChild(t,s).withIndex(this.index_)}updateFullNode(e,t,s){return s!=null&&(e.isLeafNode()||e.forEachChild(Te,(i,r)=>{t.hasChild(i)||s.trackChildChange(ir(i,r))}),t.isLeafNode()||t.forEachChild(Te,(i,r)=>{if(e.hasChild(i)){const o=e.getImmediateChild(i);o.equals(r)||s.trackChildChange(rr(i,r,o))}else s.trackChildChange($s(i,r))})),t.withIndex(this.index_)}updatePriority(e,t){return e.isEmpty()?z.EMPTY_NODE:e.updatePriority(t)}filtersNodes(){return!1}getIndexedFilter(){return this}getIndex(){return this.index_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Lh{constructor(){this.limitSet_=!1,this.startSet_=!1,this.startNameSet_=!1,this.startAfterSet_=!1,this.endSet_=!1,this.endNameSet_=!1,this.endBeforeSet_=!1,this.limit_=0,this.viewFrom_="",this.indexStartValue_=null,this.indexStartName_="",this.indexEndValue_=null,this.indexEndName_="",this.index_=Te}hasStart(){return this.startSet_}isViewFromLeft(){return this.viewFrom_===""?this.startSet_:this.viewFrom_==="l"}getIndexStartValue(){return D(this.startSet_,"Only valid if start has been set"),this.indexStartValue_}getIndexStartName(){return D(this.startSet_,"Only valid if start has been set"),this.startNameSet_?this.indexStartName_:is}hasEnd(){return this.endSet_}getIndexEndValue(){return D(this.endSet_,"Only valid if end has been set"),this.indexEndValue_}getIndexEndName(){return D(this.endSet_,"Only valid if end has been set"),this.endNameSet_?this.indexEndName_:xn}hasLimit(){return this.limitSet_}hasAnchoredLimit(){return this.limitSet_&&this.viewFrom_!==""}getLimit(){return D(this.limitSet_,"Only valid if limit has been set"),this.limit_}getIndex(){return this.index_}loadsAllData(){return!(this.startSet_||this.endSet_||this.limitSet_)}isDefault(){return this.loadsAllData()&&this.index_===Te}copy(){const e=new Lh;return e.limitSet_=this.limitSet_,e.limit_=this.limit_,e.startSet_=this.startSet_,e.startAfterSet_=this.startAfterSet_,e.indexStartValue_=this.indexStartValue_,e.startNameSet_=this.startNameSet_,e.indexStartName_=this.indexStartName_,e.endSet_=this.endSet_,e.endBeforeSet_=this.endBeforeSet_,e.indexEndValue_=this.indexEndValue_,e.endNameSet_=this.endNameSet_,e.indexEndName_=this.indexEndName_,e.index_=this.index_,e.viewFrom_=this.viewFrom_,e}}function Bb(n){return n.loadsAllData()?new Dh(n.getIndex()):n.hasLimit()?new Fb(n):new or(n)}function Ub(n,e,t){const s=n.copy();return s.endSet_=!0,e===void 0&&(e=null),s.indexEndValue_=e,t!==void 0?(s.endNameSet_=!0,s.indexEndName_=t):(s.endNameSet_=!1,s.indexEndName_=""),s}function qb(n,e){const t=n.copy();return t.index_=e,t}function qf(n){const e={};if(n.isDefault())return e;let t;if(n.index_===Te?t="$priority":n.index_===g_?t="$value":n.index_===Jn?t="$key":(D(n.index_ instanceof Nh,"Unrecognized index type!"),t=n.index_.toString()),e.orderBy=Ne(t),n.startSet_){const s=n.startAfterSet_?"startAfter":"startAt";e[s]=Ne(n.indexStartValue_),n.startNameSet_&&(e[s]+=","+Ne(n.indexStartName_))}if(n.endSet_){const s=n.endBeforeSet_?"endBefore":"endAt";e[s]=Ne(n.indexEndValue_),n.endNameSet_&&(e[s]+=","+Ne(n.indexEndName_))}return n.limitSet_&&(n.isViewFromLeft()?e.limitToFirst=n.limit_:e.limitToLast=n.limit_),e}function Wf(n){const e={};if(n.startSet_&&(e.sp=n.indexStartValue_,n.startNameSet_&&(e.sn=n.indexStartName_),e.sin=!n.startAfterSet_),n.endSet_&&(e.ep=n.indexEndValue_,n.endNameSet_&&(e.en=n.indexEndName_),e.ein=!n.endBeforeSet_),n.limitSet_){e.l=n.limit_;let t=n.viewFrom_;t===""&&(n.isViewFromLeft()?t="l":t="r"),e.vf=t}return n.index_!==Te&&(e.i=n.index_.toString()),e}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Go extends a_{constructor(e,t,s,i){super(),this.repoInfo_=e,this.onDataUpdate_=t,this.authTokenProvider_=s,this.appCheckTokenProvider_=i,this.log_=br("p:rest:"),this.listens_={}}reportStats(e){throw new Error("Method not implemented.")}static getListenId_(e,t){return t!==void 0?"tag$"+t:(D(e._queryParams.isDefault(),"should have a tag if it's not a default query."),e._path.toString())}listen(e,t,s,i){const r=e._path.toString();this.log_("Listen called for "+r+" "+e._queryIdentifier);const o=Go.getListenId_(e,s),l={};this.listens_[o]=l;const c=qf(e._queryParams);this.restRequest_(r+".json",c,(h,d)=>{let p=d;if(h===404&&(p=null,h=null),h===null&&this.onDataUpdate_(r,p,!1,s),Os(this.listens_,o)===l){let m;h?h===401?m="permission_denied":m="rest_error:"+h:m="ok",i(m,null)}})}unlisten(e,t){const s=Go.getListenId_(e,t);delete this.listens_[s]}get(e){const t=qf(e._queryParams),s=e._path.toString(),i=new cr;return this.restRequest_(s+".json",t,(r,o)=>{let l=o;r===404&&(l=null,r=null),r===null?(this.onDataUpdate_(s,l,!1,null),i.resolve(l)):i.reject(new Error(l))}),i.promise}refreshAuthToken(e){}restRequest_(e,t={},s){return t.format="export",Promise.all([this.authTokenProvider_.getToken(!1),this.appCheckTokenProvider_.getToken(!1)]).then(([i,r])=>{i&&i.accessToken&&(t.auth=i.accessToken),r&&r.token&&(t.ac=r.token);const o=(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host+e+"?ns="+this.repoInfo_.namespace+Ys(t);this.log_("Sending REST request for "+o);const l=new XMLHttpRequest;l.onreadystatechange=()=>{if(s&&l.readyState===4){this.log_("REST Response for "+o+" received. status:",l.status,"response:",l.responseText);let c=null;if(l.status>=200&&l.status<300){try{c=Hi(l.responseText)}catch{at("Failed to parse JSON response for "+o+": "+l.responseText)}s(null,c)}else l.status!==401&&l.status!==404&&at("Got unsuccessful REST response for "+o+" Status: "+l.status),s(l.status);s=null}},l.open("GET",o,!0),l.send()})}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $f=10*1e3,zb=30*1e3,Gb=5*60*1e3;class Hb{constructor(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new jb(e);const s=$f+(zb-$f)*Math.random();Wi(this.reportStats_.bind(this),Math.floor(s))}reportStats_(){const e=this.statsListener_.get(),t={};let s=!1;je(e,(i,r)=>{r>0&&Bt(this.statsToReport_,i)&&(t[i]=r,s=!0)}),s&&this.server_.reportStats(t),Wi(this.reportStats_.bind(this),Math.floor(Math.random()*2*Gb))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Tt;(function(n){n[n.OVERWRITE=0]="OVERWRITE",n[n.MERGE=1]="MERGE",n[n.ACK_USER_WRITE=2]="ACK_USER_WRITE",n[n.LISTEN_COMPLETE=3]="LISTEN_COMPLETE"})(Tt||(Tt={}));function xh(){return{fromUser:!0,fromServer:!1,queryId:null,tagged:!1}}function Oh(){return{fromUser:!1,fromServer:!0,queryId:null,tagged:!1}}function Mh(n){return{fromUser:!1,fromServer:!0,queryId:n,tagged:!0}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ar{constructor(e,t){this.source=e,this.path=t,this.type=Tt.LISTEN_COMPLETE}operationForChild(e){return X(this.path)?new ar(this.source,ce()):new ar(this.source,ye(this.path))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rs{constructor(e,t,s){this.source=e,this.path=t,this.snap=s,this.type=Tt.OVERWRITE}operationForChild(e){return X(this.path)?new rs(this.source,ce(),this.snap.getImmediateChild(e)):new rs(this.source,ye(this.path),this.snap)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class js{constructor(e,t,s){this.source=e,this.path=t,this.children=s,this.type=Tt.MERGE}operationForChild(e){if(X(this.path)){const t=this.children.subtree(new ue(e));return t.isEmpty()?null:t.value?new rs(this.source,ce(),t.value):new js(this.source,ce(),t)}else return D(J(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new js(this.source,ye(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Kb{constructor(e){this.query_=e,this.index_=this.query_._queryParams.getIndex()}}function Qb(n,e,t,s){const i=[],r=[];return e.forEach(o=>{o.type==="child_changed"&&n.index_.indexedValueChanged(o.oldSnap,o.snapshotNode)&&r.push(Vb(o.childName,o.snapshotNode))}),bi(n,i,"child_removed",e,s,t),bi(n,i,"child_added",e,s,t),bi(n,i,"child_moved",r,s,t),bi(n,i,"child_changed",e,s,t),bi(n,i,"value",e,s,t),i}function bi(n,e,t,s,i,r){const o=s.filter(l=>l.type===t);o.sort((l,c)=>Jb(n,l,c)),o.forEach(l=>{const c=Yb(n,l,r);i.forEach(h=>{h.respondsTo(l.type)&&e.push(h.createEvent(c,n.query_))})})}function Yb(n,e,t){return e.type==="value"||e.type==="child_removed"||(e.prevName=t.getPredecessorChildName(e.childName,e.snapshotNode,n.index_)),e}function Jb(n,e,t){if(e.childName==null||t.childName==null)throw Qs("Should only compare child_ events.");const s=new Z(e.childName,e.snapshotNode),i=new Z(t.childName,t.snapshotNode);return n.index_.compare(s,i)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ra(n,e){return{eventCache:n,serverCache:e}}function $i(n,e,t,s){return Ra(new Mn(e,t,s),n.serverCache)}function v_(n,e,t,s){return Ra(n.eventCache,new Mn(e,t,s))}function Qo(n){return n.eventCache.isFullyInitialized()?n.eventCache.getNode():null}function os(n){return n.serverCache.isFullyInitialized()?n.serverCache.getNode():null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let vl;const Xb=()=>(vl||(vl=new ct(MC)),vl);class _e{constructor(e,t=Xb()){this.value=e,this.children=t}static fromObject(e){let t=new _e(null);return je(e,(s,i)=>{t=t.set(new ue(s),i)}),t}isEmpty(){return this.value===null&&this.children.isEmpty()}findRootMostMatchingPathAndValue(e,t){if(this.value!=null&&t(this.value))return{path:ce(),value:this.value};if(X(e))return null;{const s=J(e),i=this.children.get(s);if(i!==null){const r=i.findRootMostMatchingPathAndValue(ye(e),t);return r!=null?{path:Ce(new ue(s),r.path),value:r.value}:null}else return null}}findRootMostValueAndPath(e){return this.findRootMostMatchingPathAndValue(e,()=>!0)}subtree(e){if(X(e))return this;{const t=J(e),s=this.children.get(t);return s!==null?s.subtree(ye(e)):new _e(null)}}set(e,t){if(X(e))return new _e(t,this.children);{const s=J(e),r=(this.children.get(s)||new _e(null)).set(ye(e),t),o=this.children.insert(s,r);return new _e(this.value,o)}}remove(e){if(X(e))return this.children.isEmpty()?new _e(null):new _e(null,this.children);{const t=J(e),s=this.children.get(t);if(s){const i=s.remove(ye(e));let r;return i.isEmpty()?r=this.children.remove(t):r=this.children.insert(t,i),this.value===null&&r.isEmpty()?new _e(null):new _e(this.value,r)}else return this}}get(e){if(X(e))return this.value;{const t=J(e),s=this.children.get(t);return s?s.get(ye(e)):null}}setTree(e,t){if(X(e))return t;{const s=J(e),r=(this.children.get(s)||new _e(null)).setTree(ye(e),t);let o;return r.isEmpty()?o=this.children.remove(s):o=this.children.insert(s,r),new _e(this.value,o)}}fold(e){return this.fold_(ce(),e)}fold_(e,t){const s={};return this.children.inorderTraversal((i,r)=>{s[i]=r.fold_(Ce(e,i),t)}),t(e,this.value,s)}findOnPath(e,t){return this.findOnPath_(e,ce(),t)}findOnPath_(e,t,s){const i=this.value?s(t,this.value):!1;if(i)return i;if(X(e))return null;{const r=J(e),o=this.children.get(r);return o?o.findOnPath_(ye(e),Ce(t,r),s):null}}foreachOnPath(e,t){return this.foreachOnPath_(e,ce(),t)}foreachOnPath_(e,t,s){if(X(e))return this;{this.value&&s(t,this.value);const i=J(e),r=this.children.get(i);return r?r.foreachOnPath_(ye(e),Ce(t,i),s):new _e(null)}}foreach(e){this.foreach_(ce(),e)}foreach_(e,t){this.children.inorderTraversal((s,i)=>{i.foreach_(Ce(e,s),t)}),this.value&&t(e,this.value)}foreachChild(e){this.children.inorderTraversal((t,s)=>{s.value&&e(t,s.value)})}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ct{constructor(e){this.writeTree_=e}static empty(){return new Ct(new _e(null))}}function ji(n,e,t){if(X(e))return new Ct(new _e(t));{const s=n.writeTree_.findRootMostValueAndPath(e);if(s!=null){const i=s.path;let r=s.value;const o=ot(i,e);return r=r.updateChild(o,t),new Ct(n.writeTree_.set(i,r))}else{const i=new _e(t),r=n.writeTree_.setTree(e,i);return new Ct(r)}}}function ac(n,e,t){let s=n;return je(t,(i,r)=>{s=ji(s,Ce(e,i),r)}),s}function jf(n,e){if(X(e))return Ct.empty();{const t=n.writeTree_.setTree(e,new _e(null));return new Ct(t)}}function lc(n,e){return ds(n,e)!=null}function ds(n,e){const t=n.writeTree_.findRootMostValueAndPath(e);return t!=null?n.writeTree_.get(t.path).getChild(ot(t.path,e)):null}function zf(n){const e=[],t=n.writeTree_.value;return t!=null?t.isLeafNode()||t.forEachChild(Te,(s,i)=>{e.push(new Z(s,i))}):n.writeTree_.children.inorderTraversal((s,i)=>{i.value!=null&&e.push(new Z(s,i.value))}),e}function Sn(n,e){if(X(e))return n;{const t=ds(n,e);return t!=null?new Ct(new _e(t)):new Ct(n.writeTree_.subtree(e))}}function cc(n){return n.writeTree_.isEmpty()}function zs(n,e){return E_(ce(),n.writeTree_,e)}function E_(n,e,t){if(e.value!=null)return t.updateChild(n,e.value);{let s=null;return e.children.inorderTraversal((i,r)=>{i===".priority"?(D(r.value!==null,"Priority writes must always be leaf nodes"),s=r.value):t=E_(Ce(n,i),r,t)}),!t.getChild(n).isEmpty()&&s!==null&&(t=t.updateChild(Ce(n,".priority"),s)),t}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Sa(n,e){return C_(e,n)}function Zb(n,e,t,s,i){D(s>n.lastWriteId,"Stacking an older write on top of newer ones"),i===void 0&&(i=!0),n.allWrites.push({path:e,snap:t,writeId:s,visible:i}),i&&(n.visibleWrites=ji(n.visibleWrites,e,t)),n.lastWriteId=s}function eR(n,e,t,s){D(s>n.lastWriteId,"Stacking an older merge on top of newer ones"),n.allWrites.push({path:e,children:t,writeId:s,visible:!0}),n.visibleWrites=ac(n.visibleWrites,e,t),n.lastWriteId=s}function tR(n,e){for(let t=0;t<n.allWrites.length;t++){const s=n.allWrites[t];if(s.writeId===e)return s}return null}function nR(n,e){const t=n.allWrites.findIndex(l=>l.writeId===e);D(t>=0,"removeWrite called with nonexistent writeId.");const s=n.allWrites[t];n.allWrites.splice(t,1);let i=s.visible,r=!1,o=n.allWrites.length-1;for(;i&&o>=0;){const l=n.allWrites[o];l.visible&&(o>=t&&sR(l,s.path)?i=!1:mt(s.path,l.path)&&(r=!0)),o--}if(i){if(r)return iR(n),!0;if(s.snap)n.visibleWrites=jf(n.visibleWrites,s.path);else{const l=s.children;je(l,c=>{n.visibleWrites=jf(n.visibleWrites,Ce(s.path,c))})}return!0}else return!1}function sR(n,e){if(n.snap)return mt(n.path,e);for(const t in n.children)if(n.children.hasOwnProperty(t)&&mt(Ce(n.path,t),e))return!0;return!1}function iR(n){n.visibleWrites=w_(n.allWrites,rR,ce()),n.allWrites.length>0?n.lastWriteId=n.allWrites[n.allWrites.length-1].writeId:n.lastWriteId=-1}function rR(n){return n.visible}function w_(n,e,t){let s=Ct.empty();for(let i=0;i<n.length;++i){const r=n[i];if(e(r)){const o=r.path;let l;if(r.snap)mt(t,o)?(l=ot(t,o),s=ji(s,l,r.snap)):mt(o,t)&&(l=ot(o,t),s=ji(s,ce(),r.snap.getChild(l)));else if(r.children){if(mt(t,o))l=ot(t,o),s=ac(s,l,r.children);else if(mt(o,t))if(l=ot(o,t),X(l))s=ac(s,ce(),r.children);else{const c=Os(r.children,J(l));if(c){const h=c.getChild(ye(l));s=ji(s,ce(),h)}}}else throw Qs("WriteRecord should have .snap or .children")}}return s}function T_(n,e,t,s,i){if(!s&&!i){const r=ds(n.visibleWrites,e);if(r!=null)return r;{const o=Sn(n.visibleWrites,e);if(cc(o))return t;if(t==null&&!lc(o,ce()))return null;{const l=t||z.EMPTY_NODE;return zs(o,l)}}}else{const r=Sn(n.visibleWrites,e);if(!i&&cc(r))return t;if(!i&&t==null&&!lc(r,ce()))return null;{const o=function(h){return(h.visible||i)&&(!s||!~s.indexOf(h.writeId))&&(mt(h.path,e)||mt(e,h.path))},l=w_(n.allWrites,o,e),c=t||z.EMPTY_NODE;return zs(l,c)}}}function oR(n,e,t){let s=z.EMPTY_NODE;const i=ds(n.visibleWrites,e);if(i)return i.isLeafNode()||i.forEachChild(Te,(r,o)=>{s=s.updateImmediateChild(r,o)}),s;if(t){const r=Sn(n.visibleWrites,e);return t.forEachChild(Te,(o,l)=>{const c=zs(Sn(r,new ue(o)),l);s=s.updateImmediateChild(o,c)}),zf(r).forEach(o=>{s=s.updateImmediateChild(o.name,o.node)}),s}else{const r=Sn(n.visibleWrites,e);return zf(r).forEach(o=>{s=s.updateImmediateChild(o.name,o.node)}),s}}function aR(n,e,t,s,i){D(s||i,"Either existingEventSnap or existingServerSnap must exist");const r=Ce(e,t);if(lc(n.visibleWrites,r))return null;{const o=Sn(n.visibleWrites,r);return cc(o)?i.getChild(t):zs(o,i.getChild(t))}}function lR(n,e,t,s){const i=Ce(e,t),r=ds(n.visibleWrites,i);if(r!=null)return r;if(s.isCompleteForChild(t)){const o=Sn(n.visibleWrites,i);return zs(o,s.getNode().getImmediateChild(t))}else return null}function cR(n,e){return ds(n.visibleWrites,e)}function hR(n,e,t,s,i,r,o){let l;const c=Sn(n.visibleWrites,e),h=ds(c,ce());if(h!=null)l=h;else if(t!=null)l=zs(c,t);else return[];if(l=l.withIndex(o),!l.isEmpty()&&!l.isLeafNode()){const d=[],p=o.getCompare(),m=r?l.getReverseIteratorFrom(s,o):l.getIteratorFrom(s,o);let E=m.getNext();for(;E&&d.length<i;)p(E,s)!==0&&d.push(E),E=m.getNext();return d}else return[]}function uR(){return{visibleWrites:Ct.empty(),allWrites:[],lastWriteId:-1}}function Yo(n,e,t,s){return T_(n.writeTree,n.treePath,e,t,s)}function Vh(n,e){return oR(n.writeTree,n.treePath,e)}function Gf(n,e,t,s){return aR(n.writeTree,n.treePath,e,t,s)}function Jo(n,e){return cR(n.writeTree,Ce(n.treePath,e))}function dR(n,e,t,s,i,r){return hR(n.writeTree,n.treePath,e,t,s,i,r)}function Fh(n,e,t){return lR(n.writeTree,n.treePath,e,t)}function I_(n,e){return C_(Ce(n.treePath,e),n.writeTree)}function C_(n,e){return{treePath:n,writeTree:e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class fR{constructor(){this.changeMap=new Map}trackChildChange(e){const t=e.type,s=e.childName;D(t==="child_added"||t==="child_changed"||t==="child_removed","Only child changes supported for tracking"),D(s!==".priority","Only non-priority child changes can be tracked.");const i=this.changeMap.get(s);if(i){const r=i.type;if(t==="child_added"&&r==="child_removed")this.changeMap.set(s,rr(s,e.snapshotNode,i.snapshotNode));else if(t==="child_removed"&&r==="child_added")this.changeMap.delete(s);else if(t==="child_removed"&&r==="child_changed")this.changeMap.set(s,ir(s,i.oldSnap));else if(t==="child_changed"&&r==="child_added")this.changeMap.set(s,$s(s,e.snapshotNode));else if(t==="child_changed"&&r==="child_changed")this.changeMap.set(s,rr(s,e.snapshotNode,i.oldSnap));else throw Qs("Illegal combination of changes: "+e+" occurred after "+i)}else this.changeMap.set(s,e)}getChanges(){return Array.from(this.changeMap.values())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let ea;function xR(n){D(!ea,"__referenceConstructor has already been defined"),ea=n}function OR(){return D(ea,"Reference.ts has not been loaded"),ea}let MR=1;class Xf{constructor(e){this.listenProvider_=e,this.syncPointTree_=new _e(null),this.pendingWriteTree_=uR(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function L_(n,e,t,s,i){return Zb(n.pendingWriteTree_,e,t,s,i),i?si(n,new rs(xh(),e,t)):[]}function VR(n,e,t,s){eR(n.pendingWriteTree_,e,t,s);const i=_e.fromObject(t);return si(n,new js(xh(),e,i))}function wn(n,e,t=!1){const s=tR(n.pendingWriteTree_,e);if(nR(n.pendingWriteTree_,e)){let r=new _e(null);return s.snap!=null?r=r.set(ce(),!0):je(s.children,o=>{r=r.set(new ue(o),!0)}),si(n,new Ko(s.path,r,t))}else return[]}function Sr(n,e,t){return si(n,new rs(Oh(),e,t))}function FR(n,e,t){const s=_e.fromObject(t);return si(n,new js(Oh(),e,s))}function BR(n,e){return si(n,new ar(Oh(),e))}function UR(n,e,t){const s=Wh(n,t);if(s){const i=$h(s),r=i.path,o=i.queryId,l=ot(r,e),c=new ar(Mh(o),l);return jh(n,r,c)}else return[]}function ta(n,e,t,s,i=!1){const r=e._path,o=n.syncPointTree_.get(r);let l=[];if(o&&(e._queryIdentifier==="default"||D_(o,e))){const c=LR(o,e,t,s);NR(o)&&(n.syncPointTree_=n.syncPointTree_.remove(r));const h=c.removed;if(l=c.events,!i){const d=h.findIndex(m=>m._queryParams.loadsAllData())!==-1,p=n.syncPointTree_.findOnPath(r,(m,E)=>Vn(E));if(d&&!p){const m=n.syncPointTree_.subtree(r);if(!m.isEmpty()){const E=$R(m);for(let C=0;C<E.length;++C){const A=E[C],k=A.query,F=V_(n,A);n.listenProvider_.startListening(zi(k),lr(n,k),F.hashFn,F.onComplete)}}}!p&&h.length>0&&!s&&(d?n.listenProvider_.stopListening(zi(e),null):h.forEach(m=>{const E=n.queryToTagMap.get(ka(m));n.listenProvider_.stopListening(zi(m),E)}))}jR(n,h)}return l}function x_(n,e,t,s){const i=Wh(n,s);if(i!=null){const r=$h(i),o=r.path,l=r.queryId,c=ot(o,e),h=new rs(Mh(l),c,t);return jh(n,o,h)}else return[]}function qR(n,e,t,s){const i=Wh(n,s);if(i){const r=$h(i),o=r.path,l=r.queryId,c=ot(o,e),h=_e.fromObject(t),d=new js(Mh(l),c,h);return jh(n,o,d)}else return[]}function dc(n,e,t,s=!1){const i=e._path;let r=null,o=!1;n.syncPointTree_.foreachOnPath(i,(m,E)=>{const C=ot(m,i);r=r||An(E,C),o=o||Vn(E)});let l=n.syncPointTree_.get(i);l?(o=o||Vn(l),r=r||An(l,ce())):(l=new A_,n.syncPointTree_=n.syncPointTree_.set(i,l));let c;r!=null?c=!0:(c=!1,r=z.EMPTY_NODE,n.syncPointTree_.subtree(i).foreachChild((E,C)=>{const A=An(C,ce());A&&(r=r.updateImmediateChild(E,A))}));const h=D_(l,e);if(!h&&!e._queryParams.loadsAllData()){const m=ka(e);D(!n.queryToTagMap.has(m),"View does not exist, but we have a tag");const E=zR();n.queryToTagMap.set(m,E),n.tagToQueryMap.set(E,m)}const d=Sa(n.pendingWriteTree_,i);let p=DR(l,e,t,d,r,c);if(!h&&!o&&!s){const m=N_(l,e);p=p.concat(GR(n,e,m))}return p}function qh(n,e,t){const i=n.pendingWriteTree_,r=n.syncPointTree_.findOnPath(e,(o,l)=>{const c=ot(o,e),h=An(l,c);if(h)return h});return T_(i,e,r,t,!0)}function WR(n,e){const t=e._path;let s=null;n.syncPointTree_.foreachOnPath(t,(h,d)=>{const p=ot(h,t);s=s||An(d,p)});let i=n.syncPointTree_.get(t);i?s=s||An(i,ce()):(i=new A_,n.syncPointTree_=n.syncPointTree_.set(t,i));const r=s!=null,o=r?new Mn(s,!0,!1):null,l=Sa(n.pendingWriteTree_,e._path),c=k_(i,e,l,r?o.getNode():z.EMPTY_NODE,r);return bR(c)}function si(n,e){return O_(e,n.syncPointTree_,null,Sa(n.pendingWriteTree_,ce()))}function O_(n,e,t,s){if(X(n.path))return M_(n,e,t,s);{const i=e.get(ce());t==null&&i!=null&&(t=An(i,ce()));let r=[];const o=J(n.path),l=n.operationForChild(o),c=e.children.get(o);if(c&&l){const h=t?t.getImmediateChild(o):null,d=I_(s,o);r=r.concat(O_(l,c,h,d))}return i&&(r=r.concat(Uh(i,n,s,t))),r}}function M_(n,e,t,s){const i=e.get(ce());t==null&&i!=null&&(t=An(i,ce()));let r=[];return e.children.inorderTraversal((o,l)=>{const c=t?t.getImmediateChild(o):null,h=I_(s,o),d=n.operationForChild(o);d&&(r=r.concat(M_(d,l,c,h)))}),i&&(r=r.concat(Uh(i,n,s,t))),r}function V_(n,e){const t=e.query,s=lr(n,t);return{hashFn:()=>(CR(e)||z.EMPTY_NODE).hash(),onComplete:i=>{if(i==="ok")return s?UR(n,t._path,s):BR(n,t._path);{const r=BC(i,t);return ta(n,t,null,r)}}}}function lr(n,e){const t=ka(e);return n.queryToTagMap.get(t)}function ka(n){return n._path.toString()+"$"+n._queryIdentifier}function Wh(n,e){return n.tagToQueryMap.get(e)}function $h(n){const e=n.indexOf("$");return D(e!==-1&&e<n.length-1,"Bad queryKey."),{queryId:n.substr(e+1),path:new ue(n.substr(0,e))}}function jh(n,e,t){const s=n.syncPointTree_.get(e);D(s,"Missing sync point for query tag that we're tracking");const i=Sa(n.pendingWriteTree_,e);return Uh(s,t,i,null)}function $R(n){return n.fold((e,t,s)=>{if(t&&Vn(t))return[Aa(t)];{let i=[];return t&&(i=P_(t)),je(s,(r,o)=>{i=i.concat(o)}),i}})}function zi(n){return n._queryParams.loadsAllData()&&!n._queryParams.isDefault()?new(OR())(n._repo,n._path):n}function jR(n,e){for(let t=0;t<e.length;++t){const s=e[t];if(!s._queryParams.loadsAllData()){const i=ka(s),r=n.queryToTagMap.get(i);n.queryToTagMap.delete(i),n.tagToQueryMap.delete(r)}}}function zR(){return MR++}function GR(n,e,t){const s=e._path,i=lr(n,e),r=V_(n,t),o=n.listenProvider_.startListening(zi(e),i,r.hashFn,r.onComplete),l=n.syncPointTree_.subtree(s);if(i)D(!Vn(l.value),"If we're adding a query, it shouldn't be shadowed");else{const c=l.fold((h,d,p)=>{if(!X(h)&&d&&Vn(d))return[Aa(d).query];{let m=[];return d&&(m=m.concat(P_(d).map(E=>E.query))),je(p,(E,C)=>{m=m.concat(C)}),m}});for(let h=0;h<c.length;++h){const d=c[h];n.listenProvider_.stopListening(zi(d),lr(n,d))}}return o}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ZR=/[\[\].#$\/\u0000-\u001F\u007F]/,eS=/[\[\].#$\u0000-\u001F\u007F]/,El=10*1024*1024,Yh=function(n){return typeof n=="string"&&n.length!==0&&!ZR.test(n)},$_=function(n){return typeof n=="string"&&n.length!==0&&!eS.test(n)},tS=function(n){return n&&(n=n.replace(/^\/*\.info(\/|$)/,"/")),$_(n)},pc=function(n){return n===null||typeof n=="string"||typeof n=="number"&&!Th(n)||n&&typeof n=="object"&&Bt(n,".sv")},Jh=function(n,e,t,s){s&&e===void 0||Na(ia(n,"value"),e,t)},Na=function(n,e,t){const s=t instanceof ue?new vb(t,n):t;if(e===void 0)throw new Error(n+"contains undefined "+zn(s));if(typeof e=="function")throw new Error(n+"contains a function "+zn(s)+" with contents = "+e.toString());if(Th(e))throw new Error(n+"contains "+e.toString()+" "+zn(s));if(typeof e=="string"&&e.length>El/3&&ra(e)>El)throw new Error(n+"contains a string greater than "+El+" utf8 bytes "+zn(s)+" ('"+e.substring(0,50)+"...')");if(e&&typeof e=="object"){let i=!1,r=!1;if(je(e,(o,l)=>{if(o===".value")i=!0;else if(o!==".priority"&&o!==".sv"&&(r=!0,!Yh(o)))throw new Error(n+" contains an invalid key ("+o+") "+zn(s)+`.  Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`);Eb(s,o),Na(n,l,s),wb(s)}),i&&r)throw new Error(n+' contains ".value" child '+zn(s)+" in addition to actual children.")}},nS=function(n,e){let t,s;for(t=0;t<e.length;t++){s=e[t];const r=sr(s);for(let o=0;o<r.length;o++)if(!(r[o]===".priority"&&o===r.length-1)){if(!Yh(r[o]))throw new Error(n+"contains an invalid key ("+r[o]+") in path "+s.toString()+`. Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`)}}e.sort(yb);let i=null;for(t=0;t<e.length;t++){if(s=e[t],i!==null&&mt(i,s))throw new Error(n+"contains a path "+i.toString()+" that is ancestor of another path "+s.toString());i=s}},sS=function(n,e,t,s){const i=ia(n,"values");if(!(e&&typeof e=="object")||Array.isArray(e))throw new Error(i+" must be an object containing the children to replace.");const r=[];je(e,(o,l)=>{const c=new ue(o);if(Na(i,l,Ce(t,c)),Sh(c)===".priority"&&!pc(l))throw new Error(i+"contains an invalid value for '"+c.toString()+"', which must be a valid Firebase priority (a string, finite number, server value, or null).");r.push(c)}),nS(i,r)},Xh=function(n,e,t,s){if(!$_(t))throw new Error(ia(n,e)+'was an invalid path = "'+t+`". Paths must be non-empty strings and can't contain ".", "#", "$", "[", or "]"`)},iS=function(n,e,t,s){t&&(t=t.replace(/^\/*\.info(\/|$)/,"/")),Xh(n,e,t)},j_=function(n,e){if(J(e)===".info")throw new Error(n+" failed = Can't modify data under /.info/")},rS=function(n,e){const t=e.path.toString();if(typeof e.repoInfo.host!="string"||e.repoInfo.host.length===0||!Yh(e.repoInfo.namespace)&&e.repoInfo.host.split(":")[0]!=="localhost"||t.length!==0&&!tS(t))throw new Error(ia(n,"url")+`must be a valid firebase URL and the path can't contain ".", "#", "$", "[", or "]".`)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class oS{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function Da(n,e){let t=null;for(let s=0;s<e.length;s++){const i=e[s],r=i.getPath();t!==null&&!Ah(r,t.path)&&(n.eventLists_.push(t),t=null),t===null&&(t={events:[],path:r}),t.events.push(i)}t&&n.eventLists_.push(t)}function z_(n,e,t){Da(n,t),G_(n,s=>Ah(s,e))}function gt(n,e,t){Da(n,t),G_(n,s=>mt(s,e)||mt(e,s))}function G_(n,e){n.recursionDepth_++;let t=!0;for(let s=0;s<n.eventLists_.length;s++){const i=n.eventLists_[s];if(i){const r=i.path;e(r)?(aS(n.eventLists_[s]),n.eventLists_[s]=null):t=!1}}t&&(n.eventLists_=[]),n.recursionDepth_--}function aS(n){for(let e=0;e<n.events.length;e++){const t=n.events[e];if(t!==null){n.events[e]=null;const s=t.getEventRunner();qi&&Ue("event: "+t.toString()),ni(s)}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const lS="repo_interrupt",cS=25;class hS{constructor(e,t,s,i){this.repoInfo_=e,this.forceRestClient_=t,this.authTokenProvider_=s,this.appCheckProvider_=i,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new oS,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=Ho(),this.transactionQueueTree_=new Kh,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function uS(n,e,t){if(n.stats_=bh(n.repoInfo_),n.forceRestClient_||$C())n.server_=new Go(n.repoInfo_,(s,i,r,o)=>{ep(n,s,i,r,o)},n.authTokenProvider_,n.appCheckProvider_),setTimeout(()=>tp(n,!0),0);else{if(typeof t<"u"&&t!==null){if(typeof t!="object")throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{Ne(t)}catch(s){throw new Error("Invalid authOverride provided: "+s)}}n.persistentConnection_=new nn(n.repoInfo_,e,(s,i,r,o)=>{ep(n,s,i,r,o)},s=>{tp(n,s)},s=>{dS(n,s)},n.authTokenProvider_,n.appCheckProvider_,t),n.server_=n.persistentConnection_}n.authTokenProvider_.addTokenChangeListener(s=>{n.server_.refreshAuthToken(s)}),n.appCheckProvider_.addTokenChangeListener(s=>{n.server_.refreshAppCheckToken(s.token)}),n.statsReporter_=KC(n.repoInfo_,()=>new Hb(n.stats_,n.server_)),n.infoData_=new Wb,n.infoSyncTree_=new Xf({startListening:(s,i,r,o)=>{let l=[];const c=n.infoData_.getNode(s._path);return c.isEmpty()||(l=Sr(n.infoSyncTree_,s._path,c),setTimeout(()=>{o("ok")},0)),l},stopListening:()=>{}}),Zh(n,"connected",!1),n.serverSyncTree_=new Xf({startListening:(s,i,r,o)=>(n.server_.listen(s,r,i,(l,c)=>{const h=o(l,c);gt(n.eventQueue_,s._path,h)}),[]),stopListening:(s,i)=>{n.server_.unlisten(s,i)}})}function H_(n){const t=n.infoData_.getNode(new ue(".info/serverTimeOffset")).val()||0;return new Date().getTime()+t}function La(n){return HR({timestamp:H_(n)})}function ep(n,e,t,s,i){n.dataUpdateCount++;const r=new ue(e);t=n.interceptServerDataCallback_?n.interceptServerDataCallback_(e,t):t;let o=[];if(i)if(s){const c=Io(t,h=>Pe(h));o=qR(n.serverSyncTree_,r,c,i)}else{const c=Pe(t);o=x_(n.serverSyncTree_,r,c,i)}else if(s){const c=Io(t,h=>Pe(h));o=FR(n.serverSyncTree_,r,c)}else{const c=Pe(t);o=Sr(n.serverSyncTree_,r,c)}let l=r;o.length>0&&(l=Gs(n,r)),gt(n.eventQueue_,l,o)}function tp(n,e){Zh(n,"connected",e),e===!1&&gS(n)}function dS(n,e){je(e,(t,s)=>{Zh(n,t,s)})}function Zh(n,e,t){const s=new ue("/.info/"+e),i=Pe(t);n.infoData_.updateSnapshot(s,i);const r=Sr(n.infoSyncTree_,s,i);gt(n.eventQueue_,s,r)}function eu(n){return n.nextWriteId_++}function fS(n,e,t){const s=WR(n.serverSyncTree_,e);return s!=null?Promise.resolve(s):n.server_.get(e).then(i=>{const r=Pe(i).withIndex(e._queryParams.getIndex());dc(n.serverSyncTree_,e,t,!0);let o;if(e._queryParams.loadsAllData())o=Sr(n.serverSyncTree_,e._path,r);else{const l=lr(n.serverSyncTree_,e);o=x_(n.serverSyncTree_,e._path,r,l)}return gt(n.eventQueue_,e._path,o),ta(n.serverSyncTree_,e,t,null,!0),r},i=>(kr(n,"get for query "+Ne(e)+" failed: "+i),Promise.reject(new Error(i))))}function pS(n,e,t,s,i){kr(n,"set",{path:e.toString(),value:t,priority:s});const r=La(n),o=Pe(t,s),l=qh(n.serverSyncTree_,e),c=B_(o,l,r),h=eu(n),d=L_(n.serverSyncTree_,e,c,h,!0);Da(n.eventQueue_,d),n.server_.put(e.toString(),o.val(!0),(m,E)=>{const C=m==="ok";C||at("set at "+e+" failed: "+m);const A=wn(n.serverSyncTree_,h,!C);gt(n.eventQueue_,e,A),mc(n,i,m,E)});const p=nu(n,e);Gs(n,p),gt(n.eventQueue_,p,[])}function mS(n,e,t,s){kr(n,"update",{path:e.toString(),value:t});let i=!0;const r=La(n),o={};if(je(t,(l,c)=>{i=!1,o[l]=F_(Ce(e,l),Pe(c),n.serverSyncTree_,r)}),i)Ue("update() called with empty data.  Don't do anything."),mc(n,s,"ok",void 0);else{const l=eu(n),c=VR(n.serverSyncTree_,e,o,l);Da(n.eventQueue_,c),n.server_.merge(e.toString(),t,(h,d)=>{const p=h==="ok";p||at("update at "+e+" failed: "+h);const m=wn(n.serverSyncTree_,l,!p),E=m.length>0?Gs(n,e):e;gt(n.eventQueue_,E,m),mc(n,s,h,d)}),je(t,h=>{const d=nu(n,Ce(e,h));Gs(n,d)}),gt(n.eventQueue_,e,[])}}function gS(n){kr(n,"onDisconnectEvents");const e=La(n),t=Ho();oc(n.onDisconnect_,ce(),(i,r)=>{const o=F_(i,r,n.serverSyncTree_,e);y_(t,i,o)});let s=[];oc(t,ce(),(i,r)=>{s=s.concat(Sr(n.serverSyncTree_,i,r));const o=nu(n,i);Gs(n,o)}),n.onDisconnect_=Ho(),gt(n.eventQueue_,ce(),s)}function _S(n,e,t){let s;J(e._path)===".info"?s=dc(n.infoSyncTree_,e,t):s=dc(n.serverSyncTree_,e,t),z_(n.eventQueue_,e._path,s)}function yS(n,e,t){let s;J(e._path)===".info"?s=ta(n.infoSyncTree_,e,t):s=ta(n.serverSyncTree_,e,t),z_(n.eventQueue_,e._path,s)}function vS(n){n.persistentConnection_&&n.persistentConnection_.interrupt(lS)}function kr(n,...e){let t="";n.persistentConnection_&&(t=n.persistentConnection_.id+":"),Ue(t,...e)}function mc(n,e,t,s){e&&ni(()=>{if(t==="ok")e(null);else{const i=(t||"error").toUpperCase();let r=i;s&&(r+=": "+s);const o=new Error(r);o.code=i,e(o)}})}function K_(n,e,t){return qh(n.serverSyncTree_,e,t)||z.EMPTY_NODE}function tu(n,e=n.transactionQueueTree_){if(e||xa(n,e),ii(e)){const t=Y_(n,e);D(t.length>0,"Sending zero length transaction queue"),t.every(i=>i.status===0)&&ES(n,Ar(e),t)}else q_(e)&&Pa(e,t=>{tu(n,t)})}function ES(n,e,t){const s=t.map(h=>h.currentWriteId),i=K_(n,e,s);let r=i;const o=i.hash();for(let h=0;h<t.length;h++){const d=t[h];D(d.status===0,"tryToSendTransactionQueue_: items in queue should all be run."),d.status=1,d.retryCount++;const p=ot(e,d.path);r=r.updateChild(p,d.currentOutputSnapshotRaw)}const l=r.val(!0),c=e;n.server_.put(c.toString(),l,h=>{kr(n,"transaction put response",{path:c.toString(),status:h});let d=[];if(h==="ok"){const p=[];for(let m=0;m<t.length;m++)t[m].status=2,d=d.concat(wn(n.serverSyncTree_,t[m].currentWriteId)),t[m].onComplete&&p.push(()=>t[m].onComplete(null,!0,t[m].currentOutputSnapshotResolved)),t[m].unwatcher();xa(n,Qh(n.transactionQueueTree_,e)),tu(n,n.transactionQueueTree_),gt(n.eventQueue_,e,d);for(let m=0;m<p.length;m++)ni(p[m])}else{if(h==="datastale")for(let p=0;p<t.length;p++)t[p].status===3?t[p].status=4:t[p].status=0;else{at("transaction at "+c.toString()+" failed: "+h);for(let p=0;p<t.length;p++)t[p].status=4,t[p].abortReason=h}Gs(n,e)}},o)}function Gs(n,e){const t=Q_(n,e),s=Ar(t),i=Y_(n,t);return wS(n,i,s),s}function wS(n,e,t){if(e.length===0)return;const s=[];let i=[];const o=e.filter(l=>l.status===0).map(l=>l.currentWriteId);for(let l=0;l<e.length;l++){const c=e[l],h=ot(t,c.path);let d=!1,p;if(D(h!==null,"rerunTransactionsUnderNode_: relativePath should not be null."),c.status===4)d=!0,p=c.abortReason,i=i.concat(wn(n.serverSyncTree_,c.currentWriteId,!0));else if(c.status===0)if(c.retryCount>=cS)d=!0,p="maxretry",i=i.concat(wn(n.serverSyncTree_,c.currentWriteId,!0));else{const m=K_(n,c.path,o);c.currentInputSnapshot=m;const E=e[l].update(m.val());if(E!==void 0){Na("transaction failed: Data returned ",E,c.path);let C=Pe(E);typeof E=="object"&&E!=null&&Bt(E,".priority")||(C=C.updatePriority(m.getPriority()));const k=c.currentWriteId,F=La(n),q=B_(C,m,F);c.currentOutputSnapshotRaw=C,c.currentOutputSnapshotResolved=q,c.currentWriteId=eu(n),o.splice(o.indexOf(k),1),i=i.concat(L_(n.serverSyncTree_,c.path,q,c.currentWriteId,c.applyLocally)),i=i.concat(wn(n.serverSyncTree_,k,!0))}else d=!0,p="nodata",i=i.concat(wn(n.serverSyncTree_,c.currentWriteId,!0))}gt(n.eventQueue_,t,i),i=[],d&&(e[l].status=2,function(m){setTimeout(m,Math.floor(0))}(e[l].unwatcher),e[l].onComplete&&(p==="nodata"?s.push(()=>e[l].onComplete(null,!1,e[l].currentInputSnapshot)):s.push(()=>e[l].onComplete(new Error(p),!1,null))))}xa(n,n.transactionQueueTree_);for(let l=0;l<s.length;l++)ni(s[l]);tu(n,n.transactionQueueTree_)}function Q_(n,e){let t,s=n.transactionQueueTree_;for(t=J(e);t!==null&&ii(s)===void 0;)s=Qh(s,t),e=ye(e),t=J(e);return s}function Y_(n,e){const t=[];return J_(n,e,t),t.sort((s,i)=>s.order-i.order),t}function J_(n,e,t){const s=ii(e);if(s)for(let i=0;i<s.length;i++)t.push(s[i]);Pa(e,i=>{J_(n,i,t)})}function xa(n,e){const t=ii(e);if(t){let s=0;for(let i=0;i<t.length;i++)t[i].status!==2&&(t[s]=t[i],s++);t.length=s,U_(e,t.length>0?t:void 0)}Pa(e,s=>{xa(n,s)})}function nu(n,e){const t=Ar(Q_(n,e)),s=Qh(n.transactionQueueTree_,e);return JR(s,i=>{wl(n,i)}),wl(n,s),W_(s,i=>{wl(n,i)}),t}function wl(n,e){const t=ii(e);if(t){const s=[];let i=[],r=-1;for(let o=0;o<t.length;o++)t[o].status===3||(t[o].status===1?(D(r===o-1,"All SENT items should be at beginning of queue."),r=o,t[o].status=3,t[o].abortReason="set"):(D(t[o].status===0,"Unexpected transaction status in abort"),t[o].unwatcher(),i=i.concat(wn(n.serverSyncTree_,t[o].currentWriteId,!0)),t[o].onComplete&&s.push(t[o].onComplete.bind(null,new Error("set"),!1,null))));r===-1?U_(e,void 0):t.length=r+1,gt(n.eventQueue_,Ar(e),i);for(let o=0;o<s.length;o++)ni(s[o])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Pr{constructor(e,t,s,i){this._repo=e,this._path=t,this._queryParams=s,this._orderByCalled=i}get key(){return X(this._path)?null:Sh(this._path)}get ref(){return new Ut(this._repo,this._path)}get _queryIdentifier(){const e=Wf(this._queryParams),t=Ih(e);return t==="{}"?"default":t}get _queryObject(){return Wf(this._queryParams)}isEqual(e){if(e=ge(e),!(e instanceof Pr))return!1;const t=this._repo===e._repo,s=Ah(this._path,e._path),i=this._queryIdentifier===e._queryIdentifier;return t&&s&&i}toJSON(){return this.toString()}toString(){return this._repo.toString()+_b(this._path)}}function RS(n,e){if(n._orderByCalled===!0)throw new Error(e+": You can't combine multiple orderBy calls.")}function ty(n){let e=null,t=null;if(n.hasStart()&&(e=n.getIndexStartValue()),n.hasEnd()&&(t=n.getIndexEndValue()),n.getIndex()===Jn){const s="Query: When ordering by key, you may only pass one argument to startAt(), endAt(), or equalTo().",i="Query: When ordering by key, the argument passed to startAt(), startAfter(), endAt(), endBefore(), or equalTo() must be a string.";if(n.hasStart()){if(n.getIndexStartName()!==is)throw new Error(s);if(typeof e!="string")throw new Error(i)}if(n.hasEnd()){if(n.getIndexEndName()!==xn)throw new Error(s);if(typeof t!="string")throw new Error(i)}}else if(n.getIndex()===Te){if(e!=null&&!pc(e)||t!=null&&!pc(t))throw new Error("Query: When ordering by priority, the first argument passed to startAt(), startAfter() endAt(), endBefore(), or equalTo() must be a valid priority value (null, a number, or a string).")}else if(D(n.getIndex()instanceof Nh||n.getIndex()===g_,"unknown index type."),e!=null&&typeof e=="object"||t!=null&&typeof t=="object")throw new Error("Query: First argument passed to startAt(), startAfter(), endAt(), endBefore(), or equalTo() cannot be an object.")}function SS(n){if(n.hasStart()&&n.hasEnd()&&n.hasLimit()&&!n.hasAnchoredLimit())throw new Error("Query: Can't combine startAt(), startAfter(), endAt(), endBefore(), and limit(). Use limitToFirst() or limitToLast() instead.")}class Ut extends Pr{constructor(e,t){super(e,t,new Lh,!1)}get parent(){const e=c_(this._path);return e===null?null:new Ut(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class Hs{constructor(e,t,s){this._node=e,this.ref=t,this._index=s}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new ue(e),s=Ks(this.ref,e);return new Hs(this._node.getChild(t),s,Te)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(s,i)=>e(new Hs(i,Ks(this.ref,s),Te)))}hasChild(e){const t=new ue(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function Tl(n,e){return n=ge(n),n._checkNotDeleted("ref"),Ks(n._root,e)}function Ks(n,e){return n=ge(n),J(n._path)===null?iS("child","path",e):Xh("child","path",e),new Ut(n._repo,Ce(n._path,e))}function AS(n,e){n=ge(n),j_("push",n._path),Jh("push",e,n._path,!0);const t=H_(n._repo),s=bS(t),i=Ks(n,s),r=Ks(n,s);let o;return e!=null?o=kS(r,e).then(()=>r):o=Promise.resolve(r),i.then=o.then.bind(o),i.catch=o.then.bind(o,void 0),i}function kS(n,e){n=ge(n),j_("set",n._path),Jh("set",e,n._path,!1);const t=new cr;return pS(n._repo,n._path,e,null,t.wrapCallback(()=>{})),t.promise}function PS(n,e){sS("update",e,n._path);const t=new cr;return mS(n._repo,n._path,e,t.wrapCallback(()=>{})),t.promise}function NS(n){n=ge(n);const e=new ey(()=>{}),t=new su(e);return fS(n._repo,n,t).then(s=>new Hs(s,new Ut(n._repo,n._path),n._queryParams.getIndex()))}class su{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,t){const s=t._queryParams.getIndex();return new X_("value",this,new Hs(e.snapshotNode,new Ut(t._repo,t._path),s))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new Z_(this,e,t):null}matches(e){return e instanceof su?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}class iu{constructor(e,t){this.eventType=e,this.callbackContext=t}respondsTo(e){let t=e==="children_added"?"child_added":e;return t=t==="children_removed"?"child_removed":t,this.eventType===t}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new Z_(this,e,t):null}createEvent(e,t){D(e.childName!=null,"Child events should have a childName.");const s=Ks(new Ut(t._repo,t._path),e.childName),i=t._queryParams.getIndex();return new X_(e.type,this,new Hs(e.snapshotNode,s,i),e.prevName)}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,e.prevName)}matches(e){return e instanceof iu?this.eventType===e.eventType&&(!this.callbackContext||!e.callbackContext||this.callbackContext.matches(e.callbackContext)):!1}hasAnyCallback(){return!!this.callbackContext}}function DS(n,e,t,s,i){const r=new ey(t,void 0),o=new iu(e,r);return _S(n._repo,n,o),()=>yS(n._repo,n,o)}function LS(n,e,t,s){return DS(n,"child_added",e)}class ny{}class xS extends ny{constructor(e,t){super(),this._value=e,this._key=t,this.type="endAt"}_apply(e){Jh("endAt",this._value,e._path,!0);const t=Ub(e._queryParams,this._value,this._key);if(SS(t),ty(t),e._queryParams.hasEnd())throw new Error("endAt: Starting point was already set (by another call to endAt, endBefore or equalTo).");return new Pr(e._repo,e._path,t,e._orderByCalled)}}function OS(n,e){return new xS(n,e)}class MS extends ny{constructor(e){super(),this._path=e,this.type="orderByChild"}_apply(e){RS(e,"orderByChild");const t=new ue(this._path);if(X(t))throw new Error("orderByChild: cannot pass in empty path. Use orderByValue() instead.");const s=new Nh(t),i=qb(e._queryParams,s);return ty(i),new Pr(e._repo,e._path,i,!0)}}function VS(n){return Xh("orderByChild","path",n),new MS(n)}function FS(n,...e){let t=ge(n);for(const s of e)t=s._apply(t);return t}kR(Ut);xR(Ut);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const BS="FIREBASE_DATABASE_EMULATOR_HOST",gc={};let US=!1;function qS(n,e,t,s){n.repoInfo_=new e_(`${e}:${t}`,!1,n.repoInfo_.namespace,n.repoInfo_.webSocketOnly,n.repoInfo_.nodeAdmin,n.repoInfo_.persistenceKey,n.repoInfo_.includeNamespaceInQueryParams,!0),s&&(n.authTokenProvider_=s)}function WS(n,e,t,s,i){let r=s||n.options.databaseURL;r===void 0&&(n.options.projectId||ln("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),Ue("Using default host for project ",n.options.projectId),r=`${n.options.projectId}-default-rtdb.firebaseio.com`);let o=np(r,i),l=o.repoInfo,c;typeof process<"u"&&Cf&&(c=Cf[BS]),c?(r=`http://${c}?ns=${l.namespace}`,o=np(r,i),l=o.repoInfo):o.repoInfo.secure;const h=new zC(n.name,n.options,e);rS("Invalid Firebase Database URL",o),X(o.path)||ln("Database URL must point to the root of a Firebase Database (not including a child path).");const d=jS(l,n,h,new jC(n.name,t));return new zS(d,n)}function $S(n,e){const t=gc[e];(!t||t[n.key]!==n)&&ln(`Database ${e}(${n.repoInfo_}) has already been deleted.`),vS(n),delete t[n.key]}function jS(n,e,t,s){let i=gc[e.name];i||(i={},gc[e.name]=i);let r=i[n.toURLString()];return r&&ln("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call."),r=new hS(n,US,t,s),i[n.toURLString()]=r,r}class zS{constructor(e,t){this._repoInternal=e,this.app=t,this.type="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||(uS(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new Ut(this._repo,ce())),this._rootInternal}_delete(){return this._rootInternal!==null&&($S(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){this._rootInternal===null&&ln("Cannot call "+e+" on a deleted database.")}}function GS(n=Rc(),e){const t=aa(n,"database").getImmediate({identifier:e});if(!t._instanceStarted){const s=Rp("database");s&&HS(t,...s)}return t}function HS(n,e,t,s={}){n=ge(n),n._checkNotDeleted("useEmulator"),n._instanceStarted&&ln("Cannot call useEmulator() after instance has already been initialized.");const i=n._repoInternal;let r;if(i.repoInfo_.nodeAdmin)s.mockUserToken&&ln('mockUserToken is not supported by the Admin SDK. For client access with mock users, please use the "firebase" package instead of "firebase-admin".'),r=new mo(mo.OWNER);else if(s.mockUserToken){const o=typeof s.mockUserToken=="string"?s.mockUserToken:kp(s.mockUserToken,n.app.options.projectId);r=new mo(o)}qS(i,e,t,r)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function KS(n){AC(as),Xn(new Pn("database",(e,{instanceIdentifier:t})=>{const s=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return WS(s,i,r,t)},"PUBLIC").setMultipleInstances(!0)),Nt(bf,Rf,n),Nt(bf,Rf,"esm2017")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */const QS={".sv":"timestamp"};function YS(){return QS}nn.prototype.simpleListen=function(n,e){this.sendRequest("q",{p:n},e)};nn.prototype.echo=function(n,e){this.sendRequest("echo",{d:n},e)};KS();const gn=n=>atob(n),JS={apiKey:gn("QUl6YVN5Q2FUUWE2Sm9NajJNQmdEZ2Rwb25WQllfTkFlUU84X3Vz"),authDomain:gn("a2lja2VyaGF4LW9ubGluZS5maXJlYmFzYXBwLmNvbQ=="),databaseURL:gn("aHR0cHM6Ly9raWNrZXJoYXgtb25saW5lLWRlZmF1bHQtcnRkYi5maXJlYmFzZWlvLmNvbQ=="),projectId:gn("a2lja2VyaGF4LW9ubGluZQ=="),storageBucket:gn("a2lja2VyaGF4LW9ubGluZS5maXJlYmFzdG9yYWdlLmFwcA=="),messagingSenderId:gn("MzM3NTk4NDY1MTcw"),appId:gn("MTozMzc1OTg0NjUxNzA6d2ViOjE5MDU0YWI4NDBkODBkMmMyMDUyNGI="),measurementId:gn("Ry0xWjhWN0NWRkcw")},ru=xp(JS),Il=CT(ru),ut=uC(ru),Cl=GS(ru),Xe={async loginWithGoogle(){const n=new Yt,e=await Lw(Il,n),t=e.user,s=Ht(ut,"users",t.uid);if((await dl(s)).exists())await If(s,{lastLogin:new Date().toISOString()});else{const r=Math.floor(Math.random()*9e3)+1e3,l=`${(t.displayName||"Jogador").replace(/\s+/g,"").replace(/[^a-zA-Z0-9]/g,"").toLowerCase()}${r}`.substring(0,12),c={uid:t.uid,username:l,displayName:l,badge:"👤",bio:"",level:1,xp:0,isNewUser:!0,dateCreated:new Date().toISOString(),lastLogin:new Date().toISOString(),settings:{volume:80,quality:"high",fieldSize:"medium"}},h={uid:t.uid,matchesPlayed:0,wins:0,losses:0,draws:0,goals:0,assists:0,saves:0};await pl(Ht(ut,"users",t.uid),c),await pl(Ht(ut,"stats",t.uid),h)}return e},async logout(){return await fw(Il)},subscribeToAuth(n){return dw(Il,n)},async getUserProfile(n){const e=Ht(ut,"users",n),t=await dl(e);return t.exists()?t.data():null},async updateUserProfile(n,e){const t=Ht(ut,"users",n);await If(t,e)},async getUserStats(n){const e=Ht(ut,"stats",n),t=await dl(e);return t.exists()?t.data():null},async saveMatchResult(n,e,t,s,i,r,o,l){const c=Ht(ut,"stats",n),h=Ht(ut,"users",n);await SC(ut,async d=>{const p=await d.get(c),m=await d.get(h);if(!p.exists()||!m.exists())throw new Error("Documento não encontrado");const E=p.data(),C=m.data(),A={matchesPlayed:(E.matchesPlayed||0)+1,wins:(E.wins||0)+(e?1:0),losses:(E.losses||0)+(t?1:0),draws:(E.draws||0)+(s?1:0),goals:(E.goals||0)+i,assists:(E.assists||0)+r,saves:(E.saves||0)+o};let k=(C.xp||0)+l,F=C.level||1,q=F*100;for(;k>=q;)k-=q,F++,q=F*100;d.update(c,A),d.update(h,{xp:k,level:F,lastLogin:new Date().toISOString()})})},async addMatchToHistory(n){const e=Ht(eo(ut,"history"));await pl(e,n)},async getRecentHistory(n,e=5){const t=eo(ut,"history"),s=vf(t,Ef("playerUids","array-contains",n),EC(20)),i=await fl(s),r=[];return i.forEach(o=>r.push({id:o.id,...o.data()})),r.sort((o,l)=>new Date(l.date)-new Date(o.date)),r.slice(0,e)},async getGlobalRanking(n="wins",e=10){try{const t=eo(ut,"users"),s=await fl(t),i=[];for(const r of s.docs){const o=r.data();if(!o.uid)continue;const l=await this.getUserStats(o.uid)||{};i.push({username:o.username,displayName:o.username,badge:o.badge||"🏳️",level:o.level||1,wins:l.wins||0,losses:l.losses||0,goals:l.goals||0,xp:o.xp||0})}return n==="level"?i.sort((r,o)=>o.level!==r.level?o.level-r.level:o.xp-r.xp):n==="wins"?i.sort((r,o)=>o.wins-r.wins):n==="goals"&&i.sort((r,o)=>o.goals-r.goals),i.slice(0,e)}catch(t){throw console.error("[Firestore] Error fetching ranking:",t),t}},async isUsernameUnique(n,e){const t=vf(eo(ut,"users"),Ef("username","==",n.toLowerCase())),s=await fl(t);let i=!0;return s.forEach(r=>{r.id!==e&&(i=!1)}),i},async pruneOldChatMessages(){try{const n=Tl(Cl,"globalChat"),e=Date.now()-72e5,t=FS(n,VS("timestamp"),OS(e)),s=await NS(t);if(s.exists()){const i={};s.forEach(r=>{i[r.key]=null}),await PS(n,i)}}catch(n){console.warn("Pruning skipped or unauthorized:",n)}},async sendGlobalChatMessage(n,e){this.pruneOldChatMessages().catch(s=>console.warn(s));const t=Tl(Cl,"globalChat");await AS(t,{uid:n.uid,username:n.username,badge:n.badge||"👤",text:e,timestamp:YS()})},subscribeToGlobalChat(n){const e=Tl(Cl,"globalChat");LS(e,t=>{n(t.val())})}};function he(n,e="info"){if(!document.getElementById("toast-style")){const r=document.createElement("style");r.id="toast-style",r.textContent=`
    ...
    `,document.head.appendChild(r)}let t=document.querySelector(".toast-container");t||(t=document.createElement("div"),t.className="toast-container",document.body.appendChild(t));const s=document.createElement("div");s.className=`toast toast-${e}`;let i="ℹ️";e==="success"&&(i="✅"),e==="error"&&(i="❌"),s.innerHTML=`<span>${i}</span> <span>${n}</span>`,t.appendChild(s),setTimeout(()=>s.classList.add("show"),50),setTimeout(()=>{s.classList.remove("show"),setTimeout(()=>s.remove(),250)},3500)}const XS={init(){const n=document.getElementById("btn-google-login");n&&n.addEventListener("click",async()=>{try{he("Iniciando login com Google...","info"),await Xe.loginWithGoogle(),he("Login realizado com sucesso!","success")}catch(e){he(e.message||"Erro ao entrar com Google.","error")}})}};function ZS(n){const e=(n??"").toString();if(!e)return[];try{const t=new Intl.Segmenter(void 0,{granularity:"grapheme"});return Array.from(t.segment(e),s=>s.segment)}catch{return Array.from(e)}}function eA(n){return new RegExp("\\p{Extended_Pictographic}","u").test(n||"")}const Be={currentUser:null,profileData:null,async init(n){if(this.currentUser=n,!n)return;const e=document.getElementById("menu-btn-play");e&&(e.onclick=()=>$.show("mode-select-screen"));const t=document.getElementById("menu-btn-profile");t&&(t.onclick=()=>$.show("profile-screen"));const s=document.getElementById("menu-quick-profile");s&&(s.onclick=()=>$.show("profile-screen"));const i=document.getElementById("menu-btn-ranking");i&&(i.onclick=()=>$.show("ranking-screen"));const r=document.getElementById("menu-btn-settings");r&&(r.onclick=()=>$.show("settings-screen"));const o=document.getElementById("menu-btn-controls");o&&(o.onclick=()=>$.show("controls-screen"));const l=document.getElementById("menu-btn-credits");l&&(l.onclick=()=>$.show("credits-screen"));const c=document.getElementById("menu-btn-logout");c&&(c.onclick=async()=>{try{await Xe.logout(),he("Desconectado com sucesso.","info")}catch{he("Erro ao sair da conta.","error")}});const h=document.getElementById("credits-btn-back");h&&(h.onclick=()=>$.show("menu-screen")),$.register("menu-screen",{onEnter:()=>this.refreshQuickProfile()}),$.register("profile-screen",{onEnter:()=>this.loadProfileScreen()});const d=document.getElementById("profile-btn-back");d&&(d.onclick=()=>$.show("menu-screen"));const p=document.getElementById("profile-btn-save");p&&(p.onclick=async()=>{await this.saveProfileEdits()});const m=document.getElementById("profile-badge-select"),E=document.getElementById("profile-avatar-display");m&&E&&m.addEventListener("change",C=>{this.updateAvatarDisplay(E,C.target.value)}),await this.refreshQuickProfile()},async refreshQuickProfile(){if(this.currentUser)try{if(this.profileData=await Xe.getUserProfile(this.currentUser.uid),!this.profileData)return;const n=document.getElementById("quick-profile-flag"),e=document.getElementById("quick-profile-name"),t=document.getElementById("quick-profile-level"),s=document.getElementById("quick-avatar-char"),i=document.querySelector(".quick-xp-fill");if(n&&(n.textContent=this.profileData.badge||"🇧🇷"),e&&(e.textContent=this.profileData.displayName||this.profileData.username),t&&(t.textContent=this.profileData.level||1),s&&(s.textContent=this.profileData.badge||"👤"),i){const r=this.profileData.level||1,o=this.profileData.xp||0,l=r*100,c=Math.min(100,Math.max(0,o/l*100));i.style.width=`${c}%`}}catch(n){console.error("Erro ao carregar perfil rápido:",n)}},async loadProfileScreen(){if(!this.currentUser||!this.profileData)return;this.profileData=await Xe.getUserProfile(this.currentUser.uid);const n=document.getElementById("profile-username-input"),e=document.getElementById("profile-badge-select"),t=document.getElementById("profile-bio-input"),s=document.getElementById("profile-avatar-display");n&&(n.value=this.profileData.username||""),e&&(e.value=this.profileData.badge||"👤"),t&&(t.value=this.profileData.bio||""),s&&this.updateAvatarDisplay(s,this.profileData.badge);const i=await Xe.getUserStats(this.currentUser.uid);if(i){const o=i.matchesPlayed>0?Math.round(i.wins/i.matchesPlayed*100):0;document.getElementById("stats-played").textContent=i.matchesPlayed||0,document.getElementById("stats-wins").textContent=i.wins||0,document.getElementById("stats-losses").textContent=i.losses||0,document.getElementById("stats-winrate").textContent=`${o}%`,document.getElementById("stats-goals").textContent=i.goals||0,document.getElementById("stats-assists").textContent=i.assists||0,document.getElementById("stats-saves").textContent=i.saves||0,document.getElementById("stats-level").textContent=this.profileData.level||1,document.getElementById("stats-xp").textContent=this.profileData.xp||0}const r=document.getElementById("profile-match-history");if(r){r.innerHTML='<div class="subtext">Carregando histórico...</div>';try{const o=await Xe.getRecentHistory(this.currentUser.uid);o.length===0?r.innerHTML='<div class="subtext">Nenhuma partida recente.</div>':(r.innerHTML="",o.forEach(l=>{const c=document.createElement("div");c.className="history-item";let h="draw",d="Empate";l.winner==="draw"?(h="draw",d="Empate"):l.winner===l.playerTeams[this.currentUser.uid]?(h="win",d="Vitória"):(h="loss",d="Derrota");const p=new Date(l.date).toLocaleDateString("pt-BR");c.innerHTML=`
      ...
      `,i.appendChild(o),i.scrollTop=i.scrollHeight}))}};function dk(){console.log("[Kicker Hax SPA] Inicializando...");const n=document.getElementById("match-btn-fullscreen");n&&(n.onclick=()=>fk()),XS.init(),Gi.loadSettings(),uk.init(),document.querySelectorAll("button, .btn").forEach(t=>{t.addEventListener("click",s=>{const i=document.createElement("span");i.className="ripple";const r=t.getBoundingClientRect(),o=Math.max(r.width,r.height);i.style.width=i.style.height=`${o}px`,i.style.left=`${s.clientX-r.left-o/2}px`,i.style.top=`${s.clientY-r.top-o/2}px`,t.appendChild(i),setTimeout(()=>i.remove(),500)})});const e=document.getElementById("splash-status");Xe.subscribeToAuth(async t=>{if(t)if(e&&(e.textContent="Conectando ao banco de dados..."),await Be.init(t),await Ep.init(t),Gi.init(),Be.profileData&&Be.profileData.isNewUser){he("Escolha seu apelido de jogador antes de começar!","info");const s=document.getElementById("profile-btn-back");s&&(s.style.display="none"),$.show("profile-screen")}else{const s=document.getElementById("profile-btn-back");s&&(s.style.display=""),$.show("menu-screen")}else Be.currentUser=null,Ep.currentUser=null,$.show("login-screen")})}function fk(){document.fullscreenElement?document.exitFullscreen():document.documentElement.requestFullscreen().catch(n=>{console.warn(`Erro ao ativar tela cheia: ${n.message}`)})}window.addEventListener("DOMContentLoaded",dk);
